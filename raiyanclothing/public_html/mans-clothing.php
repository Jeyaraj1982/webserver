				...
				<div class="container">
					...
					<div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse pull-right">
						<div class="row">
								...
								<li><a class="active"href="mans-clothing.php">Mens</a></li>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="products">
                                            ...
                                            if (isset($_REQUEST['product'])) {
                                                ...
                                                $lists = $mysql->select("select * from _products where maincategoryid=2 and ispublished=1 order by productid desc");
                                                include_once("list.php");
                                            }
                                            ?>
									        </div>
							...
							<aside id="sidebar">
								<form class="filter-form">
									<fieldset>
										<div class="widget filter brand">
											...
											<ul>
												 <?php
                                                 $lists = $mysql->select("select * from _subcategories where maincategoryid=2  order by subcategoryname");
                                                 foreach($lists as $l) {
                                                 ?>
								...
								<div class="widget sidebar-banner">
									...
									<div class="banner-text">
										...
										<a class="theme-btn-sm btn-shopnow" href="Store-locator.php">Visit Us</a>
									</div>
								</div>
							</aside>
						</div>
