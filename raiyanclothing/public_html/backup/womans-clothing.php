				...
				<div class="container">
					...
					<div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse pull-right">
						<div class="row">
								...
								<li  class="active"><a href="womans-clothing.html">Womens </a></li>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="products">
											<div class="row">
													...
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-08.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-11.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-12.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-13.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-14.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-02.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-03.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-04.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/ladies/product-05.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														...
														<figure><img alt="image description" src="images/products/ladies/product-06.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														...
														<figure><img alt="image description" src="images/products/ladies/product-07.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
							...
							<aside id="sidebar">
									...
									<fieldset>
										...
										<div class="widget filter brand">
											...
											<ul>
												...
												<li> Fancy Sarees</li>
												<li>Synthetic Sarees</li>
												<li>Fancy Silk</li>
												<li>Fancy Art Silk Sarees</li>
												<li>Cotton Sarees</li>
												<li>Cotton Embroidery Sarees</li>
												<li>Exclusive Salwar Kameez</li>
												<li>salwar kameez</li>
												<li>Half Sarees</li>
												<li>Leggings</li>
								...
								<div class="widget sidebar-banner">
									...
									<div class="banner-text">
										...
										<a class="theme-btn-sm btn-shopnow" href="store-locator.html">Visit Shop</a>
									</div>
								</div>
