				...
				<div class="container">
					...
					<div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse pull-right">
						<div class="row">
								...
								<li><a class="active"href="mans-clothing.html">Mens</a></li>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="product-banner">
											<img src="images/img-48.jpg" alt="image description">
										...
										<div class="products">
											<div class="row">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-02.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-03.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-04.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-05.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														...
														<figure><img alt="image description" src="images/products/product-06.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														...
														<figure><img alt="image description" src="images/products/product-07.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-08.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-09.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/gents/product-11.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
														...
														<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/product-01.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/gents/product-02.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 product-width">
													<div class="product">
														<figure><img alt="image description" src="images/products/gents/product-03.jpg"></figure>
														<div class="img-hover">
															<div class="box">
																<div class="holder">
																	<div class="border-center">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 pull-left">
							<aside id="sidebar">
								...
								<div class="widget sidebar-banner">
									<figure><img src="images/banner-02.jpg" alt="image description"></figure>
									<div class="banner-text">
										<span class="banner-title">Mens Fashion Wear</span>
										<p>Latest Mens Clothes With Best Collections.</p>
										<a class="theme-btn-sm btn-shopnow" href="Store-locator.html">Visit Us</a>
									</div>
								</div>
							</aside>
						</div>
