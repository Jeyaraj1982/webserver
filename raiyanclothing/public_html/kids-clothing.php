				...
				<div class="container">
					...
					<div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse pull-right">
						<div class="row">
								...
								<li class="active"><a href="kids-clothing.php">Kids</a></li>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="products">
                                            ...
                                            if (isset($_REQUEST['product'])) {
                                                ...
                                                $lists = $mysql->select("select * from _products where maincategoryid=1 and ispublished=1 order by productid desc");
                                                include_once("list.php");
                                            }
                                            ?>
                                            </div>
							...
							<aside id="sidebar">
								<form class="filter-form">
									<fieldset>
										...
										<div class="widget filter brand">
											...
											<ul>
												 <?php
                                                 $lists = $mysql->select("select * from _subcategories where maincategoryid=1 order by subcategoryname");
                                                 foreach($lists as $l) {
                                                     ?>
								...
								<div class="widget sidebar-banner">
									...
									<div class="banner-text">
										...
										<a class="theme-btn-sm btn-shopnow" href="store-locator.php">Shop Now</a>
									</div>
								</div>
