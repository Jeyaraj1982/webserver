                                ...
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">E-Pin (5H Series)</p>
                                                <h4 class="card-title"><?php echo  sizeof($mysql->select("select * from  _tbl_epins where PinPackageID='2' ")); ?></h4>
                                                <p>
                                                    <span class="pl-1"><?php echo  sizeof($mysql->select("select * from  _tbl_epins where PinPackageID='2' and IsSold='1' ")); ?></span>&nbsp;Sold,
                                                    <span class="pl-1"><?php echo  sizeof($mysql->select("select * from  _tbl_epins where PinPackageID='2' and IsUsed='1' ")); ?></span>&nbsp;Used
                                                </p>   
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">E-Pin (1H Series)</p>
                                                <h4 class="card-title"><?php echo  sizeof($mysql->select("select * from  _tbl_epins where PinPackageID='2' ")); ?></h4>
                                                <p>
                                                    <span class="pl-1"><?php echo  sizeof($mysql->select("select * from  _tbl_epins where PinPackageID='2' and IsSold='1' ")); ?></span>&nbsp;Sold,
                                                    <span class="pl-1"><?php echo  sizeof($mysql->select("select * from  _tbl_epins where PinPackageID='3' and IsUsed='1' ")); ?></span>&nbsp;Used
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Total Payout</p>
                                                <h4 class="card-title">0.00</h4>
                                                <p><span class="pl-1">Payout Requests&nbsp;0</p>
                                            </div>
                                        </div>
