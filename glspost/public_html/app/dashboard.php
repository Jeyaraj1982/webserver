<?php
    ...
    if (! (isset($_SESSION['User']['CustomerID']) )) {
        ?>
        <script>
       // location.href='https://www.j2jsoftwaresolutions.com/index.php';
        </script>
        <?php
    }
?>
...
<body>
	<div class="wrapper">
		<div class="main-header">
			...
			<!-- Navbar Header -->
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2" style="background:#222 !important;">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?php echo getImageUrl($_SESSION['User']['Thumb'],$_SESSION['User']['Sex']);?>" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
