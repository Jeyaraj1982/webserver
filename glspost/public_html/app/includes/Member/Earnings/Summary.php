                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="basic-datatables" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    <?php
                                        $requests = $mysql->select("select * from _tbl_wallet_earnings where Date(`TxnDate`)>=Date('".$_POST['From']."') and Date(`TxnDate`)<=Date('".$_POST['To']."') and  MemberID='".$_SESSION['User']['MemberID']."'  Order by `EarningID` DESC")
                                    ?> 
