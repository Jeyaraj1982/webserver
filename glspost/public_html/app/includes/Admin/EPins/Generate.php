                ...
                <div class="card-body">
                    <?php
                        ...
                        if (isset($_POST['btnGenerate'])) {
                            ...
                            if ($error==0) {
                                $_SESSION['tmp']=array("otp"=>1111,"package"=>$package[0],"member"=>$member[0],"pins"=>$_POST['NumberofPins']);
                        ...
                        <div class="form-actions">
                            <div class="form-group user-test" id="user-exists">
                                ...
                                <select name="NumberofPins" id="NumberofPins" class="form-control">
                                    <?php for($i=1;$i<=10;$i++) {?>
                                    <option value=<?php echo $i;?> <?php echo (isset($_POST['NumberofPins']) && $_POST['NumberofPins']==$i) ? ' selected="selected" ':"";?>><?php echo $i; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
