                        ...
                        <script>
                            function submitLogin() {
                               ...
                               $('#ErrPassword').html("");
                                ...
                                ErrorCount = 0;
                                IsNonEmpty("AdminCode", "ErrAdminCode", "Please Enter Valid Admin Code");
                        ...
                        <form method="post" onsubmit="return submitLogin()">
                            <div class="modal-body">
                                <div class="h5 modal-title text-center">
                                    <h4 class="mt-2"><div>Admi Login</div><span>Registered Admi Login here.</span>   </h4>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            <input type="password" class="form-control" name="AdminCode" id="AdminCode" placeholder="Admin ID here..." value="<?php echo isset($_POST['AdminCode']) ? $_POST['AdminCode'] : '';?>">
