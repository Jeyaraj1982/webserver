                                                 ...
                                                 <div class="form-group row">
                                                  ...
                                                  <div class="form-group row">
                                                   ...
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9"><input type="text"  name="MOVillage" id="MOVillage" placeholder="Village & Pin Code" class="form-control" value="<?php echo $myprofile[0]['MOVillage'];?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-3">MO & A/C Number<span id="star">*</span></div>
                                                        <div class="col-sm-9"><input type="text"  name="MOAccount" id="MOAccount" placeholder="MO & A/C Number" class="form-control" value="<?php echo $myprofile[0]['MOAccount'];?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
