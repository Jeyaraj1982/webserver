                ...
                <div class="page-title-heading">
                    ...
                    <div style="text-align:center">
                        <div class="h5 modal-title text-center">
                            <h4 class="mt-2" style="margin-bottom: 1.5rem;font-weight: normal;margin-top: .5rem !important;opacity: .6;"><div>Create Member</div><span style="font-size: 1.1rem;">Using Sponsor ID</span></h4>
                        </div>
                    </div>
                </div>
            </div>
