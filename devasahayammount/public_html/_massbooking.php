...
<table cellpadding="5" cellspacing="0" style="margin:10px;margin:10px;font-family:'Droid Sans';font-size:13px;color:#444444;width:100%">
    ...
    <tr>
        ...
        <td>
         <input type="text" name="adatepicker_b" id="adatepicker_b" value="<?php echo (isset($_POST['adatepicker_b'])) ? $_POST['adatepicker_b'] : date("Y-m-d");?>" style="width:80px;text-align:center">
          <?php if (isset($date)) {echo "&nbsp;&nbsp;<span style='color:red'>".$date."</span>"; } ?>
          <script>new JsDatePick({useMode:2,target:"adatepicker_b",dateFormat:"%Y-%m-%d",yearsRange:[2014,2020]});</script> 
        </td>
    </tr> 
    <tr>
