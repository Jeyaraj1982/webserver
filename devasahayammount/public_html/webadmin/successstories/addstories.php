...
<body style="margin:0px;">
    <div style='font-family:arial;font-size:13px;border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;'>New Success Stories</div>
        <form action="" method="post" style="height: 20px;" enctype="multipart/form-data">
            <table cellpadding="5" cellspacing="0" align="center" style="font-family:arial;font-size:12px;color:#222;width:100%">
                ...
                <tr>
                    ...
                    <td><input type="text" name="storyname"  size="40" style="width:100%;" value="<?php echo isset($_POST['storyname']) ? $_POST['storyname'] : ""; ?>" autocomplete="off"></td> 
                </tr>
                <tr>
                    <td style="width:60px">Email</td> 
                    <td><input type="text" name="storyemail"  size="40" style="width:100%;" value="<?php echo isset($_POST['storyemail']) ? $_POST['storyemail'] : ""; ?>" autocomplete="off"></td> 
                </tr>
                <tr>
                    <td style="width:60px">Mobile No.</td> 
                    <td><input type="text" name="storymobile" maxlength="10" size="40" value="<?php echo isset($_POST['storymobile']) ? $_POST['storymobile'] : ""; ?>" style="width:100%;" autocomplete="off"></td> 
                </tr>
                <tr>
