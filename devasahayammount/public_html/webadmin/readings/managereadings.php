...
<?php 
    $obj = new CommonController();  
     ...
     if(isset($_POST{"updatebtn"})) {
         ...
         $param = array("readingid"=>$_POST['rowid'],"title"=>$_POST['title'],"details"=>str_replace("'","\\'",$_POST['details']),"title_t"=>$_POST['title_t'],"details_t"=>str_replace("'","\\'",$_POST['details_t']),"date"=>$_POST['datepicker'],"isreading"=>$_POST['reading']);
...
$(function() {
    ...
    <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>Edit Readings</div>
    <form action="" method="post" style="height: 20px;"  enctype="multipart/form-data">
        ...
        <table cellpadding="5" cellspacing="0" align="center" style="font-family:arial;font-size:12px;color:#222;width:100%">
            <tr>
             ...
             <tr>
                <td>Reading/Reflexions</td>
                <td><select name="reading"><option value='0' <?php echo ($pageContent[0]["isreading"]==0) ? 'selected="selected"' : '';?>>Reading</option><option value='1' <?php echo ($pageContent[0]["isreading"]!=0) ? 'selected="selected"' : '';?>>Reflexions</option></select></td>
             </tr>
           <tr>
                <td style="width:60px">English Title</td> 
            ...
            <tr>
                <td style="width:60px">Tamil Title</td> 
      ...
      $pageContent = JReading::getReading($_POST['rowid']);
       ...
       <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>View Readings</div>
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       $pageContent = JReading::getReading($_POST['rowid']);
       ?>
       <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>Delete Readings</div>
