...
include_once("../../config.php");
            ...
            if (isset($_POST{"save"})) {
                  if(CommonController::isEmptyField($_POST['itemname']) || CommonController::isEmptyField($_POST['itemdescription'])||CommonController::isEmptyField($_POST['itemprice'])) {
                   ...
                   else if(JProduct::addProduct($_POST['itemname'],$_POST['itemdescription'],$_POST['itemprice'],$_POST['ispublished'])>0){
...
<div style='font-family:arial;font-size:13px;border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;'>Add Products</div> 
    <form action="" method="post" style="height: 20px;" enctype="multipart/form-data">
        <table  style="margin:10px;width:100%;font-size:12px;font-family:arial;color:#333" cellpadding="3" cellspacing="0" align="center">
               ...
               <tr>
                     ...
                     <td><input type="text" name="itemprice"  size="40" style="width:250px;"><br></td> 
               </tr>
                <tr>
