...
<?php 
        ...
        if (isset($_POST{"save"})) {
            ...
            if ($obj->isEmptyField($_POST['faqanswer'])) {
                ...
                $param=array("faqquestion"=>$_POST['faqquestion'],"faqanswer"=>$_POST['faqanswer'],"ispublished"=>$_POST['ispublished']);
...
<div style='font-family:arial;font-size:13px;border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;'>Add FAQ</div>
    <form action="" method="post" style="height: 20px;" enctype="multipart/form-data">
        <table  style="margin:10px;width:100%;font-size:12px;font-family:arial;color:#333" cellpadding="3" cellspacing="0" align="center">
               ...
               <tr>
                    ...
                    <input type="button" name="cancel" value="Cancel" bgcolor="grey" onclick="location.href='managefaq.php'"></td>
              </tr> 
        </table>
    </form>
</body>