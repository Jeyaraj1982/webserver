...
<?php 
         $obj = new CommonController();
            ...
            if (isset($_POST{"save"})) {
              ...
              if ($obj->err==0) {
                echo ( (JDownloads::addDownloadAlbum($param)>0) ?   $obj->printSuccess("Albums added successfully") : $obj->printError("Error Adding Albums") );
                unset($_POST);
             } 
...
<div style='font-family:arial;font-size:13px;border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;'>Add Download Albums</div> 
    <form action="" method="post" style="height: 20px;" enctype="multipart/form-data">
        <table style="margin:10px;width:100%;font-size:12px;font-family:arial;color:#333" cellpadding="3" cellspacing="0" align="center">
               ...
               <tr>
                    ...
                    <input type="button" name="cancel" value="Cancel" bgcolor="grey" onclick="location.href='dmanagealbum.php'"></td>
              </tr> 
        </table>
    </form>
</body>
