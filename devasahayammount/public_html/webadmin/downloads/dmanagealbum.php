...
<?php
          ...
          if(isset($_POST{"cdeletebtn"})){
                echo JDownloads::deleteDownloadAlbum($_POST['rowid']); 
        ...
        ?>
            <form action='' method="post">
                <table  style="margin:10px;width:100%;font-size:12px;font-family:arial;color:#333" cellpadding="3" cellspacing="0" align="center">
                    ...
                    <input type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='dmanagealbum.php'"> 
            </form>
        <?php
            exit;
      }
        if(isset($_POST{"updatebtn"})){
                ...
                $param = array("dalbumid"=>$_POST['rowid'],"albumtitle"=>$_POST['albumtitle'],"albumdescription"=>$_POST['albumdescription'],"ispublished"=>$_POST['ispublished']);
                echo JDownloads::updateDownloadAlbum($param,$_POST['rowid']);
      ...
      <form action='' method='post'  > 
        <tr class="mytr">
           ...
           <br><b>Album Description</b><br>
            ...
            <td>
                <input type='hidden' value='<?php echo $r["dalbumid"];?>' name='rowid' id='rowid' >
