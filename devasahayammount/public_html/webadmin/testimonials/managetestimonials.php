...
<?php 
     ...
     if(isset($_POST{"updatebtn"})){
                ...
                $param = array("storyid"=>$_POST['rowid'],"storytitle"=>$_POST['storytitle'],"storydescription"=>$_POST['storydescription'],"storyname"=>$_POST['storyname'],"email"=>$_POST['storyemail'],"mobileno"=>$_POST['storymobile'],"ispublish"=>$_POST['ispublish']);
      ...
      if (isset($_POST{"editbtn"})){
       ...
       <div style='font-family:arial;font-size:13px;border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;'>Edit Testimonials</div>
              ...
              <input type="hidden" name="rowid" value="<?php echo $pageContent[0]['storyid'];?>">
                <table cellpadding="5" cellspacing="0" align="center" style="font-family:arial;font-size:12px;color:#222;width:100%">
                    <tr>
                         ...
                         <td><input type="text" name="storytitle" style="width:100%;" value="<?php echo $pageContent[0]['storytitle'];?>"></td> 
                   </tr>
                    <tr>
                    ...
                    <tr>
                        <td> <?php if (strlen(trim($pageContent[0]['filepath']))>0) {?> 
                            <img src="../../assets/cms/<?php echo $pageContent[0]['filepath'];?>" align="right" style="margin:5px;border:1px solid #ccc;padding:3px;margin-right:0px;" height="120"> <br>
                             <br> <input type="submit" value="Remove Image" name="rmimage"> &nbsp;&nbsp;
                             <?php }?>  
                   ...
                   <tr>
                         ...
                         <td><input type="text" name="storyname" value="<?php echo $pageContent[0]['storyname'];?>" style="width:100%;"></td> 
                   </tr>
                    <tr>
                         <td style="width:60px">Email</td> 
                         <td><input type="text" name="storyemail" value="<?php echo $pageContent[0]['email'];?>" style="width:100%;"></td> 
                   </tr>
                   <tr>
                        <td style="width:60px">Mobile No.</td> 
                        <td><input type="text" name="storymobile" maxlength="10" value="<?php echo $pageContent[0]['mobileno'];?>" style="width:100%;"></td> 
                   </tr>
                   <tr>
                       <td> Is Publish? <select name="ispublish">
                            <option value='1' <?php echo ($pageContent[0]['ispublish']==1) ? "selected='selected'" : "";?>>Publish</option>
                            <option value='0' <?php echo ($pageContent[0]['ispublish']==0) ? "selected='selected'" : "";?>>Unpublish</option>
                            </select>&nbsp;
                        </td>
                   </tr>
                    <tr>
                         <td colspan="2"><input type="submit" name="updatebtn" value="Update" bgcolor="grey">
                        <input type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='viewtestimonials.php'"> 
                        </td>
                   </tr>
        </table>
    </form>
      ...
      if (isset($_POST{"viewbtn"})){
       ...
       <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>View Testimonials</div>
            <table  style="margin:10px;width:100%;font-size:12px;font-family:arial;color:#333" cellpadding="3" cellspacing="0" align="center">
                ...
                <tr>
                    ...
                    <td style="text-align:justify;font-family:arial;font-size:12px;" colspan="2">
                    <?php if (strlen(trim($pageContent[0]['filepath']))>0) {?> 
                    <img src="../../assets/cms/<?php echo $pageContent[0]['filepath'];?>" align="right" style="margin:5px;border:1px solid #ccc;padding:3px;margin-right:0px;" height="120">
                     <?php } ?>   
                ...
                <tr>
                    ...
                    <form action='managetestimonials.php' method='post' style='height:0px;'>
                        ...
                        <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='viewtestimonials.php'"> 
                   </form>
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       ?>
       <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>Delete Testimonials</div>
