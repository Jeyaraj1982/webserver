...
<?php 
     ...
     if(isset($_POST{"updatebtn"})){
          ...
          $param = array("pageid"=>$_POST['rowid'],"pagetitle"=>$_POST['pagetitle'],"pagedescription"=>$_POST['pagedescription'],"ispublish"=>$_POST['ispublish']);
     ...
     <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>Edit NEWS</div>
    ...
    <input type="hidden" name="rowid" value="<?php echo $pageContent[0]['pageid'];?>">
      ...
      if (isset($_POST{"viewbtn"})){
       ...
       <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>View News</div>
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       ?>
       <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>Delete News</div>
