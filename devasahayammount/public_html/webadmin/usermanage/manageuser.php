  ...
  <body style="margin:0px;">
    <?php 
      ...
      if (isset($_POST{"editbtn"})) {
       ...
       ?>
    <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>Edit User</div>
    ...
    <input type="hidden" name="rowid" value="<?php echo $pageContent[0]['userid'];?>">
      ...
      <div style='border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;font-family:arial;font-size:12px;'>View User</div>
       <table>
       <tr>
