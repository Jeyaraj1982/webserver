...
?>    
 <body style="margin:0px;">
    <div style='font-family:arial;font-size:13px;border:1px solid #ccc;background:#ccc;padding:3px;font-weight:bold;color:#444;'>Manage Photos Group Wise</div> 
        <form action="managephotos.php" method="POST" style="height: 20px;" name="managephotoalbums" id="managephotoalbums">
            <table style="margin:10px;width:100%;font-size:12px;font-family:arial;color:#333" cellpadding="3" cellspacing="0" align="center">              
                <tr>
                    <td>Gallery Name</td>
                    <td>
                        <select style="width:250px;" name="groupname" id="groupname" onchange="javascript:window.open('managephotosgroupwise.php?groupname='+(this).value,'viewPhotos')">
