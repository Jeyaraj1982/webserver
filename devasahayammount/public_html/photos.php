            ...
            <table cellpadding="0" cellpadding="0">
                <tr>
                    <td style="padding-left:0px">
                        ...
                        <a class="fancybox" rel="gallery1" href="assets/cms/<?php echo $p['photofilepath'];?>" title="<?php echo $p['phototitle'];?>" style="outline:none">
                            <img onmouseout="$(this).css('border','1px solid #ccc')" onmouseover="$(this).css('border','1px solid #333')" style="cursor:pointer;border:1px solid #ccc;" src="assets/cms/<?php echo $p['photofilepath'];?>" height="93" width="129">
                             </a>
                        </div>
                ...
                <tr>
                    <td style="padding-left:0px">
                        <div style='background:#fff;padding:3px'>
                            ...
                            <img onmouseout="$(this).css('border','none')" onmouseover="$(this).css('border','1px solid #333')" style=";cursor:pointer;border:1px solid #ccc;border-bottom:none;" src="assets/cms/<?php echo $gallery['filepath'];?>" height="93" width="129"></a>
