    ...
    <div class="jTitle">Photo Gallery</div>
                ...
                <tr>
                    <td style="padding-left:0px">
                        <div style='background:#fff;padding:3px'>
                            ...
                            <img onmouseout="$(this).css('border','none')" onmouseover="$(this).css('border','1px solid #333')" style=";cursor:pointer;border:1px solid #ccc;border-bottom:none;" src="assets/cms/<?php echo $gallery['filepath'];?>" height="93" width="124"></a>
