        ...
        $filename = ((strlen(trim($news['filepath']))>4) && file_exists("assets/cms/".$news['filepath'])) ? "assets/cms/".$news['filepath'] : "assets/cms/".JFrame::getAppSetting('noimg'); 
        ?> 
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top;padding-left:5px;">
                            <div class="jContent">
                               ...
                               <?php echo strip_tags(substr(strip_tags($news["pagedescription"]),0,130))."... ";?> </div>  </td>
                    </tr>
                </table>
            </div>
