<?php
    class JSuccessStory { 
        ...
        function addStory($param){
            global $mysql; 
            return $mysql->insert("_jsuccessstory",array("storytitle"=>$param['storytitle'],"storydescription"=>$param['storydescription'],"storyname"=>$param['storyname'],"email"=>$param['email'],"mobileno"=>$param['mobileno'],"storytype"=>$param['storytype'],"filepath"=>$param['filename'],"postedon"=>date("Y-m-d H:i:s"),"lastmodified"=>date("Y-m-d H:i:s"),"ispublish"=>$param['ispublish']));   
        }
