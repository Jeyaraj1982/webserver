...
?>
  <div class="jTitle" style="margin-left:2px;">Testimonial</div> 
                    ...
                    $filename = ((strlen(trim($story['filepath']))>4) && file_exists("assets/cms/".$story['filepath'])) ? "assets/cms/".$story['filepath'] : "assets/cms/".JFrame::getAppSetting('noimg'); 
                    ?> 
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:top;padding-left:5px;">
                                        <div class="jContent">
                                           ...
                                           Name:<span style='color:#444;font-weight:bold;'><?php echo $story['storyname'];?></span>&nbsp;&nbsp;
                                           PostedOn:<span style='color:#444;font-weight:bold;'><?php echo $story['postedon'];?></span></div>  </td>
                                </tr>
                            </table>
                        </div>
...
?>
<a class="jMore" href="testimonials.php">More</a>                    
<?php
