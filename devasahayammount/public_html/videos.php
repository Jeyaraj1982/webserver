                            ...
                            <table cellpadding="0" cellpadding="0">
                                <tr>
                                    <td style="padding-left:0px">
                                        ...
                                        <a href="videos.php?viewvid=<?php echo $video['videoid'];?>" class="viewmore"><?php echo $youtube->getTitle();?></a></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <table cellpadding="0" cellpadding="0">
                <tr>
                    <td style="padding-left:0px">
                        ...
                        <div class="jContent" style="font-size:10px;color:#222;text-align:center">
                            <a href="videos.php?viewvid=<?php echo $video['videoid'];?>" class="viewmore"><?php echo $youtube->getTitle();?></a>
                        </div>
                    </td>
                </tr>
            </table>
