        ...
        <table cellpadding="5" cellpadding="0" width="100%" style="font-family:'Droid Sans';font-size:13px;color:#444444">
            ...
            <tr>
                <td style="width: 125px;">
                    <img src="assets/cms/<?php echo $album["filepath"];?>" height="160" width="120" style="border:1px solid #ccc;padding:2px;">    
                </td>
                <td valign="top">
        ...
        <table cellpadding="0" cellpadding="0" width="100%" style="margin:10px;font-family:'Droid Sans';font-size:13px;color:#444444">
            ...
            <tr>
                ...
                <td style="width: 203px;">
                    <iframe src="assets/dewplayer.swf?mp3=cms/<?php echo $music["musicfilepath"];?>&autostart=false&autoreplay=false" style="height: 20px;;width:200px;border:none;background:none;" ></iframe>
                </td>
                <td style="width:24px;">
                    <a style="outline: none;" target="_blank" href ="assets/cms/<?php echo $music["musicfilepath"];?>" title="Download File"><img src="assets/images/DownloadButtonGreen32.gif" style="width: 22px;" title="Download"></a>                    
                </td>
            </tr>
            <?php } ?>
        </table>
