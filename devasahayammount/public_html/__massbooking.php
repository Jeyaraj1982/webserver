...
?>
<div class="jTitle">Mass Booking  (நேர்ச்சைத்  திருப்பலி பதிவு)</div>
<br> 
...
<table cellpadding="5" cellspacing="0" style="margin:10px;margin:10px;font-family:'Droid Sans';font-size:13px;color:#444444;width:100%">
    <tr>
        <td><span style="color:#222">Book for</span><br><span style="font-size:10px;">
        
        தேவை </span></td>
        <td ><select name="bookfor" style="width:400px;">
    ...
    <tr>
        <td style="vertical-align: top;width:200px;" ><span style="color:#222">Intention</span><br><span style="font-size:10px;">
        கருத்து</span></td>
        <td><textarea name="intention" style="width:400px;height:80px;"><?php echo $_POST['intention'];?></textarea>
            <?php if (isset($intention)) {echo "<br><span style='color:red'>".$intention."</span>"; } ?>
        </td>
    </tr>                        
    <tr>
        <td><span style="color:#222">Donor</span><br><span style="font-size:10px;">நன்கொடையாளர் 
         பெயர் </span></td>
        <td><input type="text" name="clientname" style="width:400px"  maxlength="15" value="<?php echo $_POST['clientname'];?>">
         <?php if (isset($donorname)) {echo "<br><span style='color:red'>".$donorname."</span>"; } ?>
        </td>
    </tr>    
    <tr style="height:50px;">
        <td><span style="color:#222">Date of Preferred</span><br><span style="font-size:10px;">
        திருப்பலி எதிர்பார்க்கப்படும் நாள் 
        </span></td>
        <td>
    ...
    <tr>
        ...
        <td><input type="text" name="amount" style="width:80px"  maxlength="10" value="<?php echo $_POST['amount'];?>"> <span style="font-size:11px;">&nbsp;&nbsp;(Min: Rs. 90 Maximum: As your choice)</span>
    ...
    <tr>
        <td colspan="2"><input type="submit" value="Book Now" class="myButton" name="paynow"></td>
    </tr>
</table> 
</form>   
<br><br>
