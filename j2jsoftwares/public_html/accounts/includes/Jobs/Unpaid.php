	    ...
	    <div class="col-md-12">
		    <div class="card">
			    <div class="card-header">
                    ...
                    <span style="font-weight:normal;color:#888">Unpaid Jobs</span>
				</div>
				<div class="card-body">
				    <div class="table-responsive">
					    <div class="table-responsive">
                            <table id="basic-datatables" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    <?php
                                        $projects = $mysql->select("select * from _Customer_Jobs where Paid='0' and IsCompleted='1' and  CustomerID='".$_SESSION['USER']['CustomerID']."' order by Requested desc");
