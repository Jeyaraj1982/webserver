<h3 style="font-family:arial">Testimonials</h3>
<?php
 include_once("config.php");
    
    //where date(endon)>=date('".date("Y-m-d H:i:s")."')
    $products = $mysql->select("select * from _tbltestimonials");
               ?>
    ...
    foreach($products as $p ) {
        ...
        <tr style="background: <?php echo $bgcolor;?>">
            <td style="padding-left:5px;padding-right:5px;text-align:center"><img src="../testimonials/<?php echo $p['photopath'];?>" height="100" width="80"><br><?php echo $p['test_name'];?></td>
            <td style="text-align:left;padding-left:5px;padding-right:5px;"><?php echo $p['testimonials'];?>
            <br>Date : <?php echo $p['date'];?> .
            </td>
    
            <td style="">
                <a href='testimonials_edit.php?item=<?php echo md5($p['id']);?>'  style="color:#444444">Edit</a> 
               </td>  
        </tr>        
        <?php
    }
