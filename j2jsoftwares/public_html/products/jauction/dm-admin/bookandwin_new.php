...
<form action="" method="post" enctype="multipart/form-data">
    <table  style="font-size:12px;font-family:arial;width:100%;" cellpadding="5" cellspacing="0" border="1">
        ...
        <tr>
            ...
            <?php } else {?>
            RM.
            <?php } ?> <input type="text" name="price" style="text-align:right;border:1px solid #999;" autocomplete="Off"></td>
        </tr>
        <tr>
            <td>Key</td>
        ...
        <tr>
            ...
            <?php } else {?>
            RM.
            <?php } ?> <input type="text" name="bidamount" style="text-align:right;border:1px solid #999" autocomplete="Off">
            Maximum Bids
