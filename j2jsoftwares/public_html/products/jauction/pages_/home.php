      <?php
            $c = 0;
                foreach($mysql->select("select * from _items where date('".date("Y-m-d H:i:s")."')<=date(endon)") as $item) {
                    $i = $item['itemid'];
            ?>
...
?>
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2"><div style="text-align: center;"><img src="productimages/<?php echo $item['productimage']; ?>" width="320"></div></td>
                    </tr>
                    <tr>
                        <td colspan="2">
