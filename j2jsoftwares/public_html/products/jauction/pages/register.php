                            ...
                            if  ( (strlen(trim($_POST['personname']))>0 && ($_POST['password']==$_POST['cpassword']) ) ) {
                                ...
                                if (sizeof($c)==0) {
                                    ...
                                    $d = $mysql->select("select * from _usertable where userid='".$userid."' and password='".$_POST['password']."'");     
                                     ...
                                     echo "<script>location.href='http://www.wincashdeal.com/p/viewCart';</script>";
                                     } else {
                                         echo "<script>location.href='http://www.wincashdeal.com/p/usr_mypage';</script>";  
                                     }
...
<div style="font-size:12px;font-family:arial;border:5px solid #F9D49D;background:#fff">
  
<div style="background:#F9D49D;color:#333;font-size:13px;font-weight:bold;font-family:arial;padding:8px;text-transform: capitalize">Register / Login </div>
<br><Br> 
    <table align="center" style="background: #fff;">
     ...
     if (isset($_POST['loginBtn'])) {
         ...
         if (sizeof($d)>0) {
               $_SESSION['USER']=$d[0];
                if (sizeof($_SESSION['cartItem'])>0) {   
                     echo "<script>alert('successfully logged');location.href='http://www.wincashdeal.com/p/viewCart'</script>";
                } else {
                    echo "<script>alert('successfully logged');location.href='http://www.wincashdeal.com/p/usr_mypage'</script>";     
                }
