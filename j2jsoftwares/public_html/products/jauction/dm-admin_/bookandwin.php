...
<?php
 include_once("config.php");
    ...
    $products = $mysql->select("select * from _items where auctiontype='btw'");
               ?>
    ...
    foreach($products as $p ) {
        ...
        <tr style="background: <?php echo $bgcolor;?>">
            ...
            <td style="text-align:right;padding-left:5px;padding-right:5px;">0</td>  
             ...
             <td style="text-align:right;padding-left:5px;padding-right:5px;"><?php echo $p['winkey'];?></td> 
            <td style="">
               <!-- <a href='javascript:void(0)'  onclick="window.open('timebased_edit.php?item=<?php echo md5($p['itemid']);?>','GoogleWindow', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no,width=480,height=480');" style="color:#444444">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;-->
                ...
                <a href='javascript:void(0)'  onclick="window.open('timebased_view.php?item=<?php echo md5($p['itemid']);?>','GoogleWindow', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no,width=390,height=435');" style="color:#444444">View</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
