...
<?php
 include_once("config.php");
    ...
    $products = $mysql->select("select * from _pjusertable order by userid desc");
               ?>
                    <table cellpadding="3" cellspacing="4" border="1" style="font-size:12px;font-family:arial;" width="100%">
                        <tr  style="background:#666;font-weight:bold;text-align: center;color:#FFFFFF">
                            ...
                            <td style="border:1px solid #f1f1f1;padding-left:5px;padding-right:5px;">City Name</td>
        ...
        <tr>  
            ...
            <td style="text-align:right;padding-left:5px;padding-right:5px;"><?php echo $p['cityname'];?></td>
