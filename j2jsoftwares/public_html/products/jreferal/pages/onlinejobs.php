...
<!--<b>Deposit&nbsp;:&nbsp;</b> Rs. 3,000 <br>
    ...
    <bR><Br><Br>     <bR><Br><Br> 
      <br>
        <div style='border:1px solid #D15B0C;font-size:12px;font-family:arial;padding:5px;margin:5px;background:#FCF1EA'>
                ...
                <form action="" method="post">
                    <table align="center" cellpadding="5" cellspacing="0" style="font-size:12px;font-family:arial;">
                        <tr>
                            ...
                            <td><input type='text' name='mnumber' style="padding:8px;border:1px solid #FF6600;font-size:18px;font-weight:bold;width:180px" maxlength="10"></td>
                            <td><input type='image' src='images/navigation-down-button.png'></td>
                        </tr>
                    </table>
                </form>
       <?php
...
?>
    ...
    <br><div style="margin:10px;text-align:center;font-size:20px;color:blue;font-weight:bold;">Online Typing Registartion Fee : Rs. 2000</div><br><br>
