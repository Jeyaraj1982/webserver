...
include_once("classes/class.MRoboticsAPI.php");
include_once("classes/class.EzytmAPI.php");
include_once("classes/class.RealRoboAPI.php");
include_once("classes/class.ManualRecharge.php");
include_once("classes/class.AnnaiAPI.php");

define("APPURL","https://www.saralservices.in");    
$mysql = new MySqlDb("localhost","saralser_user","mysqlPwd@123","saralser_database");
