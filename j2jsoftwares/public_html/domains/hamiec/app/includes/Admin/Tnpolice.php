        ...
        <div class="page-inner">
            <div class="row" class="col-md-12" style="margin-bottom:10px;">
                <div class="col-md-12" style="text-align: right;">
                    <a href="dashboard.php?action=Tnpolice&filter=accepted" <?php if($_GET['filter']=="accepted") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Accepted</small></a>&nbsp;|&nbsp; 
                    <a href="dashboard.php?action=Tnpolice&filter=paid" <?php if($_GET['filter']=="paid") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Paid</small></a>&nbsp;|&nbsp;
                    <a href="dashboard.php?action=Tnpolice&filter=reversed" <?php if($_GET['filter']=="reversed") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Reversed</small></a>&nbsp;|&nbsp;
                    <a href="dashboard.php?action=Tnpolice&filter=all" <?php if($_GET['filter']=="all") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>All</small></a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
