<?php 
      // $sql= $mysql->select("select * from `_tbl_Log_MobileSMS` order by `SMSID` desc ");
       ...
       $sql = $mysql->select("SELECT * FROM _tbl_ifsc_log
                                            LEFT JOIN _tbl_Members
                                            ON _tbl_ifsc_log.UserID = _tbl_Members.MemberID where Date(_tbl_ifsc_log.TxnOn)>=Date('".$_POST['From']."') and Date(_tbl_ifsc_log.TxnOn)<=Date('".$_POST['To']."') ORDER BY LogID Desc");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">IFSC Logs</h4>
                        </div> 
                        <div class="card-body">
