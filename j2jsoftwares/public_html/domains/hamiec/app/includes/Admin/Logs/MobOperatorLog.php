<?php 
       $sql = $mysql->select("SELECT * FROM _tbl_mobile_operator_log
                                            LEFT JOIN _tbl_Members
                                            ON _tbl_mobile_operator_log.UserID = _tbl_Members.MemberID where Date(_tbl_mobile_operator_log.LogOn)>=Date('".$_POST['From']."') and Date(_tbl_mobile_operator_log.LogOn)<=Date('".$_POST['To']."')");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Mobile Operator Logs</h4>
                        </div> 
                        <div class="card-body">
