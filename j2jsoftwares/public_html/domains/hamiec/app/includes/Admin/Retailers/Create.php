             ...
             if($Error==0){
                 ...
                 $id = $mysql->insert("_tbl_Members",array("MemberName"     => $_POST['Name'],
                      ...
                      if (sizeof($id)>0) {  
                          ...
                          ?>
                     <script>location.href='dashboard.php?action=Retailers/Created';</script>
               <?php  }
                    }                                                                                                                     
             }
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">New Retailer</div>
                                </div>
                                <div class="card-body">  
                                        <div class="form-group form-show-validation row">
                                            <label for="MemberName" class="col-sm-3 text-left" style="font-weight:normal">Dealer's Name</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control"  disabled="disabled" value="<?php echo $sql[0]['MemberName'];?>">
                                                
                                            </div>
                                        </div>      
                                        <div class="form-group form-show-validation row">
                                            <label for="MemberName" class="col-sm-3 text-left" style="font-weight:normal">Retailer Name  <span class="required-label">*</span></label>
                                            <div class="col-sm-4">
                        ...
                        <div class="col-md-12"> 
                                    <div class="card-action">
                                        <div class="row">
                                            ...
                                            <a href="dashboard.php?action=Retailers/List&Status=All" class="btn btn-outline-danger">Cancel</a>
                                            <button type="submit" class="btn btn-warning" name="BtnSubmit" id="BtnSubmit">Create Retailer</button>
                                            </div>                                        
                                        </div>                                                                             
                                    </div>
