 ...
 <?php
   ...
   // $toDate = isset($_POST['tdate']) ? $_POST['tdate'] : date("Y-m-d");
    ...
    $txn = $mysql->select("select * from _tbl_mobile_operator_log where md5(Concat('J!',`UserID`))='".$_GET['d']."' order by LogID desc");
    ?> 
