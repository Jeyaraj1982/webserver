                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <?php  foreach($sql as $s){ ?>
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" onclick="ViewContacts('<?php echo $s['ContactName'];?>','<?php echo $s['MobileNumber'];?>','<?php echo $s['MobileOperator'];?>','<?php echo $s['DTHNumber'];?>','<?php echo $s['DTHOperator'];?>','<?php echo $s['TNEBNumber'];?>','<?php echo $s['TNEBRegion'];?>')">View</a></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
