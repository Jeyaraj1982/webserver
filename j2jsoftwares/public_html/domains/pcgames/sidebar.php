    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
          ...
          <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="square"></i><span class="menu-title" data-i18n="Master">Games</span></a>
            <ul class="menu-content">
              <li class="<?php echo ($page=="Games") ? ' active ':'';?>"><a href="Games.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Code Master">Games</span></a></li>
            </ul>
          </li>                               
        </ul>
      </div>
