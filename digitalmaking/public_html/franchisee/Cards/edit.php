            ...
            if($ErrorCount==0){
                if(strlen($_FILES["uploadimage1"]["name"])>0) {                                                 
                    ...
                    if (move_uploaded_file($_FILES["uploadimage1"]["tmp_name"], $target_file)) {
                       ...
                       $mysql->execute("update _tbl_card_general_info set  
                        ...
                        <form id="exampleValidation" method="POST" action="" onsubmit="return SubmitProduct();" id="addProduct" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="Proffession" name="Proffession" placeholder="Eg. +919000000000" value="<?php echo (isset($_POST['Proffession']) ? $_POST['Proffession'] :$data[0]['Proffession']);?>">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="WhatsappNumber" name="WhatsappNumber" placeholder="Enter Mobile Number" value="<?php echo (isset($_POST['WhatsappNumber']) ? $_POST['WhatsappNumber'] :$data[0]['WhatsappNumber']);?>">
