...
$Page="login";
        if (isset($_POST['btnsubmit'])) {
         ...
         $userdata = $mysql->select("select * from _tbl_franchisee where MobileNumber='".$_POST['UserName']."' and Password='".$_POST['Password']."' ");
     
                if (sizeof($userdata)>0) {
                    if($userdata[0]['IsActive']=="1") {
                        $_SESSION['User']=$userdata[0];
                        echo "<script>location.href='dashboard.php';</script>";    
                    }else {
                         echo "<script>alert('Franchisee deactivated');</script>" ;   
                    }
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center"> <img src="https://digitalmaking.in/assets/img/logo.png" style="width: 210px;height:auto"><br><br>Franchisee Sign In</h3>
            <form method="POST" action="" onsubmit="return SubmitLogin();">
                <div class="login-form">
                <div class="form-group form-floating-label">
                    <input id="UserName" name="UserName" type="text" maxlength="10" class="form-control input-border-bottom" value="<?php echo (isset($_POST['UserName']) ? $_POST['UserName'] :"");?>">
