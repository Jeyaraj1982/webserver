...
<div class="main-panel full-height">
            <div class="container" style="margin-top: 30px;">
                <div class="page-inner">
                    <div class="row">
                        <div class="col-sm-4 col-md-4" onclick="location.href='dashboard.php?action=Resumes/list'" style="cursor: pointer;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Active Resumes</p>
                                                <h4 class="card-title">
                                                <?php echo (sizeof($mysql->select("select * from _tbl_resume_general_info where CreatedBy='Franchisee' and CreatedByID='".$_SESSION['User']['FranchiseeID']."' and IsDelete='0'")));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Deleted Resumes</p>
                                                <h4 class="card-title">
                                                <?php echo (sizeof($mysql->select("select * from _tbl_resume_general_info where CreatedBy='Franchisee' and CreatedByID='".$_SESSION['User']['FranchiseeID']."' and IsDelete='1'")));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-4 col-md-4" onclick="location.href='dashboard.php?action=Accounts/AccountSummary'" style="cursor: pointer;">
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-3">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo getTotalBalanceCredits($_SESSION['User']['FranchiseeID']);?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-4" onclick="location.href='dashboard.php?action=Cards/list'" style="cursor: pointer;">
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Active Cards</p>
                                                <h4 class="card-title">
                                                <?php echo (sizeof($mysql->select("select * from _tbl_card_general_info where CreatedBy='Franchisee' and CreatedByID='".$_SESSION['User']['FranchiseeID']."' and IsDelete='0'")));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Deleted Cards</p>
                                                <h4 class="card-title">
                                                <?php echo (sizeof($mysql->select("select * from _tbl_card_general_info where CreatedBy='Franchisee' and CreatedByID='".$_SESSION['User']['FranchiseeID']."' and IsDelete='1'")));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                         <table class="table table-striped mt-3">
                                                ...
                                                <tbody>
                                                <?php $resumes = $mysql->select("select * from _tbl_resume_general_info where IsDelete='0' and CreatedBy='Franchisee' and CreatedByID='".$_SESSION['User']['FranchiseeID']."' order by ResumeID desc limit 0,5");?>
                                                <?php foreach($resumes as $resume){ ?>
                                                    <tr>
                                                        <td style="padding-right:0px !important;padding-left:0px !important"><img src="<?php echo "../uploads/".$resume['ProfilePhoto'];?>" style='width: 50px;height:50px;margin-top: 5px;'></td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                         <table class="table table-striped mt-3">
                                                ...
                                                <tbody>
                                                <?php $resumes = $mysql->select("select * from _tbl_card_general_info where IsDelete='0' and CreatedBy='Franchisee' and CreatedByID='".$_SESSION['User']['FranchiseeID']."' order by ResumeID desc limit 0,5");?>
                                                <?php foreach($resumes as $resume){ ?>
                                                    <tr>
                                                        <td style="padding-right:0px !important;padding-left:0px !important"><img src="<?php echo "../uploads/".$resume['ProfilePhoto'];?>" style='width: 50px;height:50px;margin-top: 5px;'></td>
                                                        <td style="padding-right:0px !important;padding-left:0px !important"><?php echo $resume['ResumeName'];?></td>
