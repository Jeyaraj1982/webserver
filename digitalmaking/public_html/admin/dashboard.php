...
<div class="main-panel full-height">
            <div class="container"  style="margin-top: 30px;">
                <div class="page-inner">
                    <div class="row">
                        <div class="col-sm-4 col-md-4" onclick="location.href='dashboard.php?action=ResumeList'" style="cursor: pointer;">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Delete Resumes</p>
                                                <h4 class="card-title">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="icon-big text-center">
                                                <i class="flaticon-interface-6 text-center"></i>
                                            </div>
                                        </div>
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3" onclick="location.href='dashboard.php?action=Franchisee/List&filter=all'" style="cursor: pointer;">
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo (sizeof($mysql->select("select * from _tbl_franchisee")));?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  style="padding-right:10px !important;padding-left:0px !important;text-align: right;">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item" href="dashboard.php?action=updateresume&id=<?php echo $resume['ResumeID'];?>" draggable="false">Edit</a>
                                                                <a class="dropdown-item" href="dashboard.php?action=viewresume&id=<?php echo $resume['ResumeID'];?>" draggable="false">View</a>
