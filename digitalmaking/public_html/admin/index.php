...
$Page="login";
        if (isset($_POST['btnsubmit'])) {
         ...
         $userdata = $mysql->select("select * from _tbl_resume_admin where UserName='".$_POST['UserName']."' and Password='".$_POST['Password']."' ");
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center"> <img src="https://digitalmaking.in/assets/img/logo.png" style="width: 210px;height:auto"><br><br>Admin Sign In</h3>
