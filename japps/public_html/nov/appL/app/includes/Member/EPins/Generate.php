    ...
    <div class="page-header">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
            <?php
                if (getEarningWalletBalance($_SESSION['User']['MemberID'])==0 && !(isset($_POST['btnGenerate']))) {
                        $error++;
                        ?>
            ...
            ?>
                                ...
                                <?php
                                    $package =$mysql->select("select * from `_tbl_Settings_Packages`"); 
                                ...
                                <form action="" method="post" id="generatepin">
                                    ...
                                    <div class="form-actions">
                                        <div class="form-group user-test" id="user-exists">
                                            ...
                                            ?>
                                                <option value="<?php echo $p['PackageID'];?>"><?php echo $p['PackageName'];?></option>
                                            <?php } ?>
                                            </select>
