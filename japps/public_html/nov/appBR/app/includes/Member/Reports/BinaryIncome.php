...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Earnings/BinaryIncome">Reports</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Earnings/BinaryIncome">Binary Income</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
