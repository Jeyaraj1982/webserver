       ...
       if ($error==0) {
            ...
            <script>
                ...
                $(document).ready(function() {        
                     swal({
              title: "Transaction Password Updated",
              type: "success",
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Setttings/CreateTxnPassword">Settings</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Setttings/CreateTxnPassword">Create Transaction Password</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
