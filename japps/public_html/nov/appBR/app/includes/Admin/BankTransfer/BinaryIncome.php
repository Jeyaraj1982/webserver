...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=BankTransfer/BinaryIncome">Bank Transfer</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=BankTransfer/BinaryIncome">Binary Income</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="basic-datatables" class="display table table-striped table-hover" >
                            ...
                            <tbody>
                            <?php 
                                //$Transactions=$mysql->select("select * from `_tbl_wallet_earnings` where Date(`TxnDate`)>=Date('".$_POST['From']."') and Date(`TxnDate`)<=Date('".$_POST['To']."') and MemberID='".$_SESSION['User']['MemberID']."' and (Ledger='3' or Ledger='30001') order by EarningID DESC"); 
                                ?>
