...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Products/ManageProducts">Stockies</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Products/ManageProducts">Stock Summary</a></li>
        </ul>
    </div>
    <div class="row" style="margin-bottom:10px;">
        <div class="col-md-12" style="text-align: right;">
            <a href="dashboard.php?action=Products/Products/Add" style="color:orange" ><small>Add Stock</small></a>&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </div>
    <div class="row">
