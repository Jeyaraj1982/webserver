<?php
    if (isset($_POST['refillBtn'])) {
        ...
        if (!($_POST['Amount']*1>=100 && $_POST['Amount']*1<=10000)) {
            $error++;
            $errormsg = "Amount must have greater than Rs.100 and Rs.10000";
        }
        if ($error==0) {
            $balance = getUtilityhWalletBalance($member[0]['MemberID'])+$_POST['Amount'];
            $id=$mysql->insert("_tbl_wallet_utility",array("MemberID"         => $member[0]['MemberID'],
                                                           "Particulars"      => 'Add To Wallet/FromAdmin',                    
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Wallets/Refill">Settings</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
