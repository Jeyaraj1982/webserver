<div class="page-inner">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4" onclick="location.href='dashboard.php?action=Members/AllMembers'" style="cursor: pointer;">
                        ...
                        <div class="col-sm-6 col-md-4" onclick="location.href='dashboard.php?action=SupportingCenter/ManageBusinessSupporting&filter=all'" style="cursor: pointer;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo (sizeof($mysql->select("select * from _tbl_business_supporting_center")));?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo (sizeof($mysql->select("select * from _tbl_orders")));?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4" onclick="location.href='dashboard.php?action=EPins/MyPins'" style="cursor: pointer;">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">WTBasic</p>
                                                <h4 class="card-title">
                        ...
                        <div class="col-sm-6 col-md-4" onclick="location.href='dashboard.php?action=Members/Packages&filter=NotAssign'" style="cursor: pointer;">
                            <div class="card card-stats card-round">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Package Eligible</p>
                                                <h4 class="card-title">
                                                    <?php echo (sizeof($mysql->select("select * from _tbl_Members_Package_Elegible where `PayoutType`='0'")));?> / 
                                                    <?php echo (sizeof($mysql->select("select * from _tbl_Members_Package_Elegible")));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ml-3 ml-sm-0">
                                            <div class="numbers">
                                                <p class="card-category">20% Charges</p>
                                                <h4 class="card-title">
                                                <?php
                                                    $val = $mysql->select("select sum(Debits) as d from _tbl_wallet_earnings where Ledger in ('30001','20001')");
                                                    echo "Rs. ".$val[0]['d'];
                                                ?>
                                                </h4>
                                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ml-3 ml-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                                <?php
                                                    $val = $mysql->select("select sum(Credits) as d from _tbl_wallet_earnings where Ledger in ('3','2')");
                                                    echo "Rs. ".$val[0]['d'];
                                                ?>
                                                </h4>
                                            </div>
