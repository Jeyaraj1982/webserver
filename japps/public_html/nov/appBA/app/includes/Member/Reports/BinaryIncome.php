                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="basic-datatables" class="display table table-striped table-hover" >
                            ...
                            <tbody>
                            <?php 
                                $Transactions=$mysql->select("select * from `_tbl_wallet_earnings` where Date(`TxnDate`)>=Date('".$fDate."') and Date(`TxnDate`)<=Date('".$tDate."') and MemberID='".$_SESSION['User']['MemberID']."' and (Ledger='3' or Ledger='30001') order by EarningID DESC"); 
                                ?>
