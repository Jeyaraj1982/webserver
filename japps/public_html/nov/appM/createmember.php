            ...
            $errorCMemberPassword ="Password must have ".$password_length[0]['ParamValue']." characters.";
                            ...
                            if ($error==0) {
                                ...
                                $MemberID =  $mysql->insert("_tbl_Members",array("MemberCode"      => $MemberCode,
                                                                                 ...
                                                                                 "IsActive"        => "1",
                                                                                 "CurrentPackageID"   => $e_pin[0]['PackagePV'],
       ...
       if (isset($_POST['submitBtn'])) {
           ...
           <form action="" class="customform ajax-form" id="signupForm" method="post">
                ...
                <div class="s-12">
                    ...
                    <input type="text" class="form-control" disabled="disabled" value="<?php echo $epin[0]['OwnToName'];?> (<?php echo $epin[0]['OwnToCode'];?>)">
                </div>
                <div class="s-12">
                ...
                <button class="submit-form button border-radius text-white background-primary" name="CreateBtn" type="submit">Create Member</button>
              </form>
                 <?php
