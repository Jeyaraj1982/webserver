                       ...
                       if (isset($_POST['btnsubmit'])) {
                            ...
                            if ($error==0) {
                                ...
                                $mysql->execute("update _tbl_products set `ProductName`      ='".$_POST['ProductName']."',
                                                                          ...
                                                                          `BlockedRemarks`   ='".$_POST['BlockedRemarks']."'
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=SupportingCenter/edit">Products</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=SupportingCenter/edit">Edit Products</a></li>
        </ul>
    </div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group user-test" id="user_exists">
                                        <label>IsBlock</label>
                                        <select class="form-control" id="IsBlock" name="IsBlock">
                                             <option value="1" <?php echo (isset($_POST[ 'IsBlock'])) ? (($_POST[ 'IsBlock']=="1") ? " selected='selected' " : "") : (($data[0]['IsBlock']=="1") ? " selected='selected' " : "");?>><?php echo "Yes" ;?></option>
                                             <option value="0" <?php echo (isset($_POST[ 'IsBlock'])) ? (($_POST[ 'IsBlock']=="0") ? " selected='selected' " : "") : (($data[0]['IsBlock']=="0") ? " selected='selected' " : "");?>><?php echo "No" ;?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <textarea name="BlockedRemarks" id="BlockedRemarks" class="form-control"><?php echo isset($_POST['BlockedRemarks']) ? $_POST['BlockedRemarks'] : $data[0]['BlockedRemarks'];?></textarea>
                                        <div class="help-block"></div>
                                        <div class="help-block" style="color:red;font-size:12px"><p class="error" id="ErrBlockedRemarks"><?php echo isset($ErrBlockedRemarks)? $ErrBlockedRemarks: "";?></p></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-action">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="dashboard.php?action=SupportingCenter/ManageProducts&id=<?php echo $data[0]['StoreID'];?>&filter=All" class="btn btn-warning btn-border">Back</a>
                                </div>                                        
                            </div>
                        </div>
                    </div>
