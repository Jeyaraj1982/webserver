<?php
     $category =$mysql->select("select * from _tbl_shopping_categories where IsActive='1'");
...
?>
 <script>
        swal({
            title: '',
            text: "Active product category not found.",
            type: 'warning',
            buttons:{
                confirm: {
            ...
            if (Delete) {
                location.href='dashboard.php?action=Products/Category/Add';
            } else {
                swal.close();
            }
        });
    ...
    <?php
     $category =$mysql->select("select * from _tbl_shopping_subcategories where IsActive='1'");
...
?>
 <script>
        swal({
            title: '',
            text: "Active product sub-category not found.",
            type: 'warning',
            buttons:{
                confirm: {
            ...
            if (Delete) {
                location.href='dashboard.php?action=Products/SubCategory/Add';
            } else {
                swal.close();
            }
        });
