<?php
    if (isset($_POST['submitpassword'])) {
        ...
        if ($getpassword[0]['MemberTxnPassword']!=$_POST['CPassword']) {
            $error++;
        ...
        if ($error==0) {
            ...
            <script>
              $(document).ready(function() {
                    ...
                    swal("Transaction Password Changed sucessfully!", {
                        icon : "success" 
                    });
                 });
            </script>
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Setttings/ChangeTxnPassword">Settings</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Setttings/ChangeTxnPassword">Change Transaction Password</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row"> 
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="email2">Current Transaction Password</label>
                                    <div class="input-group">
                                        <input class="form-control" id="CPassword" name="CPassword" value="<?php echo isset($_POST['CPassword']) ? $_POST['CPassword'] : "";?>" placeholder="Current Transaction Password" type="password">
                                        <div class="input-group-append">
                                            <span onclick="showHidePwd('CPassword',$(this))" class="input-group-text" id="basic-addon1"><i class="icon-eye"></i> </span>
                                        </div>                                    
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="btn btn-primary" id="password"  value="Change Transaction Password"  name="submitpassword" type="submit">
                                </div>
                            </div>
                        </div>
                    </form>
