    ...
    <table id="example1" class="table table-striped table-bordered table-hover" width="100%">
        ...
        <tr>
            ...
            <td colspan="6" style="text-align: right;">
                <input type="submit" class="btn btn-outline btn-success" value="Cash on delivery" name="btnCashOnDelivery">
                <input type="submit" class="btn btn-outline btn-success" value="Pay Now (Rs. <?php echo number_format($totalAmt);?>)" name="btnSubmit">
            </td>
        </tr>                        
    </table>
</form>
