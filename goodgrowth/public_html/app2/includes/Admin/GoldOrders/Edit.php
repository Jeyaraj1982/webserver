...
<?php  $Order = $mysql->select("select * from `_tbl_GoldOrders` where `GoldOrderID`='".$_GET['Order']."'"); 

?>
    <table style="width: 100%;" cellspacing="0">
        <tr style="background:#ccc;font-weight:bold;">
            <td>Proforma Invoice</td>
            <td style="text-align: right;" style="width:120px;"><input type="text" name="InvoiceNumber" value="<?php echo (isset($_POST['InvoiceNumber']) ? $_POST['InvoiceNumber'] : $Order[0]['InvoiceNumber']);?>" style="min-width:100px"></td>
        </tr>
    </table>
    <table style="width: 100%;" cellspacing="0">
        <tr style="font-weight:bold;">
            <td>Date</td>
            <td style="text-align: right;" style="width:120px;"><input id="datepicker" type="text" name="InvoiceDate" value="<?php echo (isset($_POST['InvoiceDate']) ? $_POST['InvoiceDate'] : $Order[0]['InvoiceDate']);?>"  style="min-width:100px"></td>
        </tr>
    </table>
    <br>
    <table style="width: 100%;">
        <tr>
            ...
            <td style="vertical-align:top;">
                <b>Buyer</b><br><br>
                <input type="text" name="BuyerAddress1" style="width: 294px;" value="<?php echo (isset($_POST['BuyerAddress1']) ? $_POST['BuyerAddress1'] : $Order[0]['BuyerAddress1']);?>"><br>
                <input type="text" name="BuyerAddress2" style="width: 294px;" value="<?php echo (isset($_POST['BuyerAddress2']) ? $_POST['BuyerAddress2'] : $Order[0]['BuyerAddress2']);?>"><br>
                <input type="text" name="BuyerAddress3" style="width: 294px;" value="<?php echo (isset($_POST['BuyerAddress3']) ? $_POST['BuyerAddress3'] : $Order[0]['BuyerAddress3']);?>"><br>
                <!--<input type="text" name="BuyerAddress4" style="width: 294px;" value="<?php echo isset($_POST['BuyerAddress4']) ? $_POST['BuyerAddress4'] : "";?>"><br>-->                                                                     
                Email:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="BuyerEmail" value="<?php echo (isset($_POST['BuyerEmail']) ? $_POST['BuyerEmail'] : $Order[0]['BuyerEmail']);?>"><span id="error_BuyerEmail" style="color:red"><?php echo isset($error_BuyerMobile)? $error_BuyerEmail : "";?></span><br>
                Mobile:&nbsp;<input type="text" name="BuyerMobile" value="<?php echo (isset($_POST['BuyerMobile']) ? $_POST['BuyerMobile'] :  $Order[0]['BuyerMobile']);?>"><span id="error_BuyerMobile" style="color:red"><?php echo isset($error_BuyerMobile)? $error_BuyerMobile : "";?></span><br>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="2">
                <table style="width: 100%;">
                  ...
                  <?php   $products = $mysql->select("select * from _tbl_GoldOrders_items where GoldOrderID='".$Order[0]['GoldOrderID']."'");  ?>
                        //foreach($products as $p) { ?>
                    <?php for($i=1;$i<=sizeof($products);$i++) {?>         
                    <tr>
                        <td><input type="text" onkeydown="doCalc()" id="Product_<?php echo $i;?>"  name="Product[<?php echo $i;?>]" value="<?php echo (isset($_POST['Product'][$i]) ? $_POST['Product'][$i]: $products[$i]['Product']);?>" style="width: 100%;"></td>
                        <td><input type="text" onkeydown="doCalc()" id="Price_<?php echo $i;?>" name="Price[<?php echo $i;?>]" value="<?php echo (isset($_POST['Price'][$i]) ? $_POST['Price'][$i]: $products[$i]['Price']);?>" style="text-align:right;min-width:70px !important;"></td>
                        <td><input type="text" onkeydown="doCalc()" id="Qty_<?php echo $i;?>" name="Qty[<?php echo $i;?>]" value="<?php echo (isset($_POST['Qty'][$i]) ? $_POST['Qty'][$i]: $products[$i]['Qty']);?>" style="text-align: right;min-width:70px !important"></td>
                        <td><input type="text" id="Amount_<?php echo $i;?>" name="Amount[<?php echo $i;?>]" value="<?php echo (isset($_POST['Amount'][$i]) ? $_POST['Amount'][$i]: $products[$i]['Amount']);?>" style="text-align: right;min-width:70px !important"></td>
                    </tr>
                    <?php   } ?>
                    <?php for($i=sizeof($products)+1;$i<=5;$i++) {?>         
                    <tr>
                        <td><input type="text" onkeydown="doCalc()" id="Product_<?php echo $i;?>"  name="Product[<?php echo $i;?>]" value="<?php echo (isset($_POST['Product'][$i]) ? $_POST['Product'][$i]: "");?>" style="width: 100%;"></td>
                        <td><input type="text" onkeydown="doCalc()" id="Price_<?php echo $i;?>" name="Price[<?php echo $i;?>]" value="<?php echo (isset($_POST['Price'][$i]) ? $_POST['Price'][$i]: "");?>" style="text-align:right;min-width:70px !important;"></td>
                        <td><input type="text" onkeydown="doCalc()" id="Qty_<?php echo $i;?>" name="Qty[<?php echo $i;?>]" value="<?php echo (isset($_POST['Qty'][$i]) ? $_POST['Qty'][$i]: "");?>" style="text-align: right;min-width:70px !important"></td>
                        <td><input type="text" id="Amount_<?php echo $i;?>" name="Amount[<?php echo $i;?>]" value="<?php echo (isset($_POST['Amount'][$i]) ? $_POST['Amount'][$i]: "");?>" style="text-align: right;min-width:70px !important"></td>
                    </tr>
                    <?php   } ?>
                </table>
            ...
            <td colspan="2" style="padding-left:3px;padding-right:3px">
                <table style="width: 100%;" cellspacing="0">
                    <tr style="background:#ccc;font-weight:bold;">
                        ...
                        <td style="text-align: right;" style="width:120px;"><input id="subtotal" type="text" value="<?php echo isset($_POST['TotalAmount']) ? $_POST['TotalAmount'] :$Order[0]['TotalAmount'];?>" name="TotalAmount" style="min-width:100px;text-align:right"></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align: right;"><input name="FirstAmount" type="text" value="<?php echo (isset($_POST['FirstAmount']) ? $_POST['FirstAmount'] : $Order[0]['FirstAmount']);?>" style="min-width:100px;text-align:right">
        </tr>  
        <tr>
            <td colspan="2">
                <table style="width: 100%;;" cellspacing="0">
                    <tr style="background:#ccc;font-weight:bold;">
                        ...
                        <td style="text-align:left;width:120px;"><input name="DueAmount" value="<?php echo (isset($_POST['DueAmount']) ? $_POST['DueAmount'] : $Order[0]['DueAmount']);?>" type="text" style="min-width:100px;text-align:right"></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2" style="text-align: center;padding:20px;"><input name="sumbitBtn" type="submit" value="Save and send email" ></td>
        </tr>
    </table>
</div>
</form>
<script>
  ...
  function doCalc() {
      ...
      var total=0;
      for(i=1;i<=5;i++) {
          if ( parseFloat($('#Price_'+i).val()) > 0 && parseFloat($('#Qty_'+i).val())>0 )  {
              var subtotal = parseFloat($('#Qty_'+i).val() * parseFloat($('#Price_'+i).val()));
