                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    ...
                                    <div class="image-column col-md-5 col-sm-6 col-xs-12">
                                        <img class="img-detail" src="images/products/good-power.jpg" alt="">
                                    </div>
                                    ...
                                    <div class="info-column col-md-7 col-sm-6 col-xs-12">
                                        ...
                                        <div class="other-options">
                                            ...
                                            <div class="btns-box">
                                                ...
                                                <input type="hidden" name="ProName" value="Good Power">
                                                <input type="hidden" name="ProPrice" value="1200.00">
