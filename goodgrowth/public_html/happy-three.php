                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    ...
                                    <div class="image-column col-md-5 col-sm-6 col-xs-12">
                                        <img class="img-detail" src="images/products/happy3.jpg" alt="">
                                    </div>
                                    
                                    <!--Info Column-->
                                    <div class="info-column col-md-7 col-sm-6 col-xs-12">
                                    	<div class="details-header">
                                            <h4>Happy Three - Engage Your Happiness</h4>
                                        ...
                                        <div class="other-options">
                                            ...
                                            <div class="btns-box">
                                                ...
                                                <input type="hidden" name="ProName" value="Happy Three">
                                                <input type="hidden" name="ProPrice" value="1100.00">
