<?php  include("file/header.php");?>
    ...
    <section class="page-title" style="background-image:url(images/background/5.jpg);">
    	<div class="auto-container">
        	<div class="inner-box">
                <h1>Aloeloe Face Wash</h1>
                <ul class="bread-crumb">
                	<li><a href="index.php">Home</a></li>
                    <li>Aloeloe Face Wash</li>
                </ul>
            </div>
        </div>
    </section>
                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    ...
                                    <div class="image-column col-md-5 col-sm-6 col-xs-12">
                                        <img class="img-detail" src="images/products/3.jpg" alt="">
                                    </div>
                                    
                                    <!--Info Column-->
                                    <div class="info-column col-md-7 col-sm-6 col-xs-12">
                                    	<div class="details-header">
                                            <h4>Aloeloe Face Wash</h4>
                                        ...
                                        <ol>
											<li>சருமத்தில் ஆழமாக சென்று சுத்தம்  செய்கின்றது. </li>
											<li>முகத்தில் ஏற்படும் பள்ளங்களை  சமன் செய்கிறது.</li>
											<li>இயற்கையான பளபளப்பு தருகின்றது.</li>
											<li>உலர் சருமம், கரும்புள்ளிகள் மாற்றும் முகத்தை சுத்தமாகவும், புத்துணர்ச்சியோடும் வைக்க உதவுகிறது.</li>
											<li>ஆலோவேரா வைட்டமின் உ நிறைந்தது.</li>
											<li>சருமம் உலர்வதில்லை </li>
											<li>பக்க விளைவு அற்றது</li>
                                        </ol>
                                        ...
                                        <div class="other-options">
                                            ...
                                            <div class="btns-box">
                                                ...
                                                <input type="hidden" name="ProName" value="Aloeloe Face Wash (100 Ml)">
                                                <input type="hidden" name="ProPrice" value="80.00">
