                ...
                <?php
                    if (sizeof($level1_1)>0) {
                        ...
                        if (sizeof($level1_1D)==1) {
                            ...
                            echo "<div  class='Gold'>".$lData[0]['FirstName']." ".$lData['0']['LastName']."<br>".$lData[0]['MemberCode']."</div>";
                        } else {
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=L&parent=".$level1_1[0]['ChildID']."'>Create Member</a></div>";
                        }
                ...
                <?php
                    if (sizeof($level1_1)>0) {  
                        ...
                        if (sizeof($level1_1D)>0) {  
                            ...
                            echo "<div  class='Gold'>".$rData[0]['FirstName']." ".$rData['0']['LastName']."<br>".$rData[0]['MemberCode']."</div>";
                        } else {
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=R&parent=".$level1_1[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>"; 
                ...
                <?php
                    if (sizeof($level1_2)>0) {  
                        ...
                        if (sizeof($level1_2D)==1) {
                            ...
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=L&parent=".$level1_2[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>";
                ...
                <?php
                    if (sizeof($level1_2)>0) {  
                        ...
                        if (sizeof($level1_2D)==1) {
                            ...
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=R&parent=".$level1_2[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>"; 
                ...
                <?php
                    if (sizeof($level1_3)>0) {  
                        ...
                        if (sizeof($level1_3D)==1) {
                            ...
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=L&parent=".$level1_3[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>"; 
                ...
                <?php
                    if (sizeof($level1_3)>0) { 
                        ...
                        if (sizeof($level1_3D)==1) {
                            ...
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=R&parent=".$level1_3[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>";
                ...
                <?php
                    if (sizeof($level1_4)>0) { 
                        ...
                        if (sizeof($level1_4D)==1) {
                            ...
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=L&parent=".$level1_4[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>";
                ...
                <?php
                    if (sizeof($level1_4)>0) {
                        ...
                        if (sizeof($level1_4D)==1) {
                            ...
                            echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=R&parent=".$level1_4[0]['ChildID']."'>Create Member</a></div>";
                        }
                        echo "<span class='triangle-up'></span>";
                    } else {
                        echo "<div  class='noGold2'>Create Member</div>"; 
            ...
            <td colspan="2" style="width:200px;padding-bottom:10px;text-align:center;">
                <?php
                    if (sizeof($level1_1)==1) {
                        ...
                        echo "<div  class='Gold'>".$lData[0]['FirstName']." ".$level1_1D['0']['LastName']."<br>".$level1_1D[0]['MemberCode']."</div>";
                    } else {
            ...
            <td colspan="2"  style="width:200px;padding-bottom:10px;text-align:center;">
                <?php
                    if (sizeof($level1_2)==1) {
                        ...
                        echo "<div  class='Gold'>".$rData[0]['FirstName']." ".$level1_2D['0']['LastName']."<br>".$level1_2D[0]['MemberCode']."</div>";
                    } else {
            ...
            <td colspan="2" style="width:200px;padding-bottom:10px;text-align:center;">
                <?php
                    if (sizeof($level1_3)==1) {
                        ...
                        echo "<div  class='Gold'>".$rData[0]['FirstName']." ".$level1_3D['0']['LastName']."<br>".$level1_3D[0]['MemberCode']."</div>";
                    } else {
            ...
            <td colspan="2" style="width:200px;padding-bottom:10px;text-align:center;">
                <?php
                    if (sizeof($level1_4)==1) {
                        ...
                        echo "<div  class='Gold'>".$rData[0]['FirstName']." ".$level1_4D['0']['LastName']."<br>".$level1_4D[0]['MemberCode']."</div>";
                    } else {
                        echo "<div  class='noGold'><a href='dashboard.php?action=CreateMember&P=".$PlanID."&C=4'>Create<br>Member</a></div>";
                    }
                      echo "<span class='triangle-up'></span>";
                ?>
            </td>
