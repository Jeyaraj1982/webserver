     ...
     function validateForm(&$ErrorString) {
        ...
        if (isset($_POST['CreateNewsBtn'])) {
            ...
            if ($res) {
              ...
              $mysql->execute("update _tbl_Web_News set NewsTitle='".$_POST['NewsTitle']."', NewsDetails='".$_POST['NewsDetails']."', IsPublish='".$_POST['IsPublish']."' where NewsID='".$_GET['ID']."'");
...
?>
<?php $news= $mysql->select("select * from _tbl_Web_News where NewsID='".$_GET['ID']."'"); ?>
