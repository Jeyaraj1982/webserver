 ...
 <div class="heading1"><span>Manage News</span></div>
 <Br>
 <div class="LMenu" style="text-align:right">
    <a href="dashboard.php?action=CreateNews">+ Create News</a>
 </div>
  
 <?php
    $loginEntries = $mysql->select("select * from _tbl_News");
 ?>
...
<tr class="logip">
    ...
    <td style="text-align: left;"><a href="dashboard.php?action=EditNews&ID=<?php echo $entry['NewsID'];?>">Edit</a></td>
</tr>
<?php } ?>
</tbody>
</table>
