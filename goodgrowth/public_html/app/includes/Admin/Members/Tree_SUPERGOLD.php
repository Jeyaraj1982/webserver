...
<?php
 if (isset($_GET['msg'])) {
    ...
    $loginEntries = $mysql->select("select * from _tbl_Members where MemberID in (select ChildID from _tbl_Member_Placement where Plan='3' and PlacedBy='".$mem[0]['MemberID']."') order by MemberID desc");
