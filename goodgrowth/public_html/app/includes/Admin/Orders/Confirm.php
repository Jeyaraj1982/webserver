            ...
            if ($_POST['otp']==$_SESSION['rnd']) {
                ...
                if ($_POST['PaymentStatus']=="Wallet payment") {
                    ...
                    if (getBalance($userData['MemberID'])<$Order[0]['OrderValue']) {
                       echo "Order Cancelled. Insufficiant Fund";
                       ...
                       $_SESSION['rnd']=0;           
                        ...
                        $ACTransactionID = $mysql->insert("_tbl_Wallet_Transactions",array("MemberID"      => $userData['MemberID'],
                                                                                           ...
                                                                                           "ActualAmount"  => $OrderID[0]['OrderValue'],
                                                                                           "CreditAmount"  => "0",
                                                                                           "DebitAmount"   => $OrderID[0]['OrderValue'],
                                                                                           "BalanceAmount" => getBalance($userData['MemberID'])-$OrderID[0]['OrderValue'],
                                                                                           "Ledger"        => "30")); 
                        $mysql->insert("_tbl_Member_Points",array("MemberID"=>$userData['MemberID'],
                                                                  "MemberCode"=>$userData['MemberCode'],
                                                                  "EarnPoint"=>$OrderID[0]['EarnedPoint'],
                                                                  "Remarks"=>"Order ID ".$OrderID[0]['OrderID']));
        ...
        <table style="clear:both;" align="center">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" class="SubmitBtn" value="Confirm Order" name="btnConfirm">
                </td>
            </tr>
        </table>
    </div>
