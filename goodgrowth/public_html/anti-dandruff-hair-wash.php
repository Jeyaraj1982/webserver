<?php  include("file/header.php");?>
    ...
    <section class="page-title" style="background-image:url(images/background/5.jpg);">
    	<div class="auto-container">
        	<div class="inner-box">
                <h1>Anti Dandruff Hair Wash</h1>
                <ul class="bread-crumb">
                	<li><a href="index.php">Home</a></li>
                    <li>Anti Dandruff Hair Wash</li>
                </ul>
            </div>
        </div>
    </section>
                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    ...
                                    <div class="image-column col-md-5 col-sm-6 col-xs-12">
                                        <img class="img-detail" src="images/products/6.jpg" alt="">
                                    </div>
                                    ...
                                    <div class="info-column col-md-7 col-sm-6 col-xs-12">
                                        ...
                                        <ol>
											<li>இயற்கை பொருட்கள் மூலம் தலையில் உள்ள பொடுகு பிரச்சினையை முழுமையாக நீக்குதல் பக்க விளைவு அற்றது </li>
											<li>முடி உதிர்வைத் தடுக்கும் </li>
											<li>முடியின் வேர்களை வலுவூட்டி முடி வளர்வதைத் தூண்டுகிறது.</li>
											<li>ஆலோவேர</li>
											<li>ரோஸ் மேரி ஆயில் </li>
											<li>அல்மோண்ட் ஆயில்</li>
											<li>டீ இலை ஆயில் </li>
											<li>நீம் ஆயில்</li>
                                        ...
                                        <div class="other-options">
                                            ...
                                            <div class="btns-box">
                                             <form action="" method="POST">
                                                <input type="hidden" name="ProName" value="Anti Dandruff Hair Wash (100 Ml)">
                                                <input type="hidden" name="ProPrice" value="90.00">
