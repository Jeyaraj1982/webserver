                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    ...
                                    <div class="image-column col-md-5 col-sm-6 col-xs-12">
                                        <img class="img-detail" src="images/products/7.jpg" alt="">
                                    </div>
                                    
                                    <!--Info Column-->
                                    <div class="info-column col-md-7 col-sm-6 col-xs-12">
                                    	<div class="details-header">
                                            <h4>கற்றாழை ஷாம்பு</h4>
                                        ...
                                        <ol>
											<li>கூந்தலின் முதிர்ச்சியடைதலை  குறைக்கின்றது. </li>
											<li>ஒருமுறை உபயோகித்த உடனே  தலை முடியில் மிருதுவான தன்மையையும், பளபளப்பையும் காண முடியும்.<li>
											<li>தலைமுடி உதிர்வைத் தடுக்கும்.</li>
											<li>முடி வேர்களை பலப்படுத்தி முடியை </li>
											<li>பளபளப்பாகவும், நீளமாகவும் வளர உதவும்.</li>
											<li>பொடுகு தொல்லையை நீக்குகிறது.</li>
											<li>முடியை 10 மடங்கு பலப்படுத்தும்</li>
											<li>கற்றாழை பக்கவிளைவு அற்றது</li>
                                        ...
                                        <div class="other-options">
                                            ...
                                            <div class="btns-box">
                                                ...
                                                <input type="hidden" name="ProName" value="Aloe Shampoo (100 Ml)">
                                                <input type="hidden" name="ProPrice" value="70.00">
