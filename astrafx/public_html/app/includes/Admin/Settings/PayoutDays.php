<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Settings/PayoutDays">Working Payout Days</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6"><div class="card-title">Working Payout Days</div></div>
                        <div class="col-md-6" style="text-align: right;"><a href="dashboard.php?action=Settings/AddPayoutDays" class="btn btn-primary btn-round">Add</a></div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2"><label class="col-sm-1"> &nbsp;</label><button type="submit" name="SearchBtn" class="btn btn-primary">View Working Payout Days</button></div>
                            </div>
                        </form>
                    <?php if(isset($_POST['SearchBtn'])){
                        ...
                        $Dates =$mysql->select("select * from `_tbl_payout_days` where (date(TxnDate)>=date('".$fromDate."') and  date(TxnDate)<=date('".$toDate."')) ");
                        
                         echo $fromDate." To ".$toDate;
                        ?>
                    <div class="table-responsive">
                    <?php echo "Number of Working Payout Days ".sizeof($Dates);?>
