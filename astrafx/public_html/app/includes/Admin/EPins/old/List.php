...
if (isset($_GET['filter']) && $_GET['filter']=="all") {
    ...
    select *,_tbl_Settings_Packages.FileName from (SELECT * FROM _tblEpins where PackageID='".$_GET['Package']."' and  CreatedByID='".$_SESSION['User']['AdminID']."' or OwnToID='".$_SESSION['User']['AdminID']."') as t1
    ...
    $records=$mysql->select("
    select *,_tbl_Settings_Packages.FileName from (SELECT * FROM _tblEpins where PackageID='".$_GET['Package']."' and  (CreatedByID='".$_SESSION['User']['AdminID']."' or OwnToID='".$_SESSION['User']['AdminID']."' ) and `UsedForID`!='0' ) as t1 
