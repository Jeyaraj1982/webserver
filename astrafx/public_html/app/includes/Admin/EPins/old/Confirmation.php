<div style="padding:25px">
    ...
    <?php
         ...
         if (isset($_POST['btnGenerate'])) {
             ...
             $message = "Your happylife2020.in Pin generation code is ". $data['otp'];
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post" >
                        ...
                        <div class="form-actions">
                            <div class="form-group user-test" id="user-exists">
                                <label>Number of Epins</label>
                                <input type="text" disabled="disabled" value="<?php echo $data["pins"];?>" class="form-control">  
                            </div>
                        </div> 
                        <div class="form-actions">
                            <div class="form-group user-test" id="user-exists">
                                <div class="help-block">Next screen we will sent otp to your register mobile</div>
                            </div>
                        </div>
                        <div class="form-actions">
