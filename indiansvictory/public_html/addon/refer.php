...
$mysql= new MySql();
$mysql->execute("update _posts set rating=(rating+1) where md5(id)='".$_REQUEST['mail']."'");
...
class SimpleCaptcha {
    ...
    public $session_var = 'Indians Victory Party';
 
    /** Background color in RGB-array */
    public $backgroundColor = array(247, 252, 255);
    ...
    public $fonts = array(
        ...
        'Times'    => array('spacing' => -2, 'minSize' => 10, 'maxSize' => 10, 'font' => 'TimesNewRomanBold.ttf') 
