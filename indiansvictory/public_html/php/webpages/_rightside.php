...
?>
                                    ...
                                    <img src='<?php echo $ipath;?>' style='height:60px;width:75px;margin-bottom:5px;padding-right:5px;border:1px solid #f1f1f1;' align='left'>
                              
                        </td>
                        <td valign='top'><a href="?jsessionid=<?php echo md5($l['id']);?>" style="color:#0163C7;font-size:11px;text-decoration:none;line-height:15px"><?php echo $l['title'];?></a></td>
                    </tr>
                    <?php } ?>
                </table>
            </marquee>
