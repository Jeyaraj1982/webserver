...
<div class="container-fluid">
<?php
$data = $mysql->select("select * from _tbl_master_highcourts_bench where md5(HighCourtBenchID)='".$_GET['edit']."'");
    if (isset($_POST['CreateBtn'])) {
        ...
        $duplicate = $mysql->select("select * from _tbl_master_highcourts_bench where HighCourtBenchID<>'".$data[0]['HighCourtBenchID']."' and BenchName='".trim($_POST['BenchName'])."'");
        if (sizeof($duplicate)>0) {
            $BenchName = "Bench Name Name already exists";
            $error++;  
        }
 
        if ($error==0) {
             $highcourt=$mysql->select("select * from _tbl_master_highcourts where HighCourtID='".$_POST['HighCourtID']."'");
            $mysql->execute("update _tbl_master_highcourts_bench set BenchName = '".trim($_POST['BenchName'])."',
                                                                  HighCourtID      ='".$highcourt[0]['HighCourtID']."',
                                                                  HighCourtName      = '".$highcourt[0]['HighCourtName']."',
                                                                  IsActive = '".$_POST['IsActive']."',
                                                                  Remarks  = '".trim($_POST['Remarks'])."' where md5(HighCourtBenchID)='".$_GET['edit']."'");
          ...
          //  unset($_POST);
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>Bench Name updated.</p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to update Bench Name.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
            ...
            <?php
               ...
               $mysql->execute("update _tbl_master_highcourts_bench set IsActive          = '2',
                                                                 DeletedOn         = '".date("Y-m-d H:i:s")."'
                                                                 where md5(HighCourtBenchID) = '".$_GET['edit']."'");
               unset($_POST);
               ?>
                   <div class="row">
                <div class="col-12">
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>Bench Name deleted.</p>
                      <br>
                      <a href="dashboard.php?action=HighCourtBenchNames/list" class="btn btn-success">Continue</a>
                    </div>
                    </div>
              </div>
              </div>
                    ...
                    <form action="" method="post" id="create_benchname" name="create_benchname" onsubmit="return formvalidation('create_benchname');">
                        <div class="row g-3  mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="BenchName" name="BenchName" type="text" placeholder="Bench Name"  value="<?php echo isset($_POST['BenchName']) ? $_POST['BenchName'] : $data[0]['BenchName'];?>">
                         ...
                         <div class="row g-3  mb-3">
                            <div class="col-md-6">
                               ...
                               <?php $highcourts = $mysql->select("select * from _tbl_master_highcourts where IsActive=1 order by CourtName"); ?>
                                ...
                                ?>
                                <option value="<?php echo $highcourt['HighCourtID'];?>" <?php echo ($highcourt['HighCourtID']==$data[0]['HighCourtID']) ? " selected='selected' " : "";?> ><?php echo $highcourt['CourtName'];?></option>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to update bench name</p>
            </div>
...
<div class="modal fade" id="exampleModalCenterDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to <b style="color:red">delete</b> bench name</p>
            </div>
            <div class="modal-footer">
