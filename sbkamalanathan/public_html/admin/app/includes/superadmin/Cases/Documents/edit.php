...
<?php                                                                                
    ...
    $edit_data = $mysql->select("select * from _tbl_cases_documents where md5(concat(CreatedOn,CaseDocumentID))='".$_GET['edit']."'");
    if (isset($_POST['CreateBtn'])) {
        ...
        if ($error==0) {
            ...
            $mysql->execute("update _tbl_cases_documents set 
                                                         
                                                               Title         = '".trim($_POST['Title'])."',
                                                               Description    = '".trim($_POST['Description'])."'  where md5(concat(CreatedOn,CasedocumentID))='".$_GET['edit']."'");
             if ($Attachment_FileName!="") {
                
                $mysql->insert("_tbl_cases_attachments",array("CaseID"                 => $CaseDetails[0]['CaseID'],
                                                             "AttachmentFor"          => "Documents",
                                                             "RecordID"               => $edit_data[0]['CaseDocumentID'],
                                                             "FileName"               => $FileName,
            ...
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>document information updated.</p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to update document information.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
            ...
            <?php
               ...
               $mysql->execute("update _tbl_cases_documents set IsActive          = '2',
                                                                       ...
                                                                       where md5(concat(CreatedOn,CaseDocumentID))='".$_GET['edit']."'");
               unset($_POST);
               ?>
                   <div class="row">
                <div class="col-12">
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b> document information deleted.</p>
                      <br>
                      <a href="dashboard.php?action=Cases/view&sa=Documents/list&case=<?php echo $_GET['case'];?>" class="btn btn-success">Continue</a>
                    </div>
                    </div>
              </div>
              </div>
  ...
  <form id="frmD" action="" method="post" id="create_case_amountreceved" name="create_case_amountreceved" onsubmit="return formvalidation('create_case_amountreceved');" enctype="multipart/form-data">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h6 style="margin-bottom:30px">Edit Document</h6>
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom01">Title</label>
                                <input class="form-control" id="Title" name="Title" type="text" placeholder="Title"  value="<?php echo isset($_POST['Title']) ? $_POST['Title'] : $edit_data[0]['Title'];?>">
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="Description" id="Description" type="text" placeholder="Description"><?php echo isset($_POST['Description']) ? $_POST['Description'] : $edit_data[0]['Description'];?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3  mb-3">
                         ...
                         <div class="row g-3  mb-3">
                            ...
                            <input type="hidden" value="0" id="isDelete" name="isDelete">
                                <a href="dashboard.php?action=Cases/view&sa=Documents/list&case=<?php echo $_GET['case'];?>" class="btn btn-outline-primary">Back</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to update docuemnt information.</p>
            </div>
...
<div class="modal fade" id="exampleModalCenterDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to <b style="color:red">delete</b> document information</p>
            </div>
            <div class="modal-footer">
