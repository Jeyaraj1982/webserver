<?php 
    ...
    $documents = $mysql->select("select * from _tbl_cases_documents where CaseID='".$CaseDetails[0]['CaseID']."' and  IsActive=1 order by CaseDocumentID desc");
?>
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6">
                <h5 style="margin-top:5px">Documents</h5>
            </div>
            <div class="col-md-6 text-end">
                 <div class="media">
                    <div class="media-body text-end">
                        <div class="btn btn-primary" onclick="location.href='dashboard.php?action=Cases/view&sa=Documents/add&case=<?php echo $_GET['case'];?>'"><i data-feather="plus-square"></i>Add</div>
                    </div>
                 </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;" class="jsgrid jsgrid-cell jsgrid-control-field jsgrid-align-center">
                                    ...
                                    <a style="color:red" href="dashboard.php?action=Cases/view&sa=Documents/edit&case=<?php echo $_GET['case'];?>&edit=<?php echo md5($document['CreatedOn'].$document['CaseDocumentID']);?>"> 
                            ...
                            <tr>
                                `<td colspan="2" style="text-align:center;">No documents found.</td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
