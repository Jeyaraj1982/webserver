    ...
    if (isset($_POST['CreateBtn'])) {
        ...
        if ($error==0) {
            ...
            if ($_POST['RevenueCourtStateID']>0) {
                ...
                $RevenueCourtStateID   = $RevenueCourtStateName[0]['StateNameID'];
            ...
            $DistrctCourtPlaceNameID = "0";
            $DistrctCourtPlaceName = "0";
            if ($_POST['DistrctCourtPlaceNameID']>0) {
                $Record = $mysql->select("select * from _tbl_master_placenames where IsActive='1' and PlaceNameID='".$_POST['DistrctCourtPlaceNameID']."'");
                $DistrctCourtPlaceNameID = $Record[0]['PlaceNameID'];
                $DistrctCourtPlaceName   = $Record[0]['PlaceName'];
            }
            
            $DistrictCourtTypeID = "0";
            $DistrictCourtTypeName = "";
            if ($_POST['DistrictCourtTypeID']>0) {
                $Record = $mysql->select("select * from _tbl_master_districtcourttypes where IsActive='1' and DistrictCourtTypeID='".$_POST['DistrictCourtTypeID']."'"); $DistrictCourtTypeID = "0";
                $DistrictCourtTypeID = $Record[0]['DistrictCourtTypeID'];
                $DistrictCourtTypeName = $Record[0]['DistrictCourtTypeName'];
            }
            ...
            $CaseID = $mysql->insert("_tbl_cases_register",array(
                                                        ...
                                                        "DistrctCourtPlaceNameID"      => $DistrctCourtPlaceNameID,
                                                        "DistrctCourtPlaceName"        => $DistrctCourtPlaceName,
                                                        "DistrictCourtTypeID"          => $DistrictCourtTypeID,
                                                        "DistrictCourtTypeName"        => $DistrictCourtTypeName,
...
<script>
    ...
    function getDistrictCourtPlaceNames() {
        var _DistrctCourtDistrictNameID = $('#DistrctCourtDistrictNameID').val();
        $.ajax({url:'webservice.php?action=getDistrictCourtPlaceNames&rand='+Math.random()+'&DistrictNameID='+_DistrctCourtDistrictNameID,success:function(data){
            $('#ajax_getDistrictCourtPlaceNames').html(data);
        }});
    }
</script> 
<div class="row g-3 mb-3" id="districtcourt_statenames" style="display:none">
    ...
    <div class="col-md-3">
        ...
        <select class="form-select" id="DistrctCourtDistrictNameID" name="DistrctCourtDistrictNameID" onchange="getDistrictCourtPlaceNames()">
        ...
        <span id="ajax_getDistrictCourtPlaceNames"></span>
    </div>
    
    <div class="col-md-3">
        <label class="form-label" for="validationCustom01">Place of Court</label>
        <select class="form-select" id="DistrctCourtPlaceNameID" name="DistrctCourtPlaceNameID">
            <option value="0">Select Place</option>
        </select>
        <div id="ErrDistrctCourtPlaceNameID" style="color:red"><?php echo isset($DistrctCourtPlaceNameID) ? $DistrctCourtPlaceNameID : "";?></div>
    </div>
                                               
    <div class="col-md-3">                      
        <label class="form-label" for="validationCustom01">SubCourt Name</label>
        <select class="form-select" id="DistrictCourtTypeID" name="DistrictCourtTypeID">
            <option value="0">Select SubCourt</option>
        </select>
        <div id="ErrDistrictCourtTypeID" style="color:red"><?php echo isset($DistrictCourtTypeID) ? $DistrictCourtTypeID: "";?></div>
    </div>
</div>
...
<div class="row g-3  mb-3"> 
    ...
    <div class="col-md-3">
        <label class="form-label" for="validationCustomUsername">Date of Filing</label>
        <input class="datepicker-here form-control digits"    data-language="en" data-date-format="yyyy-mm-dd" id="DateOfFilling" name="DateOfFilling" type="text" placeholder="Date of Filing" aria-describedby="inputGroupPrepend" style="background:#fff"  value="<?php echo isset($_POST['DateOfFilling']) ? $_POST['DateOfFilling'] : "";?>">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        <label class="form-label" for="validationCustom03">Is the affidavit/vakalath filed ? </label>
        <div class="m-t-15 m-checkbox-inline custom-radio-ml" style="margin-top:0px !important;padding-top:12px;">
            <div class="form-check form-check-inline radio radio-primary">
    ...
    <div class="col-md-3">
        <label class="form-label" for="validationCustom03" id="affFillDate">Affdavit Filing Date</label>                                                                          
...
<table class="myTable Table_Add_Respondent">
    <thead>
       ...
       <!-- <tr>
            <td><input type="text" class="form-control ra_fullname" placeholder="Enter File Name">
