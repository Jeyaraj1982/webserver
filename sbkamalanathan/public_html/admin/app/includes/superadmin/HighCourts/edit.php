...
<div class="container-fluid">
<?php
$data = $mysql->select("select * from _tbl_master_highcourts where md5(HighCourtID)='".$_GET['edit']."'");
    if (isset($_POST['CreateBtn'])) {
        ...
        $duplicate = $mysql->select("select * from _tbl_master_highcourts where HighCourtID<>'".$data[0]['HighCourtID']."' and CourtName='".trim($_POST['CourtName'])."'");
        if (sizeof($duplicate)>0) {
            $CourtName = "Court Name Name already exists";
            $error++;  
        }
 
        if ($error==0) {
            $mysql->execute("update _tbl_master_highcourts set CourtName = '".trim($_POST['CourtName'])."',
                                                                IsActive = '".$_POST['IsActive']."',
                                                              Remarks  = '".trim($_POST['Remarks'])."' where md5(HighCourtID)='".$_GET['edit']."'");
          ...
          //  unset($_POST);
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>high court informatin updated.</p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to update high court information.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
            ...
            <?php
               ...
               $mysql->execute("update _tbl_master_highcourts set IsActive          = '2',
                                                                 DeletedOn         = '".date("Y-m-d H:i:s")."'
                                                                 where md5(HighCourtID) = '".$_GET['edit']."'");
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>high court information deleted.</p>
                      <br>
                      <a href="dashboard.php?action=HighCourts/list" class="btn btn-success">Continue</a>
                    </div>
                    </div>
              </div>
              </div>
...
?>
    <div class="row" id="frmD">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="" method="post" id="create_highcourt" name="create_highcourt" onsubmit="return formvalidation('create_highcourt');">
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-12" style="text-align: right;">
                                ...
                                <a href="dashboard.php?action=HighCourts/list" class="btn btn-outline-primary">Back</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to update high court information</p>
            </div>
...
<div class="modal fade" id="exampleModalCenterDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to <b style="color:red">delete</b> high court information</p>
            </div>
            <div class="modal-footer">
