...
<?php
    if (isset($_POST['CreateBtn'])) {
        ...
        $duplicate = $mysql->select("select * from _tbl_master_highcourts where CourtName='".trim($_POST['CourtName'])."'");
        ...
        if ($error==0) {
            $mysql->insert("_tbl_master_highcourts",array("CourtName" => trim($_POST['CourtName']),
            ...
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>High Court created.</p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to create high court.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
                    ...
                    <form action="" method="post" id="create_highcourt" name="create_highcourt" onsubmit="return formvalidation('create_highcourt');">
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-12" style="text-align: right;">
                                ...
                                <button class="btn btn-primary" type="submit" name="CreateBtn" id="CreateBtn">Create High Court</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to create high court.</p>
            </div>
