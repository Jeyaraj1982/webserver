        ...
        if (strlen(trim($_POST['EmailID']))>0) {
            if (!filter_var($_POST['EmailID'], FILTER_VALIDATE_EMAIL)) {
               ...
               $error++;
                ...
                $duplicate = $mysql->select("select * from _tbl_master_clients where EmailID='".trim($_POST['EmailID'])."'");
        ...
        if (strlen(trim($_POST['MobileNumber']))==0) {
            ...
            if (!($_POST['MobileNumber']>6000000000 && $_POST['MobileNumber']<9999999999)) {
               ...
               $error++;
                ...
                $duplicate = $mysql->select("select * from _tbl_master_clients where MobileNumber='".trim($_POST['MobileNumber'])."'");
                if (sizeof($duplicate)>0) {
        ...
        if (strlen(trim($_POST['WhatsappNumber']))>0) {
            if (!($_POST['WhatsappNumber']>6000000000 && $_POST['WhatsappNumber']<9999999999)) {
               ...
               $error++;
                ...
                $duplicate = $mysql->select("select * from _tbl_master_clients where WhatsappNumber='".trim($_POST['WhatsappNumber'])."'");
                if (sizeof($duplicate)>0) {
        ...
        if ($error==0) {
            ...
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>Client account created.</p>
                    ...
                    <h6 style="margin-bottom:20px">Personal Details</h6>
                        <div class="row g-3  mb-3">
                            <div class="col-md-9">
                                ...
                                <input class="form-control" id="ClientName" name="ClientName" type="text" placeholder="Client's Name"  value="<?php echo isset($_POST['ClientName']) ? $_POST['ClientName'] : "";?>">
                         ...
                         <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" name="FatherName" id="FatherName" type="text" placeholder="Father/Husband Name"  value="<?php echo isset($_POST['FatherName']) ? $_POST['FatherName'] : "";?>">
                            </div>
                        </div>
                        <div class="row g-3  mb-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-xl-12 col-sm-12">
                                    ...
                                    <input class="datepicker-here form-control digits"  name="DateOfBirth" id="DateOfBirth" type="text" data-language="en">
                                </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                ...
                                <input class="form-control" name="PersonalAlternativeNumbers" id="PersonalAlternativeNumbers" type="text" placeholder="Alernative Contact Numbers"  value="<?php echo isset($_POST['PersonalAlternativeNumbers']) ? $_POST['PersonalAlternativeNumbers'] : "";?>">
                            </div>
                             <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="NationalityID" name="NationalityID">
                                    ...
                                    <?php foreach($nationalities as $nationality) { ?>
                                        <option value="<?php echo $nationality['NationalityID'];?>" <?php echo $nationality['NationalityID']==$_POST['NationalityID'] ? ' selected="selected" ' : '';?> ><?php echo $nationality['NationalityName'];?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" name="PersonalRemarks" id="PersonalRemarks" type="text" placeholder="Remarks"  value="<?php echo isset($_POST['PersonalRemarks']) ? $_POST['PersonalRemarks'] : "";?>">
                            </div>
                        </div>
                </div>
            </div>
                  ...
                  <h6 style="margin-bottom:20px">Contact Details</h6>
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="ContactAddressLine1" name="ContactAddressLine1" type="text" placeholder="Address Line 1"  value="<?php echo isset($_POST['ContactAddressLine1']) ? $_POST['ContactAddressLine1'] : "";?>">
                          ...
                          <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="ContactAddressLine2" name="ContactAddressLine2" type="text" placeholder="Address Line 2"  value="<?php echo isset($_POST['ContactAddressLine2']) ? $_POST['ContactAddressLine2'] : "";?>">
                                <div id="ErrContactAddressLine2" style="color:red"><?php echo isset($ContactAddressLine2) ? $ContactAddressLine2 : "";?></div>
                            </div>
                        </div>
                        <div class="row g-3  mb-3">
                            <div class="col-md-9">
                                <label class="form-label" for="validationCustom03">Address Line3</label>
                                <input class="form-control" name="ContactAddressLine3" id="ContactAddressLine3" type="text" placeholder="Address Line 3"  value="<?php echo isset($_POST['ContactAddressLine3']) ? $_POST['ContactAddressLine3'] : "";?>">
                            </div>
                             <div class="col-md-3">
    ...
    <div class="col-md-6">
        ...
        <div id="ErrDistrictNameID" style="color:red"><?php echo isset($DistrictNameID) ? $DistrictNameID : "";?></div>
                        ...
                        <div class="row g-3 mb-3">
                             <div class="col-md-12">
                                ...
                                <input class="form-control" name="ContactAdditonalNumbers" id="ContactAdditonalNumbers" type="text" placeholder="Additional Contact Numbers"  value="<?php echo isset($_POST['ContactAdditonalNumbers']) ? $_POST['ContactAdditonalNumbers'] : "";?>">
                            </div>
                        </div>
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom03">Additional Remarks</label>
                                <input class="form-control" name="ContactRemarks" id="ContactRemarks" type="text" placeholder="Remarks"  value="<?php echo isset($_POST['ContactRemarks']) ? $_POST['ContactRemarks'] : "";?>">
                            </div>
                        </div>
                </div>
            </div>
                ...
                <div class="card-body">
                  <h6 style="margin-bottom:20px">Office Details</h6>
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom01">Address Line 1</label>
                                <input class="form-control" id="OfficeAddressLine1" name="OfficeAddressLine1" type="text" placeholder="Address Line 1"  value="<?php echo isset($_POST['OfficeAddressLine1']) ? $_POST['OfficeAddressLine1'] : "";?>">
                          ...
                          <div class="row g-3  mb-3">
                            ...
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom01">Address Line 2</label>
                                <input class="form-control" id="OfficeAddressLine2" name="OfficeAddressLine2" type="text" placeholder="Address Line 2"  value="<?php echo isset($_POST['OfficeAddressLine2']) ? $_POST['OfficeAddressLine2'] : "";?>">
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-9">
                                <label class="form-label" for="validationCustom03">Address Line3</label>
                                <input class="form-control" name="OfficeAddressLine3" id="OfficeAddressLine3" type="text" placeholder="Address Line 3"  value="<?php echo isset($_POST['OfficeAddressLine1']) ? $_POST['OfficeAddressLine1'] : "";?>">
                            </div>
                             <div class="col-md-3">
                                <label class="form-label" for="validationCustom03">Pincode</label>
                                <input class="form-control" name="OfficePincode" id="OfficePincode" type="text" placeholder="Pincode"  value="<?php echo isset($_POST['OfficePincode']) ? $_POST['OfficePincode'] : "";?>">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                             <div class="col-md-12">
                                <label class="form-label" for="validationCustom03">Additional Contact numbers</label>
                                <input class="form-control" name="OfficeAdditonalNumbers" id="OfficeAdditonalNumbers" type="text" placeholder="Additonal Contact Numbers"  value="<?php echo isset($_POST['OfficeAdditonalNumbers']) ? $_POST['OfficeAdditonalNumbers'] : "";?>">
                            </div>
                        </div>
                        <div class="row g-3  mb-3">
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom03">Additional Remarks</label>
                                <input class="form-control" name="OfficeRemarks" id="OfficeRemarks" type="text" placeholder="Remarks"  value="<?php echo isset($_POST['OfficeRemarks']) ? $_POST['OfficeRemarks'] : "";?>">
                            </div>
                        </div>
                </div>
            </div>
        ...
        <div class="col-sm-12" style="margin-bottom:50px;">
                            ...
                            <div class="col-md-12" style="text-align: right;">
                                ...
                                <button class="btn btn-primary" type="submit" name="CreateBtn" id="CreateBtn">Create Client</button>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to create Client account.</p>
            </div>
