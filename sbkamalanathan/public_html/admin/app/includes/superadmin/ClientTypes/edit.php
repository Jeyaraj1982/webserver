...
<div class="container-fluid">
<?php
$data = $mysql->select("select * from _tbl_master_clienttypes where md5(ClientTypeID)='".$_GET['edit']."'");
    if (isset($_POST['CreateBtn'])) {
        
        if ($_POST['isDelete']==0) {
        
        $error=0;
        if (strlen(trim($_POST['ClientTypeName']))==0) {
            $ClientTypeName = "Please enter Client Type";
            $error++;
        }
        
        $duplicate = $mysql->select("select * from _tbl_master_clienttypes where ClientTypeID<>'".$data[0]['ClientTypeID']."' and ClientTypeName='".trim($_POST['ClientTypeName'])."'");
        if (sizeof($duplicate)>0) {
            $ClientTypeName = "Client Type already exists";
            $error++;  
        }
 
        if ($error==0) {
            $mysql->execute("update _tbl_master_clienttypes set ClientTypeName = '".trim($_POST['ClientTypeName'])."',
                                                                IsActive = '".$_POST['IsActive']."',
                                                              Remarks  = '".trim($_POST['Remarks'])."' where md5(ClientTypeID)='".$_GET['edit']."'");
          ...
          //  unset($_POST);
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>Client Type updated.</p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to update client type.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
            ...
            <?php
               ...
               $mysql->execute("update _tbl_master_clienttypes set IsActive          = '2',
                                                                 DeletedOn         = '".date("Y-m-d H:i:s")."'
                                                                 where md5(ClientTypeID) = '".$_GET['edit']."'");
               unset($_POST);
               ?>
                   <div class="row">
                <div class="col-12">
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>client type deleted.</p>
                      <br>
                      <a href="dashboard.php?action=ClientTypes/list" class="btn btn-success">Continue</a>
                    </div>
                    </div>
              </div>
              </div>
...
?>
    <div class="row" id="frmD">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="" method="post" id="create_clienttypename" name="create_clienttypename" onsubmit="return formvalidation('create_clienttypename');">
                        <div class="row g-3  mb-3">
                            <div class="col-md-6">
                                <label class="form-label" for="validationCustom01">Client Type</label>
                                <input class="form-control" id="ClientTypeName" name="ClientTypeName" type="text" placeholder="Client Type"  value="<?php echo isset($_POST['ClientTypeName']) ? $_POST['ClientTypeName'] : $data[0]['ClientTypeName'];?>">
                                <div id="ErrClientTypeName" style="color:red"><?php echo isset($ClientTypeName) ? $ClentTypeName : "";?></div>
                            </div>
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-12" style="text-align: right;">
                                ...
                                <a href="dashboard.php?action=ClientTypes/list" class="btn btn-outline-primary">Back</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to update client type</p>
            </div>
