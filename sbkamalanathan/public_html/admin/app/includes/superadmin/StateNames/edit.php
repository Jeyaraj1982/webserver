...
<div class="container-fluid">
<?php
$data = $mysql->select("select * from _tbl_master_statenames where md5(StateNameID)='".$_GET['edit']."'");
    if (isset($_POST['CreateBtn'])) {
        ...
        $duplicate = $mysql->select("select * from _tbl_master_statenames where StateNameId<>'".$data[0]['StateNameID']."' and StateName='".trim($_POST['StateName'])."'");
        if (sizeof($duplicate)>0) {
            $StateName = "State Name Name already exists";
            $error++;  
        }
 
        if ($error==0) {
            $mysql->execute("update _tbl_master_statenames set StateName = '".trim($_POST['StateName'])."',
                                                                IsActive = '".$_POST['IsActive']."',
                                                              Remarks  = '".trim($_POST['Remarks'])."' where md5(StateNameID)='".$_GET['edit']."'");
                                                              
           $mysql->execute("update _tbl_master_districtnames set StateName='".trim($_POST['StateName'])."' where StateNameID='".$_GET['edit']."'");
           $additional = "";
           if ($_POST['IsActive']==0)  {
                    $deactivated = $mysql->select("select * from _tbl_master_districtnames where StateNameID='".$_GET['edit']."'");
                    $mysql->execute("update _tbl_master_districtnames set IsActive='0' where StateNameID='".$_GET['edit']."'");
                    if (sizeof($deactivated)>0) {
                        $additional = " and ( ".sizeof($deactivated)." district names has been deactivated.)";
                    }
           }
           if ($_POST['IsActive']==1)  {
                    $activaed= $mysql->select("select * from _tbl_master_districtnames where StateNameID='".$_GET['edit']."'");
                    $mysql->execute("update _tbl_master_districtnames set IsActive='1' where StateNameID='".$_GET['edit']."'");
                    if (sizeof($activaed)>0) {
                        $additional = " and ( ".sizeof($activaed)." district names has been activated.)";
                    }
           }
          ...
          //  unset($_POST);
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>State Name updated. <?php echo $additional;?></p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to update State Name.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
            ...
            <?php
               ...
               $mysql->execute("update _tbl_master_statenames set IsActive          = '2',
                                                                 DeletedOn         = '".date("Y-m-d H:i:s")."'
                                                                 where md5(StateNameID) = '".$_GET['edit']."'");
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>State Name deleted.</p>
                      <br>
                      <a href="dashboard.php?action=StateNames/list" class="btn btn-success">Continue</a>
                    </div>
                    </div>
              </div>
              </div>
                    ...
                    <form action="" method="post" id="create_statename" name="create_statename" onsubmit="return formvalidation('create_statename');">
                        <div class="row g-3  mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="StateName" name="StateName" type="text" placeholder="State Name"  value="<?php echo isset($_POST['StateName']) ? $_POST['StateName'] : $data[0]['StateName'];?>">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to update state name</p>
            </div>
...
<div class="modal fade" id="exampleModalCenterDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to <b style="color:red">delete</b> state name</p>
            </div>
            <div class="modal-footer">
