...
<?php
    if (isset($_POST['CreateBtn'])) {
        ...
        $duplicate = $mysql->select("select * from _tbl_master_districtcourttypes where DistrictCourtTypeName='".trim($_POST['DistrictCourtTypeName'])."'");
        ...
        if ($error==0) {
            $mysql->insert("_tbl_master_districtcourttypes",array("DistrictCourtTypeName" => trim($_POST['DistrictCourtTypeName']),
            ...
            ?>
              ...
              <div class="alert alert-success outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Well done! </b>District Court Type created.</p>
            ...
            ?>
              ...
              <div class="alert alert-danger outline alert-dismissible fade show" role="alert" style="margin-bottom: 0px;">
                      ...
                      <p style="white-space:normal !important;max-width:100%;"><b> Error found! </b>Couldn't able to create District Court Type.</p>
                      <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </div>
              </div>
                    ...
                    <form action="" method="post" id="create_districtcourttype" name="create_districtcourttype" onsubmit="return formvalidation('create_districtcourttype');">
                        <div class="row g-3  mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="DistrictCourtTypeName" name="DistrictCourtTypeName" type="text" placeholder="District Court Type Name"  value="<?php echo isset($_POST['DistrictCourtTypeName']) ? $_POST['DistrictCourtTypeName'] : "";?>">
                                <div id="ErrDistrictCourtTypeName" style="color:red"><?php echo isset($DistrictCourtTypeName) ? $DistrictCourtTypeName : "";?></div>
                            </div>
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-12" style="text-align: right;">
                                ...
                                <button class="btn btn-primary" type="submit" name="CreateBtn" id="CreateBtn">Create District Court Type</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you want to create District Court Type.</p>
            </div>
