    ...
    if (isset($_POST['CreateBtn'])) {
        ...
        if (strlen(trim($_POST['CurrentPassword']))==0) {
            ...
            $error++;
             ...
             $data = $mysql->select("select * from _tbl_master_staffs where StaffID='".$_SESSION['User']['StaffID']."'");
        ...
        if ($error==0) {
            ...
            $mysql->execute("update _tbl_master_staffs set LoginPassword='".$_POST['NewPassword']."' where  StaffID='".$_SESSION['User']['StaffID']."'");
            unset($_POST);
            ?>
                <div class="row">
                <div class="col-12">
