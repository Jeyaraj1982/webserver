            ...
            <div class="row">
                <div class="col-lg-12  col-md-12 col-sm-12">
                    ...
                    <div class="bg-white login_content login_border_radius">
                        <form action="http://sms.ecfast.in" id="login_validator" method="post" class="login_validator">
                            <div class="form-group">
                                <label for="email" class="form-control-label"> E-mail</label>
                                <div class="input-group">
                                    <span class="input-group-addon input_email"><i
                                            class="fa fa-envelope text-primary"></i></span>
                                    <input type="text" class="form-control  form-control-md" id="email" name="emailid" placeholder="Registered Email-ID">
                                </div>
                            </div>
                            <!--</h3>-->
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control form-control-md" id="password"   name="loginpassword" placeholder="Web Login Password">
                                </div>
                            </div>
							     <div class="form-group">
			        ...
			        <option value="Reseller">Reseller</option>
							 ...
							 <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="submit" value="Log In" name="loginBtn" class="btn btn-primary btn-block login_button">
                                    </div>
                                </div>
                            </div> 
