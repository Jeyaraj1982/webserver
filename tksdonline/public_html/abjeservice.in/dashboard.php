...
<div class="modal" id="myModal">
  ...
  <div class="row">
    ...
    <div class="card">
        <div class="card-header" style="text-align: center;background:#3171C0;color:#fff;font-size:25px;font-weight:bold;margin-bottom:10px;">
           ABJ E-Service
        </div>
        <!--<div class="card-header" style="text-align: center;">
            <img src="https://abjeservice.in/assets/img/logo.png" style="width:100px">
        </div>-->
