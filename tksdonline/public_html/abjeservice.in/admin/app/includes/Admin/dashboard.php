<div class="page-inner">
                            ...
                            <div class="card card-stats card-info card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers" >
                                                <p class="card-category">Admin Balance</p>
                                                <h4 class="card-title">
                                                    <?php echo number_format(TKSD::getBalance(),2); ?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
    ...
    $OperatorTypeCodes = implode(",",$OperatorTypeCodes);
                        ...
                        <div class="col-sm-6 col-md-4" style="cursor: pointer;" onclick="loadPage('Transactions/ListAll')">
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-icon">
