...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Users/TNPoliceTransaction">Utility Payments</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Users/TNPoliceTransaction"><?php echo $data[0]['OperatorTypeCode'];?></a></li>
        </ul>
    </div>
    <div class="row" style="margin-bottom:10px;">
        <div class="col-md-12" style="text-align: right;">
            <a href="dashboard.php?action=Users/TNPoliceTransaction&filter=requested" <?php if($_GET['filter']=="requested") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Requested</small></a>&nbsp;|&nbsp; 
            <a href="dashboard.php?action=Users/TNPoliceTransaction&filter=paid" <?php if($_GET['filter']=="paid") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Paid</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=Users/TNPoliceTransaction&filter=reversed" <?php if($_GET['filter']=="reversed") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Reversed</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=Users/TNPoliceTransaction&filter=all" <?php if($_GET['filter']=="all") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>All</small></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
