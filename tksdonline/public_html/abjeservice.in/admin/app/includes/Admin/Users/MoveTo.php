  ...
  <div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Users/MoveTo">Users</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Users/MoveTo">Move To</a></li>
        </ul>
    </div> 
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body"><div class="form-group m-b-0 text-right">
                            <a href="dashboard.php?action=Users/View&d=<?php echo $_GET['d'];?>" class="btn btn-outline-primary waves-effect waves-light">Cancel</a>
