    ...
    if (isset($_POST['submitBtn'])) {
        ...
        if ($error==0) {
            $MemberID =  $mysql->insert("_tbl_member",array("MemberName"      => $_POST['MemberName'],
             ...
             $d = MobileSMS::sendSMS($_POST['MobileNumber'],"Dear Distributor, your distributor account created. Your login Name: ".$_POST['MobileNumber']." and Password: ".$_POST['MemberPassword'],$MemberID);
