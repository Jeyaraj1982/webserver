<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Setttings/EnrollmentPackage">Prepaid Operators</a></li>
        </ul>
    </div>
    <div class="row">
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-orange"><i class="ti-user"></i>&nbsp;&nbsp; Prepaid mobile operators</h4>
                    <div class="row">
                        <?php $Members =$mysql->select("select * from `_tbl_operators` where OperatorType='1'"); ?>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12 col-xlg-12 col-md-12">
                                    <div class="card2">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table v-middle" style="border: 1px solid; border-color: #e1e1e1;">
                                                    <thead>
                                                        <tr>
                                                           ...
                                                           <!-- <th class="border-top-0"><b>LapuCode</b></th>-->
                                                            ...
                                                            <th class="border-top-0"><b>Connect</b></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>     
                                                    <?php foreach ($Members as $Member){ ?>
                                                        <tr>
                                                            <td>
                                                            <div class="avatar avatar-<?php echo $Member['IsActive']==1 ? 'online':'offline';?>">
                                        ...
                                        <option value="5" <?php echo ($Member['APIID']==5) ? " selected='selected' " : "";?> >TKSD Lapu</option> 
                                    </select>
