<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=ApiUsers/View">Users</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=ApiUsers/View">View User</a></li>
        </ul>
    </div> 
    <?php
                  ...
                  <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>API Key</label>                       
                                    <div style="color:#999"><?php echo $data[0]['APIKey'];?></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>API Password</label>                       
                                    <div style="color:#999"><?php echo $data[0]['APIPassword'];?></div>
                                </div>
                            </div>
                        </div>
