<?php
    ...
    // tksdonlineservice.in/callback_telegram.php?action=sendMessage&Message=
    ...
    if (sizeof($d)==0) {
        ...
        if ($mobilenumber>=6000000000 && $mobilenumber<=9999999999) {
            ...
            $message = " Welcome to TKSD Online Service. Any queries or feedback please contact support team via Whatsapp.";
