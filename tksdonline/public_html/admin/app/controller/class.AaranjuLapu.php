<?php
    class AaranjuLapu {
        ...
        public static function sendRequest($param) {
            ...
            $api_url ="https://www.aaranju.in/recharge/api.php?apiusername=d2VsY29tZUA&apipassword=jM0NTY3ODk&number=".$param['number']."&amount=".$param['amount']."&uid=".$param['txnid']."&response=json&";
