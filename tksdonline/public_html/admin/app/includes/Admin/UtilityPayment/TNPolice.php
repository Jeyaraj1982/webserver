<?php
    ...
    if(isset($_GET['filter']) && $_GET['filter']=="all") {
        $Members = $mysql->select("select txn.*,mem.MobileNumber from _tbl_transactions as txn left join _tbl_member as mem on mem.MemberID=txn.memberid   where txn.OperatorCode='".$data[0]['OperatorLAPUCode']."' order by txn.txnid desc");
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=UtilityPayment/TNPolice">Utility Payments</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=UtilityPayment/TNPolice"><?php echo $data[0]['OperatorTypeCode'];?></a></li>
        </ul>
    </div>
    <div class="row" style="margin-bottom:10px;">
        <div class="col-md-12" style="text-align: right;">
            <a href="dashboard.php?action=UtilityPayment/TNPolice&filter=requested" <?php if($_GET['filter']=="requested") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Requested</small></a>&nbsp;|&nbsp; 
            <a href="dashboard.php?action=UtilityPayment/TNPolice&filter=paid" <?php if($_GET['filter']=="paid") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Paid</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=UtilityPayment/TNPolice&filter=reversed" <?php if($_GET['filter']=="reversed") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>Reversed</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=UtilityPayment/TNPolice&filter=all" <?php if($_GET['filter']=="all") {?>style="font-weight:bold;text-decoration:underline;" <?php }?>><small>All</small></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
