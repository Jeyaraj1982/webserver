...
<div style="padding:25px">
    ...
    <div class="row" style="margin-bottom:10px;">
        <div class="col-md-12" style="text-align: right;">
            <a href="dashboard.php?action=BillPayments/MoneyTransfer&filter=requested"><small <?php if($_GET['filter']=="requested") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>>Requested</small></a>&nbsp;|&nbsp; 
            <a href="dashboard.php?action=BillPayments/MoneyTransfer&filter=paid" <?php if($_GET['filter']=="paid") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>><small>Paid</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=BillPayments/MoneyTransfer&filter=reversed" <?php if($_GET['filter']=="reversed") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>><small>Reversed</small></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                         ...
                         <table id="basic-datatables" class="display table table-striped table-hover" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;"><a href="javascript:openTxnImpsViewDialog('<?php echo $Member['txnid'];?>')">View</a></td>
                                    <?php } elseif (isset($_GET['filter']) && $_GET['filter']=="reversed") { ?>
                                    <td style="text-align: right;"><?php echo $Member['revDate'];?></td>
                                    <td style="text-align: right;"> <a href="javascript:openTxnImpsViewDialog('<?php echo $Member['txnid'];?>')">View</a></td>
                                    <?php } else {?>
                                    <td style="text-align: right;">
                                        <a href="javascript:openTxnImpsViewDialog('<?php echo $Member['txnid'];?>')">View</a><br>
...
<script>
    function openTxnImpsViewDialog(txnid) {                                  
       $('#txnData').html("Loading ...."); 
         $('#viewRxn').modal("show");
        $.ajax({url:'webservice.php?action=getIMPSTxn&txn='+txnid,success:function(data){
