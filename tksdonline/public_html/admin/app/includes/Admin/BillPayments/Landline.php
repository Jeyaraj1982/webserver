...
<div style="padding:25px">
    ...
    <div class="row" style="margin-bottom:10px;">
        <div class="col-md-12" style="text-align: right;">
            <a href="dashboard.php?action=BillPayments/Landline&filter=requested"><small <?php if($_GET['filter']=="requested") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>>Requested</small></a>&nbsp;|&nbsp; 
            <a href="dashboard.php?action=BillPayments/Landline&filter=paid" ><small <?php if($_GET['filter']=="paid") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>>Paid</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=BillPayments/Landline&filter=reversed"><small <?php if($_GET['filter']=="reversed") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>>Reversed</small></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                         ...
                         <table id="basic-datatables" class="display table table-striped table-hover" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;"><a href="javascript:openTxnLandlineViewDialog('<?php echo $Member['txnid'];?>')">View</a></td>
                                    <?php } elseif (isset($_GET['filter']) && $_GET['filter']=="reversed") { ?>
                                    <td style="text-align: right;"><?php echo $Member['TxnStatus'];?></td>
                                    ...
                                    <td style="text-align: right;">
                                       <a href="javascript:openTxnLandlineViewDialog('<?php echo $Member['txnid'];?>')">View</a><br>
...
<script>
    function openTxnLandlineViewDialog(txnid) {                                  
       $('#txnData').html("Loading ...."); 
         $('#viewRxn').modal("show");
        $.ajax({url:'webservice.php?action=getLandlineTxn&txn='+txnid,success:function(data){
