...
<div style="padding:25px">
    ...
    <div class="row" style="margin-bottom:10px;">
        <div class="col-md-12" style="text-align: right;">
            <a href="dashboard.php?action=BillPayments/Gas&filter=requested"><small <?php if($_GET['filter']=="requested") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>>Requested</small></a>&nbsp;|&nbsp; 
            <a href="dashboard.php?action=BillPayments/Gas&filter=paid" ><small <?php if($_GET['filter']=="paid") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>>Paid</small></a>&nbsp;|&nbsp;
            <a href="dashboard.php?action=BillPayments/Gas&filter=reversed" <?php if($_GET['filter']=="reversed") { ?> style="text-decoration: underline;font-weight:bold;" <?php } ?>><small>Reversed</small></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
<script>
    function openTxnPostPaidViewDialog(txnid) {                                  
       $('#txnData').html("Loading ...."); 
         $('#viewRxn').modal("show");
        $.ajax({url:'webservice.php?action=getGasBillTxn&txn='+txnid,success:function(data){
