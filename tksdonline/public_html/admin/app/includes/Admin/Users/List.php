                                         ...
                                         <td>
                                                <div class="dropdown dropdown-kanban" style="float: right;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="dashboard.php?action=Users/View&Point&User=<?php echo $Request['MemberID'];?>">View</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Users/Edit&User=<?php echo $Request['MemberID'];?>">Edit</a>
