    ...
    <?php if (isset($_POST['submitRequest'])) { ?>
        ...
        ?>
            <div class="row">
                ...
                <a href="dashboard.php?action=dth_airtel" class="btn btn-success  glow w-100 position-relative">Continue<i id="icon-arrow" class="bx bx-right-arrow-alt" style="float: right;"></i></a><br>
                <a href="dashboard.php?action=add_contacts_dth&id=<?php echo $result['txnid'];?>" class="btn btn-outline-success  glow w-100 position-relative">Add Contact<i id="icon-arrow" class="bx bx-right-arrow-alt" style="float: right;"></i></a>
            </div>
        <?php } else {?>
            <div class="row">
                <div style="padding:20px;text-align:center;width:100%;color:#666;line-height:25px;padding-bottom:0px;">
                ...
                <a href="dashboard.php?action=dth_airtel" class="btn btn-success  glow w-100 position-relative">Continue<i id="icon-arrow" class="bx bx-right-arrow-alt" style="float: right;"></i></a><br><br>
                <a href="dashboard.php?action=dthrc" class="btn btn-outline-success glow w-100 position-relative">Back<i id="icon-arrow" class="bx bx-left-arrow-alt" style="float: left;"></i></a>
            </div>
        <?php } ?>
    <?php } else { ?>
        <div class="row">
            <form action="" method="post" style="width: 80%;margin: 0px auto;" onsubmit="return checkInputs();">
                <div class="form-group">
                    <label class="text-bold-600" for="exampleInputEmail1">DTH Number</label>
                    <?php 
                        if(isset($_GET['dthnumber']))  {
                            $dthnum=$_GET['dthnumber'];
                        } else {
                            $dthnum ="";
                        }
                    ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number"  value="<?php echo isset($_POST['Amount']) ? $_POST['Amount'] : "";?>" maxlength="15" name="Amount" id="Amount" class="form-control" placeholder="Amount" required="">
...
<div class="row">
    ...
    <a href="dashboard.php?action=dthrc" class="btn btn-success  glow w-100 position-relative">Continue<i id="icon-arrow" class="bx bx-right-arrow-alt" style="float: right;"></i></a>
    <a href="dashboard.php?action=dthrc" class="btn btn-success  glow w-100 position-relative"><i id="icon-arrow" class="bx bx-left-arrow-alt" style="float: left;">Back</i></a>
</div>
<?php } ?>
<!-- List of Plans -->
      ...
      <div class="modal-body" id="mbody">
         <table>
            <?php foreach($plans as $p) { ?>
                <tr>
                    <td style="border-bottom:1px solid #ccc;padding-top:3px;padding-bottom:3px;font-size:11px;"><?php echo $p['Description'];?></td>
                    <td style="border-bottom:1px solid #ccc;padding-top:3px;padding-bottom:3px;vertical-align:top"><a href="javascript:void(0)" onclick="selectAmount('<?php echo $p['Amount'];?>');" class="btn btn-primary btn-xs" style="float: right;padding:3px 10px;font-size:11px;"><?php echo $p['Amount'];?></a></td>
                </tr>
            <?php } ?>
         </table> 
      </div>
...
var IsConfirm=0;
   ...
   function checkInputs() {
    ...
    if (!(ebnumber.length>5)) {
        $('#error_msg').html("Invalid DTH Number");
        return false;
    }
