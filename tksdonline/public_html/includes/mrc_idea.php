    ...
    <?php if (isset($_POST['submitRequest'])) { ?>
        ...
        ?>
            <div class="row">
                ...
                <a href="dashboard.php?action=mrc_idea" class="btn btn-success  glow w-100 position-relative">Continue<i id="icon-arrow" class="bx bx-right-arrow-alt" style="float: right;"></i></a><br>
        ...
        <?php } else {?>
            <div class="row">
                ...
                <a href="dashboard.php?action=mrc_idea" class="btn btn-success  glow w-100 position-relative">Continue<i id="icon-arrow" class="bx bx-right-arrow-alt" style="float: right;"></i></a><br><br>
