 <div style="padding:0px;text-align:center;margin-bottom:20px;">
                <h5>Postpaid Services</h5>
            </div> 
            <div class="row">
                <div class="col-4" style="padding-right:6px;padding-left:6px">
                    <a href="dashboard.php?action=postpaid_airtel" class="btn btn-icon glow mb-1" style="width:100%"  >
                        <img src="assets/img/logo_airtel.png" style="width:100%;border:1px solid #ccc;border-radius:10px;">
                    </a>
                </div>
                <div class="col-4" style="padding-right:6px;padding-left:6px">
                    <a href="dashboard.php?action=postpaid_bsnl" class="btn btn-icon   glow mb-1" style="width:100%">
                ...
                <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
                    <a href="dashboard.php?action=postpaid_jio"  class="btn btn-icon  glow mb-1" style="width:100%" >
             ...
             <div class="row">
                <div class="col-4" style="padding-right:6px;padding-left:6px">
                    <a href="dashboard.php?action=postpaid_vodafone" class="btn btn-icon glow mb-1" style="width:100%"  >
