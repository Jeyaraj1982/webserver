<div style="padding:0px;text-align:center;margin-bottom:0px;"></div> 

<div class="row">                                                                                 
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=mobilerc"  class="btn btn-icon glow " style="width:100%;font-size:13px;line-height:18px;" >
            <img src="assets/img/logo_prepaid.png" style="width:100%;border:1px solid #ccc;border-radius:10px;padding:10px">
            <br>Prepaid<br>Recharge
        </a>
    </div>       
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=dthrc" class="btn btn-icon glow " style="width:100%;font-size:13px;line-height:18px;">
            <img src="assets/img/logo_dth.png" style="width:100%;border:1px solid #ccc;border-radius:10px;padding:15px">
            <br>DTH<br>Recharge
        </a>
    </div>
    <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
        <a href="dashboard.php?action=moneytransfer" class="btn btn-icon  glow " style="width:100%;font-size:13px;line-height:18px;" >
...
<div class="row">
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=ticketbooking"  class="btn btn-icon " style="width:100%;font-size:13px;line-height:18px;" >
            <img src="assets/img/logo_ticket.png" style="width:100%;border:1px solid #ccc;border-radius:10px">
            <br>Ticket<br>Booking 
        </a>
    </div>
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=bill_tneb" class="btn btn-icon glow " style="width:100%;font-size:13px;line-height:18px;">
    ...
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=gasbill"  class="btn btn-icon " style="width:100%;font-size:13px;line-height:18px;" >
             ...
             <img src="assets/img/logo_gasbill.png" style="width:100%;border:1px solid #ccc;border-radius:10px;padding:10px">
             <?php                                                                                                                                             
                if($gascont[0]['cnt']>0){ 
                    $notification_css="";
                    if ($gascont[0]['cnt']<=9) {
...
<div class="row">
    <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
        <a href="dashboard.php?action=landline" class="btn btn-icon  glow " style="width:100%;font-size:13px;line-height:18px;" >
            <img src="assets/img/logo_landline.png" style="width:100%;border:1px solid #ccc;border-radius:10px">
            <br>Landline<br>Bill
        </a>
    </div>
    <div class="col-4" style="padding-right:6px;padding-left:6px">                                                                        
        <a href="dashboard.php?action=mobilepostpaid"  class="btn btn-icon " style="width:100%;font-size:13px;line-height:18px;" >
    ...
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=insurance" class="btn btn-icon glow " style="width:100%;font-size:13px;line-height:18px;">
...
<div class="row">
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=utility_tnpolice"  class="btn btn-icon " style="width:100%;font-size:13px;line-height:18px;" >
    ...
    <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
        <a href="dashboard.php?action=accountsummary" class="btn btn-icon  glow " style="width:100%;font-size:13px;line-height:18px;" >
            <img src="assets/img/logo_accounts.png" style="width:100%;border:1px solid #ccc;border-radius:10px">
            <br>Account<br>Summary
        </a>
    </div>
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=txnhistory"  class="btn btn-icon " style="width:100%;font-size:13px;line-height:18px;" >
            <img src="assets/img/logo_transaction.png" style="width:100%;border:1px solid #ccc;border-radius:10px">
            <br>Txn<br>History
        </a>
    </div>
     <!--<div class="col-4" style="padding-right:6px;padding-left:6px">
       <a href="dashboard.php?action=pendings" class="btn btn-icon glow " style="width:100%">
...
<div class="row">
    ...
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=agents_manage"  class="btn btn-icon " style="width:100%;font-size:13px;line-height:18px;" >
             <img src="assets/img/logo_distributors.png" style="width:100%;border:1px solid #ccc;border-radius:10px">
             <br>Manage<br>Agents
        </a>
    </div>
    <div class="col-4" style="padding-right:6px;padding-left:6px">
        <a href="dashboard.php?action=settings" class="btn btn-icon glow " style="width:100%;font-size:13px;line-height:18px;">
    ...
    <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
        <a href="dashboard.php?action=settings_manage_mycontacts"  class="btn btn-icon  glow " style="width:100%;font-size:13px;line-height:18px;" >
            <img src="assets/img/logo_myprofile.png" style="width:100%;border:1px solid #ccc;border-radius:10px">
            <br>My<br>Contacts
        </a>     
    </div>
    <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
        <a href="dashboard.php?action=creditsales" class="btn btn-icon  glow " style="width:100%;font-size:13px;line-height:18px;" >
        ...
        <!-- <a href="https://t.me/TKSDONLINEBOT"><img src="https://sonusmac.files.wordpress.com/2019/09/join-us-in-telegram-1-360x140.jpg?w=547" style="height:100px"></a> -->
     ...
     <!--       
            <div class="row">
                <div class="col-4" style="padding-right:6px;padding-left:6px">
                    <a href="dashboard.php?action=cashback" class="btn btn-icon btn-success glow  " style="min-width:100%">Cashback<br>
                    <?php echo number_format($application->getCashback($_SESSION['User']['MemberID']),2);?>
                    </a>
                </div>
                <div class="col-4" style="padding-right:6px;padding-left:6px">
                    <a href="dashboard.php?action=charges" class="btn btn-icon btn-success glow  " style="width:100%;font-size:0.9rem !important">Charges<br>
                    <?php echo number_format($application->getCharges($_SESSION['User']['MemberID']),2);?>
                    </a>
                </div>
                <div class="col-4" style="padding-right:6px;padding-left:6px;text-align: right;">
                    <a href="dashboard.php?action=pendingbills" class="btn btn-icon btn-success glow " style="width:100%">Pending<br>Bills</a>
                </div>
            </div> -->