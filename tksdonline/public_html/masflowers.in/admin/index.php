...
$Page="login";
        if (isset($_POST['btnsubmit'])) {
         ...
         $userdata = $mysql->select("select * from _tbl_sales_admin where UserName='".$_POST['UserName']."' and Password='".$_POST['Password']."' ");
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center"> <img src="<?php echo $Logo;?>" style="height:130px"><br>Sign In</h3>
