                            ...
                            <div class="card card-invoice" style="max-width: 400px;min-width: 400px;padding: 17px;">
                                <div style="border: 1px solid black;">
                                    <div class="row" style="padding: 10px;padding-bottom:0px">
                                        <div class="col-md-12" style="text-align:center"><p style="margin-bottom:0px;font-size:10px">?????????? ????????? ?????????</p> </div>  
                                    </div>
                                    <div class="row" style="padding: 10px;padding-bottom:0px">
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-12" style="text-align: center;">
                                            ...
                                            <p style="margin-top:0px;margin-bottom:0px;font-size:12px;font-weight:bold;line-height:15px">????? ????? ??????????</p>   
                                            <p style="margin-top:0px;margin-bottom:0px;font-size:12px;font-weight:bold;line-height:15px">???? ???????? ???????    ,  ??????????.</p>   
                                        </div>
                                    </div>
                                    <div class="row" style="padding: 10px;padding-bottom:0px">                                
                                    ...
                                    <div class="row">                                                              
                                        <div class="col-md-12" style="float: left;">
                                                <div class="invoice-desc"><p style="padding-right: 10px;font-size:10px;margin-top: -10px !important;">???????</p></div>                                                  
                                        </div>
                                    </div>
                                    <div class="row">                                                               
                                        <div class="col-md-12">                                        
                                            <div class="">
                                                <table class="" style="border: 1px solid #dee2e6;width:100%">                
                                                        <tr>
                                                            ...
                                                            <td style="border-right: 1px solid #dee2e6;border-bottom: 1px solid #dee2e6;font-size:11px;text-align: center;"><strong>???? </strong></td>
                                                            <td style="border-bottom: 1px solid #dee2e6;text-align:right;width: 110px;font-size:11px;text-align: center;"><strong>???? </strong></td>      
                                                        </tr>   
                                                        <?php 
                                    ...
                                    <div class="row" style="padding-right:10px;margin-bottom:0px !important">
                                        <div class="col-md-9" style="text-align: right;">                                                   
                                            <div class="invoice-desc">
                                                <p style="margin-bottom: 0px !important;font-size:12px">????   ??????:  </p>
                                            </div>
                                        </div>
