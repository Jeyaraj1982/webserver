                                    ...
                                    <div class="card-body">
                                       <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="BarCode" name="BarCode" placeholder="Enter BarCode" value="<?php echo (isset($_POST['BarCode']) ? $_POST['BarCode'] :"");?>"  onchange="CheckDuplicateBarCode($(this).val())">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <select name="ProductQty" id="ProductQty" class="form-control">
                                                    ...
                                                    <option value="<?php echo $unit['id'];?>" <?php echo ($_POST['ProductQty']==$unit['id']) ? " selected='selected' " : "";?> selected='selected'> <?php echo $unit['unitname'];?></option>
                                                    <?php } ?>
                                                </select>  
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" style="text-align:right" id="ProductPrice" name="ProductPrice" placeholder="0.00" value="<?php echo (isset($_POST['ProductPrice']) ? $_POST['ProductPrice'] :"");?>">
...
function successpopup(link){
    var txt = '<div class="form-group row">'
                    +'<div class="col-sm-12" style="text-align:center">'
                        +'<img src="assets/tick.jpg" style="width:30%"><br><span>Product Added Successfully</span>'
                    +'</div>'
               +'</div>'
                +'<div style="padding:20px;text-align:center">'
...
function CheckDuplicateBarCode(BarCode) {
        $.ajax({url:'webservice.php?action=CheckDuplicateBarCode&BarCode='+BarCode,success:function(data){
