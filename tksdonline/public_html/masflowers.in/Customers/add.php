...
<script type="text/javascript">
   google.load("elements", "1", {
      ...
      function onLoad() {
        ...
        var ids = ["CustomerName","Description"];
                                    ...
                                    <div class="card-body">
                                       <div class="form-group form-show-validation row">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="MaximumCreditLimit" name="MaximumCreditLimit" placeholder="Enter Maximum Credit Limit" value="<?php echo (isset($_POST['MaximumCreditLimit']) ? $_POST['MaximumCreditLimit'] :"");?>">
...
function CheckDuplicateCustomerName(CustomerName) {
        $.ajax({url:'http://japps.online/demo/admin/webservice.php?action=CheckDuplicateCustomerName&CustomerName='+CustomerName,success:function(data){
            $('#ErrCustomerName').html(data);
        }});
    }
function CheckDuplicateCustomerNameTamil(CustomerNameTamil) {
        $.ajax({url:'http://japps.online/demo/admin/webservice.php?action=CheckDuplicateCustomerNameTamil&CustomerNameTamil='+CustomerNameTamil,success:function(data){
            $('#ErrCustomerNameTamil').html(data);
        }});
    }
function CheckDuplicateShopName(ShopName) {
        $.ajax({url:'http://japps.online/demo/admin/webservice.php?action=CheckDuplicateShopName&ShopName='+ShopName,success:function(data){
            $('#ErrShopName').html(data);
        }});
    }
function CheckDuplicateShopNameTamil(ShopNameTamil) {
        $.ajax({url:'http://japps.online/demo/admin/webservice.php?action=CheckDuplicateShopNameTamil&ShopNameTamil='+ShopNameTamil,success:function(data){
            $('#ErrShopNameTamil').html(data);
        }});
    }
    function CheckDuplicateEmailID(EmailID) {
        $.ajax({url:'http://japps.online/demo/admin/webservice.php?action=CheckDuplicateEmailID&EmailID='+EmailID,success:function(data){
