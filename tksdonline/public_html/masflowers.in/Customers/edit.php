                                    ...
                                    <div class="card-body">
                                       <div class="form-group form-show-validation row">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="MaximumCreditLimit" name="MaximumCreditLimit" placeholder="Enter Maximum Credit Limit" value="<?php echo (isset($_POST['MaximumCreditLimit']) ? $_POST['MaximumCreditLimit'] :$data[0]['MaximumCreditLimit']);?>">
