...
include_once("../config.php");
    ...
    function GetTextProduct() {                                                                                     
    
    global $mysql;
   
      $id=$mysql->select("Select * FROM _tbl_sales_products where ProductID='".$_POST['product']."' or BarCode='".$_POST['BarCode']."' or ProductName='".$_POST['ProductName']."'");
