                                   ...
                                   <div class="row">  
												...
												<tr>
													...
													<td width="15%">
														<div class="input-group">
															<input type="text" name="quantity[]"  readonly="readonly" value="<?php echo $invoiceItem['order_item_quantity'];?>" onkeypress="SwitchamountBox(event)" id="quantity_<?php echo $i;?>" class="form-control quantity" autocomplete="off" style="height: auto !important;text-align:center">
															<div class="input-group-append"> 
																<div class="input-group-text" id="Unit_<?php echo $i;?>">KG</div>
															</div> 
														</div> 
													</td> 
													<td width="15%" style="text-align:right"><input type="text" readonly="readonly" value="<?php echo $invoiceItem['order_item_price'];?>" name="price[]" onkeypress="SwitchproductBox(event)" id="price_<?php echo $i;?>" class="form-control price" autocomplete="off" style="height: auto !important;text-align:right"></td>         
													<td width="15%" style="text-align:right"><input type="text"  readonly="readonly" value="<?php echo $invoiceItem['order_item_final_amount'];?>" readonly="readonly" name="total[]" id="total_<?php echo $i;?>" class="form-control total" autocomplete="off" style="height: auto !important;text-align:right"></td>          
													<td width="20%"><?php echo $AddedBy[0]['AdminName'];?><br><span style="font-size:12px"><?php echo date("d M, Y H:i", strtotime($invoiceItem['AddedOn']));?></span></td>          
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:right"> 
											<button type="button" class="btn btn-primary" onclick="CallConfirmationUpdateInvoice()">Update</button>
