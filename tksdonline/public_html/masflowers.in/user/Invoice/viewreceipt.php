                                        ...
                                        <div class="card-footer">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12" style="text-align:right">
                                                    <button type="button" onclick="location.href='http://masflowers.in/admin/Invoice/print_receipt.php?receipt_id=<?php echo $_GET['receipt_id'];?>'" class="btn btn-primary btn-sm">Print</button>    
                                                </div>
                                            </div>
                                        </div>
                                    </div>
