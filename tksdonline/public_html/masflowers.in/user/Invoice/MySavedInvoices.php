<?php 
        $invoiceList = $mysql->select("SELECT * FROM save_invoice_order where SavedByID='".$_SESSION['User']['AdminID']."' order by order_id desc"); 
...
<script>
 ...
 function DeleteInvoice(Invoiceid) {
    ...
    $.post( "http://masflowers.in/admin/webservice.php?action=DeleteSavedInvoice",param,function(data) {
