                                   ...
                                   <div class="row">  
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:right"> 
                                            <button type="button" class="btn btn-success" onclick="CallConfirmationSaveInvoice()">Save</button>
...
function SaveInvoice() {  
    ...
    if(ErrorCount==0) {
       ...
       var loading = "<div style='padding:80px;text-align:center;color:#aaa'><img src='https://masflowers.in/admin/assets/loading.gif'  style='width:80px'><br>Processing ...</div>";                                                                                
            ...
            $.post( "http://masflowers.in/admin/webservice.php?action=SaveInvoice", param,function( data ) {
                var obj = JSON.parse(data); 
                var html = "";
                if (obj.status=="failure") {    
                    ...
                    html = '<div class="form-group row">'
                            ...
                            +'</div>'
                            +'<div style="padding:20px;text-align:center">'
                                +'<button type="button" class="btn btn-outline-success" onclick="location.href=\'dashboard.php?action=Invoice/SavedInvoices\'" >Countinue</button>'
                            +'</div>';                                                                   
                    $('#ConfirmationPopup').modal("show");                                                                        
                }
