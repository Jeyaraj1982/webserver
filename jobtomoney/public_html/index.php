...
<html lang="en-US">
   <head>
      ...
      <base href="https://www.jobtomoney.com/">
   ...
   <body class="size-960">
      <header>
         <div class="line">
            <div class="box" style="background:none;padding-left:60px;padding-bottom:2px;padding-top:10px">
               <div class="s-12 l-12">
                  <img class="" src="assets/logo01.png" style="height:65px;">
               </div>
            </div>
         </div>
         <div class="line">                                         
     ...
     /*  if ($rclient[0]['country']=="india") {
      ...
      <footer class="line">
         <div class="box">
            <div class="s-12 l-9">
                <div>
                    <a href="https://www.jobtomoney.com/AboutUs" style="color:orange">About Us</a>  &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="https://www.jobtomoney.com/Privacy" style="color:orange">Privacy Policy</a>  &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="https://www.jobtomoney.com/contactus" style="color:orange">Contact Us</a>  &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="https://www.jobtomoney.com/GamesTermsofConditions" style="color:orange">Game Terms & Conditions</a>  
                </div>
               <p>Copyright 2019-2020, jobtomoney.com</p>
            </div>
            <div class="s-12 l-3" style="text-align: right;">
                <img src="https://www.jobtomoney.com/assets/footerpayments.png" style="height: 80px;">
            </div>
           <!-- <div class="s-12 l-6">
      ...
      <script type="text/javascript" src="https://www.jobtomoney.com/js/responsee.js"></script>               
      <script type="text/javascript" src="https://www.jobtomoney.com/owl-carousel/owl.carousel.js"></script>
