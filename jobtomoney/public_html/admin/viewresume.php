      ...
      <div class="box">
        ...
        <div style="border-bottom:1px solid #D4E3F6;"></div><br>
            <table cellpadding='5' cellspacing='5' style='font-size:12px;' width="100%">
                ...
                <tr><td>Resume</td><td>: <?php echo $data[0]['Resume']; ?>&nbsp;<a href="https://www.jobtomoney.com/resume_download.php?file=<?php echo $data[0]['Resume']; ?>"><img src="../assets/download.png"></a></td></tr>
            </table>
        </div>
      </div>
   </div>
