...
<h5 style="text-align: left;font-family: arial;">Add Top Earner</h5> 
...
<?php
    ...
    if (isset($_POST['isSubmit'])) {
        ...
        if ( (move_uploaded_file($_FILES["file"]["tmp_name"],"assets/topearners/" .$filename)) 
            ...
            $array = array("personname"=>strtoupper($_POST['personname']), 
                           "photopath"=>$filename,
                           "description"=>$content);
                          
                            $mysql->insert("_tbl_topEarners",$array);
...
<form action="" method="post" enctype="multipart/form-data">
    <table  style="font-size:12px;font-family:arial;" cellpadding="5" cellspacing="0">
        <tr>
            <td> Name</td>
            <td><input type="text" class="form-control" name="personname" style="border:1px solid #ccc;width:100%"></td>
        </tr>
       <tr>
            <td>Description</td>
        ...
        <tr>
            <td colspan="2"><input type="submit" value="Add Top Earners" name="isSubmit" class="btn btn-primary"></td>
        </tr>
    </table>
</form>
