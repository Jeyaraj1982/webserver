...
?>
    <div class="row">
        <div class="col-sm-6" >
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <td>
                    ...
                    <table cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                            <td colspan="4">
                                <div style="border:1px solid #ffffff;background:#ffffff;border-radius:5px;;font-family: arial;font-size:16px;padding:5px;text-align:center;color:#666666">
                                    Rs. <?php echo $item['bidamount'];?> / Bid
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td style="background:#f1f1f1;padding:5px;border-top:1px solid #aaaaaa;font-family:arial;font-size:12px;">Current Lowest Unique bidder:
            ...
            <tr>
                <td>
                    ...
                    Total Sold Bid  : <?php echo sizeof($bidusers); ?><br>
    ...
    <div class="col-sm-6">
        ...
        <table cellpadding="5" cellspacing="2" border="1">
            ...
            ?>
            <tr style="<?php echo ($bid[0]['bidrate']==$d['bidrate']) ? 'background:lime' : '';?>">
 ...
 <table cellpadding="5" cellspacing="0" border="1">
    <tr>
        ...
        <td style="padding:2px;font-size:12px;font-weight:bold;">Bid Value</td>
    </tr>
    <?php
