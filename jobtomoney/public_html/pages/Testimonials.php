...
<?php
         ...
         <div class="line">
            <div class="box margin-bottom">
                  ...
                  <div class="row">
                        <div class="col-sm-8">
                            <h4>Winner's Testimonials</h4>
        <?php  foreach($mysql->select("select * from _tbltestimonials order by id desc") as $p) { ?>
        <div class="row">
              <div class="col-sm-3">
              <img   src="assets/testimonials/<?php echo $p['photopath'];?>" style="width:80%;margin:0px auto">
              </div>
              <div class="col-sm-9">
                <b><?php echo $p['test_name'];?></b><br>
