...
<?php
     ...
     //   }
       ...
       // Email Validation
        ...
        if ($isTrue==0) {
                 ...
                 $t.="<br><br>By<br>jobtomoney Team<b>";
   ...
   <div style='border: 1px solid #ccc;margin:5px;padding:10px;'>
                        ...
                        for instant activation,
                            <form action="https://www.jobtomoney.com/pay.php" method="post">
...
?>
    <div id="formwindow" class="formwindow">
        <form action="" method="post">  
                   ...
                   <h3 style="text-align: left;font-family: arial;">Registration at jobtomoney</h3><br>
