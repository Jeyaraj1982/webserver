                            ...
                            if  ( (strlen(trim($_POST['personname']))>0 && ($_POST['password']==$_POST['cpassword']) ) ) {
                                ...
                                if (sizeof($c)==0) {
                                    ...
                                    $mysql->execute("update _usertable set rlink='".$rlink."' where userid='".$userid."'");
                                        ...
                                        $t .= "Your Link : https://www.jobtomoney.com/".$rlink."<br>";
                                        ...
                                        mail("info@jobtomoney.com",trim($_POST['emailid'])."-:-Your account has been activated",$t,$headers); 
                        ...
                        <div class="col-sm-6" style="margin-bottom:15px">
                            <div style="border:1px solid #ccc;padding:10px">
                               ...
                               <span style="font-size:12px"> Required Points: <span style="font-size:35px;"><?php echo $p['points'];?></span></span><br><Br>
                                ...
                                <?php } ?>
                                <?php }  else {?>
                                    <input type="button" value="Buy Now"   class="btn btn-primary btn-sm" onclick="location.href='https://jobtomoney.com/GameRegister'">
                                <?php } ?>
                            </div>
                        </div>
                        <?php
