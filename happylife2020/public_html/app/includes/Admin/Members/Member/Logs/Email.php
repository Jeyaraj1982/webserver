                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="basic-datatables" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    <?php $Requests  = $mysql->select("SELECT * FROM `_tbl_logs_email` where MemberID='".$data[0]['MemberID']."' and Date(EmailRequestedOn)>=Date('".$_POST['From']."') and Date(EmailRequestedOn)<=Date('".$_POST['To']."') ORDER BY EmailLogID Desc "); ?>
                                    <?php foreach ($Requests as $Request){ ?>
                                    <tr>
                                        <td><?php echo date("M d, Y",strtotime($Request['EmailRequestedOn']));?></td>
