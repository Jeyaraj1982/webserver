...
<?php 
   ...
   ?>
   <div class="j2j_box">
        <a href='https://www.astrafx.uk/app/dashboard.php?action=Members/GenealogyTree&Code=<?php echo $param['MemberCode'];?>'><img src="https://www.astrafx.uk/app/assets/logo.png" style="width: 60px;"></a><br>
        <div style="font-size:12px">
            <a href='https://www.astrafx.uk/app/dashboard.php?action=Members/GenealogyTree&Code=<?php echo $param['MemberCode'];?>'><b><?php echo $param['MemberCode'];?></b></a><br>
