...
$payload = Array(
    ...
    'buyer_name' => $userinformation[0]['firstname'],
    'redirect_url' => 'https://www.kasupanamthuttu.com/Payment',
    'send_email' => false,
    'webhook' => 'https://www.kasupanamthuttu.com/',
    'send_sms' => false,
...
if ($response['success']=="true") {
    ...
    echo "<script>location.href='https://www.kasupanamthuttu.com/Error?msg=".$response['message']."';</script>";
}
?>