...
<h5 style="text-align: left;font-family: arial;">New Testimonials</h5> 
        ...
        if ((move_uploaded_file($_FILES["file"]["tmp_name"],"assets/testimonials/" .$filename)) ) {
            ...
            $array = array("test_name"=>strtoupper($_POST['itemname']), 
                           ...
                           "testimonials"=>$content);
                            ...
                            $mysql->insert("_tbltestimonials",$array);
...
<form action="" method="post" enctype="multipart/form-data">
    <table  style="font-size:12px;font-family:arial;" cellpadding="5" cellspacing="0">
        <tr>
            <td> Name</td>
            <td><input type="text" name="itemname"  class="form-control" style="width:100%"></td>
        </tr>
        ...
        <tr>
            <td colspan="2"><input type="submit" value="Add Testimonial" name="isSubmit" class="btn btn-primary"></td>
        </tr>
    </table>
</form>
