...
<h5 style="text-align: left;font-family: arial;">Paid Resumes</h5> 
<div style="text-align: right;">
    <a href="paidresumes" style="text-decoration: underline;font-size:bold">Paid</a><!--&nbsp;&nbsp;|&nbsp;&nbsp;  
    <a href="resumes" style="text-decoration: none;">Unpaid</a>    -->
</div>
<br><br> 
 
<?php // $data = $mysql->select("select * from _clients where isblock=-1 and isactive=0 order by id desc"); ?>
  <?php
   $data = $mysql->select("select * from _full_time_job_resume where Paid='1'");
