...
<h5 style="text-align: left;font-family: arial;">Add Item (Scratch To Win Cash)</h5> 
...
<table  style="font-family:arial;font-size:12px;" cellpadding="5" cellspacing="0" width="450px"> 
    ...
    <tr>
        ...
        <td><input type="text" name="skey" class="form-control" value="<?php echo $_POST['skey'];?>" required><br> (Comma Seperated by amounts)</td>
    </tr>
    <tr>
        <td>Description</td>
