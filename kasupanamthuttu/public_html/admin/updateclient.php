...
<div style="border-bottom:1px solid #D4E3F6;"></div><br> 
    ...
    if (isset($_POST['adPostingActive'])) {
        ...
        $userinformation = $mysql->select("select * from _clients where id=".$_POST['clientid']);
                                    ...
                                    $message = "Dear ".$userinformation[0]['firstname'].", Your account (ID: ".$userinformation[0]['id'].") has been activated and enabled ad posting job. Thanks KasuPanamThuttu.com";
                                    ...
                                    if (isset($referalinfo) && sizeof($referalinfo)>0) {
                                        $rmessage = "Dear ".$referalinfo[0]['firstname'].", You refered member (ID: ".$referalinfo[0]['id'].") has been activated and enabled ad posting job. You have earned (Rs. ".number_format($cramount,2)."). Thanks KasuPanamThuttu.com";
                                ...
                                if (isset($_POST['emailJobActive'])) {
                                    ...
                                    $message = "Dear ".$userinformation[0]['firstname'].", Your account (ID: ".$userinformation[0]['id'].") has been activated and enabled email sending job. Thanks KasuPanamThuttu.com";
                                    MobileSMS::sendSMS($userinformation[0]['mobileno'],$message,$userinformation[0]['id']);
                                    ...
                                    if (isset($referalinfo) && sizeof($referalinfo)>0) {
                                        $rmessage = "Dear ".$referalinfo[0]['firstname'].", You refered member (ID: ".$referalinfo[0]['id'].") has been activated and enabled email sending job. You have earned (Rs. ".number_format($cramount,2)."). Thanks KasuPanamThuttu.com";
                                        MobileSMS::sendSMS($referalinfo[0]['mobileno'],$rmessage,$referalinfo[0]['id']); 
                                        MailController::Send(array("MailTo"     => $referalinfo[0]['emailid'],
                                                                   "Category"   => "Activation",
                                                                   "MemberID"   => $referalinfo[0]['id'],
                                ...
                                if (isset($_POST['smsJobActive'])) {
                                     ...
                                     $message = "Dear ".$userinformation[0]['firstname'].", Your account (ID: ".$userinformation[0]['id'].") has been activated and enabled sms sending job. Thanks KasuPanamThuttu.com";
                                     MobileSMS::sendSMS($userinformation[0]['mobileno'],$message,$userinformation[0]['id']);
                                     ...
                                     if (isset($referalinfo) && sizeof($referalinfo)>0) {
                                         $rmessage = "Dear ".$referalinfo[0]['firstname'].", You refered member (ID: ".$referalinfo[0]['id'].") has been activated and enabled sms sending job. You have earned (Rs. ".number_format($cramount,2)."). Thanks KasuPanamThuttu.com";
                                         MobileSMS::sendSMS($referalinfo[0]['mobileno'],$rmessage,$referalinfo[0]['id']); 
      ...
      "clientid"=>$ref[0]['referringby'],
       ...
       "description"=>"New User Activation"
        ...
        $t .= "Thanks<br>kasupanamthuttu Team.";
         ...
         mail("info@kasupanamthuttu.com",trim($data[0]['emailid'])."-:-Your account has been activated",$t,$headers); 
