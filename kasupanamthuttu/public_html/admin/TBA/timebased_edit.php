...
<div class="line">
    ...
    <div class="s-12 m-6 l-9 margin-bottom">
        <div class="box">
            <h5 style="text-align: left;font-family: arial;">Edit Product To Time Based Auction</h5> 
...
<form action="timebased_edit?item=<?php echo $_REQUEST['item']; ?>" method="post"   enctype="multipart/form-data">
    <table  style="font-size:12px;font-family:arial;" cellpadding="5" cellspacing="0">
        <tr>
            <td>Product Name</td>
            <td><input type="text" name="itemname" value="<?php echo $item['itemname'];?>" style="border:1px solid #ccc;width:100%"></td>
        </tr>
        <tr>
            <td>Product Price</td>
            <td>Rs. <input type="text" name="price" value="<?php echo $item['price'];?>" style="border:1px solid #ccc"></td>
        </tr>
        <tr>
            <td>Auction Start</td>
            <td>
        ...
        <tr>
            <td>Product Image</td>
            <td>
            <img src="assets/products/<?php echo $item['productimage']; ?>" style="height:100px"><br>
        ...
        <tr>
            <td colspan="2">
                <input type="submit" value="Update Product" name="isSubmit" class="btn btn-primary">
            <!--<input type="button"  onclick="window.open('timebasedAuction.php','rightW');window.close('GoogleWindow')" value=" Close ">-->
