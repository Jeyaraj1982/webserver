<div class="line">
    ...
    <div class="s-12 m-6 l-9 margin-bottom">
        <div class="box">
            <h5 style="text-align: left;font-family: arial;">Add Product To Time Based Auction</h5> 
    ...
    <table  style="font-size:12px;font-family:arial;width:100%;" border="1" cellpadding="5" cellspacing="0">
        ...
        <tr>
          ...
          <tr>
            ...
            <td colspan="2"><textarea  name="description" style="width:100%;height:100px;"><?php echo $post[0]['description'];?></textarea></td>
        </tr>
        <tr>
