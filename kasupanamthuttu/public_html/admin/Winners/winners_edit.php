...
<h5 style="text-align: left;font-family: arial;">Edit Winners</h5> 
...
<?php
    ...
    if (isset($_POST['isSubmit'])) {
        ...
        $sql = "update _tblwinners set IsPublish='".$_POST['IsPublish']."', productname='".$_POST['productname']."', testimonials='".$content."', test_name='".strtoupper($_POST['itemname'])."' ";
        ...
        if ((move_uploaded_file($_FILES["file"]["tmp_name"],"assets/winners/".$filename)) ) {
            ...
            $sql .= ", photopath='".$filename."' ";  
             ...
             if ((move_uploaded_file($_FILES["file2"]["tmp_name"],"assets/winners/".$filename2)) ) {
            
            $sql .= ", ProductPhoto='".$filename2."' ";  
...
<form action="winners_edit?item=<?php echo $_REQUEST['item']; ?>" method="post"   enctype="multipart/form-data">
    <table  style="font-size:12px;font-family:arial;" cellpadding="5" cellspacing="0">
        ...
        <tr>
            <td>Product Name</td>
            <td><input type="text" name="productname" value="<?php echo $item['productname'];?>"   class="form-control"  style="width:100%"></td>
        </tr>
         
        <tr>
            <td>User Image</td>
            <td>
            <img src="assets/winners/<?php echo $item['photopath']; ?>" style="height:100px"><br>
      ...
      <!--  <tr>
         ...
         <tr>
            <td>Product Image</td>
            <td>
            <img src="assets/winners/<?php echo $item['ProductPhoto']; ?>" style="height:100px"><br>
