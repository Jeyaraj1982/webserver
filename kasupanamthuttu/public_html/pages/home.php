<?php include_once("game_clients/menu.php");?>
    <div class="line">
         <div class="row">
          <div class="col-sm-12">
            <h3>Top Winners <a href="https://www.kasupanamthuttu.com/GameRegister" style="color:#fff" class="btn btn-success btn-sm">Register Now</a></h3>
          </div>
          <div class="col-sm-12">
                        ...
                        <tr>
                         ...
                         <tr>
                                <td style="background:#fff;border:none">
                                    <img src="https://www.kasupanamthuttu.com/assets/products/<?php echo $item['productimage']; ?>" style="width:80%;margin:0px auto">
                                </td>
                            </tr>
                        <tr>
