...
<h5 style="text-align: left;font-family: arial;">My Earning</h5> 
...
<table cellpadding="5" cellspacing="0" width="100%" style="font-size:12px;font-family:arial;">
    <tr style="font-weight: bold;text-align: center;background:#f5f5f5">
        ...
        <td width="120"  style="border:1px solid #ccc;border-bottom :none;">Earning Amount</td>
    </tr>
<?php
if (isset($_POST['acno'])) {
  ...
  foreach($data as $d) {
      ?>
        <tr>
            ...
            <td align="right"  style="border:1px solid #ccc;"><?php echo $d['cramount'];?></td>
        </tr>
      <?php
