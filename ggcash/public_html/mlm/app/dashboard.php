...
<head>
    ...
    .btn-purple {background:#9B0976;color:#fff}
    .btn-outline-purple {border:1px solid #9B0976;color:#9B0976}
    .btn-outline-purple:hover {background: #9B0976;color:#fff}
    p {color:#9B0976 !important}
    .text-purple {color:#9B0976 !important}
    </style>
</head>
<?php
...
?>
<body style="background:#fff7fc !important;">
	<div class="wrapper">
		<div class="main-header">
			<!-- Logo Header -->
			<div class="logo-header" data-background-color="blue" style="background:#9b0976 !important;">
				
				<a href="dashboard.php" class="logo" style="text-align: center;">
					<!--<img src="../app/assets/img/slogo.png?rand=<?php echo rand(33,333);?>" alt="navbar brand" class="navbar-brand" style="height:36px">-->
                    <!--<h4 style="color: #f1f1f1;margin-top:19px;">GGCASH</h4>-->
                    <img src="http://ggcash.in/images/logo.png" style="background:#fff;border-radius:5px;height: 48px;padding: 5px 20px;">
				</a>
			...
			<!-- Navbar Header -->
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2" style="background:#9b0976 !important;">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item   hidden-caret" style="text-align: right;">
                           ...
                           Rs. <?php echo getUtilityhWalletBalance($_SESSION['User']['AdminID']);?>  
                           <?php } else { ?>
                           <?php echo $_SESSION['User']['MemberName'];?><br>
                           Rs. <?php echo getUtilityhWalletBalance($_SESSION['User']['MemberID']);?>  
                           <?php } ?> 
                           </div>
                        </li> 
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm" style="border: 2px solid #f1f1f1;border-radius: 10px;background:#f1f1f1">
									<?php if(UserRole=="Admin"){ ?>
                                    <img src="<?php echo getImageUrl($_SESSION['User']['Thumb'],$_SESSION['User']['Gender']);?>" alt="..." class="avatar-img rounded-circle" style="width: 37px;height: 18px;">
								    <?php  } else {  ?>
                                    <img src="<?php echo getImageUrl($_SESSION['User']['Thumb'],$_SESSION['User']['Sex']);?>" alt="..." class="avatar-img rounded-circle" style="width: 37px;height: 18px;">
                                    <?php } ?>
                                </div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><?php if(UserRole=="Admin"){ ?><img src="<?php echo getImageUrl($_SESSION['User']['Thumb'],$_SESSION['User']['Gender']);?>" alt="image profile" class="avatar-img rounded" style="width: 67px;height: 32px;"><?php } else { ?><img src="<?php echo getImageUrl($_SESSION['User']['Thumb'],$_SESSION['User']['Sex']);?>" alt="image profile" class="avatar-img rounded" style="width: 67px;height: 32px;"> <?php } ?></div>
											<div class="u-text">
                                            <?php if(UserRole=="Admin"){ ?>
		...
		<!-- Sidebar -->
		<div class="sidebar sidebar-style-2" data-background-color="dark2" style="background:#FCDFF3 !important">			
			...
			<!--<footer class="footer">
				<div class="container-fluid" >
					...
					<div class="copyright ml-auto">
						Copyright &copy; 2020-2021, <!-- <i class="fa fa-heart heart text-danger"></i> by <a href="#">ThemeKita</a>-->
					</div>				
				</div>
			</footer>-->
		</div>
				...
				<div class="switcher">
					<div class="switch-block">
						...
						<div class="btnSwitch">
							...
							<button type=or" data-color="red2"></button>
						</div>
					</div>
					<div class="switch-block">
						<h4>Navbar Header</h4>
