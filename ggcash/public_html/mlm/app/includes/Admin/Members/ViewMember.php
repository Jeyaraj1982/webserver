        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title" style="line-height: 20px;">Member Information<br>
                    <span style="font-size:12px;color:#757373;">Available Balance : Rs.<?php echo getUtilityhWalletBalance($_GET['MCode']);?></span>
                    <a style="float:right;font-size:13px;color:#1572E8;" href="dashboard.php?action=Members/EditMember&MCode=<?php echo $_GET['MCode'];?>">Edit Profile</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-8  mt-sm-2 ">
                                    <small id="emailHelp" class="form-text text-muted" style="text-transform: uppercase">:&nbsp;<?php echo $bank[0]['AccountHolderName'];?></small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-show-validation row">
                               <label for="email" class="col-lg-4 col-md-3 col-sm-4 mt-sm-2 text-right">Account Number</label> 
                                <div class="col-lg-8 col-md-9 col-sm-8  mt-sm-2 ">
                                    <small id="emailHelp" class="form-text text-muted" style="text-transform: uppercase">:&nbsp;<?php echo $bank[0]['AccountNumber'];?></small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-show-validation row">
                               <label for="email" class="col-lg-4 col-md-3 col-sm-4 mt-sm-2 text-right">IFSCode</label> 
                                <div class="col-lg-8 col-md-9 col-sm-8  mt-sm-2 ">
                                    <small id="emailHelp" class="form-text text-muted" style="text-transform: uppercase">:&nbsp;<?php echo $bank[0]['IFSCode'];?></small>
                                </div>
                            </div>
                        </div>
                    </div>
