<?php
  $Members = $mysql->select("SELECT * FROM _tbl_Members WHERE MemberCode NOT IN (SELECT MemberCode FROM _tbl_Members_bank_info)");
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Report/WithoutBankDetailsMem">Members</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Report/WithoutBankDetailsMem">Manage Without Bank Details Members</a></li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage Without Bank Details Members</h4>
                </div>
                <div class="card-body">
