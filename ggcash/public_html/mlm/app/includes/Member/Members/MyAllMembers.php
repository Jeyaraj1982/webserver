<?php
    ...
    SELECT * FROM _tbl_Members LEFT JOIN
        _tbl_Settings_Packages ON _tbl_Members.CurrentPackageID=_tbl_Settings_Packages.PackageID where `_tbl_Members`.`MemberCode` in (".implode(",",$result).") order by _tbl_Members.MemberID desc");
                ...
                <div class="card-header">
                 <div class="card-head-row">
                    ...
                    <div class="card-tools">
                        <a href="dashboard.php?action=Reports/Levels" class="btn btn-info btn-border btn-round btn-sm mr-2">Level Wise</a>
                    </div>
                </div>
                </div>
                <div class="card-body">
                        ...
                        <table style="width:100%" >
                            <thead>        
                                <tr>
                                    ...
                                    <th class="border-top-0"><b>Joined</b></th>
