            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-9 align-self-center">
                        <h4 class="page-title">Earning Summary</h4>
                                ...
                                <div class="card border-left border-primary bg-primary text-bg bg-image bg-overlay-primary p-15">
                                    <div class="card-body p-0">
                                        <div class="d-flex no-block align-items-center p-b-10">
                                            ...
                                            <div class="ml-auto">
                                                <h5 class="font-normal text-right">Available Earning Balance</h5>
                                                <h3 class="text-bg text-right"><?php echo number_format(getEarningAvailableBalance($_SESSION['User']['MemberID']),2);?> </h3>
                                            </div>
...
<div class="card">
                            ...
                            <a href="widthdrawtowallet.php" style="float:right;" class="btn btn-primary waves-effect waves-light">Withdraw to wallet </a>
                                ...
                                <div class="tablesaw-bar tablesaw-mode-stack"></div><table class="tablesaw no-wrap table-bordered table-hover table tablesaw-stack" data-tablesaw="" id="tablesaw-4030">
                                    ...
                                    <tbody>
                                        <?php $Transactions=$mysqldb->select("SELECT * FROM _tbl_earnings where MemberID='".$_SESSION['User']['MemberID']."' order by EarningID desc"); ?>
