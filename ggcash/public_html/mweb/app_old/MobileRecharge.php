    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            if (isset($_POST['btnRecharge']) && ($error==0)) { 
                ...
                $request = file_get_contents("http://j2jsoftwaresolutions.com/recharge/recharge.php?username=ggcash@gmail.com&password=india_123&optr=".$_POST['Operator']."&number=".$_POST['MobileNumber']."&amount=".$_POST['Amount']."&uid=".$Recharge);
                ...
                if ($response['response']['status']=="FAILURE") {
                    ...
                    $mysqldb->execute("update _tbl_recharge_transactions set Status='Failure' where RcTxnID='".$Recharge."'");
                        ...
                        <div style="padding:36px">
                            ...
                            <br><br>
                            <p align="center">
                                <a href="MobileRechargeTransactions.php">View Summary</a>
                            </p>
                        </div>
                        <?php
