...
?>
     ...
     for ($j=0; $j <=$rowcountsleeper ; $j++) { 
        ...
        for ($k=0; $k <=$klimit ; $k++) { 
            if(!empty($seatsleep[$i][$j][$k])) { 
                if($seatsleep[$i][$j][$k]->length==2 && $seatsleep[$i][$j][$k]->width==1) {
                    if(!strcmp($seatsleep[$i][$j][$k]->available,'true')) {
                        if(!strcmp($seatsleep[$i][$j][$k]->ladiesSeat,'true')) {
                            echo "<td><div id='c_b' class='seatcontainer' style='font-size:11px;color:#555;padding:5px;text-align:center'><label style='margin-bottom: 0px;' for='hsleep".$i.$j.$k."'><img name='hsleep".$y."'src='images/non_sleeper_ac_ladies.jpg'title='Seat Number:".$seatsleep[$i][$j][$k]->name." | Fare: ".$seatsleep[$i][$j][$k]->fare."' class='imagehover'/><input tfare='".$seatsleep[$i][$j][$k]->fare."' type='checkbox' name='chkchk[]' class='checkbox' id='hsleep".$i.$j.$k."' value='".$seatsleep[$i][$j][$k]->name."' onclick=\"swapladieshsleeper(this,".$y++.",'".$_GET['tripid']."')\" style='visibility:hidden;display:none;'/></label><!--<br>".$seatsleep[$i][$j][$k]->fare."--></div></td>";
                        } else {
                            echo "<td><div id='c_b' class='seatcontainer' style='font-size:11px;color:#555;padding:5px;text-align:center'><label style='margin-bottom: 0px;' for='hsleep".$i.$j.$k."'><img name='hsleep".$y."'src='images/volvo_sleeper_vacant.jpg' title='Seat Number:".$seatsleep[$i][$j][$k]->name." | Fare: ".$seatsleep[$i][$j][$k]->fare."' class='imagehover'/><input tfare='".$seatsleep[$i][$j][$k]->fare."' type='checkbox' name='chkchk[]' class='checkbox' id='hsleep".$i.$j.$k."' value='".$seatsleep[$i][$j][$k]->name."' onclick=\"swaphsleeper(this,".$y++.",'".$_GET['tripid']."')\" style='visibility:hidden;display:none;'/></label><!--<br>".$seatsleep[$i][$j][$k]->fare."--></div></td>";
                        }
                    } else {
                        echo "<td style='font-size:11px;color:#555;padding:5px;text-align:center'><div class='container_un'><img src='images/volvo_sleeper_unavailable.jpg'/><!--<br>&nbsp;--></div></td>";
                    } 
            } elseif ($seatsleep[$i][$j][$k]->length==1 && $seatsleep[$i][$j][$k]->width==2) {
                if(!strcmp($seatsleep[$i][$j][$k]->available,'true')) {
                    if(!strcmp($seatsleep[$i][$j][$k]->ladiesSeat,'true')) {
                    echo "<td><div id='c_b' class='container_vert'><label for='vsleep".$i.$j.$k."'><img name='vsleep".$y."'src='images/non_ac_vertical_sleeper_ladies.jpg' title='Seat Number:".$seatsleep[$i][$j][$k]->name." | Fare: ".$seatsleep[$i][$j][$k]->fare."' class='imagehover'/><input tfare='".$seatsleep[$i][$j][$k]->fare."' type='checkbox' class='checkbox' name='chkchk[]' id='vsleep".$i.$j.$k."' value='".$seatsleep[$i][$j][$k]->name."' onclick='swapvsleeper(this,".$y++.")' style='visibility:hidden;display:none;'/></label><!--<br>".$seatsleep[$i][$j][$k]->fare."--></div></td>";
                    } else {
                ...
                echo "<td><div class='container_vert_un'><img src='images/volvo_sleeper_vertical_unavailable.jpg'/><br>&nbsp;</div></td>";
               } 
            } elseif ($seatsleep[$i][$j][$k]->length==1 && $seatsleep[$i][$j][$k]->width==1) {
                $storeseatname=$seatsleep[$i][$j][$k]->name;
                if(!strcmp($seatsleep[$i][$j][$k]->available,'true')) {
                    if(!strcmp($seatsleep[$i][$j][$k]->ladiesSeat,'true')) {
                    echo "<td><div id='c_b'class='seatcontainer' style='font-size:11px;color:#555;;padding:5px;text-align:center'><label for='seat".$j.$k."'><img name='img".$l."' id='".$k.$j."' src='images/non_ac_seater_ladies.jpg' title='Seat Number:".$seatsleep[$i][$j][$k]->name." | Fare: ".$seatsleep[$i][$j][$k]->fare."' class='imagehover'/><input tfare='".$seatsleep[$i][$j][$k]->fare."' type='checkbox' class='checkbox' name='chkchk[]' id='seat".$j.$k."' value='".$seatsleep[$i][$j][$k]->name."' onclick=\"swapladiesseater(this,".$l++.",'".$_GET['tripid']."')\" style='visibility:hidden;display:none;'/></label><!--<br>".$seatsleep[$i][$j][$k]->fare."--></div></td>" ;
                    } else {
                     echo "<td><div id='c_b'class='seatcontainer' style='font-size:11px;color:#555;;padding:5px;text-align:center'><label for='seat".$j.$k."'><img name='img".$l."' id='".$k.$j."'src='images/ac_semi_sleeper_vacant.jpg' title='Seat Number:".$seatsleep[$i][$j][$k]->name." | Fare: ".$seatsleep[$i][$j][$k]->fare."' class='imagehover' /><input tfare='".$seatsleep[$i][$j][$k]->fare."' type='checkbox' class='checkbox' name='chkchk[]' id='seat".$j.$k."' value='".$seatsleep[$i][$j][$k]->name."' onclick=\"swapseater(this,".$l++.",'".$_GET['tripid']."')\" style='visibility:hidden;display:none;'/></label><!--<br>".$seatsleep[$i][$j][$k]->fare."--></div></td>";
                    }  
                } else {
                    echo "<td><div class='container_un'><img src='images/ac_semi_sleeper_unavailable.jpg'/><!--<br>&nbsp;--></div></td>";
                }    
            }
        }
        if(empty($seatsleep[$i][$j][$k])) {
                    ...
                    if(!empty($s[$i][$j])) { 
                        ...
                        if(!strcmp($s[$i][$j]->available,'true')) {
                            if(!strcmp($s[$i][$j]->ladiesSeat,'true')) {
                                echo "<td><div id='c_b'class='seatcontainer' style='font-size:11px;color:#555;padding:5px;text-align:center'><label for='seat".$i.$j."'><img name='img".$k."' id='".$j.$i."' src='images/non_ac_seater_ladies.jpg' title='Seat Number:".$s[$i][$j]->name." | Fare: ".$s[$i][$j]->fare."' class='imagehover'/><input tfare='".$s[$i][$j]->fare."' type='checkbox' class='checkbox' name='chkchk[]' id='seat".$i.$j."' value='".$s[$i][$j]->name."' onclick=\"swapladiesseater(this,".$k++.",'".$_GET['tripid']."')\" style='visibility:hidden;display:none;'/></label><!--<br>".$s[$i][$j]->fare."--></div></td>" ;
                            } else {
                                echo "<td><div id='c_b'class='seatcontainer' style='font-size:11px;color:#555;;padding:5px;text-align:center'><label for='seat".$i.$j."'><img name='img".$k."' id='".$j.$i."' src='images/ac_semi_sleeper_vacant.jpg' title='Seat Number:".$s[$i][$j]->name." | Fare: ".$s[$i][$j]->fare."' class='imagehover' /><input tfare='".$s[$i][$j]->fare."'  type='checkbox' class='checkbox' name='chkchk[]' id='seat".$i.$j."' value='".$s[$i][$j]->name."' onclick=\"swapseater(this,".$k++.",".$k++.",'".$_GET['tripid']."')\" style='visibility:hidden;display:none;'/></label><!--<br>".$s[$i][$j]->fare."--></div></td>"; 
                            }
                        } else {
                            echo "<td><div class='container_un'><img src='images/ac_semi_sleeper_unavailable.jpg'/><!--<br>&nbsp;--></div></td>";
                        }  
    ...
    function BlockAndBookTicket() {
        ...
        if ($total_fare<=$balance) {
            ...
            if (strlen(trim($resdata))>0 && strlen(trim($resdata))<20)  {
                ...
                $id=$mysqldb->insert("_tbl_wallet_transactions",array("MemberID"         => $_SESSION['User']['MemberID'],
                                                                      ...
                                                                      "Credits"          => "0",                    
                                                                      "Debits"           => $total_fare, 
                                                                      "AvailableBalance" => getAvailableBalance($_SESSION['User']['MemberID'])-$total_fare,                   
                ...
                $mysqldb->execute("update `_bus_booking_requests` set `TicketInfo`='".trim($ticketInfo)."', `PNR`='".trim($pnr['pnr'])."'    where `BookingID`='".$reqID."'");
        ...
        <?php
            ...
            $mysqldb->execute("update `_bus_booking_requests` set `BlockKey`='".trim($resdata)."',`BlockStatus`='failure' where `BookingID`='".$reqID."'");
        ?>
