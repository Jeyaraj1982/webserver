        ...
        if ($_SESSION['rnd']==0) {
            ...
            if ($_POST['otp']==$_SESSION['rnd']) {
                ...
                if ($_POST['PaymentStatus']=="Wallet payment") {
                    ...
                    if (getAvailableBalance($_SESSION['User']['MemberID'])<$Order[0]['OrderValue']) {
                        ...
                        ///getAvailableBalance($_SESSION['User']['MemberID'])
                         $ACTransactionID = $mysqldb->insert("_tbl_wallet_transactions",array("MemberID"   => $_SESSION['User']['MemberID'],
                                                                                              "TxnDate"       => date("Y-m-d H:i:s"),
                                                                                              "Particulars"   => "Order ID ".$Order[0]['OrderID'],
                                                                                              "Credits"       => "0",
                                                                                              "Debits"        => $Order[0]['OrderValue'],
                                                                                              "AvailableBalance" => getAvailableBalance($_SESSION['User']['MemberID'])-$Order[0]['OrderValue'])); 
