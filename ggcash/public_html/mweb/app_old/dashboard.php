                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex align-items-center">
                                            <div class="m-r-20 border-right p-l-30"><img src="https://gcchub.org/panel/assets/img/badge/0.png" class="club-img"></div>
                                              <?php if ($_SESSION['User']['IsClub']==0) { ?>
                                            <form action="" method="post">
                                            
                                            
                                            <table>
                                                <tr>
                                                    <td><input type="text" class="form-control" name="MemberCode" placeholder="Enter Your Goodgrowth Member Code" style="width: 400px;" required></td>
                                                    <td><button type="submit" class="btn btn-primary block-default" name="btnUpdateClub">Update Club Member</button></td>
                                                </tr>
                                            </table>
                                            </form>
                                            <?php } else { ?>
                        ...
                        <div class="card-body" style="border-left:3px solid #1EA185">
                            <div class="d-flex no-block align-items-center" >
                                ...
                                <div class="ml-auto">                                                       
                                    ...
                                    <h3 class="text-bg text-right" style="margin-bottom:0px;"><?php echo number_format(getAvailableBalance($_SESSION['User']['MemberID']),2);?> </h3>
                                     
                              <a href="http://ggcash.in/app/addCash.php" style="font-size:11px;float:right" >Add Cash To Wallet </a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="card card-hover">
                        <div class="card-body" style="border-left:3px solid #6D9225">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <span class="text-orange display-6"><i class="mdi mdi-etsy text-success"></i></span>
                                </div>
                                <div class="ml-auto">
                                    <h5 class="font-normal text-right">Earning Balance</h5>
                                    <h3 class="text-bg text-right" style="margin-bottom:0px;"><?php echo number_format(getEarningAvailableBalance($_SESSION['User']['MemberID']),2);?> </h3>
                                    <a href="http://ggcash.in/app/earningsummary.php" style="font-size:11px;float:right" >View History</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body text-bg p-15" style="padding: 7px;">
                            <div class="d-flex flex-row">
                                ...
                                <div class="p-10 m-r-40 align-self-center">
                                    <h4  id="left_count"><?php echo getTotalLeftCount($_SESSION['User']['MemberCode']);?></h4>
                                ...
                                <div class="p-10 align-self-center">
                                    <h4 id="right_count"><?php echo getTotalRightCount($_SESSION['User']['MemberCode']);?></h4>
