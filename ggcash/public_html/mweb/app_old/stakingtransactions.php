            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-9 align-self-center">
                        <h4 class="page-title">Staking Transactions</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Staking Transactions</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="card border-left border-primary bg-primary text-bg bg-image bg-overlay-primary p-15">
                                    <div class="card-body p-0">
                                        <div class="d-flex no-block align-items-center p-b-10">
                                            <div>
                                                <span class="text-orange display-6"><i class="mdi mdi-format-section text-primary"></i></span>
                                            </div>
                                            <div class="ml-auto">
                                                <h5 class="font-normal text-right">Staking Balance</h5>
                                ...
                                <div class="card border-left border-warning bg-success text-bg bg-image bg-overlay-warning p-15">
                                    <div class="card-body p-0">
                                        <div class="d-flex no-block align-items-center p-b-10">
                                            ...
                                            <div class="ml-auto">
                                                <h5 class="font-normal text-right">Staking Balance Transfer</h5>
...
<div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Staking Transactions</h4>
