                        ...
                        <div class="tablesaw-bar tablesaw-mode-stack"><h4 class="card-title text-orange">Recent Bus Transactions</h4></div>
                            <div class="table-responsive">
                                    <table class="table v-middle" style="border: 1px solid; border-color: #e1e1e1;">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0"><b>Date of Journey</b></th>
                                                <th class="border-top-0"><b>Boarding Time</b></th>
                                        ...
                                        <?php $Transactions = $mysqldb->select("Select * From _bus_booking_requests  where MemberID='".$_SESSION['User']['MemberID']."' order by BookingID DESC");?>
                                          <?php foreach ($Transactions as $Transaction){ ?>
                                            <tr>
                                                <td><?php echo $Transaction['DateOfJourny'];?></td>
                                                <td><?php echo $Transaction['BPTime'];?></td>
                                                <td><?php echo $Transaction['SourceName'];?></td>
                                                <td><?php echo $Transaction['ToName'];?></td>
                                                <td><?php echo $Transaction['PrimaryPassengerName'];?></td>
                                                <td><?php echo $Transaction['PrimaryPassengerMobile'];?></td>
                                                ...
                                                <td><?php echo $Transaction['BookStatus'];?></td>
                                                <td style="line-height:20px;">
                                                <?php if ($Transaction['BookStatus']=="success") {?>
                                                ...
                                                <br><a target="blank" href="resendSms.php?pnr=<?php echo $Transaction['PNR'];?>" ><button style="background:#4994b2;border:1px solid #fff;color:white;width:120px;text-align:center" >Resend SMS</button></a>
                                                <br><a target="blank" href="cancelticket.php?pnr=<?php echo $Transaction['PNR'];?>" ><button style="background:Red;border:1px solid #fff;color:white;width:120px;text-align:center" >Cancel Ticket</button></a>
                                                <?php } ?>
                                                <?php } ?>
                                                </td>
                                            </tr>
