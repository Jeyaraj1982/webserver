                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Cash To GGC Wallet</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<div class="card">
 ...
 $mysqldb   = new MySqldatabase("localhost","ggcash_user","ggcash_user","ggcash_database");
                      ...
                      $BankDetails =$mysqldb->select("select * from _tbl_bank_details where BankID='".$_POST['BankName']."'");                                                    
                        $id=$mysqldb->insert("_tbl_wallet_request",array("MemberID"       =>$_SESSION['User']['MemberID'],
...
<div class="card">
                            ...
                            <div style="text-align: center;padding-top:80px;padding-bottom:80px;">
                              <img src="images/e-wallet.png" style="width: 256px;"><br>
                              Your wallet has INR. <?php echo number_format(getAvailableBalance($_SESSION['User']['MemberID']),2);?>
                              <br>
                              <a href="http://ggcash.in/app/accountsummary.php" >View Account Summary </a>
                              </div>
                            </div>
                        </div>
</div>
