...
<?php
 ...
 $Requests  = $mysqldb->select("SELECT *
                        ...
                        ON _tbl_wallet_request.MemberID=_tbl_Members.MemberID where _tbl_wallet_request.MemberID='".$_SESSION['User']['MemberID']."' and _tbl_wallet_request.IsApproved='0' and _tbl_wallet_request.IsRejected='0' order by _tbl_wallet_request.RequestID DESC");
  ?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align:right">
                        <h4 class="page-title">
                                <a href="MyPendingWalletRequests.php" style="font-weight:bold;text-decoration:underline"><small>Pending</small></a>&nbsp;|&nbsp;
