...
<!--
 ...
 -->   
  <script src="../../app/assets/js/popper.min.js"></script>
    ...
    <script src="../../app/assets/js/app.init.horizontal-fullwidth.js"></script>
    <script src="../../app/assets/js/app-style-switcher.horizontal.js"></script>
    
    <script src="../../app/assets/js/perfect-scrollbar.jquery.min.js"></script>
    <script src="../../app/assets/js/sparkline.js"></script>
    ...
    <script src="../../app/assets/js/chartist-plugin-tooltip.min.js"></script>
    <script src="../../app/assets/js/jquery.steps.min.js"></script>
    <script src="../../app/assets/js/jquery.validate.min.js"></script>
    <script src="../../app/assets/js/validation.js"></script>

    <script src="../../app/assets/js/bootstrap-treeview.min.js"></script>
    <script src="../../app/assets/js/bootstrap-treeview-init.js"></script>
    
    
    <script src="../../app/assets/js/dashboard1.js"></script>
<script src="../../app/assets/js/countdown-timer.js"></script>
<script>
