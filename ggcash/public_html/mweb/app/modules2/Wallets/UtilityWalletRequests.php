...
<?php
 ...
 $Requests  = $mysqldb->select("SELECT *
                        ...
                        ON _tbl_wallet_request_utility.MemberID=_tbl_Members.MemberID where _tbl_wallet_request_utility.MemberID='".$_SESSION['User']['MemberID']."'order by _tbl_wallet_request_utility.RequestID DESC");
  ?>
                                        ...
                                        <tbody>
                                          <?php foreach ($Requests as $Request){ ?>
                                            <tr>
                                                ...
                                                <td><a href="dashboard.php?action=Wallets/ViewUtilityWalletRequest&code=<?php echo $Request['RequestID'];?>">View</a></td>
                                            </tr>
                                            <?php }?>
