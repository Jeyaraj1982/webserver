    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-9 align-self-center">
                <h4 class="page-title">Add Cash To E-Pin Wallet</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Cash To E-Pin Wallet</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<div class="card">
 ...
 //$mysqldb   = new MySqldatabase("localhost","ggcash_user","ggcash_user","ggcash_database");
                      ...
                      $BankDetails =$mysqldb->select("select * from _tbl_bank_details where BankID='".$_POST['BankName']."'");                                                    
                        $id=$mysqldb->insert("_tbl_wallet_request_epin",array("MemberID"       =>$_SESSION['User']['MemberID'],
                            ...
                            return false;
                                ...
                                <div class="form-actions">
                                        <div class="text-right">
                                            <a href="dashboard.php?action=Wallets/EpinWalletRequests" >View previous requests</a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-primary block-default" name="btnAddFund">Send Requests</button>
                                        </div>
                                    </div>
                                    </form>
                            </div>
...
<div class="card">
                            ...
                            <div style="text-align: center;padding-top:80px;padding-bottom:80px;">
                              ...
                              Your wallet has INR. <?php echo number_format(getEpinWalletBalance($_SESSION['User']['MemberID']),2);?>
                              <br>
                              <a href="dashboard.php?action=Accounts/accountsummary" >View Account Summary </a> 
