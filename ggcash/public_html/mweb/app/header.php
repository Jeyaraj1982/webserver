            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="dashboard.php"><b class="logo-icon"><img src="https://ggcash.in/images/logo.png"   class="light-logo" /> </b></a>
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="dashboard.php?action=ChangePassword"><i class="fas fa-key font-20 m-r-10"></i> Change Password</a>
                                <div class="dropdown-divider"></div>
