  ...
  <div class="container">
      ...
      <div class="bg-white shadow-md rounded h-100 p-3">
      	<div class="featured-box text-center">
              <div class="featured-box-icon text-primary mt-4"> <i class="fas fa-address-book"></i></div>
              <h3>GGCASH</h3>
              <p> 5/3, Kamalam Anamalai Complex,<br> Mudangiyar Road,<br> Rajapalayam-626117,<br> Tamilnadu, India.</p>
            </div>
      </div>
      </div>
      ...
      <div class="bg-white shadow-md rounded h-100 p-3">
      	<div class="featured-box text-center">
              ...
              <h3>Telephone</h3>
              <p class="mb-0">+91-9751157370 / 9952601539</p>
              <p></p>
            </div>
      </div>
      </div>
