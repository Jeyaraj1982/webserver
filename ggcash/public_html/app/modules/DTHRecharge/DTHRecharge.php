    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                         ...
                         $error=0;
                                    ...
                                    <script>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="dashboard.php?action=DTHRecharge/DTHRechargeTransactions">View Transactions</a>&nbsp;&nbsp;
            ...
            if (isset($_POST['btnRecharge']) && ($error==0)) { 
                ...
                $url = "http://ecfast.in/hybrid/api/recharge.php?uname=admin@ggcash.in&pwd=123456&optr=".$_POST['Operator']."&number=".$_POST['DTHNumber']."&amt=".$_POST['Amount']."&uid=".$Recharge;
                $mysqldb->execute("update _tbl_recharge_transactions set url='".$url."' where RcTxnID='".$Recharge."'");
                $request = file_get_contents($url);
                $mysqldb->execute("update _tbl_recharge_transactions set ApiResponse='".$request."' where RcTxnID='".$Recharge."'");
                ...
                if ($response['response']['status']=="FAILURE") {
                    ...
                    $mysqldb->execute("update _tbl_recharge_transactions set Status='Failure' where RcTxnID='".$Recharge."'");
                        ...
                        <div style="padding:36px">
                            ...
                            <br><br>
                            <p align="center">
                                <a href="dashboard.php?action=DTHRecharge/DTHRechargeTransactions.php">View Summary</a>
                            </p>
                        </div>
                        <?php
                    ...
                    ?>
                         <div style="padding:36px">
                            ...
                            <br><br>
                            <p align="center">
                                <a href="dashboard.php?action=DTHRecharge/DTHRechargeTransactions">View Summary</a>
                            </p>
                        </div>
                    <?php
