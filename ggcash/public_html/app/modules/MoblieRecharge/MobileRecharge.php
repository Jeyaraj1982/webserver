    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            if (isset($_POST['btnRecharge']) && ($error==0)) { 
                ...
                $url = "http://ecfast.in/hybrid/api/recharge.php?uname=admin@ggcash.in&pwd=123456&optr=".$_POST['Operator']."&number=".$_POST['MobileNumber']."&amt=".$_POST['Amount']."&uid=".$Recharge;
