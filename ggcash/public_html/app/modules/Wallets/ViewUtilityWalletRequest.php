<?php 
    ...
    $Requests  = $mysqldb->select("SELECT * FROM _tbl_wallet_request_utility LEFT  JOIN _tbl_Members ON _tbl_wallet_request_utility.MemberID=_tbl_Members.MemberID where _tbl_wallet_request_utility.RequestID='".$_GET['code']."'");                                     
?>
                            ...
                            <form method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-6 b-r"> <strong>Transaction Date</strong>
                                        <br><p class="text-muted"><?php echo date("Y-m-d",strtotime($Requests[0]['TransferDate']));?></p>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-6 b-r"> <strong>Old Balance</strong>
                                        <br><p class="text-muted"><?php echo number_format($Requests[0]['OldBalance'],2);?></p>
                                    </div>
                                    <div class="col-md-4 col-xs-6 b-r"> <strong>New Balance</strong>
                                        <br><p class="text-muted"><?php echo number_format($Requests[0]['NewBalance'],2);?></p>
                                    </div>
                                    <?php } ?>
                                </div>
                            </form>
                            <div style="text-align:right">
                                <a href="dashboard.php?action=Wallets/UtilityWalletRequests">List of Requests</a>
                            </div>
                        </div>
                    </div>
                </div>
