<?php
    ...
    if (isset($_POST['submitBtn'])) {
        ...
        if ($error==0) {
            ...
            if ($_POST['pos']=="L") {
                $temp = explode(",",$memberTree->GetLeft($_SESSION['User']['MemberCode'],"L"));
                $uplineID = $temp[0];
            ...
            if ($_POST['pos']=="R") {
                $temp = explode(",",$memberTree->GetRight($_SESSION['User']['MemberCode'],"R"));
                $uplineID = $temp[0];
            ...
            if ($MemberID>0) {
                ...
                echo "<script>location.href='dashboard.php?action=Members/UnknownError';</script>"; 
            }
        } 
