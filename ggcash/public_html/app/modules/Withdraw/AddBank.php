<?php
    $BankDetails =$mysqldb->select("select * from _tbl_bank_names order by BankName");
?>
...
<div class="card">
                      ...
                      $SelBankDetails =$mysqldb->select("select * from _tbl_bank_names where BankID='".$_POST['BankName']."'");                            
                   $id=$mysqldb->insert("_tbl_member_bank_details",array("MemberID"     =>$_SESSION['User']['MemberID'],
                                ...
                                <div class="form-actions">
                                        <div class="text-left">
                                            ...
                                            &nbsp;&nbsp;<a href="dashboard.php?action=Withdraw/ManageBanks">View all bank details</a>
                                        </div>
                                    </div>
                                    </form>
                            </div>
