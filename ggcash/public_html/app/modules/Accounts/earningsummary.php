                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">GGCash Wallet summary</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-flex no-block align-items-center p-b-10">
                                            ...
                                            <div class="ml-auto">
                                                ...
                                                <h3 class="text-bg text-right"><?php echo number_format(getGGCashWalletBalance($_SESSION['User']['MemberID']),2);?> </h3>
                                            </div>
...
<div class="card">
                            ...
                            <a href="dashboard.php?action=Withdraw/NewRequest" style="float:right;" class="btn btn-primary waves-effect waves-light">Withdraw to wallet </a>
                                ...
                                <div class="tablesaw-bar tablesaw-mode-stack"></div><table class="tablesaw no-wrap table-bordered table-hover table tablesaw-stack" data-tablesaw="" id="tablesaw-4030">
                                    ...
                                    <tbody>
                                        <?php $Transactions=$mysqldb->select("SELECT * FROM `_tbl_wallet_earnings` where MemberID='".$_SESSION['User']['MemberID']."' order by EarningID desc"); ?>
