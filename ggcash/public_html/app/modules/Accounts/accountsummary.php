                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-flex no-block align-items-center p-b-10">
                                            ...
                                            <div class="ml-auto">
                                                ...
                                                <h3 class="text-bg text-right"><?php echo number_format(getEpinWalletBalance($_SESSION['User']['MemberID']),2);?> </h3>
                                            </div>
...
<div class="card">
                            <div class="card-body">
                                ...
                                <div class="tablesaw-bar tablesaw-mode-stack"></div><table class="tablesaw no-wrap table-bordered table-hover table tablesaw-stack" data-tablesaw="" id="tablesaw-4030">
                                    ...
                                    <tbody>
                                        <?php $Transactions=$mysqldb->select("SELECT * FROM _tbl_wallet_epin where MemberID='".$_SESSION['User']['MemberID']."' order by TxnID desc"); ?>
