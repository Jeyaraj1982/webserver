                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            ...
                            <!-- <img src="https://gcchub.org/panel/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"> -->
                            
                                <?php if (strlen(trim($_SESSION['User']['Thumb']))==0) { ?>
                                                       <?php if ($Profile[0]['Sex']=="Female") {?>
                                                          <img src="assets/images/female_default.png" class="rounded-circle" style="height:31px;width:31px"><br>
                                                       <?php } ?>
                                                       
                                                       <?php if ($_SESSION['User']['Sex']=="Male") {?>
                                                            <img src="assets/images/male_default.png" class="rounded-circle" style="height:31px;width:31px"><br>
                                                       <?php } ?>
                                                
                                                <?php } else { ?>
                                                <img src="uploads/<?php echo $_SESSION['User']['Thumb'];?>" class="rounded-circle" style="height:31px;width:31px"><br>
                                                <?php } ?>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                   ...
                                   <!-- <img src="https://gcchub.org/panel/assets/images/users/1.jpg" alt="user" class="img-circle" width="60">-->
                                    
                                     <?php if (strlen(trim($_SESSION['User']['Thumb']))==0) { ?>
                                                       <?php if ($Profile[0]['Sex']=="Female") {?>
                                                          <img src="assets/images/female_default.png" class="img-circle" style="height:60px;width:60px"><br>
                                                       <?php } ?>
                                                       
                                                       <?php if ($_SESSION['User']['Sex']=="Male") {?>
                                                            <img src="assets/images/male_default.png" class="img-circle" style="height:60px;width:60px"><br>
                                                       <?php } ?>
                                                
                                                <?php } else { ?>
                                                <img src="uploads/<?php echo $_SESSION['User']['Thumb'];?>" class="img-circle" style="height:60px;width:60px"><br>
                                                <?php } ?>
                                ...
                                <a class="dropdown-item" href="dashboard.php?action=ViewProfile"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="dashboard.php?action=ChangePassword"><i class="ti-settings m-r-5 m-l-5"></i> Change Password</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="dashboard.php?action=logout"><i class="ti-shift-right m-r-5 m-l-5"></i> Logout</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"><a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-bank"></i><span class="hide-menu">Account(s)</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="dashboard.php?action=Accounts/accountsummary" class="sidebar-link"><i class="mdi mdi-bank"></i><span class="hide-menu">E-Pin Wallet</span></a>
                                    <a href="dashboard.php?action=Accounts/earningsummary" class="sidebar-link"><i class="mdi mdi-bank"></i><span class="hide-menu">GGCash Wallet</span></a>
                                    <a href="dashboard.php?action=Accounts/utlityummary" class="sidebar-link"><i class="mdi mdi-bank"></i><span class="hide-menu">Utility Wallet</span></a>
                                    <a href="dashboard.php?action=Accounts/payoutsummary" class="sidebar-link"><i class="mdi mdi-bank"></i><span class="hide-menu">Payout Summary</span></a>
                                </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-arrow-up-bold-hexagon-outline"></i><span class="hide-menu">Wallet</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="dashboard.php?action=Wallets/addCashToEpin" class="sidebar-link"><i class="mdi mdi-arrow-down-bold-circle"></i><span class="hide-menu"> Add Cash To E-Pin Wallet</span></a></li>
                                <li class="sidebar-item"><a href="dashboard.php?action=Wallets/addCashToUtility" class="sidebar-link"><i class="mdi mdi-arrow-down-bold-circle"></i><span class="hide-menu"> Add Cash To Utility Wallet</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-arrow-down-bold-hexagon-outline"></i><span class="hide-menu">Withdraw</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="dashboard.php?action=Withdraw/NewRequest" class="sidebar-link"><i class="mdi mdi-arrow-down-bold-circle"></i><span class="hide-menu">New Request</span></a></li>
                                ...
                                <li class="sidebar-item"><a href="dashboard.php?action=Withdraw/AddBank" class="sidebar-link"><i class="mdi mdi-arrow-down-bold-circle"></i><span class="hide-menu">Add Bank</span></a></li>
                            </ul>
                        </li> 
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-arrow-down-bold-hexagon-outline"></i><span class="hide-menu">Recharge</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="dashboard.php?action=MoblieRecharge/MobileRecharge" class="sidebar-link"><i class="mdi mdi-cellphone"></i><span class="hide-menu">Mobile Recharge</span></a></li>
                                <li class="sidebar-item"><a href="dashboard.php?action=DTHRecharge/DTHRecharge" class="sidebar-link"><i class="mdi mdi-airplay"></i><span class="hide-menu">DTH Recharge</span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-arrow-down-bold-hexagon-outline"></i><span class="hide-menu">Ticket Booking</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="dashboard.php?action=BusTicket/BusTicketBooking" class="sidebar-link"><i class="mdi mdi-bus"></i><span class="hide-menu">Bus Ticket Booking</span></a></li>
                                <li class="sidebar-item"><a href="dashboard.php?action=BusTicket/BusTicketTransactions" class="sidebar-link"><i class="mdi mdi-airplay"></i><span class="hide-menu">Transactions</span></a></li>
                            </ul>
                        </li>
