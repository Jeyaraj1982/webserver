...
<?php
 $mysqldb   = new MySqldatabase("localhost","ggcash_user","ggcash_user","ggcash_database");
  $Members =$mysqldb->select("select * from _tbl_Members where Length(MemberCode)>1");
  ?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align:right">
                        <h4 class="page-title"><a href="ListofMembers.php" ><small style="font-weight:bold;text-decoration:underline">All</small></a>&nbsp;|&nbsp;
                                <a href="ListofActiveMembers.php"><small>Active</small></a>&nbsp;|&nbsp;
                                    ...
                                    <table class="table v-middle" style="border: 1px solid; border-color: #e1e1e1;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0"><b>Wallet</b></th>
                                        ...
                                        <tbody>
                                          <?php foreach ($Members as $Member){ ?>
                                            <tr>
                                                ...
                                                <td style="text-align: right"><?php echo number_format(getAvailableBalance($Member['MemberID']),2);?></td>
