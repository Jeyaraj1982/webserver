<div class="page-wrapper" style="display: block;">
            <div class="page-breadcrumb">
             ...
             <?php 
                ...
                if (sizeof($A)==0) {
                    $str .= "[{v:'Vacant_1581', f:'<div style=color:red;><a href=dashboard.php?action=Members/CreateMem&Code=".$L[0]['MemberCode']."&p=1 target=new></a></div><div style=width:80px; font-style:italic>&nbsp;</div><div style=width:80px;></div><br>'},'".$L[0]['MemberCode']."', 'GCCHub'],";
                } else {
                    
                    $_A = $mysqldb->select("select * from `_tbl_Members` where `MemberCode`='".$A[0]['ChildCode']."'");
                    ...
                    if (sizeof($AA)==0) {
                        $str .= "[{v:'Vacant_1582', f:'<div style=color:red;><a href=dashboard.php?action=Members/CreateMem&Code=".$A[0]['ChildCode']."&p=1 target=new></a></div><div style=width:80px; font-style:italic>&nbsp;</div><div style=width:80px;></div><br>'},'".$A[0]['ChildCode']."', 'GCCHub'],";
                    } else {
                        $_AA = $mysqldb->select("select * from `_tbl_Members` where `MemberCode`='".$AA[0]['ChildCode']."'");
                    ...
                    if (sizeof($AB)==0) {
                        $str .= "[{v:'Vacant_1583', f:'<div style=color:red;><a href=dashboard.php?action=Members/CreateMem&Code=".$A[0]['ChildCode']."&p=2 target=new></a></div><div style=width:80px; font-style:italic>&nbsp;</div><div style=width:80px;></div><br>'},'".$A[0]['ChildCode']."', 'GCCHub'],";
                    } else {
                        $_AB = $mysqldb->select("select * from `_tbl_Members` where `MemberCode`='".$AB[0]['ChildCode']."'");
                ...
                if (sizeof($B)==0) {
                    $str .= "[{v:'Vacant_1584', f:'<div style=color:red;><a href=dashboard.php?action=Members/CreateMem&Code=".$L[0]['MemberCode']."&p=2 target=new></a></div><div style=width:80px; font-style:italic>&nbsp;</div><div style=width:80px;></div><br>'},'".$L[0]['MemberCode']."', 'GCCHub'],";
                } else {
                    $_B = $mysqldb->select("select * from `_tbl_Members` where `MemberCode`='".$B[0]['ChildCode']."'");
                    ...
                    if (sizeof($BA)==0) {
                        $str .= "[{v:'Vacant_1585', f:'<div style=color:red;><a href=dashboard.php?action=Members/CreateMem&Code=".$B[0]['ChildCode']."&p=1 target=new></a></div><div style=width:80px; font-style:italic>&nbsp;</div><div style=width:80px;></div><br>'},'".$B[0]['ChildCode']."', 'GCCHub'],";
                    } else {
                        $_BA = $mysqldb->select("select * from `_tbl_Members` where `MemberCode`='".$BA[0]['ChildCode']."'");
                    ...
                    if (sizeof($BB)==0) {
                        $str .= "[{v:'Vacant_1586', f:'<div style=color:red;><a href=dashboard.php?action=Members/CreateMem&Code=".$B[0]['ChildCode']."&p=2 target=new></a></div><div style=width:80px; font-style:italic>&nbsp;</div><div style=width:80px;></div><br>'},'".$B[0]['ChildCode']."', 'GCCHub'],";
                    } else {
                        $_BB = $mysqldb->select("select * from `_tbl_Members` where `MemberCode`='".$BB[0]['ChildCode']."'");
