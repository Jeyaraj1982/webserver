            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-6 align-self-center">
                        <h4 class="page-title">GGCash Wallet Transactions Member Wise</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">GGCash Wallet Transactions Member Wise</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="table-responsive"  style="min-height:200px;">
                                    <table class="table v-middle" style="border: 1px solid; border-color: #e1e1e1;">
                                        ...
                                        <tbody>
                                          ...
                                          $summary = getGGCashWalletShortSummary($Member['MemberID']);
                                              $summary = getGGCashWalletShortSummary($Member['MemberID']);
                                           ?>
                                            <tr>
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="dashboard.php?action=Wallets/GGCashWalletTransactionForMember&code=<?php echo $Member['MemberCode'];?>">View Transactions</a>
                                                </div>
                                            </div>  </td>
                                            </tr>
                                         <?php }?>    
