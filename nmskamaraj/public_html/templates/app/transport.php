    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="<?= $_SERVER['BASE_URL']; ?>images/bg/bg1.jpg">
        <div class="container pt-120 pb-60">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-theme-colored3 font-36">TRANSPORT</h2>
                    ...
                    <div class="blog-posts single-post">
                        <article class="post clearfix mb-0">
                            ...
                            <div class="entry-content">
                                <p class="mb-15">For the comfort, we provide buses for the transportation of our students for the convenience who come from distant areas. The students can also choose their preferable mode of transportation. Every student is expected to avail the transport facility to enable him/her to be punctual to the college.
                                 The bus routes with timing at various places will be informed to students correspondingly.</p>
