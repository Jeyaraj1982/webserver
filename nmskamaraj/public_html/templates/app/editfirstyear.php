                                    ...
                                    <div class="registration_form_control">
                                        <label>
                                            <img src="images/tick.jpg" style="width:120px"><br> <br>
                                               ...
                                               <h3 style='font-weight:bold;'>Your Application Updated</h3>
                    ...
                    <div style="background:#ffeaf4;padding:20px;width: 870px;margin:0px auto;border:1px solid #f24395;border-radius:10px">
                        ...
                        <input type="hidden" name="EmailID" id="EmailID">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="CandidiateName" id="CandidiateName" value="<?php echo (isset($_POST['CandidiateName']) ? $_POST['CandidiateName'] : $data[0]['CandidiateName']);?>" onkeyup="getDeclrationName($(this).val())" onblur="getDeclrationName($(this).val())" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 100%;">
                              ...
                              <td style="padding:5px;text-align:left;width:30px">&nbsp; </td>
                                ...
                                <td>
                                    <input type="text" name="ParentName" id="ParentName" value="<?php echo (isset($_POST['ParentName']) ? $_POST['ParentName'] : $data[0]['ParentName']);?>" onkeyup="getDeclrationParentName($(this).val())" onblur="getDeclrationParentName($(this).val())" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 100%;">
                        ...
                        <tr>
                            <td style="padding:5px;text-align:left;width:30px;">&nbsp;</td>
                            <td>Date :&nbsp;&nbsp;&nbsp;<input type="text" name="Date" id="Date" value="<?php echo (isset($_POST['Date']) ? $_POST['Date'] : date("M d, Y",strtotime($data[0]['CreatedOn'])));?>" readonly="readonly" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;border-left:none;border-top:none;border-right:none;background:none;font-weight:bold;"></td>
                            <td style="text-align:right"><button type="submit" class="btn btn-success" name="UpdateForm" style="padding: 10px 50px;background: #f24395;border: 1px solid #f24395;"> Update</button><button type="submit" class="btn btn-primary" name="UpdateForm" id="UpdateForm" style="display: none;"> Submit</button></td>
                        </tr>
                    </table>
...
<?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="border:1px solid #f24395;border-radius: 10px;">
    <div class="modal-content">
      <div class="modal-body" id="confrimation_text" style="padding:10px;background:#ffeaf4;margin: 0px auto;">
    ...
    if(ErrorCount==0){
     var txt = '<table style="width:100%" style="font-size:13px;font-family:arial;color:#222">'
                ...
                +'<div style="padding:20px;text-align:center">'
                    ...
                    +'<button type="button" class="btn btn-success" onclick="doSubmit()" style="padding: 10px 50px;background: #f24395;border: 1px solid #f24395;">Yes, Confirm to Update</button>'
                 +'</div>';  
                 if (isSubmit==0) {
