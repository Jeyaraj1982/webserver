...
<?php
  ...
  $mysql =   new MySql();  
       ...
       <?php //} else {   ?>
        ...
        <?php //}
    } else {        $data = $mysql->select("select * from admission_secondyear where md5(AdmissionID)='".$_GET['id']."'");
   ?>
    <style>
