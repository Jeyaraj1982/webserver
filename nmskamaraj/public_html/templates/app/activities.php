    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="<?= $_SERVER['BASE_URL']; ?>images/bg/bg1.jpg">
        <div class="container pt-120 pb-60">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-theme-colored3 font-36">CANTEEN</h2>
                    ...
                    <div class="blog-posts single-post">
                        <article class="post clearfix mb-0">
                            ...
                            <div class="entry-content">
                                <p class="mb-15">Spacious and well-equipped canteen facility is available at the campus. A complete and planned meal is served in neat, clean and hygienic surroundings. The canteen is situated within the college campus. It is open for all and there is a separate seating arrangement for staffs and students. Our students enjoy their food in the clean, well maintained, aesthetic and appetizing atmosphere.
                                Most people fondly remember their college canteen as one of their life's high points.</p>

                                <p class="mb-15"> The homely atmosphere and aroma of delicious food permeates the air as they eat, drink and chat.
                                 It remains a focal place of the students for rest and refreshment.
                                </p>
