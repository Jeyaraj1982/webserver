    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="<?= $_SERVER['BASE_URL']; ?>images/bg/bg1.jpg">
        <div class="container pt-120 pb-60">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-theme-colored3 font-36">ACTION PLAN AND KEY STRATEGY</h2>
                    ...
                    <div class="blog-posts single-post">
                        <article class="post clearfix mb-0">
                            ...
                            <div class="entry-content">
                                <p class="mb-15">Placement training in our campus will be provided according to our action plan and key strategy which are given as follows  </p>
                                <h3>OUR ACTION PLAN: </h3> 

                                <p class="mb-15">  To identify their strength and make them confident with their communication </p>
                                <p class="mb-15">To prepare them for corporate environment </p>
                                <p class="mb-15">To mold them to face the forthcoming placement </p>

                                <h3>OUR KEY STRATEGY: </h3> 

                                <p class="mb-15">Communication Development programs </p>
                                <p class="mb-15">Personality Development class </p>
                                <p class="mb-15">Industrial visits</p>
                                <p class="mb-15">Mock Interviews </p>
                                <p class="mb-15">Seminars </p>
                                <p class="mb-15">Regular aptitude training </p>
