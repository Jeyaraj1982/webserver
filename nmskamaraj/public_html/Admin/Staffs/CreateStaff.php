...
if (isset($_POST['BtnSubmit'])) {
          ...
          if (!(strlen(trim($_POST['Name']))>0)) {
             ...
             $data = $mysql->select("select * from `admintable` where  `MobileNumber`='".$_POST['MobileNumber']."'");
             if (sizeof($data)>0) {
                 $ErrMobileNumber = "Mobile Number Already Exists";
                 $Error++;
             }
             $dataE = $mysql->select("select * from `admintable` where  `EmailID`='".$_POST['EmailID']."'");
             if (sizeof($dataE)>0) {
                 $ErrEmailID = "EmailID Already Exists";
                 $Error++;
             }
             if($Error==0){
                 $id = $mysql->insert("admintable",array("AdminName"    => $_POST['Name'],
                   ...
                   if(sizeof($id)>0){
                            unset($_POST);            
                        echo "<script>location.href='dashboard.php?action=Staffs/StaffCreated';</script>";
                      }
                        ...
                        <form method="POST" action="" onsubmit="return SubmitProfile();">
                            <div class="card-body">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="AddressLine1" name="AddressLine1" placeholder="Enter AddressLine1" value="<?php echo (isset($_POST['AddressLine1']) ? $_POST['AddressLine1'] : "");?>">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="AddressLine2" name="AddressLine2" placeholder="Enter AddressLine1" value="<?php echo (isset($_POST['AddressLine2']) ? $_POST['AddressLine2'] : "");?>">
                                    </div>
                                </div>
                                <div class="form-group form-show-validation row">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="PinCode" name="PinCode" maxlength="6" placeholder="Enter PinCode" value="<?php echo (isset($_POST['PinCode']) ? $_POST['PinCode'] : "");?>">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="UserName" name="UserName" placeholder="Enter User Name" value="<?php echo (isset($_POST['UserName']) ? $_POST['UserName'] : "");?>">
                                        <span class="errorstring" id="ErrPinCode"><?php echo isset($ErrPinCode)? $ErrPinCode : "";?></span>
                                    </div>                                                                                                                                                                         
                                </div>
                                <div class="form-group form-show-validation row">
