                                                                ...
                                                                <td colspan="3" style="padding-bottom:10px;">
                                                                    <div>
                                                                        <div style="width:100px;float:left">
                                                                            <img style="width:100px" src="http://nmskamarajpolytechnic.com/images/nms_logo.png">
                                                                        </div>
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td><input value="<?php echo $data[0]['Address4'];?>" readonly="readonly" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 50%;" type="text"> 
                                                                 &nbsp;&nbsp;&nbsp;&nbsp;PIN Code&nbsp;&nbsp;&nbsp;<input type="text" value="<?php echo $data[0]['Pincode'];?>" readonly="readonly" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width:128px;"></td>
                                                            </tr>
                                                             <tr>
                                                             <td style="padding:5px;text-align:left;width:30px">&nbsp; </td>
                                                            ...
                                                            <td colspan="2">
                                                                <table class="table-bordered" style="width:100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center;"><input type="text" value="<?php echo $data[0]['SubjectTotal'];?>" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width:80px;text-align:right;font-weight:bold"></td>
                ...
                <div class="col-md-12"  >
                    ...
                    <input type="hidden" name="EmailID" id="EmailID">
                        ...
                        <td style="padding:5px;text-align:left;width:30px">3. </td>
                            ...
                            <?php if($data[0]['Nationality']=="Others"){?><input type="text" value="<?php echo $data[0]['AdditionalNationality'];?>" readonly="readonly"  style="width:45%;display: none;float:right;line-height:normal;border: 1px solid #9dc6a2;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;"><?php } ?>
                            </td>
                        </tr>
                         <tr>
                         <td style="padding:5px;text-align:left;width:30px">4. </td>
                         ...
                         <td style="padding:5px;text-align:left;width:30px">6. </td>
                            ...
                            <td>
                                ...
                                <?php if($data[0]['Mothertongue']=="Others"){?><input type="text"  value="<?php echo $data[0]['AdditionalMothertongue'];?>" readonly="readonly" style="width:45%;display: none;float:right;line-height:normal;border: 1px solid #9dc6a2;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;"><?php } ?>
                            </td>
                        </tr>
                         <tr>
                         <td style="padding:5px;text-align:left;width:30px"> 7. </td>                                                                                                        
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <?php if($data[0]['Religion']=="Other"){?><input type="text" id="OtherReligion" name="OtherReligion"  style="width:45%;display: none;float:right;line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;"> <?php } ?>
                            </td>
                        </tr>
                         <tr>
                            <td style="padding:5px;text-align:left;width:30px;">&nbsp;</td>
                        ...
                        <tr style="vertical-align: top;">
                            ...
                            <td>
                                <table style="width: 100%;border:1px solid black"> 
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right: 1px solid black;">Part I Tamil or Language</td>
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right: 1px solid black;">Part II English</td>
                                        <td style="text-align:center;border-bottom:1px solid black;border-right: 1px solid black;">
                                    ...
                                    <tr>
                                        <td style="border-right: 1px solid black;border-bottom:1px solid black;">
                                            Part III : Elective &nbsp;<input type="text" value="ElectiveSubject" name="ElectiveSubject" id="ElectiveSubject" style="line-height:normal;border: 1px solid #9dc6a2;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width:80px;text-align:right;padding-right:30px;">
                                        </td>
                                        <td style="text-align:center;border-bottom:1px solid black;border-right:1px solid black">
                            ...
                            <td>
                                <table style="width: 100%;border:1px solid black"> 
                                  ...
                                  <!--  <tr>                   
                                        ...
                                        <td colspan="3" style="border-bottom:1px solid black;">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="VocationalCourseName" value="<?php echo $data[0]['VocationalCourseName'];?>" id="VocationalCourseName" style="line-height:normal;border: 1px solid #9dc6a2;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right: 1px solid black;">Theory</td>
                                        <td style="text-align:center;border-bottom:1px solid black;border-right: 1px solid black;">
                                    ...
                                    <tr>
                                        <td style="border-bottom:1px solid black;border-right: 1px solid black;">Practical I</td>
                                        <td style="text-align:center;border-bottom:1px solid black;border-right: 1px solid black;">
                                    ...
                                    <tr>   
                                        <td style="border-bottom:1px solid black;border-right: 1px solid black;">Practical II</td>
                                        <td style="text-align:center;border-bottom:1px solid black;border-right: 1px solid black;">
