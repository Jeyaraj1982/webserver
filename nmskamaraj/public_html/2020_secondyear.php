                  ...
                  <div style="border:1px solid green;background:#fff;padding:10px;margin-bottom:10px;width: 870px;margin:0px auto;border-radius:10px">
                    ...
                    <input type="hidden" name="EmailID" id="EmailID">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="CandidiateName" id="CandidiateName" onkeyup="getDeclrationName($(this).val())" style="line-height:normal;border: 1px solid #9dc6a2;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 100%;">
                          ...
                          <td style="padding:5px;text-align:left;width:30px">&nbsp; </td>
                            ...
                            <td>
                                <input type="text" name="ParentName" id="ParentName" onkeyup="getDeclrationParentName($(this).val())" style="line-height:normal;border: 1px solid #9dc6a2;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 100%;">
