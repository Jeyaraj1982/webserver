<?php
    class MailController {
        ...
        static public function Send($param,&$mailError) {
            ...
            $mail->isSMTP(); 
            $mail->SMTPDebug = 0;
            $mail->Host = "mail.nmskamarajpolytechnic.com";
            $mail->Port = 465;
            $mail->SMTPSecure = "ssl";
            $mail->SMTPAuth   = true;
            $mail->Username   = "info@nmskamarajpolytechnic.com";
            $mail->Password   = "NMSkamaraj@123";
            $mail->Subject    = $param['Subject'];
            $mail->setFrom("info".".info@nmskamarajpolytechnic.com","nmskamarajpolytechnic");
