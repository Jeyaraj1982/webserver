                    ...
                    <div style="background:#ffeaf4;padding:20px;width: 870px;margin:0px auto;border:1px solid #f24395;border-radius:10px">
                        ...
                        <input type="hidden" name="EmailID" id="EmailID">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="CandidiateName" id="CandidiateName" onkeyup="getDeclrationName($(this).val())" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 100%;">
                              ...
                              <td style="padding:5px;text-align:left;width:30px">&nbsp; </td>
                                ...
                                <td>
                                    <input type="text" name="ParentName" id="ParentName" onkeyup="getDeclrationParentName($(this).val())" style="line-height:normal;border: 1px solid #f9cae0;padding: 4px;font-size: 13px;color: #333;text-transform: uppercase;width: 100%;">
