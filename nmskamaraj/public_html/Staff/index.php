...
$Page="login";
        if (isset($_POST['btnsubmit'])) {
         $userdata = $mysql->select("select * from admintable where UserName='".$_POST['UserName']."' and Password='".$_POST['Password']."' and IsAdmin='0'");
                
                if (sizeof($userdata)>0) {
                    $_SESSION['STAFF']=$userdata[0];
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center"> <img src="assets/nms_logo2.png" style="height:128px"><br><br>Staff Sign In</h3>
