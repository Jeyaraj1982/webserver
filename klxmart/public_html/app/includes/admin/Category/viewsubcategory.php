<?php 
    if($_GET['status']=="All"){ 
        $SubCategorys = $mysql->select("select * from _tbl_sub_category where md5(CategoryID)='".$_GET['id']."' order by SubCategoryID desc");
        $title ="All";
    }if($_GET['status']=="Active"){
        $SubCategorys = $mysql->select("select * from _tbl_sub_category where IsActive='1' and md5(CategoryID)='".$_GET['id']."' order by SubCategoryID desc");
        $title ="Active";
    }if($_GET['status']=="Disable"){
       $SubCategorys = $mysql->select("select * from _tbl_sub_category where IsActive='0' and md5(CategoryID)='".$_GET['id']."' order by SubCategoryID desc");
       $title ="Disable";
    }
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="card-title">
                                        ...
                                        <span style="font-size: 15px"><?php echo $data[0]['CategoryName'];?>-<?php echo $title;?></span>
                                    </div>
                                </div>
                                <div class="col-md-3" style="text-align: right;">
                                    <a href="dashboard.php?action=Category/viewsubcategory&status=All&id=<?php echo $_GET['id'];?>" <?php if($_GET['status']=="All"){ ?> style="font-size:bold;text-decoration:underline;"<?php } ?>>All</a>&nbsp;|&nbsp;
                                    <a href="dashboard.php?action=Category/viewsubcategory&status=Active&id=<?php echo $_GET['id'];?>" <?php if($_GET['status']=="Active"){ ?> style="font-size:bold;text-decoration:underline;"<?php } ?>>Active</a>&nbsp;|&nbsp;
                                    <a href="dashboard.php?action=Category/viewsubcategory&status=Disable&id=<?php echo $_GET['id'];?>" <?php if($_GET['status']=="Disable"){ ?> style="font-size:bold;text-decoration:underline;"<?php } ?>>Disable</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                <td style="text-align: right">                                                   
                                                    <div class="dropdown dropdown-kanban" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="dashboard.php?action=SubCategory/edit&fr=vc&id=<?php echo md5($SubCategory['SubCategoryID']);?>" draggable="false">Edit</a>
                                                            <a class="dropdown-item" href="dashboard.php?action=SubCategory/view&fr=vc&id=<?php echo md5($SubCategory['SubCategoryID']);?>" draggable="false">View</a>
                                                            <a class="dropdown-item" href="dashboard.php?action=Products/add&id=<?php echo md5($SubCategory['CategoryID']);?>&sid=<?php echo md5($SubCategory['SubCategoryID']);?>&fr=c" draggable="false">Add Product</a>
                                                            <?php if($pc[0]['cnt']>0){ ?><a class="dropdown-item" href="dashboard.php?action=SubCategory/viewproducts&fr=c&id=<?php echo md5($SubCategory['SubCategoryID']);?>&status=All" draggable="false">View Products</a><?php } ?>
