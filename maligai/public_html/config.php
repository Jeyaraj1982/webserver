...
define("DbName","maligai_application");
define("DbUser","maligai_user");
...
define("SiteTitle","maligi.org");
define("SITE_TITLE","maligi.org");
define("EPINS","Vouchers");
define("EPIN","Voucher");
define("loginUrl","http://maligai.org/login");
define("logUrl","http://maligai.org/assets/img/logo.jpeg");
$_month = array("0","JAN","FEB","MAR","APR","MAY","JUN","JLY","AUG","SEP","OCT","NOV","DEC");
if (isset($_GET['action']) && $_GET['action']=="logout") {
    session_destroy();
    $_SESSION['User']=array();
}
   ...
   $memberTree = new MemberTree();
    ...
    function getLevelMembers($MemberCode,$Level) {
        
        global $mysql;
        
        if ($Level==1) {
            $active=$mysql->select("select * from  _tbl_Members where SponsorCode='".$MemberCode."' and IsActive='1'");
            $inactive=$mysql->select("select * from  _tbl_Members where SponsorCode='".$MemberCode."' and IsActive='0'");
            $ids = array();
             foreach($active as $a) {
                 $ids[]=$a['MemberCode'];
             }
            return array("ids"=>$ids,"TotalMembers"=>sizeof($active)+sizeof($inactive),"Active"=>sizeof($active),"Inactive"=>sizeof($inactive));
        } 
         ...
         if ($Level==2) {
             ...
             $inactive_members=0;
             $active=$mysql->select("select * from  _tbl_Members where SponsorCode='".$MemberCode."' and IsActive='1'");
             //$lm = getLevelMembers($MemberCode,1);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
             $ids = array();
             foreach($active as $id) {
                 $ids[]=$id['MemberCode'];
                 $t = getLevelMembers($id['MemberCode'],1);
                 $active_members += $t['Active'];
                 $inactive_members += $t['Inactive'];
             }
            
            return array("ids"=>$ids,"TotalMembers"=>$active_members+$inactive_members,"Active"=>$active_members,"Inactive"=>$inactive_members);
        }   
        ...
        if ($Level==3) {
             ...
             $lm = getLevelMembers($MemberCode,2);
            // $active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
             
             $ids = array();
             foreach($lm['ids'] as $id) {
                 $ids[]=$id['MemberCode'];
                 $t = getLevelMembers($id['MemberCode'],1);
                 $active_members += $t['Active'];
                 $inactive_members += $t['Inactive']; 
         ...
         if ($Level==4) {
             ...
             $lm = getLevelMembers($MemberCode,3);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==5) {
             ...
             $lm = getLevelMembers($MemberCode,4);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==6) {
             ...
             $lm = getLevelMembers($MemberCode,5);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==7) {
             ...
             $lm = getLevelMembers($MemberCode,6);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==8) {
             ...
             $lm = getLevelMembers($MemberCode,7);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==9) {
             ...
             $lm = getLevelMembers($MemberCode,8);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==10) {
             ...
             $lm = getLevelMembers($MemberCode,9);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==11) {
             ...
             $lm = getLevelMembers($MemberCode,10);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==12) {
             ...
             $lm = getLevelMembers($MemberCode,11);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==13) {
             ...
             $lm = getLevelMembers($MemberCode,12);
             //$active_members += $lm['Active'];
             //$inactive_members += $t['Inactive'];
        ...
        if ($Level==14) {
             ...
             $lm = getLevelMembers($MemberCode,13);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
         ...
         if ($Level==15) {
             ...
             $lm = getLevelMembers($MemberCode,14);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
        ...
        if ($Level==16) {
             ...
             $lm = getLevelMembers($MemberCode,15);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
          ...
          if ($Level==17) {
             ...
             $lm = getLevelMembers($MemberCode,16);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
          ...
          if ($Level==18) {
             ...
             $lm = getLevelMembers($MemberCode,17);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
         ...
         if ($Level==19) {
             ...
             $lm = getLevelMembers($MemberCode,18);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
         ...
         if ($Level==20) {
             ...
             $lm = getLevelMembers($MemberCode,19);
             //$active_members += $lm['Active'];
             //$inactive_members += $lm['Inactive'];
