			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<!--<img src="assets/img/logo.svg" alt="navbar brand" class="navbar-brand">-->
                     <img src="<?php echo logUrl;?>" style="height:50px">
				</a>
									...
									<li>
										<div class="user-box">
											<div class="avatar-lg">
                                             ...
                                             <?php if ($_SESSION['User']['ProfilePhoto']=="") {?>
                                            <img src="assets/images/user_small.png" style="height: 64px;width: 64px;">
                                            <?php } else {?>
                                            <img src="../uploads/<?php echo $_SESSION['User']['ProfilePhoto'];?>" style="border-radius:50%;height: 64px;width: 64px;">
                                            <?php } ?>
...
$( document ).ready(function() {
    ...
    //  $('#circles-1 .circles-wrp .circles-text').html('0');
     ...
     //   $('#circles-3 .circles-wrp .circles-text').html('0');
      //  $('#circles-4 .circles-wrp .circles-text').html('0');     
      //  $('#circles-5 .circles-wrp .circles-text').html('0');
      //  $('#circles-6 .circles-wrp .circles-text').html('0');     
       // $('#circles-7 .circles-wrp .circles-text').html('0');
      //  $('#circles-8 .circles-wrp .circles-text').html('0');     
      //  $('#circles-9 .circles-wrp .circles-text').html('0');     
      //  $('#circles-10 .circles-wrp .circles-text').html('0');     
    setTimeout(function() {
        for(i=1;i<=20;i++) {
        $('#circles-'+i+' .circles-wrp .circles-text').html('0');    
        }
    },2400);
