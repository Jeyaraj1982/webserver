                        ...
                        <div class="row"> 
                         ...
                         <div class="row"> 
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php if (strlen(trim($data[0]['AdhaarCard'])>5)) { ?>
                                            <img src="assets/uploads/<?php echo $data[0]['AdhaarCard'];?>" style="height:200px;"><br>
                                        <?php } else { ?>
                                         not attached
                                        <?php } ?>
                                    </div>
                                     <div class="col-md-12">
                                        <?php if (strlen(trim($data[0]['AdhaarCardBack'])>5)) { ?>
                                            <img src="assets/uploads/<?php echo $data[0]['AdhaarCardBack'];?>" style="height:200px;"><br>
                                        <?php } else { ?>
                                         not attached
                                        <?php } ?>
                                    </div>
