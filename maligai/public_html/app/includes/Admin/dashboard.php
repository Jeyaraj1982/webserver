                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                                <?php echo (sizeof($mysql->select("select * from _tbl_Members where IsActive='1'")));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo (sizeof($mysql->select("select * from _tbl_Members where IsActive='0'")));?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>                
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-icon">
                                            <div class="icon-big text-center icon-secondary bubble-shadow-small" style="background:#fff">
                                               <img src="assets/img/indian_b.png" style="background:#fff;">
                                            </div>
                                        </div>
                                        <div class="col col-stats ml-3 ml-sm-0">
                                            <div class="numbers">
