    ...
    <div class="page-inner py-5">
	    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			...
			<div class="ml-md-auto py-2 py-md-0">
				<a href="dashboard.php?action=Members/NewDirectMember" class="btn btn-secondary btn-round">Create Member</a>
			</div>
		</div>
	</div>
</div>
			    ...
			    <div class="card-body">
                   ...
                   <!-- <?php for($i=1;$i<=20;$i++) {?>
						<div class="px-2 pb-2 pb-md-0 text-center">
							<div id="circles-<?php echo $i;?>"></div>
							<h6 class="fw-bold mt-3 mb-1">L<?php echo $i;?></h6>
						</div>
                    <?php } ?>
						-->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">My Level</div>
                                </div>
                                <div class="card-body">
                            ...
                            <tbody>
                                <?php               
                                    for($i=1;$i<=20;$i++) {
                                        ...
                                        $requests = $mysql->select("select * from _payout where Level='".$i."' and  MemberCode='".$_SESSION['User']['MemberCode']."' Order by `PayoutID` Desc");
                                        //$data  = getLevelMembers($_SESSION['User']['MemberCode'],$i);
                                     
                                        if (sizeof($requests)>0) {
                                ?>
                                <tr>
                                    <td>Level <?php echo $i;?></td>
                                    <td style="text-align: right"><?php echo sizeof($requests);?></td>
                                </tr>
                                <?php
                                   }
