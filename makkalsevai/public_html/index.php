...
?>
<div class="intro-banner" data-background-image="images/home-background.jpg" style="display: none;">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-headline">
					<h3>
						<!--<strong>மக்கள் சேவை மையம் </strong>-->
						<br>
		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="section-headline centered margin-bottom-15">
					...
					<!--<img src="assets/msm_logo.png"><br>
                    <br>-->
                    ...
                    <br><br>
                     ...
                     <div class="row">
                      <div class="col-sm-6" style="margin-bottom:30px;background: #004722;">
                        <img src="assets/image_1.png" style="background: #004722;padding: 10px;    padding-right: 10px;padding-right: 14px;"><br>
                        <img src="assets/image_2.png" style="background: #004722;padding: 10px;    padding-right: 10px;padding-right: 14px;"><br>
                        <img src="assets/image_3.png" style="background: #004722;padding: 10px;    padding-right: 10px;padding-right: 14px;"><br>
                        </div>
                        <div class="col-sm-6" style="margin-bottom:30px">
                        <img src="assets/1-500x500.jpg">
                        </div>
                        <div class="col-sm-6" style="margin-bottom:30px">
                        <img src="assets/electricity-utility-bills-500x500.png">
                        </div>
                        <div class="col-sm-6" style="margin-bottom:30px">
                        <img src="assets/mobile-recharge-and-bill-payment-service-provider-500x500.jpg">
                        </div> 
                        <div class="col-sm-6" style="margin-bottom:30px">
                        <h3> Loan Services</h3>
                        <img src="assets/WhatsApp Image 2021-04-27 at 9.33.17 PM.jpeg">
                        </div>
                     </div>
...
<!-- Features Jobs -->
<div class="section gray margin-top-45 padding-top-65 padding-bottom-75" style="display: none;">
	<div class="container">
		<div class="row">
			<div class="col-xl-12">
...
<!-- Features Cities -->
<div class="section margin-top-65 margin-bottom-65" style="display: none;">
	<div class="container">
		<div class="row">
...
<div class="section gray padding-top-65 padding-bottom-70 full-width-carousel-fix" style="display: none;">
	<div class="container">
		<div class="row">
...
<!-- Membership Plans -->
<div class="section padding-top-60 padding-bottom-75" style="display:none">
	<div class="container">
		<div class="row">
