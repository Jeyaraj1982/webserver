 <footer class="main-footer">
    <strong>Copyright
    <?php
        if ($_SESSION['user']['LicencedTo']==1) {
        ?>
            <a href="https://www.j2jsoftwaresolutions.com">J2J Software Solutions</a>
        <?php
        }
    ?>
    
     &copy; 2011-2021</strong>
    All rights reserved.
...
<script src="<?php echo url;?>/plugins/jqvmap/maps/jquery.vmap.world.js"></script>
<!-- jQuery Knob Chart -->
