          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              ...
              <?php } else { ?>
                  ...
                  <h5><i class="icon fas fa-check"></i>Recharge Success</h5>
                  <?php echo $_POST['mobilenumber']; ?> has been recharged with Rs. <?php echo $_POST['amount'];?>  successfully.
                </div>
                ...
                <form role="form" action="" method="post">
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <?php $operators= $mysql->select("select * from `_tbl_operators` where `IsDTH`='1' order by `OperatorName`"); ?>
