 ...
 <?php
 $style = "";
 $Prototypes = $mysql->select("select * from _tbltasklist where  TaskAssignedTo='".$_SESSION['User']['UserID']."'   order by TaskID desc");  
...
<table style="width:100%;" cellspacing="0" cellpadding="5">
    ...
    <?php foreach($Prototypes as $Prototype) { ?>
         <tr style="background:#<?php echo $Prototype['TaskStatus']==1 ? 'fff' : 'ebffdd';?>">
             ...
             <td><?php echo date("M d, Y H:i",strtotime($Prototype['TaskAssignedOn']));?></td>
