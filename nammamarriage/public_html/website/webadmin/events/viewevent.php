...
<?php 
    ...
    $obj = new CommonController();  
     ...
     $param = array("pageid"=>$_POST['rowid'],"pagetitle"=>$_POST['pagetitle'],"pagedescription"=>str_replace("'","\\'",$_POST['pagedescription']),"ispublish"=>$_POST['ispublished']);
                    $param['ishomepage']=0; 
         ...
         if ($obj->err==0) {
             echo (JPages::updatePage($param)>0) ? $obj->printSuccess("Events Updated  Successfully") : $obj->printError("Error Updating Events");
         } else {
...
$(function() {
    ...
    <div class="titleBar">Edit Event</div>
    ...
    <input type="hidden" name="rowid" value="<?php echo $pageContent[0]['pageid'];?>">
        <table cellpadding="5" cellspacing="0" align="center">
            ...
            <tr>
                <td>Event Date:</td> <td><input id="datepicker" class="datepicker" type="text" value="<?php echo $pageContent[0]['eventtime'];?>" name="datepicker"/></td>
      ...
      if (isset($_POST{"viewbtn"})){
       ...
       <div class="titleBar">View Event</div>
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       ?>
       <div class="titleBar">Delete Event</div>
