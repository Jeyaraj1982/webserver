...
<?php 
    ...
    if (isset($_POST{"save"})) {
            ...
            $param = array("videotitle"=>$_POST['videotitle'],"videodescription"=>str_replace("'","\\'",$_POST['videodescription']),"videourl"=>$_POST['videourl']);
...
<body style="margin:0px;">
   <div class="titleBar">New Videos</div>
    <form action="" method="post" style="height: 20px;" enctype="multipart/form-data">
        <table cellpadding="5" cellspacing="0" align="center">
            ...
            <tr>
                <td style="width:70px">Video Url:</td>
                <td>
                    http://www.youtube.com/watch?v=<input type="text" name="videourl" style="width:78%;"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
