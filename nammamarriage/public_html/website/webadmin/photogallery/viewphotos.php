...
<body style="margin:0px;">
 <div class="titleBar">List of Photos</div>  
<?php 
          ...
          ?>
            <tr class='mytr'>
                <td style='padding:5px;width:70px'>
                    <img src="../../assets/<?php echo $config['photos'].$r["photofilepath"];?>"  style="height:70px;width:70px;"></img>
                </td>
                <td style="vertical-align: top;padding:10px;">
                    <b><?php echo $r["phototitle"]?></b> 
                    <div>
            ...
            <td width='160' style='text-align:center;'>
                <form action='managephotosgroupwise.php' method='post' style='height:0px;'>
