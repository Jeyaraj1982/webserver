<?php 
    include_once("../../config.php");
        $obj = new CommonController();
            ...
            $param = array("groupname"=>$_POST['groupname'],"groupdescription"=>str_replace("'","\\'",$_POST['groupdescription']),"ispublished"=>$_POST['ispublished'],"filename"=>$filename);
...
<body style="margin:0px;">
    <div class="titleBar">Add Groups</div>
        <form action="" method="post" enctype="multipart/form-data">
            <table cellpadding="3" cellspacing="0" align="center">
                <tr>
                     <td style="width:72px;">Group Name</td>
               ...
               <tr>
                   <td colspan="2">
                        <table>
                            <tr>
                                <td>Upload: <input type="file" class="input" name="filepath"/></td>
                                <td rowspan="2"> 
                ...
                <tr>
                    <td colspan="2"><input type="submit" name="save" value="Save" bgcolor="grey"> <input type="button" name="cancel" value="Cancel" bgcolor="grey" onclick="location.href='viewgroups.php'"></td>
              </tr> 
          </table>
       </form>
