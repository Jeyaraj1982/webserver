...
include_once("../../config.php");
    ...
    $obj = new CommonController();  
         ...
         if (isset($_POST{"save"})) {
              ...
              $param = array("musictitle"=>$_POST['musictitle'],"musicdescription"=>str_replace("'","\\'",$_POST['musicdescription']),"filename"=>$filename,"thumbfile"=>$tfilename,"ispublished"=>$_POST['ispublished'],"albumid"=>$_POST['albumid']);
             ...
             if (isset($_FILES['filepath']['name'])&& (strlen(trim($_FILES["filepath"]["name"]))>0)){
                ...
                echo $obj->printError("Please Attach Mp3 Files");     
            }
