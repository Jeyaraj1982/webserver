...
include_once("../../config.php");
    ...
    if (isset($_POST['rmimage'])) {
        $mysql->execute("update _jalbum set filepath='' where albumid=".$_POST['rowid']);
     ...
     if(isset($_POST{"updatebtn"})) {
         ...
         if ($obj->isEmptyField($_POST['albumtitle'])) {
           ...
           $param = array("albumid"=>$_POST['rowid'],"albumtitle"=>$_POST['albumtitle'],"albumdescription"=>str_replace("'","\\'",$_POST['albumdescription']),"filename"=>$filename,"ispublished"=>$_POST['ispublished']);
         ...
         if ($obj->err==0) {
             echo (JMusics::updateMusicAlbum($param)>0) ? $obj->printSuccess("Album Updated  Successfully") : $obj->printError("Error Updating Albums");
         }else {
...
textarea {font-family:'Trebuchet MS';font-size:13px;color:#222;width:100%}
   ...
   <div class="titleBar">Edit Albums</div>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="5" cellspacing="0" align="center">
            ...
            <tr>
                <td colspan="2"><input type="submit" name="updatebtn" value="Update" bgcolor="grey">
                    <input type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='viewalbum.php'"> 
                </td>
            </tr>
        </table>
    </form>
      ...
      $pageContent = JMusics::getMusicAlbum($_POST['rowid']);
       ?> 
      <div class="titleBar">View Albums</div>
        ...
        <tr>
            ...
            <td><?php echo $pageContent[0]['postedon'];?></td>
                ...
                <form action='managealbum.php' method='post' style='height:0px;'>
                    <input type='hidden' value='<?php echo $pageContent[0]['albumid'];?>' name='rowid' id='rowid' >
                    <input style='font-size:11px;' type='submit' name='editbtn' value='Edit'>
                    <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='viewalbum.php'"> 
                </form>     
       <?php
       exit;
      }
      if(isset($_POST{"cdeletebtn"})){
       ...
       $pageContent = JMusics::deleteMusicAlbum($_POST['rowid']); 
       echo CommonController::printSuccess("Deleted Successfully");
       echo "<script>setTimeout(\"window.open('viewalbum.php','rpanel')\",1500);</script>"; 
      }
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       $pageContent = JMusics::getMusicAlbum($_POST['rowid']);
       ?>
      <div class="titleBar">Delete Albums</div>
