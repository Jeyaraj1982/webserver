...
<div class="titleBar">Add Download Albums</div> 
    <form action="" method="post" enctype="multipart/form-data">
        <table cellpadding="3" cellspacing="0" align="center">
                <tr>
                     <td style="width:70px;">Album Title</td>
               ...
               <tr>
                    ...
                    <input type="button" name="cancel" value="Cancel" bgcolor="grey" onclick="location.href='viewdalbum.php'"></td>
              </tr> 
        </table>
    </form>
