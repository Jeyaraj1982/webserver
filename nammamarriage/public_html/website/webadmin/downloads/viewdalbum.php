...
<div class="titleBar">List of Download Albums</div>
<?php 
          ...
          ?>
            <tr class='mytr'>
                ...
                <td style="vertical-align: top;padding:10px;">
                    <b><?php echo $r["albumtit"]?></b> 
                    <br><span style='color:#555'><?php echo strip_tags(substr(strip_tags($r["albumdesc"]),0,300));?>... </span> 
                    <div>
                        Posted On: <span style="color:#444;font-weight:bold;"><?php echo $r["postedon"]; ?></span>&nbsp;&nbsp; 
                        Status: <?php echo ($r["ispublish"])  ? "<span style='color:#08912A;font-weight:bold;'>Published</span>" : "<span style='color:#FF090D;font-weight:bold;'>Un Published</span>"; ?>
                    </div>
            </td>
            <td width='160' style='text-align:center;'>
                <form action='dmanagealbum.php' method='post' style='height:0px;'>
