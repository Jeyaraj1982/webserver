                                                    ...
                                                    <div class="card-body"> 
                                                        <div class="form-group mb-50" style="text-align: center;">
                                                            <div class="lievo-svg-wrapper">
                                                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xml:space="preserve" data-shift="y" data-animoptions="{'duration':'1', 'repeat':'0', 'repeatDelay':'0.5'}" preserveAspectRatio="xMinYMin meet" style="left: 0.5px; top: -0.0333252px;height:200px;width:200px"><g class="lievo-setrotation"><g class="lievo-setsharp"><g class="lievo-setflip"><g class="lievo-main">
                                                                    <g class="lievo-common">
                                                                        <circle fill="none" transform="matrix(1,0,0,1,0,0)" stroke="rgba(165,220,134,.3)" stroke-width="2" stroke-linecap="square" stroke-miterlimit="10" cx="30" cy="30" r="23" style="stroke: rgba(165,220,134,.3);" data-svg-origin="30 30"></circle>
                                                                        <polyline class="lievo-altstroke lievo-solidbg" fill="none" stroke="rgba(165,220,134,.3)" stroke-width="2" stroke-linecap="square" stroke-miterlimit="10" points="20,29 28,37 42,23" style="stroke-dashoffset: 0.00001px; stroke-dasharray: none; stroke: rgba(165,220,134,.3);"></polyline>
                                                                    </g>
                                                                    <rect x="-19" y="-20" width="4" height="4" class="lievo-checkshift lievo-donotdraw lievo-nohoverstroke lievo-nohovercolor" style="stroke-width: 2px; stroke-linecap: butt; stroke-linejoin: round; opacity: 0;" fill="none" stroke="#22a7f0"></rect></g></g></g></g>
                                                                    <desc>LivIcons Evolution</desc><defs></defs>
                                                                </svg>
                                                            </div>
                                                            <h2 class="swal2-title" id="swal2-title" style="text-align:center"><b>Register Success</b></h2>
                                                            <div id="swal2-content" style="color:#545454;font-size: 1.125em;font-weight: 300;line-height: normal;word-wrap: break-word;">Your new password saved.</div>  <br>
                                                            <a href="login" class="btn btn-primary">Here</a>
                                                        </div>
                                                    </div>                                
                                                </div>
                                            </div>
