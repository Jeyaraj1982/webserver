    ...
    <div class="card">
        <div class="card-body">
            <div style="padding:15px !important;max-width:770px !important;">
                 <h4 class="card-title">Deactive Request</h4>  
                        <form method="post" id="frmfrn_<?php echo $Request['ReqID'];?>" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3"><small style="color:#737373;"><?php echo $Member['PersonName'];?></small></div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3"><small style="color:#737373;"><?php echo $Request['DeactiveReason'];?></small></div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3"><small>Request On:</small> </div>
                                <div class="col-sm-3"><small style="color:#737373;"><?php echo putDateTime($Request['DeactiveRequestOn']);?></small></div>
                            </div>
                            ...
                            <?php if($Request['IsVerified']==0){?>
                                <div class="form-group row">
                                    <div class="col-sm-12"><a href="javascript:void(0)" onclick="Member.showConfirmApproveMemDeactiveReq('<?php echo $Request['ReqID'];?>')" class="btn btn-success" name="ApproveDeactiveReq" style="font-family:roboto">Approve</a>
                                    &nbsp;&nbsp;<a href="javascript:void(0)" onclick="Member.showConfirmRejectMemDeactiveReq('<?php echo $Request['ReqID'];?>')" class="btn btn-danger" name="RejectDeactiveReq" style="font-family:roboto">Reject</a>
                                    </div>
                                </div>
                            <?php } ?>  
                   </form>   
