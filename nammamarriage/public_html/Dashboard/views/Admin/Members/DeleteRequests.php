    ...
    <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9" style="text-align:right;padding-top:5px;color:skyblue;">
                ...
                <a href="DeleteRequests"><small style="font-weight:bold;text-decoration:underline">Delete Request</small></a>&nbsp;|&nbsp;
            ...
            <div class="table-responsive">   
                ...
                <tbody> 
                    <?php $response = $webservice->getData("Admin","GetManageRequests",array("Request"=>"Delete")); ?>  
                        ...
                        <tr>
                         <form method="post" id="frmfrn_<?php echo $Request['ReqID'];?>">      
                            ...
                            <td style="text-align:right">
                                <a href="javascript:void(0)" onclick="Member.GetTxnPasswordViewDeleteRequest('<?php echo $Request['ReqID'];?>')"><span>View</span></a>
                            </td>
                            </tr>
                         </form>
                    <?php } ?>            
