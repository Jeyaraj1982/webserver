                 ...
                 <h4 class="card-title">Active Request</h4>  
                        <form method="post" id="frmfrn_<?php echo $Request['ReqID'];?>" >
                            ...
                            <?php if($Request['IsVerified']==0){?>
                                <div class="form-group row">
                                    <div class="col-sm-12"><a href="javascript:void(0)" onclick="Member.showConfirmApproveMemActiveReq('<?php echo $Request['ReqID'];?>')" class="btn btn-success" name="ApproveDeactiveReq" style="font-family:roboto">Approve</a>
                                    &nbsp;&nbsp;<a href="javascript:void(0)" onclick="Member.showConfirmRejectMemActiveReq('<?php echo $Request['ReqID'];?>')" class="btn btn-danger" name="RejectDeactiveReq" style="font-family:roboto">Reject</a>
                                    </div>
                                </div>
                            <?php } ?>  
                   </form>   
