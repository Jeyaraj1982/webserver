    ...
    <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9" style="text-align:right;padding-top:5px;color:skyblue;">
                ...
                <a href="ActiveRequests" style="font-weight:bold;text-decoration:underline"><small>Active Request</small></a>&nbsp;|&nbsp;
                <a href="DeleteRequests"><small>Delete Request</small></a>&nbsp;|&nbsp;
                <a href="RestoreRequests"><small>Restore Request</small></a>&nbsp;|&nbsp;
            </div>    
            </div>
            <div class="table-responsive">   
                ...
                <tbody> 
                    <?php $response = $webservice->getData("Admin","GetManageRequests",array("Request"=>"Active")); ?>  
                    <?php foreach($response['data'] as $Request) { ?>
                        ...
                        <form method="post" id="frmfrn_<?php echo $Request['ReqID'];?>">      
                            ...
                            <td style="text-align:right">
                                <a href="javascript:void(0)" onclick="Member.GetTxnPasswordViewActiveRequest('<?php echo $Request['ReqID'];?>')"><span>View</span></a>
                            </td>
                            </tr>
                         </form>
                    <?php } ?>            
