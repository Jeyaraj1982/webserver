<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        ...
        <div class="form-group row">
            <div class="col-sm-3">
            <h4 class="card-title" style="margin-bottom: 0px;margin-top: 0px;">Requests From Member</h4>
            ...
            <div class="col-sm-9" style="text-align:right;padding-top:5px;color:skyblue;">
                <a href="MemberRequests"><small  style="font-weight:bold;text-decoration:underline">Deactive Request</small></a>&nbsp;|&nbsp;
                <a href="ActiveRequestsFrMember"><small>Active Request</small></a>&nbsp;|&nbsp;
                <a href="DeleteRequestsFrMember"><small>Delete Request</small></a>&nbsp;|&nbsp;
                <a href="RestoreRequestsFrMember"><small>Restore Request</small></a>&nbsp;|&nbsp;
            </div>    
            </div>
            <div class="table-responsive">   
                ...
                <tbody> 
                    <?php $response = $webservice->getData("Admin","GetManageRequestsFromMember",array("Request"=>"Deactive")); ?>  
                    <?php foreach($response['data'] as $Request) { ?>
                        ...
                        <form method="post" id="frmfrn_<?php echo $Request['ReqID'];?>">      
                            ...
                            <td style="text-align:right">
                                <a href="javascript:void(0)" onclick="Member.GetTxnPasswordViewDactiveRequestFrMember('<?php echo $Request['ReqID'];?>')"><span>View</span></a>
                            </td>
                            </tr>
                         </form>
                    <?php } ?>            
