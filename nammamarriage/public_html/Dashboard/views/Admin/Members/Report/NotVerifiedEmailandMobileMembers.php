    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="form-group row">
                ...
                <h5 class="card-title" style="font-size: 14px;font-weight: 399; margin-bottom: 10px;Color:#888">Non-Verified Email and Mobile Members</h5>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <tbody> 
                        ...
                        <?php foreach($Members as $Member) { ?>
                                ...
                                <td><?php echo $Member['IsEmailVerified'];?></td>
                                <td><?php echo $Member['IsMobileVerified'];?></td>
