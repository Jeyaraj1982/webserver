    ...
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    ...
                    <a href="ManageDeactiveCaste"><small>Deactive</small></a>
                </div>
                </div>
                    ...
                    <table id="myTable" class="table table-striped">
                      ...
                      <tbody>  
                       <?php $ReligionNames = $webservice->getData("Admin","GetMastersManageDetails"); ?>
                        <?php foreach($ReligionNames['data']['CasteNames'] as $CasteName) { ?>
                                <tr>
                                ...
                                <td style="text-align:right"><a href="<?php echo GetUrl("Settings/Masters/CasteNames/Manage/Edit/". $CasteName['SoftCode'].".html");?>"><span>Edit</span></a>&nbsp;&nbsp;&nbsp;
                                <a href="<?php echo GetUrl("Settings/Masters/CasteNames/Manage/View/". $CasteName['SoftCode'].".html");?>"><span>View</span></a></td> 
                                </tr>
                        <?php } ?>   
                            </tbody>
                    </table>
