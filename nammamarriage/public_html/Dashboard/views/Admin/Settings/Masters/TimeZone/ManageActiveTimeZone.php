...
<form method="post" action="<?php echo GetUrl("Settings/Masters/TimeZone/New");?>" onsubmit="">
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    ...
                    <a href="ManageActiveTimeZone"><small style="font-weight:bold;text-decoration:underline">Active</small></a>&nbsp;|&nbsp;
    ...
    <div class="table-responsive">
        <table id="myTable" class="table table-striped" width="100%">
            ...
            <tbody>                      
            <?php $TimeZones = $webservice->getData("Admin","GetManageActiveTimeZone"); ?>
