...
<?php                   
  if (isset($_POST['BtnSequence'])) {   
    $response = $webservice->getData("Admin","EditSequence",$_POST);
...
<form method="post" action="" onsubmit="return SubmitNewSequence();">
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="SequenceFor" name="SequenceFor" value="<?php echo (isset($_POST['SequenceFor']) ? $_POST['SequenceFor'] : $Sequence['SequenceFor']);?>" placeholder="Sequence For">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="Prefix" name="Prefix" value="<?php echo (isset($_POST['Prefix']) ? $_POST['Prefix'] : $Sequence['Prefix']);?>" placeholder="Prefix">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="StringLength" name="StringLength" value="<?php echo (isset($_POST['StringLength']) ? $_POST['StringLength'] : $Sequence['StringLength']);?>" placeholder="String Length">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="LastNumber" name="LastNumber" value="<?php echo (isset($_POST['LastNumber']) ? $_POST['LastNumber'] : $Sequence['LastNumber']);?>" placeholder="Last Number">
        ...
        <div class="form-group row">
        <div class="col-sm-3">
       <button type="submit" name="BtnSequence" id="BtnSequence"  class="btn btn-primary mr-2">Update Sequence For</button> </div>
