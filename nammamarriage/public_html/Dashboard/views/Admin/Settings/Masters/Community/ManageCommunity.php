...
<form method="post" action="<?php echo GetUrl("Settings/Masters/Community/New");?>" onsubmit="">
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    <a href="ManageCommunity" ><small style="font-weight:bold;text-decoration:underline">All</small></a>&nbsp;|&nbsp;
                    <a href="ManageActiveCommunity"><small>Active</small></a>&nbsp;|&nbsp;
    ...
    <div class="table-responsive">
        <table id="myTable" class="table table-striped" width="100%">
            ...
            <tbody>                      
            <?php $Communitys = $webservice->getData("Admin","GetMastersManageDetails"); ?>
            <?php foreach($Communitys['data']['Community'] as $Community) { ?>
                <tr>
