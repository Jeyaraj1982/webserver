...
<form method="post" action="<?php echo GetUrl("Settings/Masters/Currency/New");?>" onsubmit="">
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    <a href="ManageCurrency" ><small style="font-weight:bold;text-decoration:underline">All</small></a>&nbsp;|&nbsp;
                    <a href="ManageActiveCurrency"><small>Active</small></a>&nbsp;|&nbsp;
                    <a href="ManageDeactiveCurrency"><small>Deactive</small></a>
                </div>
                </div>
    <div class="table-responsive">
        <table id="myTable" class="table table-striped" width="100%">
            ...
            <tbody>                      
            <?php $Currencys = $webservice->getData("Admin","GetMastersManageDetails"); ?>
            <?php foreach($Currencys['data']['Currency'] as $Currency) { ?>
                <tr>
