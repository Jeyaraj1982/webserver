...
<form method="post" action="<?php echo GetUrl("Settings/Masters/AddressProof/New");?>" onsubmit="">
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    <a href="ManageAddressProof" ><small>All</small></a>&nbsp;|&nbsp;
                    <a href="ManageActiveAddressProof"><small>Active</small></a>&nbsp;|&nbsp;
                    <a href="ManageDeactiveAddressProof"><small style="font-weight:bold;text-decoration:underline">Deactive</small></a>
                </div>
                </div>
    <div class="table-responsive">
        <table id="myTable" class="table table-striped" width="100%">
            ...
            <tbody>                      
            <?php $AddressProofs = $webservice->getData("Admin","GetManageDeactiveAddressProof"); ?>
            <?php foreach($AddressProofs['data'] as $AddressProof) { ?>
                <tr>
