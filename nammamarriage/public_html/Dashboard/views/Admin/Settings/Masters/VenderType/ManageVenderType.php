...
<form method="post" action="<?php echo GetUrl("Settings/Masters/VenderType/New");?>" onsubmit="">
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    <a href="ManageVenderType" ><small style="font-weight:bold;text-decoration:underline">All</small></a>&nbsp;|&nbsp;
                    <a href="ManageActiveVenderType"><small>Active</small></a>&nbsp;|&nbsp;
                    <a href="ManageDeactiveVenderType"><small>Deactive</small></a>
                </div>
                </div>
    <div class="table-responsive">
        <table id="myTable" class="table table-striped" width="100%">
            ...
            <tbody>                      
            <?php $VenderTypes = $webservice->getData("Admin","GetMastersManageDetails"); ?>
            <?php foreach($VenderTypes['data']['VenderType'] as $VenderType) { ?>
                <tr>
