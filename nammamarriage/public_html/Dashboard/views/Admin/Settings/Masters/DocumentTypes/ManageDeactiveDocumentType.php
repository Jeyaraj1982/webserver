...
<form method="post" action="<?php echo GetUrl("Settings/Masters/DocumentTypes/New");?>" onsubmit="">
    <h4 class="card-title">Masters</h4>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    <a href="ManageDocumentType" ><small>All</small></a>&nbsp;|&nbsp;
                    <a href="ManageActiveDocumentType"><small>Active</small></a>&nbsp;|&nbsp;
                    <a href="ManageDeactiveDocumentType"><small style="font-weight:bold;text-decoration:underline">Deactive</small></a>
                </div>
                </div>
    <div class="table-responsive">
        <table id="myTable" class="table table-striped" width="100%">
            ...
            <tbody>                      
            <?php $DocumentTypes = $webservice->getData("Admin","GetManageDeactiveDocumentType"); ?>
            <?php foreach($DocumentTypes['data'] as $DocumentType) { ?>
                <tr>
