<?php                   
  ...
  $response = $webservice->getData("Admin","EditSequenceMaster",$_POST);   
  print_r($response);  
    ...
    $response = $webservice->getData("Admin","GetSequenceMasterDetailsForView",$_POST);   
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="SequenceForName" name="SequenceForName" value="<?php echo (isset($_POST['SequenceForName']) ? $_POST['SequenceForName'] : $Sequence[0]['SequenceFor']);?>" placeholder="Sequence For">
                       ...
                       <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="Prefix" name="Prefix" value="<?php echo (isset($_POST['Prefix']) ? $_POST['Prefix'] : $Sequence[0]['Prefix']);?>" placeholder="Prefix">
                       ...
                       <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="SLength" name="SLength" value="<?php echo (isset($_POST['SLength']) ? $_POST['SLength'] : $Sequence[0]['StringLength']);?>" placeholder="String Length">
                       ...
                       <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="LastNumber" name="LastNumber" value="<?php echo (isset($_POST['LastNumber']) ? $_POST['LastNumber'] : $Sequence[0]['LastNumber']);?>" placeholder="Last Number">
                            <span class="errorstring" id="ErrLastNumber"><?php echo isset($ErrLastNumber)? $ErrLastNumber : "";?></span>
                          </div>
                       </div>
                       <div class="form-group row">
                        <div class="col-sm-2">
                        <button type="submit" name="SequenceFor" class="btn btn-primary mr-2" style="font-family:roboto">Save Sequence</button></div>
