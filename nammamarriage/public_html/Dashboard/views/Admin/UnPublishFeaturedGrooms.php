<?php
    $response = $webservice->getData("Admin","GetFeatuerdGrooms",array("Request"=>"UnPublish"));
            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8" style="text-align:right;padding-top:5px;color:skyblue;">
                        ...
                        <a href="UnPublishFeaturedGrooms"><small style="font-weight:bold;text-decoration:underline">Unpublish</small></a>&nbsp;|&nbsp;
