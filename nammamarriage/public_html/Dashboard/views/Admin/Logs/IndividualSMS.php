<?php $page="IndividualSMSLog";?>
<?php include_once("settings_header.php");?>
<div class="col-sm-10 rightwidget">   
    <form method="post" action="#" onsubmit="">
        <div class="card-body">
            <div class="form-group row">
                <div class="col-sm-3"><h4 class="card-title" style="margin-bottom: 0px;margin-top: 0px;">Individual SMS</h4></div>
            </div>
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <?php foreach($response['data'] as $SMS ) { ?>
                            ...
                            <td style="text-align:right">
                                <a href="<?php echo GetUrl("Logs/ViewIndividualSMS/". $SMS['ManualSendID'].".htm"); ?>"><span>View</span></a></td>
                            </tr>
                    <?php } ?>            
                    </tbody>                        
                </table>
