                    ...
                    <table id="myTable" class="table table-striped">
                      ...
                      <?php 
                        ...
                        <?php foreach($response['data'] as $New) { ?>
                                ...
                                <td style="text-align:right"><a href="<?php echo GetUrl("Franchisees/News/Edit/". $New['NewsID'].".htm");?>"><span>Edit</span></a>&nbsp;&nbsp;&nbsp;
                                <a href="<?php echo GetUrl("Franchisees/News/View/". $New['NewsID'].".htm");?>"><span>View</span></a></td>
                                </tr>
                        <?php } ?>            
                      </tbody>           
                    </table>
