...
<?php if (isset($_POST['MemberDetails'])) {
?>
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <?php foreach($Members as $Member) { ?>
                        <tr>
                            ...
                            <td style="text-align:right"><a href="<?php echo GetUrl("Franchisees/ResetPassword/Reset/". $Member['MemberID'].".html");?>"><span>Reset Password</span></a></td>
                        </tr>
                    <?php } ?>            
                    </tbody>                        
                </table>
