...
<?php
    $response = $webservice->getData("Admin","GetExpiredLandingPageProfiles",(array("Gender"=>"Male")));
            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8" style="text-align:right;padding-top:5px;color:skyblue;">
                        <a href="ListOfLandingPageProfiles" ><small style="font-weight:bold;text-decoration:underline">All</small></a>&nbsp;|&nbsp;
                        <a href="ActiveLandingPageProfiles"><small style="font-weight:bold;text-decoration:underline">Active</small></a>&nbsp;|&nbsp;
                        <a href="ExpiredLandingPageProfiles"><small style="font-weight:bold;text-decoration:underline">Expired</small></a>
                    </div>
                </div>                          
