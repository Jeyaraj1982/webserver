...
<?php
     $response = $webservice->getData("Admin","GetViewAbusedProfilesDetails");
...
?>
        ...
        <form method="post" onsubmit="">
            <div class="card">
                ...
                <div class="col-sm-6">
                     <h4 class="card-title">Profile Abused Profiles</h4>
                </div>
            </div>
                          <?php
                          $P =$response['data'][0];
                ...
                <div class="form-group row">
                    ...
                    <div style="line-height: 25px;color: #867c7c;font-size:14px;">Abuse Counts : <?php echo $P['AbuseCount'];?>
                    </div>    
                    </div>
                    <div class="col-sm-9">
                        ...
                        <br>
                       <?php
                            foreach($response['data'][0]['AbusedDetails'] as $P)  {  ?>
                         <div style="width:100%;background:white;padding:20px" class="box-shaddow">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Report By ID</label>
                                <label class="col-sm-10 col-form-label" style="color:#737373;"><?php echo $P['ReportByCode'];?></label>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Report Reseon</label>
                                <label class="col-sm-10 col-form-label" style="color:#737373;"><?php echo $P['ReportReason'];?></label>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Report On</label>
                                <label class="col-sm-10 col-form-label" style="color:#737373;"><?php echo putDateTime($P['ReportOn']);?></label>
                            </div>
                        </div>
                        <?php } ?>
                        <br>
