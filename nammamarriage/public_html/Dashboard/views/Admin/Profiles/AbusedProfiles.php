...
<?php
     $response = $webservice->getData("Admin","GetAbusedProfilesDetails");
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div style="line-height: 25px;color: #867c7c;font-size:14px;">Abuse Counts : <?php echo $P['AbuseCount'];?><br>
                        <a href="<?php echo GetUrl("Profiles/ViewAbusedDetails/". $P['AbuseProfile']['ProfileCode'].".htm");?>">View</a>
                    </div>    
                    </div>
                    <div class="col-sm-9">
