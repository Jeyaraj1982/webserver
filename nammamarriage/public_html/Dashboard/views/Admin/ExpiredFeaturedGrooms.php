...
<?php
    $response = $webservice->getData("Admin","GetFeatuerdGrooms",array("Request"=>"Expired"));
            ...
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8" style="text-align:right;padding-top:5px;color:skyblue;">
                        ...
                        <a href="UnPublishFeaturedGrooms"><small>Active</small></a>&nbsp;|&nbsp;
                        <a href="ExpiredFeaturedGrooms"><small style="font-weight:bold;text-decoration:underline">Expired</small></a>
                    </div>
                </div>                          
