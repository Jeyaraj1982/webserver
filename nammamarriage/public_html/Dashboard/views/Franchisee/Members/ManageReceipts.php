<form method="post" action="#" onsubmit="">      
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <?php 
            $response = $webservice->getData("Franchisee","GetMemberOrderInvoiceReceiptDetails",array("Request"=>"Receipt"));
        ...
        <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="<?php echo GetUrl("Members/ViewReceipts/". $Receipt['ReceiptNumber'].".htm");?>">View</a></td>
                </tr>
            <?php } ?>            
            </tbody>                        
        </table>
