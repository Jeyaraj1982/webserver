<?php 
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="form-group row">
            <div class="col-sm-6"><a href="<?php echo GetUrl("Members/ManageReceipts");?>">List Of Receipts</a></div>
            <div class="col-sm-6" style="text-align:right">
                <a href="<?php echo GetUrl("FranchiseeReceipt/".$_GET['Code'].".htm");?>" data-toggle="tooltip" title="Print profile information" target="_blank"><i class="menu-icon mdi mdi-printer" style="font-size: 15px;color: purple;"></i><label style="background:none;cursor:pointer">Print</label></a> 
                <a href="<?php echo GetUrl("DownloadFranchiseeReceipt/".$_GET['Code'].".pdf");?>" data-toggle="tooltip" title="Download profile information" target="_blank"><i class="menu-icon mdi mdi-download" style="font-size: 15px;color: purple;"></i><label style="background:none;cursor:pointer">Download</label></a>   
            </div>
        </div>
        </div>
    </div>
