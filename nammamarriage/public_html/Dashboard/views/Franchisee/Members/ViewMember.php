...
<div class="col-sm-3">
           ...
           <div class="col-sm-12 col-form-label">
            ...
            <div class="col-sm-12 col-form-label">
                <?php  if($Member['IsActive']==1 && $Member['IsDeleted']==0 ) {    ?>
                    <?php if($Member['IsActive']==0) {  ?>
                            <a href="javascript:void(0)" onclick="Member.ConfirmActiveMemberRequest()"><small style="font-weight:bold;text-decoration:underline">Active Member</small></a>
        ...
        <div class="card-body">
                        ...
                        <div class="Col-sm-12" id="resdiv" style="width: 100%;">    
                         ...
                         <div style="display:none">
                            <div class="WalletRequests" id="WalletRequestsdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                ...
                                <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"WalletRequests","MCode"=>$Member['MemberCode'])); 
                                ?>
                            ...
                            <div class="WalletTransactions" id="WalletTransactionsdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>Wallet Transactions</h4>
                                  <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"WalletTransactions","MCode"=>$Member['MemberCode'])); 
                                ?>
                                    <?php if (sizeof($response['data'])>0) {   ?>
                                        <div class="table-responsive">
                                        <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
                            ...
                            <div class="Orders" id="Ordersdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>Orders</h4>
                                <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"Order","MCode"=>$Member['MemberCode'])); ?>
                                 <?php if (sizeof($response['data'])>0) {   ?>
                                    <div class="table-responsive">
                                    <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
                                        <thead>  
            ...
            No orders found at this time<br><br>
                            ...
                            <div class="Invoice" id="Invoicediv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                         <h4>Invoice</h4>
                                         <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"Invoice","MCode"=>$Member['MemberCode'])); ?>
                                         <?php if (sizeof($response['data'])>0) {   ?>
                                    <div class="table-responsive">
                                    <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
                                        <thead>  
                            ...
                            <div class="RecentlyViewed" id="RecentlyVieweddiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>Recently Viewed</h4>
                                   <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"Recentlyviewed","MCode"=>$Member['MemberCode'])); ?>
                                    <?php if (sizeof($response['data'])>0) {   ?>
                                      <?php foreach($response['data']as $P) { 
                                            $Profile = $P['ProfileInfo'];
                                            ?>
                            ...
                            <div class="LoginLogs" id="LoginLogsdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>Login Logs</h4>
                                       <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"LoginLogs","MCode"=>$Member['MemberCode'])); 
                                ?>
                                    <?php if (sizeof($response['data'])>0) {   ?>
                                        <div class="table-responsive">
                                        <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
                            ...
                            <div class="Activities" id="Activitiesdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>Activities</h4>
                                  <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"Activities","MCode"=>$Member['MemberCode'])); 
                                ?>
                                    <?php if (sizeof($response['data'])>0) {   ?>
                                        <div class="table-responsive">
                                        <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
                            ...
                            <div class="EmailLog" id="EmailLogdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>Email Log</h4>
                                  <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"EmailLog","MCode"=>$Member['MemberCode'])); 
                                ?>
                                    <?php if (sizeof($response['data'])>0) {   ?>
                                        <div class="table-responsive">
                                        <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
                            ...
                            <div class="SMSLog" id="SMSLogdiv" style="padding:40px;padding-bottom:100px;text-align:center;color:#aaa">
                                <h4>SMS Log</h4>
                                  <?php $response = $webservice->getData("Franchisee","GetMemberWalletAndProfileDetails",array("DetailFor"=>"SMSLog","MCode"=>$Member['MemberCode'])); 
                                ?>
                                    <?php if (sizeof($response['data'])>0) {   ?>
                                        <div class="table-responsive">
                                        <table id="myTable" class="table table-striped" style="width:100%;border-bottom:1px solid #ccc;">
