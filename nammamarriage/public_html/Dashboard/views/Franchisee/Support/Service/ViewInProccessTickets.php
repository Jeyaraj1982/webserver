<?php 
	...
	$response    = $webservice->getData("Franchisee","GetSupportTicketsDetails",array("Request"=>"InProccess"));
	...
	<div class="card">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6"><img src="<?php echo AppUrl;?>uploads/ServiceRequest/<?php echo $Ticket[0]['RequestByCode'];?>/Ticket/<?php echo $Ticket[0]['FileName'];?>" style="height:120px;"></div>
			</div>
			<div class="form-group row">
