...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="col-sm-12 col-form-label">
            <a href="<?php echo GetUrl("WhoFavorited/".$_GET['Code'].".htm");?>"><small style="font-weight:bold;text-decoration:underline">Who Liked (<?php echo $response['data']['WhoFavoritedCount'];?>)</small></a>
        </div>
        <div class="col-sm-12 col-form-label">
