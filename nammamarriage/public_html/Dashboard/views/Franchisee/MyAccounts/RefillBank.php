...
?>
    ...
    <div class="col-sm-9" style="margin-top: -8px;">  
        ...
        <span style="color:#999;">It's is safe transaction and gives refill amount.</span>
        <?php 
             $verification_info  = $webservice->getData("Franchisee","GetFranchiseeInfo");
             $MobileVerification=$verification_info['data']['IsMobileVerified'];
             $EmailVerification=$verification_info['data']['IsEmailVerified'];
       ...
       <?php if($EmailVerification==0) { ?>
        ...
        <?php// }   ?>
        <?php if($EmailVerification==1 && $MobileVerification==1) { ?>
