<?php
    ...
    $spage="RefillWallet";
    $sp="Bank";
    $response = $webservice->getData("Franchisee","GetListOfPreviousBankRequests",array("Request"=>"Reject"));
?>
    ...
    <div class="col-sm-9" style="margin-top: -8px;">
        <div class="form-group row">
            ...
            <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                ...
                <a href="RejectBankRequests"><small style="font-weight:bold;text-decoration:underline">Reject</small></a>
            </div>
        </div>
