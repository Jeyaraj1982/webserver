        ...
        <div class="card">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                    ...
                    <a href="SuccessWalletRequests"><small style="font-weight:bold;text-decoration:underline">Success</small></a>&nbsp;|&nbsp;
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                     ...
                     <tbody>  
                        <?php $response = $webservice->getData("Franchisee","GetListOfPreviousBankRequests",array("Request"=>"Success"));?>
