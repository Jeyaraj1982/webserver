<?php
    ...
    $spage="RefillWallet";
    $sp="Bank";
    $response = $webservice->getData("Franchisee","GetListOfPreviousBankRequests",array("Request"=>"Pending"));
?>
    ...
    <div class="col-sm-9" style="margin-top: -8px;">
        <div class="form-group row">
            ...
            <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                ...
                <a href="PendingBankRequests"><small style="font-weight:bold;text-decoration:underline">Pending</small></a>&nbsp;|&nbsp;
