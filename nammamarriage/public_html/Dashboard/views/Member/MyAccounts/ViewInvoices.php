        ...
        <div style="width:770px;border:1px solid #737373;padding: 10px 20px;">
                                ...
                                <div class="form-group row">                                                                                                                                                                                             
                                        ...
                                        <div class="col-sm-6 col-form-label" style="text-align: right">
                                            <a href="<?php echo GetUrl("Invoice/".$Invoice['InvoiceNumber'].".htm");?>" data-toggle="tooltip" title="Print Order information" target="_blank"><i class="menu-icon mdi mdi-printer" style="font-size: 15px;color: purple;"></i><label style="background:none;cursor:pointer">Print</label></a> &nbsp;&nbsp;
                                            <a href="<?php echo GetUrl("DownloadInvoice/".$Invoice['InvoiceNumber'].".pdf");?>"><i class="menu-icon mdi mdi-download" style="font-size: 15px;color: purple;"></i><label style="background:none;cursor:pointer">Download</label></a> </div>                       
                                    </div>
