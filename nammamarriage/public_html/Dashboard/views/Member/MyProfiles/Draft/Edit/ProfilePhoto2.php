...
<script src="<?php echo SiteUrl?>assets/jcrop/jquery.Jcrop.min.js"></script> 
<?php                     
    $page="ProfilePhoto";       
    ...
    <?php
                if (isset($_POST['UpdateProfilePhoto'])) {
                    ...
                    if ($err==0) {
                        ?>
                             <div>
    <img src="<?php echo AppUrl;?>uploads/<?php echo $profilephoto; ?>" id="cropbox" class="img" /><br />
</div>
<div id="btn">
...
:!0,fixedSupport:!0,touchSupport:null,shade:null,boxWidth:0,boxHeight:0,boundary:2,fadeTime:400,animationDelay:20,swingSpeed:3,minSelect:[0,0],maxSize:[0,0],minSize:[0,0],onChange:function(){},onSelect:function(){},onDblClick:function(){},onRelease:function(){}}})(jQuery);
   ...
   jcrop_api =  jQuery('#cropbox').Jcrop({
        aspectRatio: 1,
