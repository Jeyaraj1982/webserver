    ...
    if(submitexpectation()) {
      ...
      var content = '<div class="modal-header">'
                    ...
                    + '<div class="modal-footer">'
                        ...
                        + '<button type="button" class="btn btn-primary" name="Update" class="btn btn-primary" onclick="EditDraftPartnersExpectation()" style="font-family:roboto">Update</button>'
                    + '</div>';
...
function EditDraftPartnersExpectation() {
    ...
    $('#Publish_body').html(preloading_withText("Updating partners expectation ...","95"));
        ...
        $.post(API_URL + "m=Member&a=AddPartnersExpectaion",param,function(result) {
