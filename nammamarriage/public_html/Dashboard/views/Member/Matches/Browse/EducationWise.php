    ...
    <div class="card" style="padding:15px;">
        <div class="card-body" style="padding-top:80px;padding-bottom:80px;text-align:center;color:#aaa">
            <?php if($response['data']['param']=="mobile") {?>
                ...
                <?php echo $response['message'];?><br><br><a href="javascript:void(0)" onclick="MobileNumberVerification()"  style="font-weight:Bold;font-family:'Roboto';">Verifynow</a>
            <?php }?>
            <?php if($response['data']['param']=="email") {?>
                <img src="<?php echo ImageUrl;?>email_address_not_verified.png"><br><br><br>
                <?php echo $response['message'];?><br><br><a href="javascript:void(0)" onclick="EmailVerification()"  style="font-weight:Bold;font-family:'Roboto';">Verifynow</a>
            <?php }?>
        ...
        <div style="margin:25px;margin-top:5px;padding:0px !important">
            <div class="card" style="padding:15px;">
                <div class="card-body" style="padding:80px;text-align:center;color:#aaa">
                    ...
                    No profiles found, for matched your education<br><Br><br><Br><br><Br>
                    <br>
                </div>
            </div>
        </div>       
