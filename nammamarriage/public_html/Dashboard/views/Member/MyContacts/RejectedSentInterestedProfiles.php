<?php 
    $page="RejectedSentInterestedProfiles";
    include_once("SentInterest_top_menu.php");
    $response = $webservice->getData("Member","GetRejectedSentInterestedProfiles");
?>
    ...
    <?php } else { ?>
        <div style="margin:25px;margin-top:5px;padding:0px !important">
            <div class="card" style="padding:15px;">
                ...
                No recently rejected interested profiles found at this time<br><br>
                    <br>
                </div>
            </div>
        </div>       
