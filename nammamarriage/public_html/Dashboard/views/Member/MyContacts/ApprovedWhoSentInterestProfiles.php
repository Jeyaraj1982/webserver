<?php 
    $page="ApprovedWhoSentInterestProfiles";
    include_once("WhoSentInterest_top_menu.php");
    $response = $webservice->getData("Member","GetApprovedWhoSentInterestMyProfiles");
?>
    ...
    <?php } else { ?>
        <div style="margin:25px;margin-top:5px;padding:0px !important">
            <div class="card" style="padding:15px;">
                ...
                No recently Approved profiles found at this time<br><br>
                    <br>
                </div>
            </div>
        </div>       
