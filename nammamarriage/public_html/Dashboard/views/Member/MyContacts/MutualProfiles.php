<div class="col-12 grid-margin" style="padding:0px !important">
    <div class="card">
        <div class="card-body" style="padding:15px !important">
            <h4 class="card-title" style="font-size: 22px;margin-top:0px;margin-bottom:15px">Mutual Profiles</h4>
...
<?php
    $response = $webservice->getData("Member","GetMutualProfiles");
   // print_r($response);
    ...
    <div class="col-lg-12 grid-margin stretch-card bshadow" style="background:#fff;padding:90px;">
        <div class="card">
            <div class="card-body" style="text-align:center;font-family:'Roboto'">
                ...
                No mutual profiles found at this time<br><br>
            </div>
        </div>
    </div>
<?php } ?>
