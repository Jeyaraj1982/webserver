...
if (isset($_POST['BtnSubmit'])) {
          ...
          if (!(strlen(trim($_POST['Name']))>0)) {
             ...
             if (!(strlen(trim($_POST['EmailID']))>0)) {
              ...
              $dataA = $mysql->select("select * from `_tbl_Agents` where `MobileNumber`='".$_POST['MobileNumber']."' and AgentCode<>'".$sql[0]['AgentCode']."'");
             if (sizeof($dataA)>0) {
                 $ErrMobileNumber = "Mobile Number Already Exists";
                 $Error++;
             }  
            $dataA = $mysql->select("select * from `_tbl_Agents` where `EmailID`='".$_POST['EmailID']."' and AgentCode<>'".$sql[0]['AgentCode']."'");
             if (sizeof($dataA)>0) {
             ...
             if($Error==0){
               ...
               //`DateofBirth`      ='".$dob."',
                   $id = $mysql->execute("update `_tbl_Agents` set `AgentName`        ='".$_POST['Name']."',                          
                            ...
                            <div class="card">
                                ...
                                <div class="card-body"> 
                                        <div class="form-group form-show-validation row">
                                            <label for="Name" class="col-sm-3" style="font-weight:normal">Agnet Code <span class="required-label">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" disabled="disabled" value="<?php echo $sql[0]['AgentCode'];?>" Placeholder="Agent Code">
                                            </div>
                                        </div>
                                        <div class="form-group form-show-validation row">
                                            <label for="Name" class="col-sm-3" style="font-weight:normal">Agnet Name <span class="required-label">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="Name" name="Name" value="<?php echo (isset($_POST['Name']) ? $_POST['Name'] :$sql[0]['AgentName']);?>" Placeholder="Agent Name">
                                        ...
                                        <div class="form-group form-show-validation row">
                                         ...
                                         <div class="form-group form-show-validation row">
                                            <label for="CityName" class="col-sm-3 text-left" style="font-weight:normal">Pin code <span class="required-label">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="Pincode" name="Pincode" value="<?php echo (isset($_POST['Pincode']) ? $_POST['Pincode'] :$sql[0]['Pincode']);?>" Placeholder="Pin Code">
                                         ...
                                         <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="GSTNumber" name="GSTNumber" value="<?php echo (isset($_POST['GSTNumber']) ? $_POST['GSTNumber'] :$sql[0]['GSTNumber']);?>" Placeholder="GST Number">
                                                <span class="errorstring" id="ErrGSTNumber"><?php echo isset($ErrGSTNumber)? $ErrGSTNumber : "";?></span>
                                            </div>
                                        </div>
                                        <div class="form-group form-show-validation row">
