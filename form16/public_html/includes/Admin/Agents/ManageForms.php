 <?php 
                                                if( $_GET['Status']=="All"){
                                                    $sql= $mysql->select("select * from `_tbl_form_16` where AgentID='".$_GET['ACode']."'");
                                                }
                                                if( $_GET['Status']=="Submitted"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where InProccess='0' and AgentID='".$_GET['ACode']."'"); 
                                                }
                                                if( $_GET['Status']=="Accepted"){
                                                     $sql= $mysql->select("select * from `_tbl_form_16` where InProccess='1' and AgentID='".$_GET['ACode']."'");
                                                }
                                                if( $_GET['Status']=="InProccessed"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where IsApproved='1' and Completed='0' and AgentID='".$_GET['ACode']."'");  
                                                }
                                                if( $_GET['Status']=="Completed"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where Completed='1' and AgentID='".$_GET['ACode']."'");  
                                                }
                                                if( $_GET['Status']=="Rejected"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where IsRejected='1' and Completed='0' and AgentID='".$_GET['ACode']."'");  
                                                }
                                            ?>
            ...
            <div class="container">
                <div class="page-inner">
                        <div class="form-group row">
                            <div class="col-sm-6"><h4 class="page-title">Form 16</h4></div>
                            <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                                <a href="dashboard.php?action=Agents/ManageForms&Status=All&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="All") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>All</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Agents/ManageForms&Status=Submitted&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Submitted") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Submitted</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Agents/ManageForms&Status=Accepted&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Accepted") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Accepted</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Agents/ManageForms&Status=InProccessed&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="InProccessed") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>InProcess</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Agents/ManageForms&Status=Completed&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Completed") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Completed</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Agents/ManageForms&Status=Rejected&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Rejected") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Rejected</small></a>
                            </div> 
                        </div>
                                    ...
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($form16['InProccess']==0){  echo "Sumbitted"; } ?>
