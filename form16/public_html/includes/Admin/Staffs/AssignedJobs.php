                ...
                <div class="page-inner">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6" style="text-align:right;padding-top:5px;color:skyblue;">
                                <a href="dashboard.php?action=Staffs/AssignedJobs&Status=All&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="All") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>All</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Staffs/AssignedJobs&Status=Submitted&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Submitted") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Submitted</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Staffs/AssignedJobs&Status=Accepted&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Accepted") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Accepted</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Staffs/AssignedJobs&Status=InProccessed&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="InProccessed") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>InProcess</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Staffs/AssignedJobs&Status=Completed&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Completed") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Completed</small></a>&nbsp;|&nbsp;
                                <a href="dashboard.php?action=Staffs/AssignedJobs&Status=Rejected&ACode=<?php echo $_GET['ACode'];?>"><?php if($_GET['Status']=="Rejected") { ?><small style="font-weight:bold;text-decoration:underline;"><?php } else{ ?><small><?php } ?>Rejected</small></a>
                            </div> 
                        </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                            $form = $mysql->select("select * from _tbl_AssignedForms where StaffCode='".$_GET['ACode']."'");
