<?php 
    ...
    $Member = $mysql->select("select * from _tbl_Members where MemberID='".$_GET['Code']."'");
    if (isset($_POST['BtnSubmit'])) {
        ...
        $dataA = $mysql->select("select * from `_tbl_form_16` where `FinancialYear`='".$_POST['FinancialYear']."' and `FormByCode`='".$Member[0]['MemberCode']."'");
        if (sizeof($dataA)>0) {
            ...
            if ($err==0) {
                ...
                if ($id>0) {
                    ...
                    $mysql->insert("_tbl_formlogs",array("ActionPerformed"    => date("Y-m-d H:i:s"),
                                                         "FormID"             => $id,
                                                         "CustomerID"         => '0',
                                                         "ActionTitle"        => 'Form 16 Submitted by Admin',
                                                         "ActionDescription"  => '0',
                    ...
                    //Agent SMS
                    MobileSMS::sendSMS($_SESSION['User']['MobileNumber'],SMSTemplate::submitTemplete("Admin",$id,$Member[0]['MemberName']),$_SESSION['User']['AgentID']);
                                ...
                                <div class="card-body"> 
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5 text-left">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="datepicker"  placeholder="Date of Birth" name="dateofbirth" value="<?php echo (isset($_POST['dateofbirth'])) ? $_POST['dateofbirth'] : "";?>">
                        ...
                        <div class="col-md-12"> 
                                    <div class="card-action">
                                        <div class="row">
                                            ...
                                            <a href="dashboard.php?action=ManageForm16&Status=All" class="btn btn-outline-primary">Cancel</a>
