            ...
            $dataA = $mysql->select("select * from `_tbl_Members` where `EmailID`='".$_POST['EmailID']."'");
             ...
             if($Error==0){
                 ...
                 $id = $mysql->insert("_tbl_Members",array("MemberName"     => $_POST['Name'],
                      ...
                      if (sizeof($id)>0) {  ?>
                     <script>location.href='dashboard.php?action=CreateForm16&Code=<?php echo $id;?>';</script>
               <?php  }
                    }                                                                                                                     
             }
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">        
                                        ...
                                        <div class="form-group form-show-validation row">
                                            <label for="MemebrPassword" class="col-sm-3 text-left" style="font-weight:normal">Member Password <span class="required-label">*</span></label>
                                            <div class="col-sm-4">
                                                <div class="input-group">
