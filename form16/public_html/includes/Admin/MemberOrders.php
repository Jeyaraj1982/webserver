<?php 
    if( $_GET['Status']=="All"){
        $sql= $mysql->select("select * from `_tbl_orders` where `MemberCode`='".$_GET['MCode']."' order by `OrderID` desc ");
        $title="Orders";
    }
?>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <?php  foreach($sql as $order){ ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($order['OrderValue'],2);?></td>
                                            <td>
                                                <div class="dropdown dropdown-kanban" style="float: right;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="dashboard.php?action=Accounts/ViewOrder&Code=<?php echo $order['OrderNumber'];?>" draggable="false">View</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
