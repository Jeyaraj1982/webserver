<?php 
    ...
    if (isset($_POST['BtnSubmit'])) {
        ...
        $data = $mysql->select("select * from `_tbl_form_16` where `FinancialYearID`='".$_POST['FinYear']."' and `FormByCode`='".$_SESSION['User']['MemberCode']."'");
        if (sizeof($data)>0) {
        ...
        if($Error==0) {
            ...
            $target_dir = "uploads/Form16/".$_SESSION['User']['MemberCode']."/";
            ...
            if ($err==0) {
                ...
                $orderNumber = SeqMaster::GetNextOrderCode();
                ...
                $id = $mysql->insert("_tbl_form_16",array("FinancialYearID"  => $_POST['FinYear'],                          
                                                          ...
                                                          "FormFor"          => trim($_POST['FormFor']), 
                                                          "FormForName"      => trim($_POST['FormForName']), 
                                                          "FormBy"           => $_SESSION['User']['MemberName'], 
                                                          "Remarks"          => trim($_POST['Remarks']), 
                                                          "FormByID"         => $_SESSION['User']['MemberID'], 
                                                          "FormByCode"       => $_SESSION['User']['MemberCode'], 
                                                          "zip_file"         => $zip_file, 
                ...
                $orderid =  $mysql->insert("_tbl_orders",array("OrderDate"=>date("Y-m-d H:i:s"),
                                                               ...
                                                               "MemberMobileNumber"=>$_SESSION['User']['MobileNumber'],
                                                               "MemeberEmail"=>$_SESSION['User']['EmailID'],
                                                               "MemberAddressLine1"=>$_SESSION['User']['AddressLine1'],
                                                               "MemberAddressLine2"=>$_SESSION['User']['AddressLine2'],
                                                               "razorpay_orderid"=>"",
                                                               "OrderValue"=>$OrderValue,
                                                               "FormID"=>$id));
                  $orderitemid =  $mysql->insert("_tbl_orders_items",array("OrderID"=>$orderid,
                                                               "Particulars"=>"Submit Form16 ".$Finance[0]['FinancialYear'],
                                                               "Qty"=>"1",
                                                               "Amount"=>$OrderValue,
                                                               "SubAmount"=>$OrderValue));
                if ($id>0) {                                                            
                    ...
                    $mysql->insert("_tbl_formlogs",array("ActionPerformed"    => date("Y-m-d H:i:s"),
                                                         "FormID"             => $id,
                                                         "CustomerID"         => '0',
                                                         "ActionTitle"        => 'Form 16 Submitted by member',
                                                         "ActionDescription"  => '0',
                                                         "MemberID"           => $_SESSION['User']['MemberID'],
                                                         "UserRemarks"        => "",
                                                         "AdminRemarks"       => "",
                    ...
                    MobileSMS::sendSMS($_POST['MobileNumber'],SMSTemplate::submitTemplete("Member",$id,$_SESSION['User']['MemberName']),$_SESSION['User']['MemberID']);
                    $mparam['MailTo']=$_POST['EmailID'];
                    $mparam['MemberID']=$id;
                    $mparam['Subject']="Form16 Created";
                    $mparam['Message']=$message;
                    MailController::Send($mparam,$mailError);
                    echo "<script>location.href='dashboard.php?action=Form16Created&req=".md5($id.$orderNumber)."';</script>";
                    exit;
                } else {
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                            ...
                                            <div class="col-sm-5 text-left">       
                                                ...
                                                <?php $FinancialYears = $mysql->select("select * from _tblFinancialYears");?>                          
                                                     <?php foreach($FinancialYears as $FinancialYear) { 
                                                         $t = $mysql->select("SELECT FinancialYearID FROM _tbl_form_16 WHERE FinancialYearID='".$FinancialYear['FinancialYearID']."' and FormByID='".$_SESSION['User']['MemberID']."'");
                                                         $disabled = (sizeof($t)==0) ? "" : "disabled";
                                                     ?>
                                                     <option <?php echo $disabled;?> value="<?php echo $FinancialYear['FinancialYearID'];?>" assyear="<?php echo $FinancialYear['AssesmentYear'];?>" <?php echo ($_POST['FinYear']==$FinancialYear['FinancialYearID']) ? " selected='selected' " : "";?>><?php echo $FinancialYear['FinancialYear'];?> <?php echo ($disabled!="") ? " (already submitted) " : "";?></option>
                                                     <?php } ?>
                                                </select>
                                        ...
                                        <div class="form-group form-show-validation row">                                                                                                                                                         
                                            ...
                                            <div class="col-sm-5 text-left">
                                                <input type="text" readonly="readonly" class="form-control" name="assyearval" value="<?php echo isset($_POST['assyearval']) ? $_POST['assyearval'] : "";?>" id="assyearval">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body"> 
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-2 text-left">
                                                <select id="FormFor" name="FormFor" class="form-control">
                                            ...
                                            <div class="col-sm-3 text-left" style="font-weight:normal;padding-left:0px">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5 text-left">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Date of Birth" id="datepicker" name="dateofbirth" value="<?php echo (isset($_POST['dateofbirth'])) ? $_POST['dateofbirth'] : "";?>">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                     ...
                                                     <input type="text" class="form-control" id="MobileNumber" maxlength="10" name="MobileNumber" value="<?php echo (isset($_POST['MobileNumber']) ? $_POST['MobileNumber'] : $_SESSION['User']['MobileNumber']);?>" Placeholder="Mobile Number">
                                                </div>
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="EmailID" name="EmailID" value="<?php echo (isset($_POST['EmailID']) ? $_POST['EmailID'] : $_SESSION['User']['EmailID']);?>" Placeholder="Email ID">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="AddressLine1" name="AddressLine1" value="<?php echo (isset($_POST['AddressLine1']) ? $_POST['AddressLine1'] : $_SESSION['User']['AddressLine1']);?>" Placeholder="AddressLine1">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="AddressLine2" name="AddressLine2" value="<?php echo (isset($_POST['AddressLine2']) ? $_POST['AddressLine2'] : $_SESSION['User']['AddressLine2']);?>" Placeholder="AddressLine2">
                                            </div>
                                        </div>
                                        <div class="form-group form-show-validation row">
                                            <label for="CityName" class="col-sm-3 text-left" style="font-weight:normal">City Name <span class="required-label">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="CityName" name="CityName" value="<?php echo (isset($_POST['CityName']) ? $_POST['CityName'] : $_SESSION['User']['CityName']);?>" Placeholder="City Name">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="Pincode" name="Pincode" value="<?php echo (isset($_POST['Pincode']) ? $_POST['Pincode'] : $_SESSION['User']['Pincode']);?>" Placeholder="Pincode">
