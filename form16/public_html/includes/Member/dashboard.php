                        ...
                        <div class="d-flex align-items-left flex-column">
                            ...
                            <div class="nav-scroller d-flex">
                                <div class="nav nav-line nav-color-info d-flex align-items-center justify-contents-center">
                                    ...
                                    <?php echo sizeof($mysql->select("select * from `_tbl_form_16` where InProccess='0' and FormByID='".$_SESSION['User']['MemberID']."'"));  ?>
                                    </span></a>
                                    <a class="nav-link" href="dashboard.php?action=ManageForm16&Status=InProccessed">Processing Jobs
                                    <span class="badge badge-warning ml-2">
                                    <?php echo sizeof($mysql->select("select * from `_tbl_form_16` where IsApproved='1' and Completed='0' and FormByID='".$_SESSION['User']['MemberID']."'"));  ?>
                                    </span
                                    </a>
                                    <a class="nav-link" href="dashboard.php?action=ManageForm16&Status=Rejected">Cancelled Jobs<span class="badge badge-danger ml-2">
                                     <?php echo sizeof($mysql->select("select * from `_tbl_form_16` where IsRejected='1' and FormByID='".$_SESSION['User']['MemberID']."'"));  ?>
                                    </span></a>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                                 <?php echo number_format(MemberWalletBalance($_SESSION['User']['MemberID']),2);?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <?php
                                                      ...
                                                      echo sizeof($mysql->select("select * from `_tbl_form_16` where Completed='1' and FormByID='".$_SESSION['User']['MemberID']."'"));
                                                      echo "/";
                                                      echo sizeof($mysql->select("select * from `_tbl_form_16` where FormByID='".$_SESSION['User']['MemberID']."'"));
                                                ?>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                               <?php echo sizeof($mysql->select("select * from _tbl_orders where MemberID='".$_SESSION['User']['MemberID']."'"));?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
