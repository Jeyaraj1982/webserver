<?php 
        $sql= $mysql->select("select * from `_tbl_orders`  where `MemberCode`='".$_SESSION['User']['MemberCode']."' order by `OrderID` desc ");
        $title="Orders";
?>
                                            ...
                                            <td>
                                                <div class="dropdown dropdown-kanban" style="float: right;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="dashboard.php?action=ViewOrder&Code=<?php echo $order['OrderNumber'];?>" draggable="false">View</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
