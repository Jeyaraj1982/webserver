<?php 
        $sql= $mysql->select("select * from `_tbl_payments` where `MemberCode`='".$_SESSION['User']['MemberCode']."' order by `PaymentID` desc ");
        $title="Payments";
?>
                                            ...
                                            <td>
                                                <div class="dropdown dropdown-kanban" style="float: right;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="dashboard.php?action=ViewPayments&Code=<?php echo $order['PaymentID'];?>" draggable="false">View</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
