            ...
            if ($err==0) {
                ...
                if ($id>0) {
                    ...
                    $orderitemid =  $mysql->insert("_tbl_orders_items",array("OrderID"      => $orderid,
                                                                             "Particulars"  => "Submit Form16 ".$Finance[0]['FinancialYear']." for ".$_POST['CustomerName']."/Jobid".$id,
                                                                             "Qty"          => "1",
                                                                             "Amount"       => $OrderValue,
                   ...
                   //Customer ID                                        
                    MobileSMS::sendSMS($_POST['MobileNumber'],SMSTemplate::submitTemplete("Member",$id,$_POST['CustomerMobileNumber']),$Mid);
                    //Agent SMS
                    MobileSMS::sendSMS($_SESSION['User']['MobileNumber'],SMSTemplate::submitTemplete("Agent",$id,$_POST['CustomerName']),$_SESSION['User']['AgentID']);
