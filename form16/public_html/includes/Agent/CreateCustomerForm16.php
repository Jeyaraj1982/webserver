<?php 
    ...
    if (isset($_POST['BtnSubmit'])) {
        ...
        if (sizeof($data)>0) {
         ...
         if (!(AgentWalletBalance($_SESSION['User']['AgentID'])>99)) {
            $ErrorGeneral = "Insufficant fund, Couldn't process. Require Rs. 99/-. Your available balance is ".number_format(AgentWalletBalance($_SESSION['User']['AgentID']),2);
            $Error++;
        }       
            ...
            if ($err==0) {
                ...
                if ($id>0) {
                    ...
                    $orderid =  $mysql->insert("_tbl_orders",array("OrderDate"          => date("Y-m-d H:i:s"),
                                                                   ...
                                                                   "MemberName"         => $_SESSION['User']['AgentName'],
                                                                   ...
                                                                   "razorpay_orderid"   => "",
                                                                   "OrderByAgentID"     => $_SESSION['User']['AgentID'],
                                                                   "OrderValue"         => $OrderValue,
                                                                   "IsPaid"             => '1',
                                                                   "FormID"             => $id));
                                                                   
                    $orderitemid =  $mysql->insert("_tbl_orders_items",array("OrderID"      => $orderid,
                                                                             "Particulars"  => "Submit Form16 ".$Finance[0]['FinancialYear']." for ".$member[0]['MemberName']."/Jobid".$id,
                                                                             "Qty"          => "1",
                                                                             "Amount"       => $OrderValue,
                                                                             "SubAmount"    => $OrderValue)); 
                    
                    $walletID = $mysql->insert("_wallet_agent", array("AgentID"     => $_SESSION['User']['AgentID'],
                                                                      "TxnDate"      => date("Y-m-d H:i:s"),
                                                                      "Particulars"  => "Invoice/".$invoiceNumber." /Odr:".$orderNumber,
                                                                      "ActualAmount" => $OrderValue,
                                                                      "CreditAmount" => "0",
                                                                      "DebitAmount"  => $OrderValue,
                                                                      "Balance"      => AgentWalletBalance($_SESSION['User']['AgentID'])-$OrderValue,
                                                                      "Ledger"       => "4"));
                                                                                   
                    $invoiceNumber = SeqMaster::GetNextInvoice();
                    $invoiceID =  $mysql->insert("_tbl_invoices",array("OrderID"       => $orderid,
                                                                       "OrderNumber"   => $orderNumber,
                                                                       ...
                                                                       "InvoiceValue"  => $OrderValue,
                                                                       "FormID"        => $id,
                                                                       "PaymentMode"   => "Wallet",
                                                                       "WalletID"      => $walletID));
                    $orderitems = $mysql->select("select * from _tbl_orders_items where OrderID='".$orderid."'");
                    ...
                    $mysql->execute("update _tbl_form_16 set IsPaid='1',InvoiceNumber='".$invoiceNumber."' where  id='".$id."'");
                    ...
                    $mysql->insert("_tbl_formlogs",array("ActionPerformed"    => date("Y-m-d H:i:s"),
                                                         "FormID"             => $id,
                                                         "CustomerID"         => '0',
                                                         "ActionTitle"        => 'Form 16 Submitted by Agent',
                                                         "ActionDescription"  => '0',
                                                         "MemberID"           => $member[0]['MemberID'],
                                                         "UserRemarks"        => "",
                                                         "AdminRemarks"       => "",
                    ...
                    //Agent SMS
                    MobileSMS::sendSMS($_SESSION['User']['MobileNumber'],SMSTemplate::submitTemplete("Agent",$id,$member[0]['MemberName']),$_SESSION['User']['AgentID']);
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="dropdown dropdown-kanban" style="float: right;">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="dashboard.php?action=ViewMember&MCode=<?php echo $member[0]['MemberCode'];?>" draggable="false">View Customer</a>
                                            <a class="dropdown-item" href="dashboard.php?action=ManageForm16ByAgent&MCode=<?php echo $member[0]['MemberCode'];?>&Status=All" draggable="false">View All Forms</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <?php if (isset($ErrorGeneral) && strlen($ErrorGeneral)>0) {?>
                                        <div class="form-group form-show-validation row">                                                                                                                                                         
                                            <span class="errorstring" ><?php echo $ErrorGeneral;?></span>
                                        </div> 
                                        <?php } ?>
                                        <div class="form-group form-show-validation row">                                                                                                                                                         
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">        
                                        ...
                                        <div class="form-group form-show-validation row">
                                            <label for="AccountName" class="col-sm-3 text-left" style="font-weight:normal">IFSCode <span class="required-label">*</span></label>
                                            <div class="col-sm-4">
                        ...
                        <div class="col-md-12"> 
                                    <div class="card-action">
                                        <div class="row">
                                            ...
                                            <a href="dashboard.php?action=ManageForm16&Status=All" class="btn btn-outline-danger">Cancel</a>
