                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                                if( $_GET['Status']=="All"){
                                                    $sql= $mysql->select("select * from `_tbl_form_16` where StaffID='".$_SESSION['User']['AdminID']."'");
                                                }
                                                if( $_GET['Status']=="Submitted"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where InProccess='0' and StaffID='".$_SESSION['User']['AdminID']."'"); 
                                                }
                                                if( $_GET['Status']=="Accepted"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where InProccess='1' and StaffID='".$_SESSION['User']['AdminID']."'");  
                                                }
                                                if( $_GET['Status']=="InProccessed"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where IsApproved='1' and Completed='0' and StaffID='".$_SESSION['User']['AdminID']."'");  
                                                }
                                                if( $_GET['Status']=="Completed"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where Completed='1' and StaffID='".$_SESSION['User']['AdminID']."'");  
                                                }
                                                if( $_GET['Status']=="Rejected"){
                                                   $sql= $mysql->select("select * from `_tbl_form_16` where IsRejected='1' and StaffID='".$_SESSION['User']['AdminID']."'");  
                                                }
                                            ?>
                                            <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($form16['IsRejected']==1){ echo "Rejected"; } ?>
                                                </td>
                                                <td>
                                                    ...
                                                    <?php if($form16['IsRejected']==1){ echo $form16['VerifiedOn']; } ?>
                                                </td>
                                                <td>
                                                <div class="dropdown dropdown-kanban" style="float: right;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item" href="dashboard.php?action=ViewMember&MCode=<?php echo $form16['FormByCode'];?>" draggable="false">View Member Info</a>
                                                    </div>
                                                </div>
                                            </td>
                                            </tr>
