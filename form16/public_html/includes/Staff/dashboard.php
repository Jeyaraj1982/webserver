                        ...
                        <div class="d-flex align-items-left flex-column">                                           
                            ...
                            <div class="nav-scroller d-flex">
                                <div class="nav nav-line nav-color-info d-flex align-items-center justify-contents-center">
                                    ...
                                    <?php echo sizeof($mysql->select("select * from `_tbl_form_16` where `StaffID`='".$_SESSION['User']['AdminID']."' and InProccess='0'"));  ?>
                                    </span></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                                <?php
                                                   echo sizeof($mysql->select("select MemberID from _tbl_Members where StaffID='".$_SESSION['User']['AdminID']."'"));
                                                ?>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <?php
                                                      ...
                                                      echo sizeof($mysql->select("select id from _tbl_form_16 where Completed='1' and StaffID='".$_SESSION['User']['AdminID']."'"));
                                                      echo "/";
                                                      echo sizeof($mysql->select("select * from _tbl_form_16 where StaffID='".$_SESSION['User']['AdminID']."'"));
                                                ?>
                                                </h4>
                                            </div>
                                        </div>
...
<script>
<?php
    $tjob = $mysql->select("select * from _tbl_form_16 where StaffID='".$_SESSION['User']['AdminID']."'");
    $cjob = $mysql->select("select * from _tbl_form_16 where Completed='1' and StaffID='".$_SESSION['User']['AdminID']."'");
    $percentage = 100;
