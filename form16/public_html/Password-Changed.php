                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="themesflat-headings style-1 text-center clearfix">
                                                <img src="assets/tick.jpg" style="height:120px;margin-top:-5px"> 
                                                <h2 class="heading">Your password Saved</h2>
                                            </div>
                                        </div> 
                                    </div> 
                                </div> 
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-4" style="margin:0px auto">                                            
                                            <div class="themesflat-contact-form style-2 w100 clearfix" style="text-align: center;">
                                            
                              
                   
                     
                
                    <a href="login.php"  style="color:orange">Click to continue</a>
