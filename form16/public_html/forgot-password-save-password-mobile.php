...
if (isset($_POST['btnsubmit'])) {
    $data = $mysql->select("Select * from `_tbl_verification_code` where `RequestID`='".$_POST['reqID']."' ");
         ...
         if($err==0){
             ...
             MobileSMS::sendSMS($data[0]['SmsTo'],"Your Your password chnaged Thanks Form16.online");   
		...
		<div class="container container-login animated fadeIn">
            ...
            <input type="hidden"  value="<?php echo $_POST['reqID'];?>" name="reqID">
				...
				<div class="form-group form-floating-label">
					...
					<input  id="Password" placeholder="Password" name="Password" type="password" class="wpcf7-form-control valid" value="<?php echo (isset($_POST['Password']) ? $_POST['Password'] :"");?>">
                    <span class="errorstring" id="ErrPassword"><?php echo isset($ErrPassword)? $ErrPassword : "";?></span>
				</div>
				<div class="form-group form-floating-label">
                    <label for="confirmpassword" class="placeholder">Confirm Password</label>
					<input placeholder="Confrim Password" required  id="confirmpassword" name="confirmpassword" type="password" class="wpcf7-form-control valid"  value="<?php echo (isset($_POST['confirmpassword']) ? $_POST['confirmpassword'] :"");?>">
