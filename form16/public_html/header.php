...
<div class="main-header">
            ...
            <div class="logo-header" data-background-color="dark">
                ...
                <a href="dashboard.php" class="logo" style="color:#fff;text-align:center;line-height:15px;text-align:left;height:30px !important">
                    <span style="font-weight:bold;">Form16.online</span><br>
                        ...
                        <li class="nav-item   hidden-caret">
                           ...
                           <div style="font-size:12px;color:#ccc">
                            <?php
                                ...
                                if ($_SESSION['User']['UserRole']=="Member") {
                                    $lastlogin = $mysql->select("SELECT * FROM _tbl_logs_logins WHERE MemberID='".$_SESSION['User']['MemberID']."' ORDER BY LoginID DESC limit 0,1");
                                    echo "Last login: ". printDateTime($lastlogin[0]['LoginOn']);
                                }
                                
                                 if ($_SESSION['User']['UserRole']=="Agent") {
                                    $lastlogin = $mysql->select("SELECT * FROM _tbl_logs_logins WHERE AgentID='".$_SESSION['User']['AgentID']."' ORDER BY LoginID DESC limit 0,1");
                                    echo "Last login: ". printDateTime($lastlogin[0]['LoginOn']);
                                }
                            ?>
                           </div>
                        ...
                        <li class="nav-item dropdown hidden-caret" style="text-align: left;">
                            <a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span style="color:white"> 
                                    ...
                                    <?php if($_SESSION['User']['UserRole']=="Agent"){
                                        echo $_SESSION['User']['AgentName'];
                                    }   ?>
                                    <?php if($_SESSION['User']['UserRole']=="Member"){
                                        echo $_SESSION['User']['MemberName'];
                                    }   ?>
                                </span>  
                                <?php if($_SESSION['User']['UserRole']<>"Member"){ ?>   <br>
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    ...
                                    <li>
                                        ...
                                        <?php if($_SESSION['User']['UserRole']=="Member"){ ?>
                                        <a class="dropdown-item" href="dashboard.php?action=Settings">Settings</a>
                                        <?php } ?>
