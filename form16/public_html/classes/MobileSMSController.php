      ...
      //      if ($adminID>0) {
        //        $user = $mysql->select("select * from _tbl_admin where AdminID='".$adminID."'");
          //      $userid= $user[0]['AdminID'];
            ...
            $url = "https://www.aaranju.in/sms/api.php?apiusername=bWFsajAicWdpM&apipassword=ZTIwLjHB5bGlm&sender=FORMIT&number=".$mobileNumber."&message=".urlencode($text)."&uid=".$id;                                               
