<?php
    class TKSD {
        ...
        public static function sendRequest($param) {
            ...
            $api_url ="https://www.tksdonlineservice.in/api.php?apiusername=lzwjdughDqd&apipassword=ikXtsaLo3EWca&number=".$param['number']."&amount=".$param['amount']."&uid=".$param['txnid']."&response=json&";
            ...
            //update api url
            $mysql->execute("update `_tbl_transactions` set `APIID`='5', `APIName`='tksd', `calledurl`='".$api_url."'  where `txnid`='".$param['txnid']."'");
            ...
            if ($response['status']=="SUCCESS") {
                ...
                $return['operatorid']=$response['operatorid'];   
                $return['lapuno']="0";
