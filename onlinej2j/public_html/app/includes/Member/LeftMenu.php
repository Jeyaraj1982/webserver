            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="Wallet">
                        <ul class="nav nav-collapse">
                            <li><a href="dashboard.php?action=Transactions"><span class="sub-item">Wallet Transaction</span></a></li>
                 ...
                 <li class="nav-item">
                    <a data-toggle="collapse" href="#BizDiary"><i class="fas fa-user"></i><p>Biz Diary</p><span class="caret"></span></a>
                    <div class="collapse" id="BizDiary">
                        <ul class="nav nav-collapse">
                            <li><a href="dashboard.php?action=Settings/ManageMyContact"><span class="sub-item">Manage Customer</span></a></li>
                        </ul>
                    </div>
                </li>
