<?php 
       $sql = $mysql->select("SELECT * FROM _tbl_mobile_plan_log
                                            ...
                                            ON _tbl_mobile_plan_log.UserID = _tbl_Members.MemberID where _tbl_mobile_plan_log.Plan='plan' and Date(_tbl_mobile_plan_log.LogOn)>=Date('".$_POST['From']."') and Date(_tbl_mobile_plan_log.LogOn)<=Date('".$_POST['To']."') ");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Mobile Offer Logs</h4>
                        </div> 
                        <div class="card-body">
