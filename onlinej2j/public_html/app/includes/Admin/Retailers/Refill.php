    ...
    if (isset($_POST['refillBtn'])) {
        ...
        if ($error==0) {
            ...
            $id=$mysql->insert("_tbl_accounts",array("MemberID"    => $member[0]['MemberID'],
                                                     "Particulars" => 'Refill/FromAdmin/Member:'.$member[0]['MobileNumber']."/".$description,                    
                                                     "Credit"      => $_POST['Amount'],                    
                                                     "Debit"       => "0", 
             ...
             $id=$mysql->insert("_tbl_accounts",array("MemberID"    => $_SESSION['User']['MemberID'],
                                                     "Particulars" => 'Refill/ToAdmin/Member:'.$member[0]['MobileNumber']."/".$description,                   
                                                     "Credit"      => "0",                    
                                                     "Debit"       => $_POST['Amount'], 
             ...
             $id=$mysql->insert("_tbl_accounts",array("MemberID"    => $member[0]['MemberID'],
                                                     "Particulars" => 'Commission/FromAdmin/Member:'.$member[0]['MobileNumber'],                    
                                                     "Credit"      => $commission,                    
                                                     "Debit"       => "0", 
             ...
             $id=$mysql->insert("_tbl_accounts",array("MemberID"   => $_SESSION['User']['MemberID'],
                                                     "Particulars" => 'Commission/ToAdmin/Member:'.$member[0]['MobileNumber'],                   
                                                     "Credit"      => "0",                    
                                                     "Debit"       => $commission, 
             ...
             MobileSMS::sendSMS($member[0]['MobileNumber'],"Dear Retailer, Your wallet has credited Rs. ".$_POST['Amount'].". and Commission: ".$commission.". Wallet Balance Rs.".number_format($app->getBalance($member[0]['MemberID']),2),$member[0]['MemberID']);
            ...
            <script>
             $(document).ready(function() {
                swal("Transfer Successfully", {
                    ...
                    location.href='dashboard.php?action=Retailers/Refill'
                });
                 });
            </script>
        <?php } else { ?>
