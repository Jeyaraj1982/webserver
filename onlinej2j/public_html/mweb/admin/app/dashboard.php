...
<?php
     if (isset($_POST['txnupdateBtn'])) {
        ...
        if (sizeof($t)>0) {
            $mysql->execute("update _tbl_transactions set OperatorNumber = '".$_POST['OperatorNumber']."',
            ...
            $message = "Dear ".$member_info[0]['MemberName'].", You requested ".$optr[0]['OperatorName']." bill payment of ".$t[0]['rcnumber'].",  Rs.".$t[0]['rcamount']." has paid. Receipt/Provider/Bill number: ".$_POST['OperatorNumber'];
            if (strlen($member_info[0]['TelegramID'])>2) {
                TelegramMessageController::sendSMS($member_info[0]['TelegramID'],$message,0,0);  
            }
            Whatsapp::sendsms("91".$member_info[0]['MobileNumber'],$message,0,"");
            //MobileSMS::sendSMS($member_info[0]['MobileNumber'],$message,$member_info[0]['MemberID']);                                                             
            
            $message = "Dear Customer, You requested ".$optr[0]['OperatorName']." bill payment of ".$t[0]['rcnumber'].",  Rs.".$t[0]['rcamount']." has paid. Receipt/Provider/Bill number: ".$_POST['OperatorNumber']." - ".$member_info[0]['MemberName']." ".$member_info[0]['MobileNumber'];
            ...
            Whatsapp::sendsms("91".$t[0]['CustomerMobileNumber'],$message,0,"");
            //MobileSMS::sendSMS($t[0]['CustomerMobileNumber'],$message,$member_info[0]['MemberID']);                                                             
    ...
    if (isset($_POST['reverseBtn'])) {
        ...
        // MobileSMS::sendSMS($t[0]['CustomerMobileNumber'],"Dear Customer, You requested ".$optr[0]['OperatorName']." bill payment of ".$t[0]['rcnumber'].",  Rs.".$t[0]['rcamount']." has reversed.",$mem[0]['MemberID']);                     
        ...
        $message = "Dear Customer, You requested ".$optr[0]['OperatorName']." bill payment of ".$t[0]['rcnumber'].",  Rs.".$t[0]['rcamount']." has reversed. - ".$mem[0]['MemberName'].", ".$mem[0]['MobileNumber'];
        $subscribed_customer = $mysql->select("select * from telegram_recevied_records where Lower(reciviedmessage)='".strtolower(trim($t[0]['CustomerMobileNumber']))."'");
        if (sizeof($subscribed_customer)) {
            TelegramMessageController::sendSMS($subscribed_customer[0]['client_id'],$message,0,0);  
        }
        ...
        $message = "Dear ".$mem[0]['MemberName'].", You requested ".$optr[0]['OperatorName']." bill payment of ".$t[0]['rcnumber'].",  Rs.".$t[0]['rcamount']." has reversed.";
        if ($mem[0]['TelegramID']>0) {
            TelegramMessageController::sendSMS($mem[0]['TelegramID'],$message,0,0);  
        }
        Whatsapp::sendsms("91".$mem[0]['MobileNumber'],$message,0,"");
