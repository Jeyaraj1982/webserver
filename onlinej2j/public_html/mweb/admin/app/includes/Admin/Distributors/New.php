 <?php
    if (isset($_POST['submitBtn'])) {
        ...
        if ($error==0) {
            ...
            $message = "Dear ".$_POST['MemberName'].", your distributor account created. Your login Name: ".$_POST['MobileNumber']." and Password: ".$_POST['MemberPassword'].". Please download https://play.google.com/store/apps/details?id=com.tksd.Service";
            Whatsapp::sendsms("91".$_POST['MobileNumber'],$message,0,"");
            echo "<script>location.href='dashboard.php?action=Distributors/Created';</script>";                                                                
        } 
    } 
 ?>
  <div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Distributors/New">New Distributors</a></li>
        </ul>
    </div> 
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group user-test" id="user-exists">
                                    ...
                                    <input name="MemberName" id="MemberName" placeholder="Distributor Name" value="<?php echo isset($_POST['MemberName']) ? $_POST['MemberName'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter distributor name" type="text">
                         ...
                         <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group user-test" id="user-exists">
                                    ...
                                    <input name="PersonName" id="PersonName" placeholder="Distributor Name" value="<?php echo isset($_POST['PersonName']) ? $_POST['PersonName'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter distributor name" type="text">
                                    <div class="help-block"></div>
                                    <div class="help-block"><p class="error" id="username-exists"></p></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="PostalCode" id="PostalCode" placeholder="PostalCode" value="<?php echo isset($_POST['PostalCode']) ? $_POST['PostalCode'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter PinCode" type="text">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body"><div class="form-group m-b-0 text-right">
                        ...
                        <button type="submit" name="submitBtn" class="btn btn-primary waves-effect waves-light">Create Distributors</button>
                    </div>
                    </div>
                </div>
            </div>
