<?php
    $subscribed_agents = $mysql->select("select * from _tbl_member where  IsActive='1' and IsDistributor=1");
    if (isset($_POST['sendMessage'])) {
        
        $error=0;
        foreach($subscribed_agents as $agent) {
             Whatsapp::sendsms("91".$agent['MobileNumber'],"Dear ".$agent['MemberName'].", ".$_POST['Message'],0,"");
        }
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Whatsapp/SendAllDistributors">Send Message All Distributors</a></li>
        </ul>
    </div>
    ...
    <div class="row">
        ...
        <div class="card-header">
                    <div class="card-title">Message Send All Whatsapp Distributors</div>
                </div>
            <div class="card-body">
