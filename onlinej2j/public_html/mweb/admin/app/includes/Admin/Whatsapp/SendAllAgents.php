<?php
    $subscribed_agents = $mysql->select("select * from _tbl_member where IsActive='1' and IsMember=1 and MapedTo<>3");
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="nav-item"><a href="dashboard.php?action=Whatsapp/SendAllAgents">Send Message All Retailers</a></li>
        </ul>
    </div>    
    ...
    <div class="row">
        ...
        <div class="card-header">
                    <div class="card-title">Message Send All Whatsapp Members</div>
                </div>
            <div class="card-body">
