<?php
    $subscribed_agents = $mysql->select("select * from _tbl_member where IsDistributor=1 AND TelegramID>0");
...
<div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Wallets/Refill">Send Message All Distributors</a></li>
        </ul>
    </div>
    ...
    <div class="row">
        ...
        <div class="card-header">
                    <div class="card-title">Message Send All Telegram Distributors</div>
                </div>
            <div class="card-body">
