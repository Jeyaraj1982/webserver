<ul class="nav nav-primary">
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
      ...
      <li class="nav-item">
        <a data-toggle="collapse" href="#Whatsapp"><i class="fas fa-layer-group"></i><p>Whatsapp</p><span class="caret"></span></a>
        <div class="collapse" id="Whatsapp">
            <ul class="nav nav-collapse">
                <li><a href="dashboard.php?action=Whatsapp/OutgoingMsg"><span class="sub-item">OutGoing Msg</span></a></li>
                <li><a href="dashboard.php?action=Whatsapp/SendAllAgents"><span class="sub-item">Msg to Retailer</span></a></li>
                <li><a href="dashboard.php?action=Whatsapp/SendAllDistributors"><span class="sub-item">Msg to Distributor</span></a></li>
            </ul>
        </div>
    </li>
