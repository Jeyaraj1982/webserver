...
txn.memberid=mem.MemberID where mem.MemberID='3' and date(txn.txndate)=date('".$reportDate."') ".$optr_sql."order by txn.txnid desc");
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <input type="hidden" value="Transactions/StaffReport" name="action">
                <select name="d">
