 <?php
    if (isset($_POST['submitBtn'])) {
        ...
        if ($error==0) {
            $MemberID =  $mysql->insert("_tbl_stock_admin",array("StockPointName"          => $_POST['StockPointName'],
             ...
             echo "<script>location.href='dashboard.php?action=Stockiest/Created';</script>";                                                                
        } 
    } 
 ?>
  <div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=/NewStockPoint">New Stockiest</a></li>
        </ul>
    </div> 
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="m-b-0 text-orange "><i class="mdi mdi-account-multiple-plus  p-r-10"></i>New Stock Point</h4>
                </div>
                <div class="card-body">
                    <div class="form-body">
                        <div class="card-body"> 
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointName" id="StockPointName" placeholder="Stock Point Name" value="<?php echo isset($_POST['StockPointName']) ? $_POST['StockPointName'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter stock point name" type="text">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointAddressLine1" id="StockPointAddressLine1" placeholder="Address Line 1" value="<?php echo isset($_POST['StockPointAddressLine1']) ? $_POST['StockPointAddressLine1'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter address line 1" type="text">
                                        <div class="help-block"></div>
                                        <div class="help-block"><p class="error" id="username-exists"></p></div>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointAddressLine2" id="StockPointAddressLine2" placeholder="Address Line 2" value="<?php echo isset($_POST['StockPointAddressLine1']) ? $_POST['StockPointAddressLine1'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter address line 2" type="text">
                                        <div class="help-block"></div>
                                        <div class="help-block"><p class="error" id="username-exists"></p></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointCityName" id="StockPointCityName" placeholder="City Name" value="<?php echo isset($_POST['StockPointCityName']) ? $_POST['StockPointCityName'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter City Name" type="text">
                                        <div class="help-block"></div>
                                        <div class="help-block"><p class="error" id="username-exists"></p></div>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointLandmark" id="StockPointLandmark" placeholder="Landmark" value="<?php echo isset($_POST['StockPointLandmark']) ? $_POST['StockPointLandmark'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter Landmark" type="text">
                                        <div class="help-block"></div>
                                        <div class="help-block"><p class="error" id="username-exists"></p></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointPinCode" id="StockPointPinCode" placeholder="Pin Code" value="<?php echo isset($_POST['StockPointPinCode']) ? $_POST['StockPointPinCode'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter pincode" type="text">
                                        <div class="help-block"></div>
                                        <div class="help-block"><p class="error" id="username-exists"></p></div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointEmail" id="StockPointEmail" placeholder="Email ID" value="<?php echo isset($_POST['StockPointEmail']) ? $_POST['StockPointEmail'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter email" type="text">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group user-test" id="user-exists">
                                        ...
                                        <input name="StockPointMobile" id="StockPointMobile" placeholder="Mobile Number" value="<?php echo isset($_POST['StockPointMobile']) ? $_POST['StockPointMobile'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter mobile number" type="text">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group user-test" id="user-exists">
                                    ...
                                    <input name="StockAdminName" id="StockAdminName" placeholder="Admin Name" value="<?php echo isset($_POST['StockAdminName']) ? $_POST['StockAdminName'] : "";?>" class="form-control" required="" aria-invalid="true" data-validation-required-message="Please enter admin name" type="text">
                                    <div class="help-block"></div>
                                    <div class="help-block"><p class="error" id="username-exists"></p></div>
                                </div>
                            </div>
                    ...
                    <div class="card-body"><div class="form-group m-b-0 text-right">
                        <button type="submit" name="submitBtn" class="btn btn-primary waves-effect waves-light">Create Stockiest</button>
