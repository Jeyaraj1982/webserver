<?php
    class TelegramMessageController {
        ...
        public static function sendSMS($mobileNumber,$text,$memberID="",$adminID="") {
            ...
            $url = "https://www.aaranju.in/telegram/api.php?apiusername=d2VsY29tZUA&apipassword=jM0NTY3ODk&msgtype=text&clientid=".$mobileNumber."&message=".urlencode($text)."&uid=tksd_".$id;                                               
