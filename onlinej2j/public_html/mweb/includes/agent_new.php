...
<?php if ($_SESSION['User']['IsDistributor']==1) { ?>
    <?php if (isset($_POST['submitRequest'])) { ?>
        ...
        if ($error==0) {
           ...
           $message = "*Welcome To TKSD Online Service* ".WAP_NEWLINE." Dear ".$_POST['MemberName'].", your retailer account created. Your User Name: ".$_POST['MobileNumber']." and Password: ".$_POST['Password']." ".WAP_NEWLINE." Download app from https://play.google.com/store/apps/details?id=com.tksd.Service";
