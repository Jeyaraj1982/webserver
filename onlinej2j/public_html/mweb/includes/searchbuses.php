<h3 style="text-align: center;padding:10px;">Available Buses</h3> 
<?php 
class Webservice {
...
<script>
    ...
    for(var i=0;i<100;i++) {
        imgseaterArr[i]=new Array('assets/images/ac_semi_sleeper_vacant.jpg','assets/images/ac_sleeper_selected.jpg'); 
        imgladiesseaterArr[i]=new Array('assets/images/non_ac_seater_ladies.jpg','assets/images/ac_sleeper_selected.jpg'); 
        imgvsleeperArr[i]=new Array('assets/images/volvo_sleeper_vertical_vacant.jpg','assets/images/volvo_sleeper_vertical_selected.jpg');
        imgladiesvsleeperArr[i]=new Array('assets/images/non_ac_vertical_sleeper_ladies.jpg','assets/images/volvo_sleeper_vertical_selected.jpg');
        imghsleeperArr[i]=new Array('assets/images/volvo_sleeper_vacant.jpg','assets/images/volvo_sleeper_selected.jpg');
        imgladieshsleeperArr[i]=new Array('assets/images/non_sleeper_ac_ladies.jpg','assets/images/volvo_sleeper_selected.jpg');
    }
    ...
    <div class="page-wrapper">
        ...
        <input type="hidden" id="doj_full" name="_doj_full" value="<?php echo date("l, F d, Y",strtotime($_GET['doj']));?>">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-xlg-12 col-md-12" style="padding-right: 0px;padding-left: 0px;">
                        <div class="card">
                            <div class="card-body" style="padding: 0px;">
                             <?php $datas = $webservice->getData("_getAvailableTrips&fromid=".$_GET['fromid']."&toid=".$_GET['toid']."&doj=".$_GET['doj']); ?>
                             <?php // print_r($datas);?>
                             <div class="row">
                                    <div class="col-4 col-xs-1 b-r"> <strong>From</strong></div>
                                    <div class="col-8 col-xs-6 b-r"><?php echo $_GET['From'];?></div>
							</div>
							<div class="row">
                                    <div class="col-4 col-xs-1 b-r"> <strong>To</strong></div>
                                     <div class="col-8 col-xs-6 b-r"><?php echo $_GET['To'];?></div>
                            </div> 
							<div class="row">		
									<div class="col-4 col-xs-1 b-r"> <strong>Date</strong></div>
                                     <div class="col-8 col-xs-6 b-r"><?php echo $_GET['doj'];?></div>
                              </div> 
                             <?php
                                //print_r("_getAvailableTrips&fromid=".$_GET['fromid']."&toid=".$_GET['toid']."&doj=".$_GET['doj']);
                              $datas = $webservice->getData("_getAvailableTrips&fromid=".$_GET['fromid']."&toid=".$_GET['toid']."&doj=".$_GET['doj']);
                               //print_r($datas);
                              ?>
                             <?php  
                             $datas['availableTrips'] = isset($datas['availableTrips']) ? $datas['availableTrips'] : array();
                               ...
                               ?>
                                <div style="border: 1px solid #ddd;margin-top: 20px;padding: 10px;padding-bottom:0px;" >
                                    <div class="row">
										<div class="col-8">
											<p style="font-size: 19px;font-weight: 700;color: #3e3e52;margin-bottom: 0px;"><?php echo BusTicket::getTime($bTime); ?>&nbsp;-&nbsp;<span style="font-weight:normal"><?php echo BusTicket::getTime($dTime); ?></span></p>
											<p style="line-height: 24px;color: #7e7e8c;margin-bottom: 0px;"><?php echo $duration;?></p>
											<p style="font-size:14px;font-weight:400;color:#7e7e8c;">
												<span style="height:10px;width:10px;background-color:#20e512;border-radius:50%;display:none;"></span><?php echo $data['availableSeats']; ?> Seats&nbsp;
												<?php echo ($data['avlWindowSeats']<0) ? 0 : $data['avlWindowSeats'] ;?>  Window
											</p>
										</div>
										<div class="col-4" style="padding-left:0px">
											<?php if (is_array($data['fares'])) { ?>
												<p style="font-size:14px;font-weight:400;color:#7e7e8c;margin-bottom:0px">from</p> <span style="color:#000;font-size:18px;font-weight:bold;"><i class="fas fa-rupee-sign"></i>&nbsp;<?php echo $data['fares'][(sizeof($data['fares'])-1)];?></span>
											<?php } else {?>
											   <span style="color:#000;font-size:18px;font-weight:bold;"><i class="fas fa-rupee-sign"></i>&nbsp;<?php echo $data['fares'];?></span>
											<?php } ?>
										</div>
									</div>
									<div class="row">
									...
									<div class="row" style="margin-right: 0px;margin-left: 0px;"> 
										<div class="col-12" style="text-align:right">
											<div class="scrollmenu">
												<a onclick="ViewSeats('<?php echo $data['id'];?>')"  class="btn btn-danger" style="cursor:pointer;color: white;margin-right: -20px;">View Seats</a>
                                            </div>
										</div>
									</div>
									<div class="row" style="margin-right: 0px;margin-left: 0px;"> 
										<div class="col-12" style="text-align:right;padding-left:0px;padding-right:0px">
											<a  onclick="toggle_bpdp('<?php echo $data['id'];?>');"  class="btn btn-default" style="cursor:pointer;background-color:white;margin-bottom: -10px;padding-left:0px;padding-right:0px;vertical-align: bottom;">Boarding & Dropping Points</a>&nbsp;|&nbsp;
											<a onclick="toggle_bpolicy('<?php echo $data['id'];?>');" class="btn btn-default"  data-toggle="collapse" data-target="#Bookingpolicies" style="cursor:pointer;background-color:white;padding-left:0px;padding-right:0px">Cancellation Policy</a>
										</div>
									</div>
                                    ...
                                    <div id="result_<?php echo $data['id'];?>" style="background-color: #f0f0f0;padding: 20px 30px;margin:-10px;margin-top:0px;overflow:auto"  class="collapse">
                                        <div class="col-sm-12" style="padding: 0 20px;">
