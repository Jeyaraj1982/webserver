    ...
    <?php if (isset($_POST['submitRequest'])) { ?>
     ...
     //   if ($_POST['Amount']<=($upper_lmit-$today_transfer)) {
        ...
        if ($result['status']=="success" || $result['status']=="requested") {
            $message = "Dear Customer, you requested money transfer  INR. ".$_POST['Amount']." has been settled to ".$_POST['AccountName']."(A/c No: ".$_POST['MobileNumber'].") IFSC Code: ".$_POST['IFSCode'].". Bank Reference No *".$result['impsno']."* - ". $_SESSION['User']['MemberName'].", ".$_SESSION['User']['MobileNumber'];
             Whatsapp::sendsms("91".$_POST['CustomerMobileNumber'],$message,0,"");
            ...
            <form action="" method="post" id="frms"  onsubmit="return beforeSubmit()">
                ...
                <div class="form-group" style="margin-bottom:0px">
                    <div class="input-group">
                        ...
                        <?php  if (sizeof($benifechery_details)>0) { ?>
                        <input type="number"  value="<?php echo $benifechery_details[0]['CustomerMobileNumber'];?>"  maxlength="10" name="CustomerMobileNumber" id="CustomerMobileNumber" class="form-control" placeholder="Customer Mobile Number" >
                        <?php } else {?>
