            ...
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              ...
              <div class="flexslider flexslider-thumb">
                ...
                <?php foreach($additionalImages as $image){ ?>
                  <li><a href='images/products/product-1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/products/product-1.jpg' "><img src="http://japps.online/ecommerce/uploads/<?php echo $image['ProductImage'];?>" alt = "Thumbnail 2"/></a></li>
                <?php } ?>
                </ul>
              </div>
