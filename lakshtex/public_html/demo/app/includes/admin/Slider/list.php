                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row">
                                ...
                                <div class="col-md-8" style="text-align: right;">
                                    <a href="dashboard.php?action=Slider/add" class="btn btn-primary btn-xs">Add Slider</a><br>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                 <table class="table table-striped mt-3">
                                        ...
                                        <tbody>
                                        <?php 
                                            $Sliders = $mysql->select("select * from _tbl_sliders order by SliderOrder asc"); 
                                                ...
                                                <td style="text-align: right">                                                   
                                                    <div class="dropdown dropdown-kanban" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="dashboard.php?action=Slider/edit&id=<?php echo md5($Slider['SliderID']);?>" draggable="false">Edit</a>
 ...
 function DeleteSlider(SliderID) {
    ...
    $.post( "../webservice.php?action=DeleteSlider",param,function(data) {                 
        ...
        if (obj.status=="failure") {
            ...
            html += "<div style='padding:20px;text-align:center'>" + "<a href='dashboard.php?action=Slider/list&status=All' class='btn btn-outline-success'>Continue</a></div>"; 
        }
