            ...
            <ul class="nav nav-primary">
                        ...
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="dashboard.php?action=Brands/list&status=All">
                                    <span class="sub-item">Brand Names</span>
                                </a>
                            </li>
                            
                             <li>
                                <a href="dashboard.php?action=BrandSize/AgeGroup&status=All">
                                    <span class="sub-item">Size [Age Group]</span>
                                </a>
                            </li>
                             ...
                             <li>
                                <a href="dashboard.php?action=BrandSize/BySize&status=All">
                                    <span class="sub-item">Size [Brand Size]</span>
                                </a>
                            </li>
                ...
                <li class="nav-item">   
                    ...
                    <div class="collapse" id="Order">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="dashboard.php?action=Order/list&status=new">
                ...
                <li class="nav-item">   
                    ...
                    <div class="collapse" id="Invoice">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="dashboard.php?action=Invoice/list&status=All">
                ...
                <li class="nav-item">   
                    ...
                    <div class="collapse" id="Receipts">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="dashboard.php?action=Receipt/list&status=All">
                                    <span class="sub-item">Manage Receipt</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">   
                    ...
                    <div class="collapse" id="Website">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="dashboard.php?action=Slider/list">
