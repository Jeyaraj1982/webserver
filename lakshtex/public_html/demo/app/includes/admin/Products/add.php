                                   ...
                                   <input type="file" onchange="image1_onchage()" name="image1" id="image1" style="display: none;">    
                                    <div class="card-body">
                                       ...
                                       <div class="form-group form-show-validation row">
                                            ...
                                            <div class="row">
                                            <?php $AgeGroups = $mysql->select("select * from _tbl_size_age_group where IsActive='1'");?>
                                            <?php foreach($AgeGroups as $AgeGroup){ ?>
                                            <div class="col-3">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" id="<?php echo $AgeGroup['AgeGroupID'];?>" value="<?php echo $AgeGroup['Label'];?>" name="AgeGroup[]">
                                                <label class="custom-control-label" for="<?php echo $AgeGroup['AgeGroupID'];?>" style="font-weight: normal;"><?php echo $AgeGroup['Label'];?></label>
                                            </div>
                                            </div>
                                            <?php } ?>
                                            </div>
                                       ...
                                       <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-sm-12">
                                            <?php $BrandSizes = $mysql->select("select * from _tbl_brand_size where IsActive='1'");?>
                                            <?php foreach($BrandSizes as $BrandSize){ ?>
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" id="BrndSize<?php echo $BrandSize['SizeID'];?>" value="<?php echo $BrandSize['Label'];?>" name="BrandSize[]">
                                                <label class="custom-control-label" for="BrndSize<?php echo $BrandSize['SizeID'];?>" style="font-weight: normal;"><?php echo $BrandSize['Label'];?></label>
                                            </div>
                                            <?php } ?>
                                            </div>
                                            <span class="errorstring" id="ErrDetailDescription"><?php echo isset($ErrDetailDescription)? $ErrDetailDescription : "";?></span>
