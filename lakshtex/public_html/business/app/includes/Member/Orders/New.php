                    ...
                    <div class="table-responsive">
                        ...
                        <form action="dashboard.php?action=Orders/Submit" method="post" id="order_form" name="order_form" >
                            <table id="example1" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <input type="button" value="Submit Order"  onclick="submitOrder()" class="btn btn-purple">
                                        <input type="submit" name="btnSubmit" id="btnSubmit" style="height:0px;width:0px;display:none;">
                                        &nbsp;&nbsp;<a href="javascript:reSet()" class="btn btn-outline-purple" style="background: white;">Reset</a>
                                    </td>
                                </tr>
                              </tbody>
                            </table>
