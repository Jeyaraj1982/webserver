            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                         <?php $Orders = $mysql->select("select * from `_tbl_Member_Orders` where `MemberID`='".$_SESSION['User']['MemberID']."' order by `OrderID` desc"); ?>
            <table id="example1" class="table table-striped table-bordered table-hover" width="100%" style="border-top:1px solid #ebedf2">
                <thead>
                <tr>
