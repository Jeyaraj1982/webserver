  <div style="padding:25px">
    <div class="page-header">
        <ul class="breadcrumbs" style="border: none;padding-left: 0px;margin-left: 0px;">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="dashboard.php?action=Members/MyAllMembers">Genealogy Tree</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <table cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="width:130px;vertical-align:top">
                                    ...
                                    <div style="width:130px;margin:0px auto;text-align:center;font-size:10px;">
                                        <div style="border:2px solid #9B0976;padding:5px;height:85px;width:85px;border-radius:50%;background:#fff;margin:0px auto">
                    ...
                    <?php
                        ...
                        <table align="left" style="clear:both" cellspacing="0" cellpadding="0">                                                                                    
                            <tr>
                                ...
                                ?>
                                <td style="width:130px;vertical-align:top">
                                    <div style="font-size:10px;width:130px;margin:0px auto;text-align:center;cursor:pointer" onclick="javascript:getTree('<?php echo $childa['ChildCode'];?>','<?php echo $i?>','level2');">
