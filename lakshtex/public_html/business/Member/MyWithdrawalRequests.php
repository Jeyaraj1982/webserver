<?php
 $Requests  = $mysql->select("SELECT * FROM _tbl_member_withdraw_request where MemberID='".$_SESSION['User']['MemberID']."'" );
  ?>
                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="Dashboard.php?action=AddWithdrawalRequests" class="btn btn-primary btn-sm">Add Withdrawal Requests</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
