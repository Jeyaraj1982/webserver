<?php
 ...
 ?>
     <Script>
          setTimeout(function(){
          location.href='Dashboard.php?action=MyProfile';
          },1000);
          </script>
     <?php
     exit;
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-icon">
                                            ...
                                            <input type="text" name="MemberMobileNumber"  class="form-control" value="<?php echo $myprofile[0]['MemberMobileNumber'];?>" style="padding-left: 45px;" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
