...
<script>
 ...
 <?php
                                    ...
                                    if (sizeof($epin)==0) {
                                        ...
                                        if (sizeof($sponsor)==0) {
                                          $ErrSponserID="Invalid Sponsor's ID";
                                          $ErrorCount++;
                                        } 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card-title">
                                        <h4 style="margin-bottom: 1.5rem;font-weight: normal;margin-top: .5rem !important;opacity: .6;"><div>Create Member</div><span style="font-size: 1.1rem;">Using Sponsor ID</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form method="post" action="" onsubmit="return submitMember();" id="createform">
                                <div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">Sponsor's ID<span id="star">*</span></div>
                                        <div class="col-sm-9"><input type="text" value="<?php echo (isset($_POST['SponserID']) ? $_POST['SponserID'] : "");?>" placehoder="SponserID" name="SponsorID" class="form-control" >
                                        ...
                                        <div class="col-sm-9">
                                            <select name="PinCode" class="form-control">
                                             <?php foreach($epin as $e) {?>
                                                <option value="<?php echo $e['PinCode'];?>" <?php echo ($_POST['PinCode']==$e['PinCode']) ? " selected='selected' " : "";?> ><?php echo $e['PinCode'];?></option>
                                             <?php } ?>
                                            </select>
