                    ...
                    <div class="table-responsive">
                        <table id="basic-datatables" class="table table-bordered table-hover" style="border: 1px solid #dee2e6;">
                            <thead>
                                <tr>
                                    <th>Income Type</th>
                                    <th  style="text-align: right">Earned (INR)</th>
                                    <th style="text-align: right">Charged (INR)</th>
                                    <th style="text-align: right">Creditd (INR)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                <tr>
                                    <td>Discounts from purchase</td>
                                    <td style="text-align: right"><?php echo number_format(0,3);?></td>
                                    <td style="text-align: right"><?php echo number_format(0,3);?></td>
                                    <td style="text-align: right"><?php echo number_format(0,3);?></td>
                                </tr>
