<?php $Members =$mysqldb->select("select * from `_tbl_Members` order by MemberID desc"); ?>
<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-6 align-self-center">
                <h4 class="page-title">Utility Wallet Transactions Member Wise</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Utility Wallet Transactions Member Wise </li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <table class="table v-middle" style="border: 1px solid; border-color: #e1e1e1;">
                                ...
                                <tbody>
                                    <?php foreach ($Members as $Member){
                                          $summary = getUtilityhWalletShortSummary($Member['MemberID']);
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="dashboard.php?action=Wallets/UtilityWalletTransactionForMember&code=<?php echo $Member['MemberCode'];?>">View Transactions</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
