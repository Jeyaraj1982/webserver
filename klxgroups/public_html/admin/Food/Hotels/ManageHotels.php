                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row"> 
                                ...
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="dashboard.php?action=Food/Hotels/AddHotel" class="btn btn-primary btn-xs">Add Food Hotel</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                 <table class="table table-striped mt-3">
                                        ...
                                        <tbody>
                                        <?php $tours = $mysql->select("select * from _tbl_foods_hotels where IsActive='1' order by HotelID desc");?>
                                        <?php foreach($tours as $tour){
                                            $place= $mysql->Select("select * from _tbl_foods_citynames where HotelCityNameID='".$tour['HotelCityNameID']."'");
                                            $packages= $mysql->Select("select * from _tbl_foods_items where  IsActive='1' and FoodHotelID='".$tour['HotelID']."'");
                                            ?>
                                       
                                            <tr>
                                                <td><img src="../<?php echo "../assets/food/".$tour['HotelThumb'];?>" style='width: 50px;height:50px;margin-top: 5px;'></td>
                                                ...
                                                <td style="text-align: right">                                                   
                                                    <div class="dropdown dropdown-kanban" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="dashboard.php?action=Food/Hotels/EditHotel&Hotel=<?php echo md5($tour['HotelID']);?>" draggable="false">Edit</a>
                                                            <a class="dropdown-item" href="dashboard.php?action=Food/Hotels/ViewHotel&Hotel=<?php echo md5($tour['HotelID']);?>" draggable="false">View</a>
                                                            <a class="dropdown-item" href="dashboard.php?action=Food/Hotels/ViewProducts&Hotel=<?php echo md5($tour['HotelID']);?>" draggable="false">View Products</a>
