<?php 
    $packages = $mysql->select("select * from _tbl_foods_items where IsActive='1' and md5(FoodHotelID)='".$_GET['Hotel']."'");
?>
                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="dashboard.php?action=Food/Product/AddProduct&Hotel=<?php echo $_GET['Hotel'];?>" class="btn btn-primary btn-xs">Add Product</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                 <table id="tbl" class="table table-striped mt-3">
                                        ...
                                        ?>   
                                            <tr>
                                            <td><img src="../<?php echo "../assets/food/".$package['FoodThumb'];?>" style='width: 50px;height:50px;margin-top: 5px;'></td>

                                                  <td><?php echo $package['ProductName'];?>
                                                ...
                                                <td style="text-align: right">                                                    
                                                    <div class="dropdown dropdown-kanban" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">          
                                                            <a class="dropdown-item" href="dashboard.php?action=Food/Product/EditProduct&id=<?php echo md5($package['FoodID']);?>" draggable="false">Edit</a>
                                                            <a class="dropdown-item" href="dashboard.php?action=Food/Product/ViewProduct&id=<?php echo md5($package['FoodID']);?>" draggable="false">View</a>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="col-md-12">                                  
                                                <a href="dashboard.php?action=Food/Hotels/ManageHotels" class="btn btn-warning">Back</a>
                                            </div>                                        
