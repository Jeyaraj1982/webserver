<?php
    ...
    $data= $mysql->Select("select * from _tbl_foods_hotels where md5(HotelID)='".$_GET['Hotel']."'");
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                ...
                                                <div id="div_1">
                                                    <?php if(strlen($data[0]['HotelThumb'])>1) { ?>
                                                        <img src="../<?php echo "assets/food/".$data[0]['HotelThumb'];?>" style='width: 100%;margin-top: 5px;'>
                                                    <?php } ?>
                                    ...
                                    <div class="card-action">
                                        <div class="row">                                       
                                            <div class="col-md-12">
                                                ...
                                                <a href="dashboard.php?action=Food/Hotels/ManageHotels&id=<?php echo md5($data[0]['TourTypeID']);?>" class="btn btn-warning btn-border">Back</a>
                                            </div>                                        
                                        </div>
                                    </div>
                                </form>
