...
$data= $mysql->Select("select * from _tbl_foods_citynames where HotelCityNameID='".$_GET['City']."'");
    if (isset($_POST['btnsubmit'])) {
        $ErrorCount =0;
                ...
                $mysql->execute("update _tbl_foods_citynames set `CityName`    ='".$_POST['CityName']."',
                                    ...
                                    <div class="card-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a href="dashboard.php?action=Food/CityNames/CityNames" class="btn btn-warning btn-border">Back</a>
                                            </div>                                        
                                        </div>
                                    </div>
                                </form>
