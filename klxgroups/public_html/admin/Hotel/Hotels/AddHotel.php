            ...
            if($ErrorCount==0){
                ...
                $target_dir = "../assets/hotel/";
                  ...
                  if (move_uploaded_file($_FILES["uploadimage1"]["tmp_name"], $target_file)) {
                    ...
                    $id = $mysql->insert("_tbl_hotels",array("HotelCityNameID"      => $_POST['HotelCityNameID'],
                                    ...
                                    <div class="card-action">
                                        <div class="row">                                       
                                            <div class="col-md-12">
                                                ...
                                                <a href="dashboard.php?action=Hotel/Hotels/ManageHotels&id=<?php echo $_GET['id'];?>" class="btn btn-warning btn-border">Back</a>
                                            </div>                                        
                                        </div>
                                    </div>
                                </form>
