                            ...
                            <div class="card">
                                ...
                                <form id="exampleValidation" method="POST" action=""   id="addProduct" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" disabled="disabled" id="PackageName" name="PackageName" placeholder="Enter Package Name" value="<?php echo (isset($_POST['PackageName']) ? $_POST['PackageName'] : $data[0]['PackageName']);?>">
                                    ...
                                    <div class="card-action">
                                        <div class="row">                                       
                                            <div class="col-md-12">
                                                <a href="dashboard.php?action=Hotel/Hotels/ManageHotels" class="btn btn-warning btn-border">Back</a>
                                            </div>                                        
                                        </div>
                                    </div>
                                </form>
