    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2  style="margin-bottom:0px;font-size:15px">Food Hotel</h2>
    ...
    <section id="contact" class="contact" style="padding-top:20px;">
      <div class="container">
          <div class="row ">
           ...
           <?php
                 $hotels = $mysql->select("select * from _tbl_foods_hotels where IsActive='1' and HotelCityNameID='".$_GET['city']."'");
                 foreach($hotels as $hotel) {
             ?>  
              <div class="col-6 " style="text-align: center;margin-bottom:10px;">
                <div class="card">
                    <div class="card-body" style="padding:0px;padding-bottom:10px;">
                <a href="foods_list.php?hotel=<?php echo $hotel['HotelID'];?>" style="color:#222">
