                                    ...
                                    <div class="card-body">
                                     <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" name="SliderTitle" class="form-control" id="SliderTitle" accept=".jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.ppt,.pptx,.odt,.avi,.ogg,.m4a,.mov,.mp3,.mp4,.mpg,.wav,.wmv" >
                                         ...
                                         <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" name="SliderDescription" class="form-control" id="SliderDescription" accept=".jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.ppt,.pptx,.odt,.avi,.ogg,.m4a,.mov,.mp3,.mp4,.mpg,.wav,.wmv" >
                                         ...
                                         <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" name="ButtonName" class="form-control" id="ButtonName" accept=".jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.ppt,.pptx,.odt,.avi,.ogg,.m4a,.mov,.mp3,.mp4,.mpg,.wav,.wmv" >
                                         ...
                                         <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                <input type="text" name="ButtonLink" class="form-control" id="ButtonLink" accept=".jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.ppt,.pptx,.odt,.avi,.ogg,.m4a,.mov,.mp3,.mp4,.mpg,.wav,.wmv" >
