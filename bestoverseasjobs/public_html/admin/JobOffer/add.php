        ...
        $ErrorCount =0;
            ...
            if($ErrorCount==0){
              ...
              if (move_uploaded_file($_FILES["uploadimage1"]["tmp_name"], $target_file)) {
                 ...
                 $id = $mysql->insert("_tbl_joboffers",array("JobOfferImage"         => $file,
                 ...
                 if($id>0){  ?>
                    ...
                    $(document).ready(function() {
                        swal("Added Successfully", {
                            ...
                            location.href='dashboard.php?action=JobOffer/list'
                        });
                    });
                    </script>
                 <?php } ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Add JobOffer</div>
                        </div>
                        <form id="exampleValidation" method="POST" action="" onsubmit="return SubmitSlider();" enctype="multipart/form-data">
                            ...
                            <div class="card-action">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="btn btn-warning" type="submit" name="btnsubmit" value="Add Job">&nbsp;
                                        <a href="dashboard.php?action=JobOrder/list" class="btn btn-warning btn-border">Back</a>
                                    </div>                                        
                                </div>
                            </div>
                        </form>
