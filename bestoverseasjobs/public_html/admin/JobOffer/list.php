                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row">
                                ...
                                <div class="col-md-8" style="text-align: right;">
                                    <a href="dashboard.php?action=JobOffer/add" class="btn btn-primary btn-xs">Add Job</a><br>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                 <table class="table table-striped mt-3">
                                        ...
                                        ?>
                                            <tr>
                                                <td><img src="<?php echo "../uploads/".$Slider['JobOfferImage'];?>" style='width: 50px;height:50px;margin-top: 5px;'></td>
                                                ...
                                                <td style="text-align: right">                                                   
                                                    <div class="dropdown dropdown-kanban" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="dashboard.php?action=JobOffer/edit&id=<?php echo md5($Slider['JobOfferID']);?>" draggable="false">Edit</a>
                                                            <a class="dropdown-item" draggable="false"><span onclick='CallConfirmation("<?php echo $Slider['JobOfferID'];?>")' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                          <?php  if(sizeof($Sliders)=="0"){ ?>
                                            <tr>
                                                <td style="text-align: center;" colspan="3">No Jobs found</td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
