                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                 <table class="table table-striped mt-3">
                                        ...
                                        <tbody>
                                        <?php 
                                            $Sliders = $mysql->select("select * from _tbl_lookingfor_jobs order by LookingForJobID desc"); 
                                            foreach($Sliders as $Slider){ 
                                        ?>
                                            <tr>
                                                <td><?php echo $Slider['CandidateName'];?></td>
                                                <td><?php echo $Slider['Email'];?></td>
                                            
                                                <td><?php echo date("d M Y ,H:i",strtotime($Slider['SubmittedOn']));?></td>
                                                <td style="text-align: right">                                                   
                                                    <a href="dashboard.php?action=LookingForJob/view&id=<?php echo $Slider['LookingForJobID'];?>">View</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
