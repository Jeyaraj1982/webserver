                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit My Contacts</div>
                        </div>
                            ...
                            <div class="card-body">
                                 <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">                   
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"  value="<?php echo (isset($_POST['ContactName']) ? $_POST['ContactName'] : $mycontacts[0]['ContactName']);?>" name="ContactName" id="ContactName" class="form-control" placeholder="Contact Name" style="font-size:16px">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">                   
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"  value="<?php echo (isset($_POST['MobileNumber']) ? $_POST['MobileNumber'] : $mycontacts[0]['MobileNumber']);?>" maxlength="10" name="MobileNumber" id="MobileNumber" class="form-control" placeholder="Mobile Number" style="font-size:16px">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">                   
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"  value="<?php echo (isset($_POST['DTHNumber']) ? $_POST['DTHNumber'] : $mycontacts[0]['DTHNumber']);?>" name="DTHNumber" id="DTHNumber" class="form-control" placeholder="DTH Number" style="font-size:16px">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <button type="button" class="btn btn-primary  btn-sm" onclick="doConfrim()"  name="submitRequest">Update</button>
                                            </div>                                        
                                        </div>
                                    </div>
                                </div>
       ...
       var Cbuttons = "<div style='text-align:center;padding:10px;'><button type='button' class='btn btn-danger btn-sm' data-dismiss='modal'>Continue</button>"; 
        $.post( "webservice.php?action=updatemycontact",  $( "#ContactForm" ).serialize(),function( data ) {
            ...
            if (obj.status=="failure") {
                ...
                html += "<br>"; 
                html += "<div style='text-align:center;padding:10px;'><a href='dashboard.php?action=Settings/EditMyContact&cid="+obj.cid+"' class='btn btn-danger btn-sm' >Continue</a>";
            }
