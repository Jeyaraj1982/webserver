	...
	<div class="sidebar-wrapper scrollbar scrollbar-inner">
		<div class="sidebar-content">
			<ul class="nav nav-primary">
                ...
                <br><Br>
                <li class="nav-item">
                    <a data-toggle="collapse" href="#Recharge"><i class="fas fa-user"></i><p>Recharge</p><span class="caret"></span></a>
                    <div class="collapse" id="Recharge">
                        <ul class="nav nav-collapse">
                            ...
                            <li><a href="dashboard.php?action=ElectricityBill"><span class="sub-item">Electricity Bill</span></a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item"><a href="dashboard.php?action=UtilityTnpolice"><span class="sub-item">Utility TN Police</span></a></li>
			</ul>
		</div>
	</div>
</div>
