<div class="main-panel full-height">
            <div class="container">
                ...
                <div class="col-md-12">
                 ...
                 <?php
                     $nsql= $mysql->select("select * from `_tbl_news` where (NewsFor='Dealers' or NewsFor='All') and IsPublish='1' and NewsID not in (select NewsID from _tbl_news_log where MemberID='".$_SESSION['User']['MemberID']."')  order by `NewsID` desc ");
                     foreach($nsql as $n) {
                ?>     
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Earned Comm</p>
                                                <h4 class="card-title">
                                                <?php echo number_format($app->getCommissionCredited($_SESSION['User']['MemberID']),2);?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                <p class="card-category">Transfered Comm</p>
                                                <h4 class="card-title">
                                                 <?php echo number_format($app->getCommissionTransfered($_SESSION['User']['MemberID']),2);?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                                 <?php echo number_format($app->getCommissionCredited($_SESSION['User']['MemberID'])-$app->getCommissionTransfered($_SESSION['User']['MemberID']),2);?>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-stats">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title">
                                                <?php
                                                   echo sizeof($mysql->select("select MemberID from _tbl_Members where `MapedTo`='".$_SESSION['User']['MemberID']."'"));
                                                ?>
                                                </h4>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">Recent Retailers</div>
                                       <div class="card-tools">
                                            <a href="dashboard.php?action=Retailers/Manage" class="btn btn-info btn-border btn-round btn-sm mr-2">
                                ...
                                <div class="card-body">
                                <?php
                                     $sql= $mysql->select("select * from `_tbl_Members` where `IsMember`='1' and MapedTo='".$_SESSION['User']['MemberID']."' order by `MemberID` desc limit 0,5");
