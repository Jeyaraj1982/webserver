                                            ...
                                            <td>
                                                <div class="dropdown dropdown-kanban" style="float: right;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/EditStaff&ACode=<?php echo $staff['AdminCode'];?>" draggable="false">Edit</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/ViewStaff&ACode=<?php echo $staff['AdminCode'];?>" draggable="false">View</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/SMSLog&ACode=<?php echo $staff['AdminCode'];?>" draggable="false">SMS Log</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/EmailLog&ACode=<?php echo $staff['AdminCode'];?>" draggable="false">Email Log</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/LoginLog&ACode=<?php echo $staff['AdminCode'];?>&Status=All" draggable="false">Login Log</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/ViewMembers&ACode=<?php echo $staff['AdminCode'];?>&Status=All" draggable="false">View Members</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Staffs/AssignedJobs&ACode=<?php echo $staff['AdminCode'];?>&Status=All" draggable="false">Assigned Jobs</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
