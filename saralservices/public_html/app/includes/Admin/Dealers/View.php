                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title" style="float: left;">View Dealer Information</div>
                                    <div class="dropdown dropdown-kanban" style="float: right;padding-top:10px;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item" href="dashboard.php?action=Retailers/Create&d=<?php echo $_GET['d'];?>" draggable="false">Create Retailer</a>
                                                        <a class="dropdown-item" href="dashboard.php?action=Retailers/Manage&d=<?php echo $_GET['d'];?>&Status=All" draggable="false">View Retailers</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group form-show-validation row">
                                         ...
                                         <div class="form-group form-show-validation row">
                                           ...
                                           <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-4 col-md-9 col-sm-8"><span class="<?php echo ($sql[0]['IsActive']==1) ? 'Activedot' : 'Deactivedot';?>"></span>&nbsp;&nbsp;&nbsp;<?php echo $sql[0]['IsActive']==1 ? "Active" : "Deactivated";?><br><?php if($sql[0]['IsActive']==0){ echo $sql[0]['IsDeactiveOn']; } ?></div>
                                        </div>
                                         <div class="form-group form-show-validation row">
                                        ...
                                        <div class="card-action">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="dashboard.php?action=Dealers/Manage&Status=All" id="show-signup" class="link">Back</a>
                                                </div>                                        
                                            </div>
                                        </div>
                                    </div>                                                                                             
