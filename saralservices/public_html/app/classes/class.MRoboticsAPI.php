<?php
    class MRoboticsApi {
        ...
        public static function sendRequest($param) {
            ...
            $api_url ="https://mrobotics.in/api/recharge_get?api_token=b87fd7e9-db93-4b15-8281-2d73b1ab30fd&mobile_no=".$param['number']."&amount=".$param['amount']."&order_id=web".$param['txnid']."&";
            ...
            //update api url
            $mysql->execute("update `_tbl_transactions` set `APIID`='1', `APIName`='mrobotics', `calledurl`='".$api_url."'  where `txnid`='".$param['txnid']."'");
