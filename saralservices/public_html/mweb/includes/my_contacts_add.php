                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            ...
                                            ?>
                                            <input type="text"  value="<?php echo (isset($_POST['MobileNumber']) ? $_POST['MobileNumber'] : $mobnumber);?>" maxlength="10" name="MobileNumber" id="MobileNumber" class="form-control" placeholder="Mobile Number" required>
                                        </div>
