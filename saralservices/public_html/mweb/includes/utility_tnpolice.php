                ...
                <div class="col-md-12" style="padding: 5px;">
                    <div class="card" style="background: none;">
                        <div class="card-header">
                            <div class="card-title" style="text-align: center;">TN Police</div>
                        </div>
                        <div class="card-body" style="padding: 0px;">
                            <form action="" method="post" style="width: 80%;margin: 0px auto;" id="ContactForm" onsubmit="return doConfrim();">
                                <div class="row">
                                ...
                                <div id="chassis">
                                    <div class="row" id="chassis">
                                      <div  class="col-lg-12 col-md-12 col-sm-12">
                                        <label style="text-transform:none ;">Chassis Number</label>
                                 ...
                                 <div class="row">
                                    <div  class="col-lg-12 col-md-12 col-sm-12">
                                        <label style="text-transform:none ;">Vechicle Owner Name</label>
                                ...
                                <div class="row">     
                                    <div  class="col-lg-12 col-md-12 col-sm-12">
                                        <label style="text-transform:none ;">Amount</label>
                                     ...
                                     <div  class="col-lg-12 col-md-12 col-sm-12">
                                         <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1" style="padding-left:13px;font-weight:bold;font-size:12px;">+91</span>
                                            </div>
...
function doSaveutilitytnpolice() {
    IsConfirm=1;
        ...
        var buttons = "<div style='text-align:center;padding:10px;'><button type='button' class='btn btn-primary btn-sm' onclick='location.href=\"dashboard.php?action=utility_tnpolice\"'>Continue</button>";
