                ...
                <div class="col-md-12" style="padding: 5px;">
                    <div class="card" style="background: none;">
                        <div class="card-header">
                            <div class="card-title" style="text-align: center;">Edit My Contacts</div>
                        </div>
                        <div class="card-body" style="padding: 0px;">
                            <form action="" method="post" style="width: 80%;margin: 0px auto;" id="ContactForm">
                            <input type="text"  value="<?php echo $mycontacts[0]['ContactID'];?>" name="ContactID" id="ContactID" style="display:none">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1" style="padding-left:13px;font-weight:bold;font-size:12px;">Mobile Number</span>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"  style="padding-left: 6px;font-weight:bold;font-size:12px;">Mobile Operator</span>
                                            </div>
                                ...
                                <div class="row">                                                                       
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"  style="padding-left:47px;font-weight:bold;font-size:12px;">EB Region</span>
                                            </div>
                                ...
                                <div class="row">                                                                       
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"  style="padding-left:40px;font-weight:bold;font-size:12px;">EB Number</span>
                                            </div>
                                            <input type="text"  value="<?php echo (isset($_POST['TNEBNumber']) ? $_POST['TNEBNumber'] : $mycontacts[0]['TNEBNumber']);?>" name="TNEBNumber" id="TNEBNumber" class="form-control" placeholder="TNEB Number" >
                                        </div>
                                ...
                                <div class="row" style="margin-top:25px;margin-bottom:10px;">
                                    <div class="col-lg-12 col-md-12 col-sm-12" >
                                        ...
                                        <button type="button" class="btn btn-danger" onclick="doConfrim()" name="submitRequest" style="width: 46%;float:right">Update</button>
                                    </div>                                        
                                </div>
                            </form>    
                        </div>
    ...
    if (Error==0) {
      ...
      var txt = '<h5 class="modal-title" style="text-align: center;width:100%">Confirmation</h5> <br>'
                ...
                +'<div class="form-group" style="text-align: left;">'
                    +'<div class="input-group mt-1">'
                        +'<div class="input-group-prepend">'
                            +'<span class="input-group-text" id="basic-addon1"  style="padding-left:44px;font-weight:bold;font-size:12px;">EB Number</span>'
                        +'</div>'
    ...
    $("#xconfrimation_text").html(loading);
        ...
        $.post( "webservice.php?action=updatemycontact",  $( "#ContactForm" ).serialize(),function( data ) {
            ...
            if (obj.status=="failure") {
                ...
                html += "<br>"; 
                html += "<div style='text-align:center;padding:10px;'><a href='dashboard.php?action=my_contacts_edit&cid="+obj.cid+"' class='btn btn-danger btn-sm' >Continue</a>";
            }
