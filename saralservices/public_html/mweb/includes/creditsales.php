        ...
        <tr>
            ...
            <?php
                if ($s['PayableAmount']>0) {
                    ...
                    <?php } ?>
             <br> 
            <a href="dashboard.php?action=credit_sales_paynow&paynow=<?php echo $s['CreditID'];?>" class="btn btn-success  glow position-relative" style="width: 120px !important;">Paynow</a>
             <?php
                } else {
                    ?>
                    <br>
...
function deleteCreditTrasnaction(id) {
    if ( confirm("Are you delete this history?") ) {
        location.href='dashboard.php?action=creditsales&htxn='+id;
    } 
    return false;
}
</script>