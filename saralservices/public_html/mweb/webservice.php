...
function GetMobileOperatorPlan() {
        ...
        case   'RB':
         ...
         case   'RJ':
          ...
          default :
                    ...
                    <img src="https://www.saralservices.in/app/assets/info.png"><br><br>
   ...
   <div>
    ...
    <div style="margin-bottom:10px;">
        <table>
            <tr>
                <td><img src='https://www.saralservices.in/app/assets/operator/<?php echo $optr;?>.png' style="width:64px"></td>
         ...
         <?php if($roffer>0 && $rdata['ERROR']==0) { ?>
            <div class="card" style="margin-bottom:5px;">
                <div style="margin-bottom:5px;">
                    <a class="card-header card-link collapsed" data-toggle="collapse" id="xcollapse1_0" href="#collapse1_0" style="width:100%;display:inherit;padding:5px;border:1px solid #f1f1f1;border-radius:0px;background:#f9f9f9" aria-expanded="false">
                        R-Offer
                    </a>                    
                </div>
                                ...
                                <?php foreach($rdata['RDATA'] as $pl ) { ?>
                                            <tr>                                          
                                                ...
                                                <td style="border-bottom:1px solid #ccc;padding-top:3px;padding-bottom:3px;vertical-align:top;text-align:right">
                                                    <a href="javascript:void(0)" onclick="selectAmount('<?php echo $pl['price'];?>','collapse1_0');" class="btn btn-primary btn-xs" style="float: right;padding:3px 10px;width:50px;font-size:11px;">
                                                        <?php echo $pl['price'];?>
                                                    </a>
                                                </td>
                                            </tr>      
...
function GetDTHPlan() {
   ...
   <div>
    ...
    <div style="margin-bottom:10px;">
        <table>
            <tr>
                <td><img src='https://www.saralservices.in/mweb/assets/operator/<?php echo $img;?>' style="width:64px"></td>
                <td style="padding-left:10px;line-height:15px;;">
                    <span style="font-size:25px"><?php echo $optr;?></span><br>
                </td>
            </tr>
...
function _getIFSCode() {
  ...
  //  curl_setopt($ch,CURLOPT_URL,"https://www.aaranju.in/ifscode/api.php?username=a2x4Lmn2cvLmluI&password=IGhhcHB==&uid=".$txnid."&ifscode=".$_GET['IFSCode']);
    curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
    curl_setopt($ch,CURLOPT_HEADER, false); 
    $output=curl_exec($ch);
    curl_close($ch);
                                ...
                                <?php if(sizeof($users)==0){ ?>
                                    <tr>
                                        <td style="text-align:center">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="location.href='dashboard.php?action=my_contacts_add'" style="padding-top: 1px;padding-bottom: 2px;padding-right: 7px;padding-left: 7px;">Add Contact</button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                            ...
                            <tbody>
                                <?php $i=1; foreach($users as $u) { ?>
                                    <tr id="tblid_<?php echo $i;?>"> 
                                        ...
                                        <td style="border-bottom:1px solid #ccc;padding-top:3px;padding-bottom:3px;vertical-align:top;text-align:right;padding-right:10px">
                                            <a href="dashboard.php?action=bill_tneb&ebnumber=<?php echo $u['TNEBNumber'];?>&region=<?php echo $u['TNEBRegion'];?>" class="btn btn-primary btn-xs" style="float: right;padding:3px 10px;width:50px;font-size:11px;">Select</a>
                                        </td>
                                    </tr>      
                                <?php $i++; } ?>
                                <?php if(sizeof($users)==0){ ?>
