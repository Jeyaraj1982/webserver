                                    ...
                                    if (sizeof($epin)==0) {
                                      ...
                                      if (strlen(trim($_POST['FirstName']))==0) {
                                       ...
                                       if (strlen(trim($_POST['MOVillage']))==0) {
                                          $ErrMOVillage="Please enter Village & Pin Code" ;
                                          $ErrorCount++;
                                      } 
                                      
                                       if (strlen(trim($_POST['MOAccount']))==0) {
                                          $ErrMOAccount="Please enter MO & A/C Number" ;
                                          $ErrorCount++;
                                      } 
                                      if (strlen(trim($_POST['BAccount']))==0) {
                                          $ErrBAccount="Please enter A/C Number" ;
                                          $ErrorCount++;
                                      }
                                      if (strlen(trim($_POST['IFSCode']))==0) {
                                          $ErrIFSCode="Please enter Bank & IFSC Code" ;
                                          $ErrorCount++;
                                      } 
                                      if (strlen(trim($_POST['BVillage']))==0) {
                                          $ErrBVillage="Please enter Name of Village" ;
                                          $ErrorCount++;
                                      }                         
                                      ...
                                      //       $MemberCode=SeqMaster::GetNextMemberCode(3);                                                                      
                                       // }                                                                     
                                          $Member = $mysql->insert("_tbl_member",array("MemberCode"         => $MemberCode,
                                                                                       ...
                                                                                       "BAccount"           => trim($_POST['BAccount']),
                                                                                       "IFSCode"            => trim($_POST['IFSCode']),
                                                                                       "BVillage"           => trim($_POST['BVillage']),
                ...
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card-title">
                                        <h4 style="margin-bottom: 1.5rem;font-weight: normal;margin-top: .5rem !important;opacity: .6;"><div>Create Member</div><span style="font-size: 1.1rem;">My Direct Downline</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form method="post" action="" onsubmit="return submitMember();" id="createform">
                                <div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">Village & Pin Code<span id="star">*</span></div>
                                        <div class="col-sm-9"><input type="text" name="MOVillage" id="MOVillage" placeholder="Village & Pin Code" class="form-control" value="<?php echo (isset($_POST['MOVillage']) ? $_POST['MOVillage'] : "");?>"><span class="errorstring" id="ErrMOVillage"><?php echo isset($ErrMOVillage)? $ErrMOVillage : "";?></span></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">MO & A/C Number<span id="star">*</span></div>
                                        <div class="col-sm-9"><input type="text" name="MOAccount" id="MOAccount" placeholder="MO & A/C Number" class="form-control" value="<?php echo (isset($_POST['MOAccount']) ? $_POST['MOVillage'] : "");?>"><span class="errorstring" id="ErrMOAccount"><?php echo isset($ErrMOAccount)? $ErrMOAccount : "";?></span></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">A/C Number<span id="star">*</span></div>
                                        <div class="col-sm-9"><input type="text" name="BAccount" id="BAccount" placeholder="A/C Number" class="form-control" value="<?php echo (isset($_POST['BAccount']) ? $_POST['BAccount'] : "");?>"><span class="errorstring" id="ErrBAccount"><?php echo isset($ErrBAccount)? $ErrBAccount : "";?></span></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">Bank & IFSC Code<span id="star">*</span></div>
                                        <div class="col-sm-9"><input type="text" name="IFSCode" id="IFSCode" placeholder="Bank & IFSC Code" class="form-control" value="<?php echo (isset($_POST['IFSCode']) ? $_POST['IFSCode'] : "");?>"><span class="errorstring" id="ErrIFSCode"><?php echo isset($ErrIFSCode)? $ErrIFSCode : "";?></span></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">Name of Village<span id="star">*</span></div>
                                        <div class="col-sm-9"><input type="text" name="BVillage" id="BVillage" placeholder="Name of Village" class="form-control" value="<?php echo (isset($_POST['BVillage']) ? $_POST['BVillage'] : "");?>"><span class="errorstring" id="ErrBVillage"><?php echo isset($ErrBVillage)? $ErrBVillage : "";?></span></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12" style="text-align:center;color:green"><hr></div>
                                    </div>                                                                       
