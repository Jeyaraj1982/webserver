            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Generate and Sold E-Pins</div>
                    </div>
                </div>
            </div>        
            <div class="tab-content" id="memform">
                                ...
                                <div class="card-body"> 
                                    <form method="post" action="" >
                                        <div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12" style="text-align:right"><button class="mb-2 mr-2 btn btn-gradient-primary" name="submitMember">Next</button></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
