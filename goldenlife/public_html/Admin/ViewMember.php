...
<?php
     ...
     ?>
          <script>location.href='dashboard.php?action=ViewMember&code=<?php echo $myprofile[0]['MemberCode'];?>';</script>
         <?php
         exit;
     }
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><input type="text" disabled='disabled'  style="background:#fff;border:1px solid #fff;"  name="MOVillage" id="MOVillage" placeholder="Money Order Village Name" class="form-control" value="<?php echo $myprofile[0]['MOVillage'];?>"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3">MO & A/C Number<span id="star">*</span></div>
                                    <div class="col-sm-9"><input type="text" disabled='disabled'  style="background:#fff;border:1px solid #fff;"  name="MOAccount" id="MOAccount" class="form-control" value="<?php echo $myprofile[0]['MOAccount'];?>"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3">A/C Number<span id="star">*</span></div>
                                    <div class="col-sm-9"><input type="text" disabled='disabled'  style="background:#fff;border:1px solid #fff;"  name="BAccount" id="BAccount" class="form-control" value="<?php echo $myprofile[0]['BAccount'];?>"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3">Bank & IFSC Code<span id="star">*</span></div>
                                    <div class="col-sm-9"><input type="text" disabled='disabled'  style="background:#fff;border:1px solid #fff;"  name="IFSCode" id="IFSCode" class="form-control" value="<?php echo $myprofile[0]['IFSCode'];?>"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3">Name of Village<span id="star">*</span></div>
                                    <div class="col-sm-9"><input type="text" disabled='disabled'  style="background:#fff;border:1px solid #fff;"  name="BVillage" id="BVillage" class="form-control" value="<?php echo $myprofile[0]['BVillage'];?>"></div>
                                </div>
                            </div>
                        </div>
                    </div>                                                                                             
                        ...
                        <div class="card-body">
                            <div>
                                            ...
                                            <tr>                 
                                                ...
                                                <form method="post" action="">
                                                   ...
                                                   <?php if($kycInformation['KycVerified']==0){?>
                                                         <button type="submit" name="ApproveKyc" class="btn btn-primary">Approve</button>
                                                   <?php }?>
                              ...
                              <div class="form-group row" style="margin-bottom:0px"  style="text-align:right;">
                                    <div class="col-sm-12" style="text-align:right"><a href="dashboard.php?action=AddKYCInformation&code=<?php echo $myprofile[0]['MemberCode'];?>">Add</a></div>
                              </div>
                            </div>
                        </div>
                    </div>                                                                                             
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                                ...
                                                <td style="text-align: center;">
                                                 <form method="post" action="">
                                                   ...
                                                   <?php if($nominiInformation['NomineeVerified']==0){?>
                                                          <button type="submit" name="ApproveNominee" class="btn btn-primary">Approve</button>
                                                   <?php }?>
                                ...
                                <?php } ?>
                              <div class="form-group row" style="margin-bottom:0px"  style="text-align:right;">
                                    <div class="col-sm-12" style="text-align:right"><a href="dashboard.php?action=AddNomineeInformation&code=<?php echo $myprofile[0]['MemberCode'];?>">Add</a></div>
                              </div>
                            </div>
                        </div>
                    </div>                                                                                             
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <?php } ?>
                              <div class="form-group row" style="margin-bottom:0px"  style="text-align:right;">
                                    <div class="col-sm-12" style="text-align:right"><a href="dashboard.php?action=AddBankInformation&code=<?php echo $myprofile[0]['MemberCode'];?>">Add</a></div>
                              </div>
                            </div>
                        </div>
                    </div>                                                                                             
