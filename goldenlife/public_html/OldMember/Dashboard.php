                ...
                <div class="col-sm-6 col-md-4 col-xl-4">
                                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                        ...
                                        <div class="widget-chart-content">
                                            ...
                                            <?php echo sizeof($mysql->select("select SoldMemberCode from  _tbl_epins where IsUsed='0' and SoldMemberCode='".$_SESSION['User']['MemberCode']."' and `PinPackageID`='1'")); ?>/<?php echo sizeof($mysql->select("select SoldMemberCode from  _tbl_epins where SoldMemberCode='".$_SESSION['User']['MemberCode']."' and `PinPackageID`='1'")); ?>
                                            </span></div>
