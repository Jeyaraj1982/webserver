...
<head>                                          
    ...
    <link href="styleold.css?v=<?php echo rand(3,3333);?>" rel="stylesheet">
                        ...
                        <div class="widget-content-wrapper">
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    ...
                                    <div tabindex="-1" id="chn" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right" style="min-width:250px;max-width:250px;height:180px">
                                        <div class="dropdown-menu-header">
                                            <div class="dropdown-menu-header-inner bg-info"  data-toggle="dropdown">
                                       ...
                                       <!--class="btn-pill btn-shadow btn-shine btn btn-focus" <ul class="nav flex-column">
