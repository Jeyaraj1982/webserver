                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="col-sm-9"><input type="text" name="MemberFatherName" id="MemberFatherName" placeholder="Father's Name" class="form-control" value="<?php echo $myprofile[0]['MemberFatherName'];?>"></div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9"><input type="text"  name="MOVillage" id="MOVillage" placeholder="Money Order Village Name" class="form-control" value="<?php echo $myprofile[0]['MOVillage'];?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-3">MO & A/C Number<span id="star">*</span></div>
                                                    <div class="col-sm-9"><input type="text"  name="MOAccount" id="MOAccount" placeholder="Money Order A/C & Mobile Number" class="form-control" value="<?php echo $myprofile[0]['MOAccount'];?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-3">A/C Number<span id="star">*</span></div>
                                                    <div class="col-sm-9"><input type="text" name="BAccount" id="BAccount" placeholder="Account Number" class="form-control" value="<?php echo (isset($_POST['BAccount']) ? $_POST['BAccount'] : $myprofile[0]['BAccount']);?>"><span class="errorstring" id="ErrBAccount"><?php echo isset($ErrBAccount)? $ErrBAccount : "";?></span></div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-3">Bank & IFSC Code<span id="star">*</span></div>
                                                    <div class="col-sm-9"><input type="text" name="IFSCode" id="IFSCode" placeholder="IFSCode" class="form-control" value="<?php echo (isset($_POST['IFSCode']) ? $_POST['IFSCode'] : $myprofile[0]['IFSCode']);?>"><span class="errorstring" id="ErrIFSCode"><?php echo isset($ErrIFSCode)? $ErrIFSCode : "";?></span></div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-3">Name of Village<span id="star">*</span></div>
                                                    <div class="col-sm-9"><input type="text" name="BVillage" id="BVillage" placeholder="VillageName" class="form-control" value="<?php echo (isset($_POST['BVillage']) ? $_POST['BVillage'] : $myprofile[0]['BVillage']);?>"><span class="errorstring" id="ErrBVillage"><?php echo isset($ErrBVillage)? $ErrBVillage : "";?></span></div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <div class="col-sm-12"><button type="submit" class="mb-2 mr-2 btn btn-gradient-primary" name="updateBtn">Update Profile</button></div>
                                                </div>
                                            </div>
                                            </form>
                                        </div>
