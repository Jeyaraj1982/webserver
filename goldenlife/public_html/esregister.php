            ...
            <div class="container" style="padding-bottom: 35px;"> 
                ...
                <form id="memberform" method="post" action=""   onsubmit="return submitRegister()">
                    <div class="h5 modal-title text-center">
                        <h4 class="mt-2" style="margin-bottom: 1.5rem;font-weight: normal;margin-top: .5rem !important;opacity: .6;"><div style="color:#333 !important">GLS Member Registration Form</div><span style="font-size: 1.1rem;">Using Epin, Epin Password & Sponsor ID</span>   </h4>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="h5 modal-title text-center">
                        <h4 class="mt-2" style="margin-bottom: 1.5rem;font-weight: normal;margin-top: .5rem !important;opacity: .6;"><span style="font-size: 1.1rem;">My Sponsor's Info</span>   </h4>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4">Sponsor's ID</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="SponsorID" placeholder="Sponser ID here ..." id="SponserID" value="<?php echo isset($_POST['SponsorID']) ? $_POST['SponsorID'] : '';?>" style="padding: 10px 14px;border-radius: 0;box-shadow: none;font-size: 15px;">
                            <span class="errorstring" id="ErrSponserID"><?php echo isset($ErrSponserID)? $ErrSponserID : "";?></span>
                        </div> 
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4">Sponsor's Name</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="SponserName" placeholder="Sponser Name here ..." id="SponserName" value="<?php echo isset($_POST['SponserName']) ? $_POST['SponserName'] : '';?>" style="padding: 10px 14px;border-radius: 0;box-shadow: none;font-size: 15px;">
