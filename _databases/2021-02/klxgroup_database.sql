...
MySQL - 5.7.33 : Database - klxgroup_database
*********************************************************************
*/
...
insert  into `_tbl_foods_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (5,'Nagercoil',1);
insert  into `_tbl_foods_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (6,'Kanya Kumari',1);
insert  into `_tbl_foods_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (7,'Monday Market',1);
insert  into `_tbl_foods_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (8,'Muttom',0);
...
insert  into `_tbl_from_places`(`FromPlaceID`,`FromPlaceName`) values (1,'Marthandam');
insert  into `_tbl_from_places`(`FromPlaceID`,`FromPlaceName`) values (2,'Thuckalay');
insert  into `_tbl_from_places`(`FromPlaceID`,`FromPlaceName`) values (3,'Kulasekharam');
...
insert  into `_tbl_hotel_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (1,'Marthandam',1);
insert  into `_tbl_hotel_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (2,'Nagercoil',1);
insert  into `_tbl_hotel_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (3,'Kanyakumari',1);
insert  into `_tbl_hotel_citynames`(`HotelCityNameID`,`CityName`,`IsActive`) values (4,'Chennai',0);
...
insert  into `_tbl_hotels`(`HotelID`,`HotelCityNameID`,`HotelName`,`HotelThumb`,`HotelDescription`,`IsActive`) values (1,2,'Pepper Residency','Pepper Residency.png','Best Hotels in nagercoil',1);
insert  into `_tbl_hotels`(`HotelID`,`HotelCityNameID`,`HotelName`,`HotelThumb`,`HotelDescription`,`IsActive`) values (2,2,'Hotel Ganga Tamilnadu','ganga.jpg',NULL,1);
insert  into `_tbl_hotels`(`HotelID`,`HotelCityNameID`,`HotelName`,`HotelThumb`,`HotelDescription`,`IsActive`) values (3,2,'Hotel Ramraj Regency','Hotel Ramraj Regency.jpg',NULL,1);
insert  into `_tbl_hotels`(`HotelID`,`HotelCityNameID`,`HotelName`,`HotelThumb`,`HotelDescription`,`IsActive`) values (4,2,'SGS Lodgings International','sgs.jpg',NULL,1);
insert  into `_tbl_hotels`(`HotelID`,`HotelCityNameID`,`HotelName`,`HotelThumb`,`HotelDescription`,`IsActive`) values (5,1,'GSSS 123','Pepper Residency.png','sadfgsagsag456',0);
...
insert  into `_tbl_hotels_packages`(`HotelPackageID`,`HotelCityNameID`,`HotelID`,`PackageName`,`Price`,`OfferPrice`,`Description`,`IsActive`) values (1,2,1,'Single Bed Rome AC','850','800',NULL,1);
insert  into `_tbl_hotels_packages`(`HotelPackageID`,`HotelCityNameID`,`HotelID`,`PackageName`,`Price`,`OfferPrice`,`Description`,`IsActive`) values (2,2,1,'Single Bed Room Non-AC','700','650',NULL,1);
insert  into `_tbl_hotels_packages`(`HotelPackageID`,`HotelCityNameID`,`HotelID`,`PackageName`,`Price`,`OfferPrice`,`Description`,`IsActive`) values (3,2,1,'Double Bed Room AC','1500','1400',NULL,1);
insert  into `_tbl_hotels_packages`(`HotelPackageID`,`HotelCityNameID`,`HotelID`,`PackageName`,`Price`,`OfferPrice`,`Description`,`IsActive`) values (4,2,1,'Double Bed Room Non-AC','1800','1700',NULL,1);
insert  into `_tbl_hotels_packages`(`HotelPackageID`,`HotelCityNameID`,`HotelID`,`PackageName`,`Price`,`OfferPrice`,`Description`,`IsActive`) values (5,2,1,'Triple Bed A/C','3333','2222','Triple Bed A/C',1);
insert  into `_tbl_hotels_packages`(`HotelPackageID`,`HotelCityNameID`,`HotelID`,`PackageName`,`Price`,`OfferPrice`,`Description`,`IsActive`) values (6,2,1,'package single room','1500','1300','Details',0);
...
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (1,'Auto',NULL,'auto.png',1,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (2,'Maruthi Ertiga',NULL,'ertiga.png',2,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (3,'Innova',NULL,'inova.png',3,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (4,'Mahindra Van',NULL,'mahindravan.png',4,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (5,'Maruthi Swift',NULL,'swift.png',5,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (6,'Tempo Traveller',NULL,'temp_traveller.png',6,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (7,'etios.png',NULL,'tyotaets.png',7,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (8,'Indica V2',NULL,'tataindigo.png',8,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (9,'Fortuine',NULL,'toya_for.png',9,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (10,'Polo',NULL,'polo.png',10,1);
insert  into `_tbl_taxi`(`TaxiTypeID`,`TaxiName`,`Description`,`TaxiThumb`,`taxi_order`,`IsActive`) values (11,'Xylo','Rs. 15 per km','mahindra-xylo-car-500x500.png',11,1);
