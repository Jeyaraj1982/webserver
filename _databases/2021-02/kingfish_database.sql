...
MySQL - 5.7.33 : Database - kingfish_database
*********************************************************************
*/
...
insert  into `_tbl_product_categories`(`CategoryID`,`CategoryName`) values (2,'Fish');
insert  into `_tbl_product_categories`(`CategoryID`,`CategoryName`) values (3,'Furits & Vegitables');
insert  into `_tbl_product_categories`(`CategoryID`,`CategoryName`) values (4,'Other foods');
...
insert  into `_tbl_products`(`ProductID`,`CategoryID`,`CategoryName`,`ProductName`,`ProductPrice`,`filepath1`,`Description`,`AddedOn`,`IsPublish`,`Isdelete`) values (47,2,'','நண்டு ','120/kg','Three_Spot_Crab_01.jpg','Nandu ','2020-09-01 23:28:40',1,0);
