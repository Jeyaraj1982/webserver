                                ...
                                <?php 
                                    ...
                                    switch($_REQUEST['view']) {
                                      ...
                                      $sql    = " where distcid='".$_SESSION['FRANCHISEE']['DistrictID']."' and  date(postedon)=date('".date("Y-m-d")."') ";
                                                            $rows   = sizeof(JPostads::getPostads(0,$sql));
                                                            $result = JPostads::getPostads(0, $sql." order by postadid desc ");
                               ...
                               <?php foreach ($result as $r){   ?> 
                                <tr class='mytr'>
                                    ...
                                    <td width='160' style='text-align:center;'>
                                        <form action='https://klx.co.in/Franchisee/dashboard.php?action=postad/managepostads' method='post' style='height:0px;'>
