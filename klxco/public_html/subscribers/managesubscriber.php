                            ...
                            <div class="card-title">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action='https://klx.co.in/klxadmin/dashboard.php?action=faq/managefaq' method='post' style='height:0px;'>
                                        ...
                                        <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='https://klx.co.in/klxadmin/dashboard.php?action=subscribers/viewsubscriber'"> 
                                   </form>
                             </div>      
                                <?php
                                 exit;
