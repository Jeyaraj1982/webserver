     ...
     include_once("config.php"); 
       $obj = new CommonController();
         ...
         if (isset($_POST['loginbtn'])) {
                 ...
                 $state = $mysql->select("select * from _jstatenames where stateid='".$_POST['state']."'");
                 $district = $mysql->select("select * from _jdistrictnames where distcid='".$_POST['district']."'");
                 
                  $mysql->execute("update _jusertable set stateid       ='".$_POST['state']."',
                                                          statename       ='".$state[0]['statenames']."',
...
<body class="login">
        ...
        <div class="container container-login animated fadeIn">
            ...
            <div class="login-form">
                <!--<div class="form-group form-floating-label">
                    ...
                    <label for="countryid" class="placeholder">Country Name</label>
                </div>
                <div class="form-group form-floating-label">
                    ...
                    <label for="state" class="placeholder">State Name</label>
                </div>
                <div class="form-group form-floating-label">
                    ...
                    <label for="district" class="placeholder">District Name</label>
                </div>  -->
                <div class="row mb-2">
                                <div class="col-sm-12">
                                    <label >Country Name</label>
                                   <select name="countryid" disabled="disabled" required id="countryid" class="form-control" onchange="getStateNames($(this).val())">
                                        <option value="0" selected="selected">Select Country</option> 
                                        <?php foreach(JPostads::getCountryNames() as $countryname) {?>
                                        <option value="<?php echo $countryname['countryid'];?>" <?php echo ($countryname['countryid']==$record[0]['countryid'])? 'selected="selected"':'';?><?php echo isset($_POST['country']) ? $_POST['countryid'] : ""; ?>><?php echo $countryname['countryname'];?></option>
                                        <?php } ?>
                                    </select>  
                                </div>
                            </div>                                     
                ...
                <div class="form-action mb-3">
                    <button type="submit"  name="loginbtn"class="btn btn-primary btn-rounded btn-login" style="width:auto;padding:4px 20px;">Update</button>
                </div>
                <div class="form-action mb-3">
   ...
   $(document).ready(function(){
     getStateNames('<?php echo $record[0]['countryid'];?>');
   });
   </script> 
