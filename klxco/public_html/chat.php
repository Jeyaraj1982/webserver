        ...
        <div class="col-md-12" style="height:50px;background:#e5e5e5;padding-top:10px;padding-bottom:10px;">
            <div style="width:100%">
                <table style="width: 95%;margin:0px auto">
                    <tr>
                        <td style="width:32px">
                            <a href="<?php echo country_url;?>"><img src="https://www.klx.co.in/assets/back_1.png" style="height:24px"></a> 
                        </td>
                        <td style="width:32px">
                            <img src="https://www.klx.co.in/assets/user.png" style="height:32px"> 
                        </td>
                        ...
                        <td style="width:32px">
                            <?php if ($_SESSION['USER']['userid']==$postedBy) { ?>
                              <a href="tel:<?php echo $viewedByInfo[0]['mobile'];?>"><img src="https://www.klx.co.in/assets/phone.png" style="height:24px"></a><br> 
                            <?php }  else {?>
                            <a href="tel:<?php echo $postedByInfo[0]['mobile'];?>"><img src="https://www.klx.co.in/assets/phone.png" style="height:24px"></a><br> 
                            <?php } ?>
                        </td>
                    </tr>
                </table>
