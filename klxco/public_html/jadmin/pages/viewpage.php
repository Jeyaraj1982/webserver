...
include_once("../../config.php");
    ...
    if (isset($_POST['rmimage'])) {
     ...
     if(isset($_POST{"updatebtn"})) {
         ...
         $param = array("pageid"=>$_POST['rowid'],"pagetitle"=>$_POST['pagetitle'],"pagedescription"=>str_replace("'","\\'",$_POST['pagedescription']),"ispublish"=>$_POST['ispublished'],"ishomepage"=>$_POST['ishomepage'],""=>$_POST['noofvisit'],"keywords"=>$_POST['keywords'],"description"=>$_POST['desc']);
...
textarea {font-family:'Trebuchet MS';font-size:13px;color:#222;width:100%}
    ...
    <div class="titleBar">Edit Page</div>
    <form action="" method="post" style="height: 20px;"  enctype="multipart/form-data">
        ...
        <table cellpadding="5" cellspacing="0" align="center">
            <tr>
                ...
                <td><?php echo Jca::getAppSetting('siteurl');?>/index.php?page=<?php echo $pageContent[0]['pageid'];?></td> 
            </tr>
            <tr>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td rowspan="2"> 
                                ...
                                Is HomePage? <select name="ishomepage"><option value='1' <?php echo ($pageContent[0]["ishomepage"]) ? 'selected="selected"' : '';?>>Yes</option><option value='0' <?php echo ($pageContent[0]["ishomepage"]!=1) ? 'selected="selected"' : '';?>>No</option></select><br>
            ...
            <tr>
                <td colspan="2"><hr style="border:none;border-bottom:1px solid #e5e5e5"></td>
            </tr>
            <tr>
      ...
      <div class="titleBar">View Page</div>
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       $pageContent = JPages::getPages($_POST['rowid']);
       ?>
      <div class="titleBar">Delete Page</div>
