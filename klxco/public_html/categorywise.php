        ...
        <a class="btn btn-outline-primary btn-sm" style="width:50px;" href="<?php echo country_url;?>">Back</a><br><br>
            <div class="page-header">
                ...
                <ul class="breadcrumbs" style="border:none;margin-left:0px;padding-left:0px;">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo country_url;?>myads" >My Posted Ads</a>
                    </li>
                </ul>
            </div>
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">My Posted Ads</h4>
                </div>
                <div class="card-body">
                    <div class="row row-projects">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card adbox"  style="height:500px !important">
                                <div class="p-2 text-center">
                                    <img class="card-img-top rounded adImage" src="<?php echo base_url;?><?php echo $filename;?>" alt="Product 7">
                                    <br>Ad ID: <?php echo $ad['postadid'];?>
                                    <?php if ($ad['isdeleted']==1) {?>
                                    <div> <a class="btn btn-danger  btn-sm" style="padding:2px 5px">deleted</a> </div>
                                    <?php } else { ?>
                                    ...
                                    <?php } if ($ad['isdeleted']!=1) { ?>
                                       <div class="dropdown dropdown-kanban" style="float: right;">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <!--<a class="dropdown-item" href="<?php echo country_url;?>view/m<?php echo $ad['postadid'];?>" draggable="false">Trash</a>-->
