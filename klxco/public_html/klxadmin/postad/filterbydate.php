                               ...
                               <?php foreach ($result as $r){   ?> 
                                <tr class='mytr'>
                                    ...
                                    <td width='160' style='text-align:center;'>
                                        <form action='https://klx.co.in/klxadmin/dashboard.php?action=postad/managepostads' method='post' style='height:0px;'>
                                            ...
                                            <a href="https://klx.co.in/klxadmin/dashboard.php?action=postad/view&rowid=<?php echo  $r["postadid"];?>">view</a>
