                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <form action="" method="POST" id="CountryFrm">
                                                ...
                                                <td style="padding-left:10px;text-align:left"><a class="leftMenu" href="https://klx.co.in/klxadmin/dashboard.php?action=country/managestatenames&countryid=<?php echo $d['countryid'];?>" target="rpanel"><?php echo $d['countryname'];?></a></td>
...
function ConfirmationEditCountry(country){
 ...
 function doUpdate() {
    ...
    if(ErrorCount==0){
        ...
        $.post( "https://klx.co.in/webservice.php?action=UpdateCountryName",  $( "#CountryFrm" ).serialize(),function( data ) {
