                                 ...
                                 <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:10px;text-align:left"><a class="leftMenu" href="https://klx.co.in/klxadmin/dashboard.php?action=category/managesubcategories&categid=<?php echo $d['categid'];?>"><?php echo $d['categname'];?></a></td>
