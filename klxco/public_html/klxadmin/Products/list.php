 <?php 
    if($_GET['status']=="All"){ 
        $products = $mysql->select("select * from _tbl_products where IsAdmin='1' order by ProductID Desc");
        $title="All Products";
    }if($_GET['status']=="Active"){
        $products = $mysql->select("select * from _tbl_products where IsActive='1' and IsAdmin='1' order by ProductID Desc");
        $title="Active Products";
    }if($_GET['status']=="Disable"){
        $products = $mysql->select("select * from _tbl_products where IsActive='0' and IsAdmin='1' order by ProductID Desc");
                                 ...
                                 <table class="table table-striped mt-3">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align: right;">Referal Income</th>                                   
                                                <th scope="col" style="text-align: right;">Links</th>                                   
                                                <th scope="col"> </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <?php foreach($products as $product){ 
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right"><?php echo $product['ReferalIncome'];?></td>
                                                <td style="text-align:right"><?php echo sizeof($q);?></td>
