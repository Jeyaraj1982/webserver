                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="https://klx.co.in/klxadmin/dashboard.php?action=Requests/FranchiseeWithdrawalRequests&filter=All" <?php if($_GET['filter']=="All"){ ?> style="text-decoration:underline;font-weight:bold;"<?php } ?>>All</a>&nbsp;&nbsp;|&nbsp;&nbsp;    
                                    <a href="https://klx.co.in/klxadmin/dashboard.php?action=Requests/FranchiseeWithdrawalRequests&filter=Requested" <?php if($_GET['filter']=="Requested"){ ?> style="text-decoration:underline;font-weight:bold;"<?php } ?>>Requested</a>&nbsp;&nbsp;|&nbsp;&nbsp;    
                                    <a href="https://klx.co.in/klxadmin/dashboard.php?action=Requests/FranchiseeWithdrawalRequests&filter=Paid" <?php if($_GET['filter']=="Paid"){ ?> style="text-decoration:underline;font-weight:bold;"<?php } ?>>Paid</a>&nbsp;&nbsp;|&nbsp;&nbsp;    
                                    <a href="https://klx.co.in/klxadmin/dashboard.php?action=Requests/FranchiseeWithdrawalRequests&filter=Rejected" <?php if($_GET['filter']=="Rejected"){ ?> style="text-decoration:underline;font-weight:bold;"<?php } ?>>Rejected</a>    
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
