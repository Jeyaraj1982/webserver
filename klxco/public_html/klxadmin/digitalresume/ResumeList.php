                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="dashboard.php?action=digitalresume/CreateResume" class="btn btn-primary btn-xs">Add Resume</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                 <table class="table table-striped mt-3">
                                        ...
                                        <?php foreach($resumes as $resume){ ?>
                                            <tr>
                                                <td><img src="<?php echo "../share/uploads/".$resume['ProfilePhoto'];?>" style='width: 50px;height:50px;margin-top: 5px;'></td>
                                                <td><?php echo $resume['ResumeName'];?></td>
                                                <td><?php echo $resume['MobileNumber'];?></td>
                                                <td><?php echo $resume['EmailID'];?></td>
                                                <td style="text-align: right">
                                                <a href="dashboard.php?action=digitalresume/updateresume&id=<?php echo $resume['ResumeID'];?>">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="dashboard.php?action=digitalresume/viewresume&id=<?php echo $resume['ResumeID'];?>">View</a>&nbsp;&nbsp;|<span onclick='CallConfirmation(<?php echo $resume['ResumeID'];?>)' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                                                </td>
                                            </tr>
                                        <?php } ?>
