<?php
    if (isset($_POST['btnsubmit'])) {
        $ErrorCount =0;
            $dupmobile = $mysql->select("select * from _tbl_franchisee where userid='".$_POST['MobileNumber']."'");
            if(sizeof($dupmobile)==0){
                $ErrMobileNumber="Franchisee Not Found in this ID";  
                $ErrorCount++;  
            }
            if($ErrorCount==0){ 
                $data = $mysql->select("select * from _tbl_franchisee where userid='".$_POST['MobileNumber']."'");
                ?>
                <script>
...
$(document).ready(function () {
    $("#MobileNumber").blur(function () {
        if(IsNonEmpty("MobileNumber","ErrMobileNumber","Please Enter Franchisee ID")){
           IsNumeric("MobileNumber","ErrMobileNumber","Please Enter Numeric Characters Only"); 
        }
    });
                        ...
                        <form id="exampleValidation" method="POST" action="" onsubmit="return SubmitFranchisee();" id="addProduct" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-left">Franchisee ID<span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="MobileNumber" name="MobileNumber" placeholder="Enter FranchiseeID" value="<?php echo (isset($_POST['MobileNumber']) ? $_POST['MobileNumber'] :"");?>">                                    
                            ...
                            <div class="card-body">  
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        ...
                                        <input type="hidden" class="form-control" id="FranchiseeID" name="FranchiseeID" value="<?php echo $data[0]['userid'];?>">                                    
...
function SuccessPopup(){
    html = "<div class='form-group row'><div class='col-sm-12' style='text-align:center'><img src='assets/tick.jpg' style='width:128px'><br><br>Credits Added Successfully<br></div></div>";
        html += "<div style='padding:20px;text-align:center'>" + "<a href='dashboard.php?action=digitalresume/AddCredits' class='btn btn-outline-success'>Continue</a></div>"; 
