                    ...
                    <div class="card">
                        ...
                        <div class="card-body">    
                            <div style="text-align: right;">
                                ...
                                <a href="dashboard.php?action=additional/photoads/newad" class="btn btn-info btn-sm">Add</a>
                            </div>
                        
                           <?php
                                    if (isset($_POST['DeleteBtn'])) {
                                        $mysql->execute("delete from Ads_Photo where PhotoAdID='".$_POST['PhotoAdID']."'");
                            ...
                            <div class="table-responsive">
                                 ...
                                 <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($data as $r){     ?>
                                        <tr>
                                            <td><?php echo $r["PhotoAdID"];?></td>
                                           <td class="mytd">
                                            <img src="https://www.klx.co.in/assets/photoads/<?php echo $r["FileName"];?>" style="height:100px"></td>
                                           <td class="mytd"><?php echo $r["CreatedOn"];?></td>
                                           <td class="mytd">
                                           <form action="" method="post">
                                           <input type="hidden" value="<?php echo $r['PhotoAdID'];?>" name="PhotoAdID">
