    ...
    <div class="container">
     ...
     $obj = new CommonController();
      ...
      if(empty($errors)==true) {
         move_uploaded_file($file_tmp,"../assets/otherads/".$file_name);
            ...
            $param=array("FileName" => $file_name,
               ...
               $id = $mysql->insert("Ads_Others",$param);
                            ...
                            <div class="card-action">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="dashboard.php?action=additional/others/manage" class="btn btn-outline-success">Back</a>
                                    </div>                                        
                                </div>
                            </div>
                        </form>                          
