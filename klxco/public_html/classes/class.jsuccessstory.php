<?php
    class JSuccessStory { 
        ...
        function addStory($param){
            global $mysql; 
            return $mysql->insert("_jsuccessstory",array("storytitle"=>$param['storytitle'],"storydesc"=>$param['storydescription'],"storyname"=>$param['storyname'],"email"=>$param['email'],"mobile"=>$param['mobileno'],"storytype"=>$param['storytype'],"filepath"=>$param['filename'],"postedon"=>date("Y-m-d H:i:s"),"ispublish"=>$param['ispublish']));   
        }
        ...
        function updateStory($param,$storyid){
            ...
            return $mysql->execute("update _jsuccessstory set storytitle='".$param['storytitle']."',storydesc='".$param['storydescription']."',storyname='".$param['storyname']."',email='".$param['email']."',mobile='".$param['mobileno']."',ispublish='".$param['ispublish']."',lastmodified='".date("Y-m-d H:i:s")."'".$sql." where storyid='".$param['storyid']."'");
