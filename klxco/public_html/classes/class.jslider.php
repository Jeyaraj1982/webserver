<?php
      class JSlider {
          ...
          function addSlider($param) {
              ...
              return $mysql->insert("_jslider",array("slidertitle"=>$param['slidertitle'],"sliderdesc"=>$param['sliderdescription'],"filepath"=>$param['filename'],"ispublished"=>$param['ispublished'],"postedon"=>date("Y-m-d H:i:s"),"sliderorder"=>$param['sliderorder'])); 
          ...
          function updateSlider($param,$sliderid) {
              ...
              return $mysql->execute("update _jslider set slidertitle='".$param['slidertitle']."',sliderdesc='".$param['sliderdescription']."',ispublished='".$param['ispublished']."',sliderorder='".$param['sliderorder']."'".$sql." where sliderid='".$param['sliderid']."'");
          }
