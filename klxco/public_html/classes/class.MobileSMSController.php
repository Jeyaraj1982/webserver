      ...
      //      if ($adminID>0) {
        //        $user = $mysql->select("select * from _tbl_admin where AdminID='".$adminID."'");
          //      $userid= $user[0]['AdminID'];
            ...
            //$url = "http://103.146.177.183/api/mt/SendSMS?user=infant&password=infant1&number=".$mobileNumber."&text=".urlencode($text)."&senderid=WEBSMS&channel=Trans&DCS=0&flashsms=0&route==7&APIKey=ZTevx8iXIUqegAKJeZncJA";
