                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" class="btn btn-warning" name="cancelbtn"  onclick="location.href='https://klx.co.in/klxadmin/dashboard.php?action=successstories/viewstories'">Cancel</button>
                                        </div>                                        
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="card-title">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action='https://klx.co.in/klxadmin/dashboard.php?action=successstories/managestories' method='post' style='height:0px;'>
                                        ...
                                        <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='https://klx.co.in/klxadmin/dashboard.php?action=successstories/viewstories'"> 
                                   </form>
                                </div>
                                <?php
                                    exit;                                                  
