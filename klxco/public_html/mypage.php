                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                         ...
                                                         <div class="col-6" style="text-align: right;">
                                                            <a class="btn btn-primary btn-sm" style="border:1px solid #fff !important;" href="https://www.klx.co.in/in/upgrade/c0">VIEW PACKAGES</a>
                                                         </div>
                                                    </div>
                                                </div>
                    </div>
...
<?php if (isset($_GET['vm'])) {?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body" style="text-align: center;">
      Your mobile number verified by klx
      </div>
...
<?php if (isset($_GET['em'])) {?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body" style="text-align: center;">
      Your email verified by klx
      </div>

      <!-- Modal footer -->
      <div class="modal-footer"  style="border-top:none">
        
            <button type="button" class="btn btn-primary" onclick="location.href='https://www.klx.co.in/in/freeadpost'">Continue</button>
