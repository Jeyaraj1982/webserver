                                             ...
                                             <table id="basic-datatables" class="table table-bordered" style="border-top:1px solid #ebedf2;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right"><a href="javascript:void(0)" onclick="EditExperienceDetails('<?php echo $Epericence['ExperienceID'];?>')">Edit</a>&nbsp;&nbsp;<span onclick="ConfirmationDeleteEpericence('<?php echo $Epericence['ExperienceID'];?>','<?php echo $Epericence['FromYear']."-".$Epericence['FromMonth']."-".$Epericence['ToYear']."-".$Epericence['ToMonth'];?>','<?php echo $Epericence['Title'];?>','<?php echo $Epericence['WorkingPlace'];?>','<?php echo $Epericence['Description'];?>')" style="background: #ff5a5a;color:white;padding: 2px 5px 2px 5px;font-size: 12px;border-radius: 5px;cursor:pointer">Delete</span></td>
                                                    </tr>
                                                    <?php } ?>
                                            ...
                                            <table id="basic-datatables" class="table table-bordered" style="border-top:1px solid #ebedf2;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right"><a href="javascript:void(0)" onclick="EditHobbiesDetails('<?php echo $Hobby['AdditionalInfoID'];?>')">Edit</a>&nbsp;&nbsp;<span onclick="ConfirmationDeleteHobbies('<?php echo $Hobby['AdditionalInfoID'];?>','<?php echo $Hobby['AdditionalInfo'];?>','<?php echo $Hobby['Description'];?>')" style="background: #ff5a5a;color:white;padding: 2px 5px 2px 5px;font-size: 12px;border-radius: 5px;cursor:pointer">Delete</span></td>
                                                    </tr>
                                                    <?php } ?>
...
function AddHobbiesDetails(ResumeID) {   
        $.ajax({url:'../digital_webservice.php?action=AddHobbiesDetails&ResumeID='+ResumeID,success:function(data){
            $("#xconfrimation_text").html(data);
            $('#ConfirmationPopup').modal("show");
        }});
    }
function AddHobbies(ResumeID) {
   ...
   // $("#confrimation_text").html(loading);                                                                
    $.post( "../digital_webservice.php?action=AddHobbies",param,function(data) {
        var obj = JSON.parse(data); 
        var html = "";                                                                                         
        if (obj.status=="failure") {
            html = "<div class='form-group row'><div class='col-sm-12' style='text-align:center'><img src='assets/accessdenied.png' style='width:128px'><br><br>"+obj.message+"<br></div></div>";
...
function EditHobbiesDetails(AdditionalInfoID) {   
        $.ajax({url:'../digital_webservice.php?action=EditHobbiesDetails&AdditionalInfoID='+AdditionalInfoID,success:function(data){
            $("#xconfrimation_text").html(data);
            $('#ConfirmationPopup').modal("show");
        }});
    }
...
function UpdateHobbies(AdditionalInfoID) {
   ...
   // $("#confrimation_text").html(loading);                                                                
    $.post( "../digital_webservice.php?action=UpdateHobbies",param,function(data) {
        var obj = JSON.parse(data); 
        var html = "";                                                                                         
        if (obj.status=="failure") {
            html = "<div class='form-group row'><div class='col-sm-12' style='text-align:center'><img src='assets/accessdenied.png' style='width:128px'><br><br>"+obj.message+"<br></div></div>";
...
function DeleteHobbies(AdditionalInfoID) {
   ...
   // $("#confrimation_text").html(loading);                                                                
    $.post( "../digital_webservice.php?action=DeleteHobbies",param,function(data) {
        var obj = JSON.parse(data); 
        var html = "";                                                                                          
        if (obj.status=="failure") {
            html = "<div class='form-group row'><div class='col-sm-12' style='text-align:center'><img src='assets/accessdenied.png' style='width:128px'><br><br>"+obj.message+"<br></div></div>";
