                      ...
                      <input type="submit" value="Save District Name" name="SaveBtn" class="btn btn-primary">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td style="padding-left:10px;text-align:left"><a class="leftMenu" href="https://klx.co.in/klxadmin/dashboard.php?action=country/managecitynames&countryid=<?php echo $country[0]['countryid'];?>&stateid=<?php echo $statename[0]['stateid'];?>&distcid=<?php echo $d['distcid'];?>" target="rpanel"><?php echo $d['districtname'];?></a></td>
...
function ConfirmationDeleteDistrictName(distid, distname){
 ...
 function doUpdate(distid) {
    ...
    if(ErrorCount==0){
        ...
        $.post( "https://klx.co.in/webservice.php?action=UpdateDistrictName",  param,function( data ) {
 ...
 function doDelete(distid) {
        ...
        $.post( "https://klx.co.in/webservice.php?action=deleteDistrictName",  param,function( data ) {
            var obj = JSON.parse(data); 
            var html = "";
            if (obj.status=="failure") {
                html = "<div style='width:100%;padding:10px;background:#fff;text-align:center;color:red'><img src='https://klx.co.in/klxadmin/assets/accessdenied.png' style='width:128px'><br><br>Transaction failed.<br>"+obj.message;
