...
//$ads = JPostads::getMyRecentlyViewedAds($_SESSION['USER']['userid']);
    $ads = $mysql->select("select * from _jpostads where postadid in (SELECT toadid FROM _tblmessages WHERE (touserid='".$_SESSION['USER']['userid']."' or fromuserid='".$_SESSION['USER']['userid']."') group by toadid)");
    ...
    <div class="container"> 
        ...
        <div class="page-header">
                <ul class="breadcrumbs" style="border:none;margin-left:0px;padding-left:0px;">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo country_url;?>messaged" >Messaged</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Messaged Ads (<?php echo sizeof($ads);?>)</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <?php if ($ad['isdeleted']!=1) {?>
                                       <div class="dropdown dropdown-kanban" style="float: right;">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="<?php echo country_url;?>view/m<?php echo $ad['postadid'];?>" draggable="false">Messages</a>
