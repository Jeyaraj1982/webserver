<?php 
 ...
 $Products = $mysql->select("select * from _tbl_products where CategoryID='3' and IsPublish='1'");
 
?>
 <section class="section section-xl bg-default text-center">
        <div class="container">
          <div class="title-group">
            <h3 class="oh"><span class="d-inline-block wow slideInUp" data-wow-delay="0s" style="visibility: visible; animation-delay: 0s; animation-name: slideInUp;">பழங்கள் மற்றும் காய்கறிகள்</span></h3>
