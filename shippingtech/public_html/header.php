    ...
    <header id="header-wrap">
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container" style="padding: 10px 0px;">
          ...
          <a href="index.php" class="navbar-brand"><img src="assets/nlogo.png" alt=""></a>       
        ...
        <li class="nav-item">
                <a class="nav-link" href="gp-ratingcourses.php">
                  GP Rating Courses
                </a>
              </li>
                <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="study-in-abroad.php">
                  Study in Abroad
                </a>
              </li>
