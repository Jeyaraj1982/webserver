...
<body class="login">
    ...
    <script src="<?php echo AppUrl;?>/assets/js/js/jquery-ui.min.js"></script>
    <script src="<?php echo AppUrl;?>/assets/js/js/popper.min.js"></script>
    <script src="<?php echo AppUrl;?>/assets/js/js/bootstrap.min.js"></script>
