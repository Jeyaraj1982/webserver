    ...
    <form action="" method="post">
        ...
        <table cellpadding="5" cellspacing="0" align="center">
            <tr>
                ...
                <td><input type="text" name="faqquestion" style="width:100%;" value="<?php echo $pageContent[0]['faqques'];?>"></td> 
            </tr>
            <tr>
                <td colspan="2"><textarea name="faqanswer" style="height: 350px;width:100%"><?php echo $pageContent[0]['faqans'];?></textarea></td>
            </tr> 
            <tr>
                <td colspan="2">
                    <table>
      ...
      <div class="titleBar">View FAQs</div>
       <table  style="margin:10px;width:100%;font-size:12px;font-family:'Trebuchet MS';color:#333" cellpadding="3" cellspacing="0" align="center">
        <tr>
            ...
            <td><?php echo $pageContent[0]['faqques'];?></td>
        </tr>
        <tr>
            <td>Faq Answer</td>
            <td style="text-align:justify;font-family:arial;font-size:12px;">
                <?php echo $pageContent[0]['faqans'];?>
            </td>
        </tr>
        <tr>
            <td>Is Published</td>  
