...
include_once("../../config.php");
     ...
     if(isset($_POST{"updatebtn"})){
      ...
      if (isset($_POST{"editbtn"})){
       ...
       <style>
        ...
        <div class="titleBar">Edit Testimonials</div>
           <form action="" method="post" style="height: 20px;" enctype="multipart/form-data">
              <input type="hidden" name="rowid" value="<?php echo $pageContent[0]['storyid'];?>">
                <table cellpadding="5" cellspacing="0" align="center">
                    ...
                    <tr>
                         <td colspan="2"><textarea name="storydescription" style="height: 350px;width:100%"><?php echo $pageContent[0]['storydesc'];?></textarea></td>
                    </tr>
                    <tr>
                         <td colspan="2">
                                <table>
                   ...
                   <tr>
                        <td>Mobile No.</td> 
                        <td><input type="text" name="storymobile" maxlength="10" value="<?php echo $pageContent[0]['mobile'];?>" style="width:100%;"></td> 
                   </tr>
                    <tr>
    ...
    <script>$('#success').hide(3000);</script>
      ...
      if (isset($_POST{"viewbtn"})){
       ...
       <div class="titleBar">View Testimonials</div>
            <table style="margin:10px;width:100%;font-size:12px;font-family:'Trebuchet MS';color:#333" cellpadding="3" cellspacing="0" align="center">
                ...
                <tr>
                    ...
                    <td><?php echo $pageContent[0]['mobile'];?></td>
                </tr>
                <tr>
      ...
      if (isset($_POST{"deletebtn"})){
       ...
       ?>
      <div class="titleBar">Delete Testimonials</div>
