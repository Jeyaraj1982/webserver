     ...
     include_once("config.php"); 
       $obj = new CommonController();
         if (isset($_POST['loginbtn'])) {
             ...
             $id = $mysql->execute("update `_jusertable` set `pwd`='".$_POST['confirmpassword']."' where `userid`='".$data[0]['UserID']."'"); 
          if (sizeof($id)>0) {  
            //echo "<script>location.href='".path_url."'PasswordSaved';</script>";  
               ?>
            <form action="<?php echo path_url;?>PasswordSaved" id="reqFrm" method="post">
           ...
           <a href="<?php echo country_url;?>" class="close-quick-sidebar" style="float: right;font-size:20px;margin-top:-40px;color:#ccc">
            ...
            <div class="login-form">
                <div class="form-group form-floating-label">                                        
                    <input id="password" name="password" type="password" value="<?php echo $_POST['password'];?>" class="form-control input-border-bottom" >
                    <label for="password" class="placeholder">Password</label>
                    <div class="show-password">
                        <i class="icon-eye"></i>
                    </div>
                    <br><span class="errorstring" id="Errpassword" style="color: red;font-size:11px"></span>
                </div>
                <div class="form-group form-floating-label">
                    <input id="confirmpassword" name="confirmpassword" type="password" value="<?php echo $_POST['confirmpassword'];?>" class="form-control input-border-bottom" >
                    <label for="password" class="placeholder">Confirm Password</label>
                    <div class="show-password">
                        <i class="icon-eye"></i>
                    </div>
                    <br><span class="errorstring" id="Errconfirmpassword" style="color: red;font-size:11px"></span>
                </div>
               <!-- <div class="row form-sub m-0">
                ...
                <?php  echo'<span class="errorstring" id="server_error">'.$status.'</span>';
                  ?>  
                    <button type="submit"  name="loginbtn" class="btn btn-primary btn-rounded btn-login">Save Password</button>
                </div>
            </div>
            </form>
        </div>
