...
if($_SESSION['USER']['isstaff']==0){
    if (isset($_SESSION['USER']['userid']) && $_SESSION['USER']['userid']>0) {
            ...
            if ($_SESSION['USER']['isemailverified']==0) {
                echo "<script>location.href=".AppUrl."/in/emailverification';</script>";
            }else { 
                if ($_SESSION['USER']['stateid']==0 || $_SESSION['USER']['districtid']==0 ){
                    echo "<script>location.href='".AppUrl."/in/updatelocation';</script>";
                }
            }
           // }
      //  }
...
<head>
    ...
    <title>Rhole Classifieds</title>
    <meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
    <?php if (isset($share) && $share==true) {?>
    <meta data-react-helmet="true" property="og:site_name"   content="rhole Classified" />
    ...
    <?php } else {?>
     ...
     <meta data-react-helmet="true" property="og:site_name"   content="rhole Classified" />
    <meta data-react-helmet="true" property="og:title"       content="rhole Classified" />
    <meta data-react-helmet="true" property="og:description" content="rhole classifed" />
    <meta data-react-helmet="true" property="og:url"         content="<?php echo AppUrl;?>" />
    <meta data-react-helmet="true" property="og:type"        content="website" />
    <meta data-react-helmet="true" property="og:image"     content="<?php echo logo_url;?>" />
    <meta data-react-helmet="true" name="description" content="rhole Classifieds "/> 
    <?php } ?>
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="white">
                <a href="<?php echo base_url;?>index.php" class="logo" style="left:10px !important;transform:none">
                    <img src="<?php echo logo_url;?>" alt="logo" class="navbar-brand" style="height:30px;">
                </a>
