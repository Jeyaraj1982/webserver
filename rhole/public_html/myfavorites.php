...
$ads = JPostads::getLikedAd($_SESSION['USER']['userid']);
?>
    ...
    <div class="container"> 
        ...
        <div class="page-header">
                <ul class="breadcrumbs" style="border:none;margin-left:0px;padding-left:0px;">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo country_url;?>myfavorites" >My Liked Ads</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">My Liked Ads (<?php echo sizeof($ads);?>)</h4>
                </div>
                <div class="card-body">
