                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('4-Real-Estate')">
                                    <div style="border:none;background:#93cab3;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('1-Automobiles')">
                                    <div style="border:none;background:#ec9cc9;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('12-Entertainment')" style="padding-right:0px">
                                    <div style="border:none;background:#119aa1;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('5-Jobs')">
                                    <div style="border:none;background:#f2c1d3;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('3-Electronics-Appliances')">
                                    <div style="border:none;background:#f27c76;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('2-Mobiles-Tablets')"  style="padding-right:0px">
                                    <div style="border:none;background:#bef7c7;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('7-Food')">
                                    <div style="border:none;background:#d1fcfb;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('8-Services')">
                                    <div style="border:none;background:#d6d6f9;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('6-Life-Style')"  style="padding-right:0px">
                                    <div style="border:none;background:#fcbdbd;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto;">
                                 ...
                                 <div class="col-4 cursor-hand" onclick="ListSubCategories('13-Pets')">
                                    <div style="border:none;background:#fce2a9;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto">
                                ...
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('14-Furniture')"  style="padding-right:0px">
                                    <div style="border:none;background:#bdf6f9;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto;">
                                        <img src="<?php echo base_url;?>assets/icons/couch.png" style=""> 
                                    </div>
                                    <p style="text-align: center;;font-size:11px;">Furniture</p>
                                </div> 
                                <div class="col-4 cursor-hand" onclick="ListSubCategories('15-MyNeeds')"  style="padding-right:0px">
                                    <div style="border:none;background:#c1447f;border-radius:10%;padding:16px;height: 64px;width: 64px;margin:0px auto;">
