   ...
   //   $chatroom = $mysql->select("select * from _chat_initiate where adID='".$adID."'  and adPosted='".$d[0]["postedby"]."'  and adViewed='".$_SESSION['USER']['userid']."' ");
      ...
      if(sizeof($logview)==1){
         $message = '
                    ...
                    $mparam['Subject']="Rhole.in :) Your ad is viewed by ".$_SESSION['USER']['personname'];
      ...
      $message = '
                    ...
                    $mparam['MailTo']=$postedByInfo[0]['email'];
                    $mparam['MemberID']=$postedByInfo[0]['userid'];
                    $mparam['Subject']="Rhole.in :) Your ad is viewed by unknown person";
                    $mparam['Message']=$message;
                    MailController::Send($mparam,$mailError);        
      }
  }
                            ...
                            ?>
                                    ...
                                    <div class="col-md-4">
                                        <div>
                                            ...
                                            <br><Br>
                                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo   (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI];?>" ><img src="<?php echo AppUrl;?>/assets/facebook.png" style="width:32px"></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="https://www.twitter.com/share?text=<?php echo $d[0]['title'];?>&url=<?php echo  (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI];?>" > <img src="<?php echo AppUrl;?>/assets/twitter.png"  style="width:32px"></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="https://api.whatsapp.com/send?text=<?php echo  (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI];?>" > <img src="<?php echo AppUrl;?>/assets/whatsapp.png"  style="width:32px"></a> 
                                            &nbsp;&nbsp;
                            ...
                            <?php } ?>
                                  ...
                                  if ($days_between<=1) {
                                    ...
                                    <table>
                                        <tr>
                                            <td style="width:50px">
                                               <img src="<?php echo AppUrl;?>/assets/user.png" style="height:48px"> 
                                            </td>
 ...
 //setInterval("sendMessage(0)",10000);
    ...
    function Chat(id){
        <?php 
            ...
            if (sizeof($chatroom)>0)    {
        ?>
        location.href="<?php echo AppUrl;?>/in/chat/room/<?php echo md5("j2jsoftwaresolutoins_".$chatroom[0]['ChatID']);?>";
        <?php } else { ?>
        location.href="<?php echo AppUrl;?>/in/chat/create/<?php echo $adID;?>";
        <?php }  ?>
    }
  </script>      
