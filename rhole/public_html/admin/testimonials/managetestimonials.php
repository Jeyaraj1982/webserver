                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" class="btn btn-warning" name="cancelbtn"  onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=successstories/viewtestimonials'">Cancel</button>
                                        </div>                                        
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="card-title">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action='<?php echo AppUrl;?>/admin/dashboard.php?action=testimonials/managetestimonials' method='post' style='height:0px;'>
                                        ...
                                        <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=testimonials/viewtestimonials'"> 
                                   </form>
                                </div>
                                <?php
                                    exit;                                                  
                                ...
                                <div class="card-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" class="btn btn-warning" name="cancelbtn"  onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=testimonials/viewtestimonials'">Cancel</button>
                                        </div>                                        
                                    </div>
                                </div>
                            </form>    
