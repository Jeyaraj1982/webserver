                                        ...
                                        <tr class='mytr'>
                                           <td style='padding:5px;width:70px'>
                                            ...
                                            <td width='160' style='text-align:center;'>
                                                <a href="<?php echo AppUrl;?>/admin/dashboard.php?action=postad/managepostads&rowid=<?php echo  $r["postadid"];?>&btn=editbtn">Edit</a>&nbsp;
                                                <a href="<?php echo AppUrl;?>/admin/dashboard.php?action=postad/managepostads&rowid=<?php echo  $r["postadid"];?>&btn=viewbtn">View</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
