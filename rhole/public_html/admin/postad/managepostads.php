...
if (isset($_GET['btn'])) {
 ...
 setTimeout("loadPre()","1000");
     ...
     function getAdtype(categoryID) {
      $.ajax({url:'<?php echo AppUrl;?>/admin/postad/webservice.php?action=getAdtype&categoryID='+categoryID,success:function(data){
           $('#adtype').html(data);
      }});
     }
...
<script>
     function getDistrict(stateID) {
      $.ajax({url:'<?php echo AppUrl;?>/admin/postad/webservice.php?action=getDistrict&stateID='+stateID,success:function(data){
           $('#district').html(data);
      }});
     }
...
<script>
     function getSubcategory(categoryID) {
      $.ajax({url:'<?php echo AppUrl;?>/admin/postad/webservice.php?action=getSubcategory&categoryID='+categoryID,success:function(data){
                                ...
                                <div class="card-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" class="btn btn-warning" name="cancelbtn"  onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=postad/viewpostads'">Cancel</button>
                                        </div>                                        
                                    </div>
                                </div>
                            </form>
