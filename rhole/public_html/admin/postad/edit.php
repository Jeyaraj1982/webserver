<?php
       ...
       if (isset($_POST['unpublishbtn'])) {
         ...
         $filename = ((strlen(trim($d[0]['filepath1']))>4) && file_exists("/home/rhole/public_html/assets/".$config['thumb'].$d[0]['filepath1'])) ? "assets/".$config['thumb'].$d[0]['filepath1'] : "";
              
         if ($filename!="") {
             
                
                   if (copy("/home/rhole/public_html/".$filename,"/home/ztemp_klx/".$d[0]['filepath1'])) 
                   {
                    unlink("/home/rhole/public_html/".$filename);
        ...
        <div class="row mb-2">
            <div id="div_1">
                <?php if(strlen($pageContent[0]['filepath1'])>1) { ?>
                    <img src="<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'].$pageContent[0]['filepath1'];?>" style='width: 64px;height:64px;margin-top: 5px;'><br><span onclick='image1_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                <?php }else { ?>
                    <img id="src_image1" onclick="uploadimage('1')" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                <?php } ?>
            </div> 
            <div  id="div_2">
                <?php if(strlen($pageContent[0]['filepath2'])>1) { ?>
                    <img src="<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'].$pageContent[0]['filepath2'];?>" style='width: 64px;height:64px;margin-top: 5px;'><br><span onclick='image2_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                <?php }else { ?>
                    <img id="src_image2" onclick="uploadimage('2')" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                <?php } ?>
            </div>
            <div  id="div_3">
               <?php if(strlen($pageContent[0]['filepath3'])>1) { ?>
                    <img src="<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'].$pageContent[0]['filepath3'];?>" style='width: 64px;height:64px;margin-top: 5px;'><br><span onclick='image3_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                <?php }else { ?>
                    <img id="src_image3" onclick="uploadimage('3')" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                <?php } ?>
            </div>
            <div  id="div_4">
                <?php if(strlen($pageContent[0]['filepath4'])>1) { ?>
                    <img src="<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'].$pageContent[0]['filepath4'];?>" style='width: 64px;height:64px;margin-top: 5px;'><br><span onclick='image4_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                <?php }else { ?>
                    <img id="src_image4" onclick="uploadimage('4')" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                <?php } ?>
            </div>
            <div  id="div_5">
                <?php if(strlen($pageContent[0]['filepath5'])>1) { ?>
                    <img src="<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'].$pageContent[0]['filepath5'];?>" style='width: 64px;height:64px;margin-top: 5px;'><br><span onclick='image5_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                <?php }else { ?>
                    <img id="src_image5" onclick="uploadimage('5')" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                <?php } ?>
            </div>
            <div  id="div_6">
                <?php if(strlen($pageContent[0]['filepath6'])>1) { ?>
                    <img src="<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'].$pageContent[0]['filepath6'];?>" style='width: 64px;height:64px;margin-top: 5px;'><br><span onclick='image6_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>
                <?php }else { ?>
                    <img id="src_image6" onclick="uploadimage('6')" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                <?php } ?>
            </div> 
              
        </div>
         <div class="errorstring" id="Errimage1"><?php echo isset($Errimage1)? $Errimage1 : "";?></div>
        <img src='<?php echo AppUrl;?>/assets/loading.gif' style='width:0px'>
                            </div>
                        </div>
            ...
            success: function(response){
                ...
                if (response!="error") {
                    $('#uploadimage1').val(response);
                        $('#div_1').html("<div><img src='<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='height: 64px;width: 64px;margin-top: 5px;'><br><span onclick='image1_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
            ...
            success: function(response){ 
                if (response!="error") {
                    $('#uploadimage2').val(response);
                        $('#div_2').html("<div><img src='<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='width: 64px;height: 64px;margin-top: 5px;'><br><span onclick='image2_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
                    } else {
                        alert("error");
                    }
                }, 
            ...
            success: function(response){ 
                if (response!="error") {
                    $('#uploadimage3').val(response);
                        $('#div_3').html("<div><img src='<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='height:64px;width: 64px;margin-top: 5px;'><br><span onclick='image3_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
                    } else {
                        alert("error");
                    }
                }, 
            ...
            success: function(response){ 
                if (response!="error") {
                    $('#uploadimage4').val(response);
                        $('#div_4').html("<div><img src='<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='width: 64px;height: 64px;margin-top: 5px;'><br><span onclick='image4_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
                    } else {
                        alert("error");
                    }
                }, 
            ...
            success: function(response){ 
                if (response!="error") {
                    $('#uploadimage5').val(response);
                        $('#div_5').html("<div><img src='<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='width: 64px;height: 64px;margin-top: 5px;'><br><span onclick='image5_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
                    } else {
                        alert("error");
                    }
                }, 
            ...
            success: function(response){ 
                if (response!="error") {
                    $('#uploadimage6').val(response);
                        $('#div_6').html("<div><img src='<?php echo AppUrl;?>/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='height: 64px;width: 64px;margin-top: 5px;'><br><span onclick='image6_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
                    } else {
                        alert("error");
                    }
                }, 
