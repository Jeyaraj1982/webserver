     ...
     ?> 
                                ...
                                <div class="card-action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" class="btn btn-warning" name="cancelbtn"  onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=usertable/viewuser'">Cancel</button>
                                        </div>                                        
                                    </div>
                                </div>
                            </form>
       ...
       $pageContent = JUsertable::getUser($_POST['rowid']);?>
                ...
                <?php } ?>
                                    ...
                                    <form action='<?php echo AppUrl;?>/admin/dashboard.php?action=usertable/viewuser' method='post' style='height:0px;'>
                                        ...
                                        <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=usertable/viewuser'"> 
                                   </form>
                                </div>
                                <?php
                                    exit;                                                  
