      ...
      $pageContent = JContactus::getContactus($_POST['rowid']); ?>
                            ...
                            <div class="card-title">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action='<?php echo AppUrl;?>/admin/dashboard.php?action=contactus/managecontact' method='post' style='height:0px;'>
                                        <input type='hidden' value='<?php echo $pageContent[0]['contid'];?>' name='rowid' id='rowid' >
                                        <input style='font-size:11px;' type="button" name="cancelbtn" value="Cancel" bgcolor="grey" onclick="location.href='<?php echo AppUrl;?>/admin/dashboard.php?action=contactus/viewcontact'"> 
                                   </form>
                             </div>      
                                <?php
                           exit;
