                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['submitBtn'])) {
                                ...
                                <label for="Name" class="col-md-3 text-right">Debited Process successfully.</label>
                        ...
                        <form action="" method="post">
                          <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <label for="Name" class="col-md-3 text-right">Debit Amount</label>
                               ...
                               <div class="form-group row">
                                ...
                                <div class="col-md-3"><input type="submit" name="submitBtn" class="btn btn-success" value="Debit Amount"></div>
                            </div>
                          </form>     
