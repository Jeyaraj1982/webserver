...
<script>
 ...
 function DoApprove(RequestID) {
    ...
    $.post( "<?php echo AppUrl;?>/webservice.php?action=ApproveFranchiseeWithdrawalRequest",  $( "#frmapprove" ).serialize(),function( data ) {
        ...
        if (obj.status=="failure") {
            ...
            html = "<div style='width:100%;padding:10px;background:#fff;text-align:center;color:#222'><img src='<?php echo AppUrl;?>/admin/assets/tick.jpg' style='width:128px'><br><br>Approved<br></div>";
            html += "<br>" + buttons;
...
function DoReject(RequestID) {
    ...
    $.post( "<?php echo AppUrl;?>/webservice.php?action=RejectFranchiseeWithdrawalRequest",  $( "#frmapprove" ).serialize(),function( data ) {
        var obj = JSON.parse(data); 
        var html = "";
        if (obj.status=="failure") {
            html = "<div style='width:100%;padding:10px;background:#fff;text-align:center;color:red'><img src='<?php echo AppUrl;?>/admin/assets/accessdenied.png' style='width:128px'><br><br>Transaction failed.<br>"+obj.message;
            ...
            html = "<div style='width:100%;padding:10px;background:#fff;text-align:center;color:#222'><img src='<?php echo AppUrl;?>/admin/assets/tick.jpg' style='width:128px'><br><br>Rejected<br></div>";
            html += "<br>" + buttons;
        }
        $("#confrimation_text").html(html);
        $('#ConfirmationPopup').modal("show");
