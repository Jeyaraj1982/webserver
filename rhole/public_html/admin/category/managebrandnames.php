                                 ...
                                 <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:10px;text-align:left"><a class="leftMenu" href="<?php echo AppUrl;?>/admin/dashboard.php?action=category/managemodelnames&brandid=<?php echo $d['brandid'];?>&subcateid=<?php echo $d['subcateid'];?>&categid=<?php echo $d['categid'];?>"><?php echo $d['brandname'];?></a></td>
...
function ConfirmationEditBrandName(brandid, brandname){
 ...
 function doUpdate(brandid) {
    ...
    if(ErrorCount==0){
        ...
        $.post( "<?php echo AppUrl;?>/webservice.php?action=UpdateBrandName",  param,function( data ) {
...
function ConfirmationDeleteBrandName(brandid, brandname){
 ...
 function doDelete(brandid) {
        ...
        $.post( "<?php echo AppUrl;?>/webservice.php?action=deleteBrandName",  param,function( data ) {
            var obj = JSON.parse(data); 
            var html = "";
            if (obj.status=="failure") {
