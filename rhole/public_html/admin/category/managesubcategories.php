                                 ...
                                 <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:10px;text-align:left"><a class="leftMenu" href="<?php echo AppUrl;?>/admin/dashboard.php?action=category/managebrandnames&subcateid=<?php echo $d['subcateid'];?>&categid=<?php echo $_GET['categid'];?>" ><?php echo $d['subcatename'];?></a></td>
