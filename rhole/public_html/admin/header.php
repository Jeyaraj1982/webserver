...
<head>
	...
	<title><?php echo AppUrl;?></title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="icon" href="images/favicon.png" type="image/x-icon"/>

	<!-- Fonts and icons -->
	<script src="<?php echo AppUrl;?>/admin/assets/js/plugin/webfont/webfont.min.js"></script>
	<script>
		WebFont.load({
			google: {"families":["Lato:300,400,700,900"]},
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['<?php echo AppUrl;?>/admin/assets/css/fonts.min.css']},
			active: function() {
	...
	<!-- CSS Files -->
	<link rel="stylesheet" href="<?php echo AppUrl;?>/admin/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo AppUrl;?>/admin/assets/css/atlantis.css">
	<link rel="stylesheet" href="<?php echo AppUrl;?>/admin/assets/css/demo.css">
    <script src="<?php echo AppUrl;?>/admin/assets/js/app.js" type='text/javascript'></script>
...
<div class="main-header">
            ...
            <div class="logo-header" data-background-color="dark">
                ...
                <a href="dashboard.php" class="logo" style="color:#fff;text-align:center;line-height:15px;text-align:left;height:30px !important">
                    <span style="font-weight:bold;">Rhole</span><br>
                </a>
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    ...
                                    <li>
                                        ...
                                        <a class="dropdown-item" href="<?php echo AppUrl;?>/admin/dashboard.php?action=MyProfile">My Profile</a>
                                        <a class="dropdown-item" href="<?php echo AppUrl;?>/admin/dashboard.php?action=ChangePassword">Change Password</a>
                                        <!--<a class="dropdown-item" href="#">My Balance</a>
                                        <a class="dropdown-item" href="#">Inbox</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">Account Setting</a>
                                        <div class="dropdown-divider"></div>-->
                                        <a class="dropdown-item" href="<?php echo AppUrl;?>/admin/dashboard.php?action=logout">Logout</a>
                                    </li>
                                </div>
                            </ul>
                        </li>
