            ...
            <div class="page-inner" >
                ...
                <div class="card" style="box-shadow:none;border: 1px solid #e5e5e5;margin-bottom:15px ;">
                    <div class="card-body d" style="padding-top: 10px;padding-bottom: 0px;">
                        <div class="row mb-2">
                            <div class="col-12">
                                <h4 style="font-weight:bold;font-size:13px;text-transform:uppercase;float:left">Selected Category</h4>&nbsp;&nbsp;&nbsp;<a href="<?php echo AppUrl;?>/freeadpost1.php" style="color: blue;"><b style="font-size: 12px;float: right;">CHANGE</b></a><br>
