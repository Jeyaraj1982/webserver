...
<?php
    ...
    if(isset($_POST["dosave"]) && $_POST['dosave']=="1") {
        ...
        <div>
            ...
            <a href="<?php echo AppUrl;?>/in/upgrade/c0" class="btn btn-primary btn-sm">View Packages</a>
        </div>
        <?php
                exit;
            }
        ...
        if ($obj->err==0) { 
            ...
            if ($postedadid>0) {
                ...
                $message = '
                    ...
                    $mparam['Subject']="Rhole.in :) Your ad is now live!";
                    ...
                    <?php if($_GET['subc']!=0){?>
                        <div class="card" style="box-shadow:none;border: 1px solid #e5e5e5;margin-bottom:15px ;">
                            <div class="card-body d" style="padding-top: 10px;padding-bottom: 0px;">
                                <div class="row mb-2">
                                    <div class="col-12">
                                        <h4 style="font-weight:bold;font-size:13px;text-transform:uppercase;float:left">Selected Category</h4>&nbsp;&nbsp;&nbsp;<a href="<?php echo AppUrl;?>/in/freeadpost.php" style="color: blue;"><b style="font-size: 12px;float: right;">CHANGE</b></a><br>
                        ...
                        <div class="card" style="box-shadow:none;border: 1px solid #e5e5e5;margin-bottom:15px ;">
                            <div class="card-body d">            
                                ...
                                <div class="row mb-2">
                                <div id="div_1">
                                    <img id="src_image1" onclick="fupload()" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                                </div> 
                                <div  id="div_2">
                                    <img id="src_image2" onclick="fupload()" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                                </div>
                                <div  id="div_3">
                                    <img id="src_image3" onclick="fupload()" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                                </div>
                                <div  id="div_4">
                                    <img id="src_image4" onclick="fupload()" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                                </div>
                                <div  id="div_5">
                                    <img id="src_image5" onclick="fupload()" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                                </div>
                                <div  id="div_6">
                                    <img id="src_image6" onclick="fupload()" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">
                                </div> 
...
function CallConfirmation(){
 ...
 function doPostAd() {
        ...
        $.post( "<?php echo AppUrl;?>/webservice.php?action=doPostAd", param,function( data ) {
            var obj = JSON.parse(data); 
            var html = "";
            if (obj.status=="failure") {
                html = "<div style='width:100%;padding:10px;background:#fff;text-align:center;color:red'><img src='<?php echo AppUrl;?>/assets/accessdenied.png' style='width:128px'><br><br>Transaction failed.<br>"+obj.message;
                
            } else { 
                var buttons = "<div style='text-align:center;padding:10px;'><a href='<?php echo AppUrl;?>/in/freeadpost' class='btn btn-success'>Continue</a></div>";
   ...
   $(document).ready(function(){
       ...
       $('#files').change(function() {
          ...
          // for (var index = uploaded_count; index < (uploaded_count+totalfiles); index++) {
           for (var index = 0; index < (totalfiles); index++) {
            ...
            // AJAX request
            $.ajax({                                     
                url: '<?php echo AppUrl;?>/ajaxfile.php',
                   type: 'post',
                   xhr: function() {
                   ...
                   for(var index = 0; index < response.length; index++) {
                       if (response[index]['error']==0) {
                        var src = response[index]['filename'];
                            ...
                            $('#img'+uploaded_count).html("<img src='<?php echo AppUrl;?>/"+img_path+"/"+src+"' width='100px;' height='100px'><br><span onclick='image_close("+(uploaded_count+1)+")' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span>");
    ...
    <?php }?> 
       ...
       function image_close(id) {
        $('#uploadimage'+id).val("");
        $('#div_'+id).html('<img onclick="fupload()" id="src_image'+id+'" src="<?php echo AppUrl;?>/assets/add-image.png" style="width: 64px;margin-top: 20px;opacity: 0.3;cursor: pointer;">');  
