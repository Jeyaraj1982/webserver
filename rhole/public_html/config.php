<?php 
    ...
    define("AppUrl","https://www.rhole.in");
    define("logo_url","https://www.rhole.in/assets/logo.png");
    error_reporting(0);
    ...
    define("DBUSER","rhole_user");
    define("DBPASS","mysql@Pwd");
    
    $homeUrl = AppUrl;
    $application = array("dbName"=>"rhole_database");
    ...
    define("country_url",AppUrl."/".$_SESSION['country']."/");
