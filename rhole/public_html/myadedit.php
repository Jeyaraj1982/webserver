            ...
            success: function(response){ 
                if (response!="error") {
                    $('#uploadimage5').val(response);
                        $('#div_5').html("<div><img src='<?php echo AppUrl;?>n/<?php echo "assets/".$config['thumb'];?>"+response.trim()+"' style='width: 64px;height: 64px;margin-top: 5px;'><br><span onclick='image5_close()' class='btn btn-danger btn-sm' style='padding: 0px 10px;font-size: 10px;'>Delete</span></div>");
                    } else {
                        alert("error");
                    }
                }, 
