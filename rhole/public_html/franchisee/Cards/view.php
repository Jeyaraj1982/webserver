                                ...
                                <div class="form-group form-show-validation row" style="padding: 0px;">
                                     ...
                                     <label>Visiting Card Url</label>
                                        <div class="input-group">
                                          <input type="text" class="form-control" readonly="readonly" id="CardUrl" value="https://share.klx.co.in/c-<?php echo $data[0]['Url'];?>">
                        ...
                        <form id="exampleValidation" method="POST" action="" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Name</label>
                                    <div class="col-sm-9"><?php echo $data[0]['ResumeName'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Proffession</label>
                                    <div class="col-sm-9"><?php echo $data[0]['Proffession'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Whatsapp Number</label>
                                    <div class="col-sm-9"><?php echo $data[0]['WhatsappNumber'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Landline Number</label>
                                    <div class="col-sm-9"><?php echo $data[0]['LandlineNumber'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Email ID</label>
                                    <div class="col-sm-9"><?php echo $data[0]['EmailID'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Website</label>
                                    <div class="col-sm-9"><?php echo "https://".$data[0]['Website'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Address Line1</label>
                                    <div class="col-sm-9"><?php echo $data[0]['AddressLine1'];?></div>
                                </div>
                                <?php if($data[0]['AddressLine2']!=""){ ?>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Address Line2</label>
                                    <div class="col-sm-9"><?php echo $data[0]['AddressLine2'];?></div>
                                </div>
                                <?php } ?>
                                <?php if($data[0]['AddressLine3']!=""){ ?>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Address Line3</label>
                                    <div class="col-sm-9"><?php echo $data[0]['AddressLine3'];?></div>
                                </div>
                                <?php } ?>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Facebook Url</label>
                                    <div class="col-sm-9"><?php echo "https://twitter.com/".$data[0]['FaceBook'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Twitter Url</label>
                                    <div class="col-sm-9"><?php echo "https://facebook.com/".$data[0]['Twitter'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Instagram Url</label>
                                    <div class="col-sm-9"><?php echo "https://instagram.com/".$data[0]['Instagram'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">LinkedIn Url</label>
                                    <div class="col-sm-9"><?php echo "https://linkedin.com/".$data[0]['LinkedIn'];?></div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="name" class="col-sm-3 text-left">Profile Photo</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="card-action">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="dashboard.php?action=Cards/edit&id=<?php echo $data[0]['ResumeID'];?>" class="btn btn-warning">Edit</a>
                                    </div>                                        
                                </div>
                            </div>
                        </form>
