...
<div class="main-header">
            ...
            <div class="logo-header" data-background-color="dark">
                ...
                <a href="dashboard.php" class="logo" style="color:#fff;text-align:center;line-height:15px;text-align:left;height:30px !important">
                    <span style="font-weight:bold;">KLX<br>Franchisee</span><br>
                </a>
                ...
                <div class="container-fluid">
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item dropdown hidden-caret" style="text-align: left;">
                            <a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span style="color:white"> 
                                    <?php echo $_SESSION['FRANCHISEE']['FranchiseeName']; ?>
                                </span>  
                                <br>
                                <span style="color:white">Franchisee&nbsp;Panel</span>
                            </a>
                        </li>
                                ...
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">                      
                                            ...
                                            <div class="u-text">
                                                <h4><?php echo $_SESSION['FRANCHISEE']['FranchiseeName'];?></h4>
                                                <p class="text-muted"><?php echo $_SESSION['FRANCHISEE']['EmailID'];?></p>
                                                <p class="text-muted">My Account Balance Rs.<?php echo number_format($application->getBalance($_SESSION['FRANCHISEE']['userid']),2); ?>&nbsp;<a href="dashboard.php?action=Wallet/Transactions">View</a></p>
                                            </div>
                                        </div>         
                                    </li>
                                    <li>                                                                           
                                        ...
                                        <div class="dropdown-divider"></div>-->
                                        <a class="dropdown-item" href="dashboard.php?action=dologout">Logout</a>
                                    </li>
                                </div>
                            </ul>
                        </li>
