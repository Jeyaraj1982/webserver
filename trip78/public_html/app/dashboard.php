<?php
    ...
    if (! (isset($_SESSION['User']['AdminID']) || isset($_SESSION['User']['AgentID']) )) {
        ?>
        <script>
...
<div class="main-header">
            ...
            <div class="logo-header" data-background-color="dark">
                ...
                <a href="dashboard.php" class="logo" style="color:#fff;text-align:center;line-height:15px;text-align:left;height:30px !important">
                    <span style="font-weight:bold;">Tour</span><br>
                </a>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret" style="text-align: left;">
                            <a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php } ?>
                                <?php if(UserRole=="agents"){ ?>
                                <span style="color:white">Agent Panel</span>
                                <?php } ?>
                            </a>
                        </li>
                                ...
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">                      
                                            ...
                                            <?php } ?>
                                            <?php if(UserRole=="agents"){ ?>
                                                <h4><?php echo $_SESSION['User']['AgentName'];?></h4>
                                                <p class="text-muted"><?php echo $_SESSION['User']['EmailID'];?></p>
                                            <?php } ?>    
                                            </div>
                                        </div>         
		...
		<!-- End Sidebar -->
                ...
                if (isset($_GET['action']) && strlen($_GET['action'])>0) {
                  ...
                  //  print_r("includes/".UserRole."/".$_GET['action'].".php");
                } else {
	    ...
	    <?php include_once("includes/".UserRole."/footer.php"); ?>    
        <script>
