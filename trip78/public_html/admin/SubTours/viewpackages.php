                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card-title">
                                        Manage Packages ( <?php echo $t[0]['TourTypeName'];?> / <?php echo $st[0]['SubTourTypeName'];?>)
                                    </div>
                                </div>
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="dashboard.php?action=ToursPackage/add" class="btn btn-primary btn-xs">Add Package</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                 ...
                                 <table class="table table-striped mt-3">
                                        ...
                                        ?>   
                                            <tr>
                                                ...
                                                <td><?php echo $Enquiries[0]['cnt'];?></td>
