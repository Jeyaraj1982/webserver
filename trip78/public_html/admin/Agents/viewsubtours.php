                        ...
                        <div class="card-header" style="padding-top:10px;padding-bottom:10px">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align: right;">
                                    <a href="dashboard.php?action=SubTours/add&id=<?php echo $_GET['id'];?>" class="btn btn-primary btn-xs">Add Sub Tour</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
...
function DeleteSubTourType(SubTourID) {
    ...
    $.post( "webservice.php?action=DeleteSubTourType",param,function(data) {
        ...
        if (obj.status=="failure") {
            ...
            html += "<div style='padding:20px;text-align:center'>" + "<a href='dashboard.php?action=Tours/viewsubtours&id=<?php echo $_GET['id'];?>' class='btn btn-outline-danger'>Continue</a></div>"; 
        }
