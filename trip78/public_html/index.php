...
.gradient-button:hover{
    ...
    <div class="slider">
        ...
        <?php foreach($sliders as $slider){ ?>
            <li data-thumb="uploads/<?php echo $slider['SliderImage'];?>"> 
                <img src="uploads/<?php echo $slider['SliderImage'];?>" alt="" />
            </li>
        <?php } ?>
        </ul>
    </div>
...
.shadow {                                                                                         
    ...
    <main class="main" style="padding-bottom:0px !important">
        ...
        <?php if(sizeof($SubTours)>0){ ?>
            <div class="row">
                <div class="full-width">
                    <div class="box-container shadow ng-scope" ng-if="gitInternationalLoaded" style="padding:0px 25px !important;">
                        <h2 class="tour-block-title" style="padding-top:20px"><?php echo $Tour['TourTypeName'];?> <a href="subtour.php?tid=<?php echo md5($Tour['TourTypeID']);?>" title="View all"  style="float: right;color:#47b4af" target="_self"><small>View all</small></a></h2>
                                        ...
                                        <div class="details">
                                           <div class="form-group row">
                                                <div class="col-sm-12" style="padding-left:5px">
                                                    <h4 style="margin-top:0px;float: left;text-align:left;margin-bottom: -23px;"><?php echo $SubTour['SubTourTypeName'];?><?php if(strlen($SubTour['PriceStartingFrom'])>0) { ?><br><span style="color: red;font-size:13px;font-weight:400">Starting From INR <?php echo number_format($SubTour['PriceStartingFrom']);?></span><?php }?></h4>
                                                </div>
                                           </div>
                                           <div class="row">
