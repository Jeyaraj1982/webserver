...
if (isset($_POST['btnsubmit'])) {
    $userdata = $mysql->select("select * from _tbl_tour_agents where LoginName='".$_POST['UserName']."' and LoginPassword='".$_POST['Password']."' ");
    if (sizeof($userdata)>0) {
        if($userdata[0]['IsActive']=="1"){    
            ...
            $ErrorMessage = 'Account Deactivated. Please contact administrator';
        }
    }else{
...
<head>
    ...
    <script src="app/assets/js/core/jquery.3.2.1.min.js"></script>
</head>
<style>
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center"> <img src="https://www.trip78.in/images/logo_trip78.png" style="height:128px;margin:0px auto"><br><br>Agent Sign In</h3>
