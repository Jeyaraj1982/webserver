                                   ...
                                   <div class="card-body">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            <div class="col-sm-6" style="padding-left:0px">
                                                ...
                                                <div class="col-sm-12" style="padding: 0px;">
                                                    <div class="custom-control custom-checkbox">
                                                      <input type="checkbox" class="custom-control-input" id="AllowtoChangeStaff" name="AllowtoChangeStaff" <?php echo ($data[0]['AllowtoChangeStaff']==1) ? ' checked="checked" ' :'';?>>
                                            ...
                                            <div class="col-sm-6" style="padding-right:0px;">
                                                ...
                                                <div class="col-sm-12" style="padding: 0px;">
                                                    <div class="custom-control custom-checkbox">
                                                      <input type="checkbox" class="custom-control-input" id="AllowtochargeChangeStaff" name="AllowtochargeChangeStaff" <?php echo ($data[0]['AllowtochargeChangeStaff']==1) ? ' checked="checked" ' :'';?>>
