    ...
    if (isset($_POST['btnsubmit'])) {
        $ErrorCount =0;
            ...
            if($_POST['AlternativeMobileNumber']!=""){
                $dupAlternativeMobileNumber = $mysql->select("select * from _queen_agent where AlternativeMobileNumber='".$_POST['AlternativeMobileNumber']."' and AgentID<>'".$data[0]['AgentID']."'");
                if(sizeof($dupAlternativeMobileNumber)>0){
                    $ErrAlternativeMobileNumber ="Alternative Mobile Number Already Exist";
                    $ErrorCount++;
                }
            }
            if($ErrorCount==0){
            ...
            ?>
                <script>
                    $(document).ready(function() {
                        swal("Agent Updated Successfully", { 
                            icon:"success"
                        })
                    });
                </script>
			<?php  
                ...
                <script>
					 $(document).ready(function() {
						swal("", "Error update agent", "warning")
					 });
				</script>
           <?php   }
    }
                                ...
                                <form id="exampleValidation" method="POST" action="" enctype="multipart/form-data">
                                   <div class="card-body">
                                            ...
                                            <div class="col-sm-6" style="padding-right: 0px;">
                                                ...
                                                <div class="col-sm-12" style="padding-right: 0px;padding-left:0px">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control onlynumeric" maxlength="10" id="AlternativeMobileNumber" name="AlternativeMobileNumber" placeholder="Enter Mobile Number" value="<?php echo (isset($_POST['AlternativeMobileNumber']) ? $_POST['AlternativeMobileNumber'] :$data[0]['AlternativeMobileNumber']);?>">
                                                    </div>
                                    ...
                                    <div class="card-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="btn btn-warning" type="button" onclick="CallConfirmation()">Update Agent</button>&nbsp;
                                                <button class="btn btn-warning" type="submit" name="btnsubmit" id="btnsubmit" style="display: none;">Update Agent</button>
            ...
            var txt= '<div class="modal-header" style="padding-bottom:5px">'
                     ...
                     +'<div class="modal-body">'
                        +'<div class="form-group row">'                                                            
                            +'<div class="col-sm-12">'
                                +'Are you sure want to update agent?<br>'
                            +'</div>'
                        +'</div>'
                     +'</div>'
                     +'<div class="modal-footer">'
                        +'<button type="button" class="btn btn-outline-success" data-dismiss="modal" >Cancel</button>&nbsp;&nbsp;&nbsp;'
                        +'<button type="button" class="btn btn-success" onclick="UpdateAgent()" >Yes, Confirm</button>'
                     +'</div>';
