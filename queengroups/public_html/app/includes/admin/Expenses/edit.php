    ...
    if (isset($_POST['btnsubmit'])) {
        $ErrorCount =0;
            ...
            if($ErrorCount==0){
              ...
              $id = $mysql->execute("update _queen_expenses set ExpenseTypeID     ='".$ExpTypes[0]['ExpenseTypeID']."',
                                                                ...
                                                                UpdateBy          ='Admin',
																UpdateByID        ='".$_SESSION['User']['AdminID']."' where ExpenseID='".$data[0]['ExpenseID']."'"); 
            ?>
                <script>
			...
			<?php  } else {   ?>
                <script>
					 $(document).ready(function() {
						swal("", "Error update Expense", "warning")
					 });
				</script>
           <?php   }
    }
                                ...
                                <form id="exampleValidation" method="POST" action="" enctype="multipart/form-data">
                                   <div class="card-body">
										<div class="form-group form-show-validation row">
                                            ...
                                            <select class="form-control" name="ExpenseType" id="ExpenseType">
                                                ...
                                                <?php foreach($ExpenseTypes as $ExpenseType){ ?>
													<option value="<?php echo $ExpenseType['ExpenseTypeID'];?>" <?php echo (isset($_POST[ 'ExpenseType'])) ? (($_POST[ 'ExpenseType']==$ExpenseType['ExpenseTypeID']) ? " selected='selected' " : "") : (($data[0]['ExpenseTypeID']==$ExpenseType['ExpenseTypeID']) ? " selected='selected' " : "");?>><?php echo $ExpenseType['ExpenseType'];?></option>
												<?php } ?>
                                            </select>
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <input type="text" class="form-control" id="ShortDescription" name="ShortDescription" placeholder="Enter Expense Name" value="<?php echo (isset($_POST['ShortDescription']) ? $_POST['ShortDescription'] :$data[0]['ShortDescription']);?>">
										...
										<div class="form-group form-show-validation row">
                                            ...
                                            <input type="text" class="form-control" id="ExpenseAmount" name="ExpenseAmount" placeholder="Enter Expense Amount" value="<?php echo (isset($_POST['ExpenseAmount']) ? $_POST['ExpenseAmount'] :$data[0]['ExpenseAmount']);?>">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <select class="form-control" name="PaymentMode" id="PaymentMode">
                                                <option value="Cash" <?php echo (isset($_POST[ 'PaymentMode'])) ? (($_POST[ 'PaymentMode']=="Cash") ? " selected='selected' " : "") : (($data[0]['PaymentMode']=="Cash") ? " selected='selected' " : "");?>>Cash</option>
												<option value="Bank Transfer" <?php echo (isset($_POST[ 'PaymentMode'])) ? (($_POST[ 'PaymentMode']=="Bank Transfer") ? " selected='selected' " : "") : (($data[0]['PaymentMode']=="Bank Transfer") ? " selected='selected' " : "");?>>Bank Transfer</option>
												<option value="Cheque" <?php echo (isset($_POST[ 'PaymentMode'])) ? (($_POST[ 'PaymentMode']=="Cheque") ? " selected='selected' " : "") : (($data[0]['PaymentMode']=="Cheque") ? " selected='selected' " : "");?>>Cheque</option>
												<option value="DD" <?php echo (isset($_POST[ 'PaymentMode'])) ? (($_POST[ 'PaymentMode']=="DD") ? " selected='selected' " : "") : (($data[0]['PaymentMode']=="DD") ? " selected='selected' " : "");?>>DD</option>
											</select>
										...
										<div class="form-group form-show-validation row">
                                            ...
                                            <textarea class="form-control" id="ExpenseDetails" name="ExpenseDetails" placeholder="Enter Expense Details"><?php echo (isset($_POST['ExpenseDetails']) ? $_POST['ExpenseDetails'] :$data[0]['ExpenseDetails']);?></textarea>
                                    ...
                                    <div class="card-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="btn btn-warning" type="button" onclick="CallConfirmation()">Update Expense</button>&nbsp;
                                                <button class="btn btn-warning" type="submit" name="btnsubmit" id="btnsubmit" style="display: none;">Update Expense</button>
            ...
            var txt= '<div class="modal-header" style="padding-bottom:5px">'
                     ...
                     +'<div class="modal-body">'
                        +'<div class="form-group row">'                                                            
                            +'<div class="col-sm-12">'
                                +'Are you sure want to update expense?<br>'
                            +'</div>'
                        +'</div>'
                     +'</div>'
                     +'<div class="modal-footer">'
                        +'<button type="button" class="btn btn-outline-success" data-dismiss="modal" >Cancel</button>&nbsp;&nbsp;&nbsp;'
                        +'<button type="button" class="btn btn-success" onclick="UpdateExpense()" >Yes, Confirm</button>'
                     +'</div>';
