<?php 
     ...
     $ToY = isset($_POST['ToY']) ? $_POST['ToY'] : date("Y");
        ...
        $_POST['ToDate']=$toDate;
            $Expenses = $mysql->select("SELECT * FROM _queen_expenses where StaffID='".$_POST['Staff']."' and (date(CreatedOn)>=date('".$_POST['FromDate']."') and date(CreatedOn)<=date('".$_POST['ToDate']."') ) order by ExpenseID asc");
                    ...
                    <div class="card">
                        ...
                        <div class="card-body"> 
                            <div class="form-group row" style="padding: 0px;">
                                    <div class="col-sm-6">
                                        <h5 class="card-title" style="margin-bottom:5px;font-size:15px"><b>Staff Details</b></h5>
                                        <div class="form-group form-show-validation row" style="padding: 0px;">
                                            <label class="col-sm-4" for="name">Staff Code</label>
                                            <div class="col-sm-8"><?php echo $data[0]['StaffCode'];?></div> 
                                        </div>
                                        <div class="form-group form-show-validation row" style="padding: 0px;">
                                            <label class="col-sm-4" for="name">Staff Name</label>
                                            <div class="col-sm-8"><?php echo $data[0]['StaffName'];?></div> 
                                        </div>
                                        <div class="form-group form-show-validation row" style="padding: 0px;">
                ...
                <div class="col-md-12" style="max-width: 100%;position: relative;width: 100%;min-height: 1px;">
                    <div class="card" style="border-radius: 5px;background-color: #ffffff;margin-bottom: 30px;border: 0px;position: relative;flex-direction: column;min-width: 0;word-wrap: break-word;background-clip: border-box;">
                        <div class="card-body" style="padding: 0;border: 0px !important;margin: auto;flex: 1 1 auto;"> 
                            <h5 style="margin-bottom:0px;font-weight: bold;font-size:20px;margin-top: 0px;"><b>Expense Staff - Datewise Report</b></h5>
                                    ...
                                    <table class="table table-striped mt-3" border="1" style="width:100%" cellspacing="0" cellpadding="3">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-weight: 600;font-size: 14px;padding: 0 5px !important;vertical-align: middle !important;text-align: inherit;">Expense Type</th>
                                        ...
                                        <?php foreach($Expenses as $Expense){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 14px;padding: 0 5px !important;height: auto !important;vertical-align: middle !important;"><?php echo $Expense["ExpenseType"];?></td>
