<?php
    if (isset($_POST['btnsubmit'])) {
       ...
       <?php     }
                ...
                <script>
             $(document).ready(function() {
                swal("", "Error add customer", "warning")
             });
            </script>
           <?php   }
    }
                                ...
                                <form id="exampleValidation" method="POST" action="" enctype="multipart/form-data">
                                   <div class="card-body">
                                    ...
                                    <div class="card-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="btn btn-warning" type="button" onclick="CallConfirmation()">Add Customer</button>&nbsp;
            ...
            var txt= '<div class="modal-header" style="padding-bottom:5px">'
                     ...
                     +'<div class="modal-body">'
                        +'<div class="form-group row">'                                                            
                            +'<div class="col-sm-12">'
                                +'Are you sure want to add customer?<br>'
                            +'</div>'
                        +'</div>'
                     +'</div>'
