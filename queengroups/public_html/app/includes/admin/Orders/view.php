	            ...
	            <div class="col-md-12">
		            <div class="card card-invoice">
			            ...
			            <div class="card-footer">
							...
							<button type="button" onclick="location.href='dashboard.php?action=Orders/edit&id=<?php echo $_GET['id'];?>'" class="btn btn-outline-success submit_btn invoice-save-btm" style="float:right">Edit Order</button>
				        </div>
		            </div>
	            </div>
            </div>
