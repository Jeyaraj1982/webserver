...
$Page="login";
        if (isset($_POST['btnsubmit'])) {
         ...
         $userdata = $mysql->select("select * from _queen_staffs where LoginName='".$_POST['UserName']."' and LoginPassword='".$_POST['Password']."' ");
				if (sizeof($userdata)>0) {
					if($userdata[0]['IsActive']=="1"){
						$_SESSION['User']=$userdata[0];
						echo "<script>location.href='dashboard.php';</script>";
					}else{
						echo "<script>alert('Account Blocked, Please Contact Administrator');</script>" ;		
					}
                }  else {
...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center"> <img src="" style="height:128px;margin:0px auto"><br><br>Staff Sign In</h3>
