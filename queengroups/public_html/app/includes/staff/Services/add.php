<?php if($_SESSION['User']['AllowAddService']==0){ ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            ...
                            Not Allow to Create New Service. Please Contact Admin<br><br>
...
<?php
    if (isset($_POST['btnsubmit'])) {
       ...
       <?php     }
                ...
                <script>
             $(document).ready(function() {
                swal("", "Error create service", "warning")
             });
            </script>
           <?php   }
    }
                                ...
                                <form id="exampleValidation" method="POST" action="" enctype="multipart/form-data">
                                   <div class="card-body">
                                    ...
                                    <div class="card-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="btn btn-warning" type="button" onclick="CallConfirmation()">Create Service</button>&nbsp;
                                                <button class="btn btn-warning" type="submit" name="btnsubmit" id="btnsubmit" style="display: none;">Create Service</button>
            ...
            var txt= '<div class="modal-header" style="padding-bottom:5px">'
                     ...
                     +'<div class="modal-body">'
                        +'<div class="form-group row">'                                                            
                            +'<div class="col-sm-12">'
                                +'Are you sure want to create service?<br>'
                            +'</div>'
                        +'</div>'
                     +'</div>'
                     +'<div class="modal-footer">'
                        +'<button type="button" class="btn btn-outline-success" data-dismiss="modal" >Cancel</button>&nbsp;&nbsp;&nbsp;'
                        +'<button type="button" class="btn btn-success" onclick="CreateService()" >Yes, Confirm</button>'
                     +'</div>';
