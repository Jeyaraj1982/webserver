<?php if($_SESSION['User']['AllowEditAgent']==0){ ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            ...
                            Not Allow to Edit Agent. Please Contact Admin<br><br>
                            <button type="button" class="btn btn-outline-success" onclick="location.href='dashboard.php?action=Agent/list&status=All'">Continue</button>
                        </div>    
                    </div>
                </div>
            </div>
