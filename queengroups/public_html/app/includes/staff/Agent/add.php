<?php if($_SESSION['User']['AllowAddAgent']==0){ ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            ...
                            Not Allow to Create New Agent. Please Contact Admin<br><br>
                            ...
                            <div class="card-action">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-warning" type="submit" name="btnsubmit" id="btnsubmit" style="display: none;">Add Agent</button>
        ...
        if(ErrorCount==0) {
            var txt= '<div class="modal-header" style="padding-bottom:5px">'
                     ...
                     +'<div class="modal-footer">'
                        ...
                        +'<button type="button" class="btn btn-success" onclick="AddAgent()" >Yes, Confirm</button>'
                     +'</div>';
